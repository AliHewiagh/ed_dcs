...
(lib.T_features = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},1).wait(2).to({_off:false,startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},1).wait(2).to({_off:false},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({_off:true},1).wait(2).to({_off:false,startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1));
...
(lib.hackerholo = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_28 = new cjs.Graphics().p("");
	var mask_graphics_58 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-16.6,y:0}).wait(28).to({graphics:mask_graphics_28,x:-16.6,y:13.1}).wait(30).to({graphics:mask_graphics_58,x:-16.6,y:0}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-69.2,-87.5,106.4,175);
...
(lib.tapirhead = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({_off:true},1).wait(2).to({_off:false,startPosition:4},0).to({_off:true},1).wait(3).to({_off:false,startPosition:7},0).wait(1));
...
(lib.TAPIR_HERO = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(213,-226.9,1,1,40.3,0,0,20.7,-42.3);

	this.instance_1 = new lib.tapir_spacehelmet("single",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(49,-261.5,1,1,1.7,0,0,0.2,-0.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1,p:{regX:0.2,regY:-0.2,rotation:1.7,x:49,y:-261.5}},{t:this.instance}]},3).to({state:[{t:this.instance_1,p:{regX:0,regY:0,rotation:0,x:-5.4,y:-293.2}}]},1).to({state:[]},1).to({state:[{t:this.instance_1,p:{regX:0,regY:0,rotation:0,x:-5.4,y:-293.2}}]},2).to({state:[]},1).to({state:[{t:this.instance_1,p:{regX:0,regY:0,rotation:0,x:-5.4,y:-293.2}}]},4).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_3},{t:this.instance_2}]},3).to({state:[{t:this.instance_4,p:{regX:0,regY:0,rotation:-4,x:82.7,y:-184.5}}]},1).to({state:[]},1).to({state:[{t:this.instance_4,p:{regX:0.1,regY:-0.1,rotation:-7.3,x:87.1,y:-184.4}},{t:this.instance_5}]},2).to({state:[]},1).to({state:[{t:this.instance_4,p:{regX:0,regY:0,rotation:0,x:83.7,y:-181.3}}]},4).wait(1));

	// tapir body
	this.instance_6 = new lib.T_Body("single",3);
	this.instance_6.parent = this;
	this.instance_6.setTransform(15.7,-90.3,1,1,5.7,0,0,0,0.2);

	this.instance_7 = new lib.T_Legs("single",2);
	this.instance_7.parent = this;
	this.instance_7.setTransform(-3.8,-18.4,1,1,0,0,0,16.9,-193.8);

	this.instance_8 = new lib.T_shoulderPad_R("single",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(-136,-176.1);

	this.instance_9 = new lib.T_Arm_R("single",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-132.2,-192.4,1,1,0,0,0,-33.8,-140);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7,p:{startPosition:2}},{t:this.instance_6,p:{rotation:5.7,x:15.7,y:-90.3,startPosition:3}}]},3).to({state:[{t:this.instance_7,p:{startPosition:0}},{t:this.instance_9,p:{regX:-33.8,regY:-140,rotation:0,x:-132.2,y:-192.4,startPosition:0}},{t:this.instance_6,p:{rotation:0,x:-27.5,y:-125.1,startPosition:0}},{t:this.instance_8,p:{regX:0,regY:0,rotation:0,x:-136,y:-176.1}}]},1).to({state:[]},1).to({state:[{t:this.instance_7,p:{startPosition:0}},{t:this.instance_6,p:{rotation:0,x:-27.5,y:-125.1,startPosition:0}},{t:this.instance_9,p:{regX:-34.1,regY:-140.2,rotation:3.1,x:-114.3,y:-210.2,startPosition:5}},{t:this.instance_8,p:{regX:-0.1,regY:-0.1,rotation:6.2,x:-129.3,y:-192.7}}]},2).to({state:[]},1).to({state:[{t:this.instance_7,p:{startPosition:0}},{t:this.instance_9,p:{regX:-33.8,regY:-140,rotation:0,x:-132.2,y:-192.4,startPosition:0}},{t:this.instance_6,p:{rotation:0,x:-27.5,y:-125.1,startPosition:0}},{t:this.instance_8,p:{regX:0,regY:0,rotation:0,x:-136,y:-176.1}}]},4).wait(1));

	// Layer_6
	this.instance_10 = new lib.T_shoulderPad_L("single",1);
	this.instance_10.parent = this;
	this.instance_10.setTransform(137.6,-210.8,1,1,-74.5,0,0,0.1,0.1);

	this.instance_11 = new lib.T_Arm_L("single",9);
	this.instance_11.parent = this;
	this.instance_11.setTransform(106.9,-183.7,1,1,-91.8,0,0,-14.7,-117.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_11,p:{regX:-14.7,rotation:-91.8,x:106.9,y:-183.7,startPosition:9,regY:-117.2,scaleX:1,scaleY:1}},{t:this.instance_10}]},3).to({state:[{t:this.instance_11,p:{regX:-14.8,rotation:0,x:68.1,y:-194,startPosition:1,regY:-117.2,scaleX:1,scaleY:1}}]},1).to({state:[]},1).to({state:[{t:this.instance_11,p:{regX:-14.7,rotation:12.7,x:79.3,y:-180.2,startPosition:4,regY:-117.3,scaleX:1.101,scaleY:1.06}}]},2).to({state:[]},1).to({state:[{t:this.instance_11,p:{regX:-14.8,rotation:0,x:70.2,y:-184.3,startPosition:0,regY:-117.2,scaleX:1,scaleY:1}}]},4).wait(1));

	// tapir head
	this.instance_12 = new lib.tapirhead("single",11);
	this.instance_12.parent = this;
	this.instance_12.setTransform(47.7,-241.4,1,1,0,6.4,-173.6,-0.2,0);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(3).to({_off:false},0).wait(1).to({regX:-0.1,regY:0.1,skewX:4.5,skewY:-175.5,x:-1.4,y:-278.5,startPosition:4},0).to({_off:true},1).wait(2).to({_off:false,startPosition:7},0).to({_off:true},1).wait(4).to({_off:false,startPosition:11},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(3).to({_off:false},0).to({_off:true},2).wait(2).to({_off:false},0).to({_off:true},1).wait(4).to({_off:false},0).wait(1));
...
(lib.DigiBot = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_19,p:{regX:22.9,regY:-29,rotation:0,x:-64.4,y:-30.5,startPosition:0}},{t:this.instance_18,p:{regY:-19,skewX:0,skewY:0,x:-103.4,y:23.7}},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10,p:{startPosition:0}},{t:this.instance_9},{t:this.instance_8}]}).to({state:[]},1).to({state:[{t:this.instance_19,p:{regX:22.8,regY:-28.8,rotation:96,x:-22.5,y:-21.5,startPosition:1}},{t:this.instance_18,p:{regY:-18.8,skewX:170.2,skewY:-9.8,x:-93.3,y:-91.7}}]},1).to({state:[]},1).to({state:[{t:this.instance_19,p:{regX:22.9,regY:-29,rotation:0,x:-64.4,y:-30.5,startPosition:0}},{t:this.instance_18,p:{regY:-19,skewX:0,skewY:0,x:-103.4,y:23.7}},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10,p:{startPosition:5}},{t:this.instance_9},{t:this.instance_8}]},4).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_20).to({_off:true},1).wait(1).to({_off:false,rotation:1,x:9.5,y:210.5},0).to({_off:true},1).wait(4).to({_off:false,rotation:0,x:1.7,y:207.3},0).wait(1));
...
(lib.tEn3 = function(mode,startPosition,loop) {
	...
	this.mcCont.setTransform(343.3,21.5,0.35,0.35,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1));

	// Layer_1
	this.myTxt = new cjs.Text("Sure! Answer these questions and \nI’ll tell you where to find me.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	this.myTxt.lineWidth = 392;
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(135.8,-24.4);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AeZiLInIAAICXD9Im9j9MgxDAAA");
	this.shape.setTransform(136.1,61.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AeZGdIAAs0Mg8xAAAIAAM0");
	this.shape_1.setTransform(136.1,6.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("Ajeh+IElAAICYD9g");
	this.shape_2.setTransform(277.8,60.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(0,0,0,0.898)").s().p("AXQGaIkmAAMgxBAAAIAAszMA8wAAAIAAMzg");
	this.shape_3.setTransform(136.1,6.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tEn3, new cjs.Rectangle(-62.4,-35.5,430.5,113.1), null);
...
(lib.tEn1 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(165.9,-2.2,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_6
	this.myTxt2 = new cjs.Text("Are you sure we landed on \nthe right planet? ", "italic bold 20px 'Quantico'", "#0EE0E0");
	...
	this.myTxt2.setTransform(18.6,-75.4);
	...
	// Layer_7
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("A35i8IGRAAIi/FVIFNlVMAnUAAA");
	this.shape.setTransform(17.9,10.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AX6F0IAAriMgvzAAAIAALi");
	this.shape_1.setTransform(17.9,-45.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("AAZiqICOAAIlMFVg");
	this.shape_2.setTransform(-97.5,8.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AvaFxIiOAAImRAAIAArhMAvzAAAIAALhg");
	this.shape_3.setTransform(17.9,-45.1);
	...
	// Layer_8
	this.myTxt1 = new cjs.Text("There's no one here.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 251;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(-105.6,-184.1);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_9
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#0EE0E0").ss(4,0,0,3).p("AUCjGI8/AAIkbFoICGloIovAA");
	this.shape_4.setTransform(-103.4,-127.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#0EE0E0").ss(1,0,0,3).p("A0BDYIAAmpMAoDAAAIAAGp");
	this.shape_5.setTransform(-103.4,-169);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("ArSAgIovAAIAAmoMAoDAAAIAAGoI8/AAIkbFpg");
	this.shape_6.setTransform(-103.4,-150.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-233.6,-191.1,260.5,85.4);
...
(lib.tBm3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("Pasti! Jawablah soalan ini dan saya akan\n beritahu awak di mana awak harus mencari saya.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	...
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(64.3,-24.4);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EApfgCLInJAAICYD9Im9j9MhHPAAA");
	this.shape.setTransform(65.1,61.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EApfAGdIAAs0MhS9AAAIAAM0");
	this.shape_1.setTransform(65.1,6.2);
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(0,0,0,0.898)").s().p("EAiWAGaIkmAAMhHNAAAIAAszMBS8AAAIAAMzg");
	this.shape_3.setTransform(65.1,6.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tBm3, new cjs.Rectangle(-202.4,-35.5,570.5,113.1), null);
...
(lib.tBm1 = function(mode,startPosition,loop) {
	...
	// Layer_6
	this.myTxt2 = new cjs.Text("Awak pasti ke kita mendarat \ndi planet yang betul?", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 313;
	...
	// Layer_1
	this.myTxt1 = new cjs.Text("Tak ada seorang pun di sini.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 325;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(-106.6,-184.1);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_2
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#0EE0E0").ss(4,0,0,3).p("AZMjGMghrAAAIkbFoICGloIuXAA");
	this.shape_4.setTransform(-106.4,-127.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#0EE0E0").ss(1,0,0,3).p("A5LDYIAAmpMAyXAAAIAAGp");
	this.shape_5.setTransform(-106.4,-169);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("Aq0AgIuXAAIAAmoMAyXAAAIAAGoMghrAAAIkbFpg");
	this.shape_6.setTransform(-106.4,-150.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-271.3,-191.1,329.4,85.4);
...
p.nominalBounds = new cjs.Rectangle(-163.4,-55.5,570.5,112.6);
...
p.nominalBounds = new cjs.Rectangle(-287.6,-204.6,329.4,84.9);


// stage content:
(lib.intro7 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{a1:1,a2:208});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(3).call(this.frame_4).wait(197).call(this.frame_201).wait(7).call(this.frame_208).wait(54).call(this.frame_262).wait(1));

	// t
	this.instance = new lib.dialogue1();
	this.instance.parent = this;
	this.instance.setTransform(613.5,424.4);

	this.instance_1 = new lib.dialogue3();
	this.instance_1.parent = this;
	this.instance_1.setTransform(194,111.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},136).to({state:[]},72).to({state:[{t:this.instance_1}]},19).wait(36));

	// Mist
	this.instance_2 = new lib.buss();
	this.instance_2.parent = this;
	this.instance_2.setTransform(256.6,314.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:425.6},56,cjs.Ease.get(1)).wait(152).to({scaleX:1.28,scaleY:1.28,x:238.8,y:264.4},0).wait(55));

	// Digi-Bot
	this.instance_3 = new lib.DigiBot("single",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(-214,543.6,0.3,0.3,0,0,180,-2.6,66);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:462},124).wait(12).to({startPosition:7},0).wait(40).to({startPosition:2},0).wait(32).to({regX:-2.8,scaleX:0.38,scaleY:0.38,x:285.4,y:557.2,startPosition:7},0).wait(55));

	// TAPIR_HERO
	this.instance_4 = new lib.TAPIR_HERO("single",3);
	this.instance_4.parent = this;
	this.instance_4.setTransform(199.8,538.5,0.3,0.3,0,0,0,0,401.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:368.8},56,cjs.Ease.get(1)).wait(120).to({startPosition:4},0).wait(32).to({scaleX:0.38,scaleY:0.38,x:199.1,y:550.6,startPosition:12},0).wait(30).to({x:166.1,startPosition:7},0).wait(25));

	// hacker
	this.instance_5 = new lib.hackerholo();
	this.instance_5.parent = this;
	this.instance_5.setTransform(648,317.8,0.539,0.063,0,0,0,0.2,2.4);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(208).to({_off:false},0).to({regX:0.1,regY:0.2,scaleX:1.89,scaleY:1.89,x:627.6,y:309.5},19,cjs.Ease.backOut).wait(36));

	// bg
	this.instance_6 = new lib.bgG("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(314,300.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({x:481.1},56,cjs.Ease.get(1)).wait(152).to({scaleX:1.28,scaleY:1.28,x:309.8,y:246.1},0).wait(55));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-194.2,175.4,2011,792);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/intro7/Bitmap1.png?1522467578002", id:"Bitmap1"},
		{src:"images/intro7/Bitmap4.png?1522467578002", id:"Bitmap4"},
		{src:"images/intro7/Bitmap5.png?1522467578002", id:"Bitmap5"},
		{src:"images/intro7/Bitmap6.png?1522467578002", id:"Bitmap6"},
		{src:"sounds/intro.mp3?1522467578002", id:"intro"}
	],
	preloads: []
};
