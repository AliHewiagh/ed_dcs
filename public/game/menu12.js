...
p.nominalBounds = new cjs.Rectangle(0,0,319,326);
...
(lib.planet13c = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_3
	this.instance = new lib.Bitmap22();
	this.instance.parent = this;
	this.instance.setTransform(-128,-130,0.799,0.799);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-128,-130,255,260.6);
...
(lib.mcTxt2En = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET GEREBOOTY", "italic bold 28px 'Quantico'", "#0EE0E0");
...
(lib.mcTxt2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET JEREBUTI", "italic bold 28px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.lineHeight = 42;
...
(lib.animPlanet13 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.planet13c("single",0);
	this.instance.parent = this;
...
p.nominalBounds = new cjs.Rectangle(-127.8,-137.7,255,260.6);
...
// stage content:
(lib.menu12 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(90).call(this.frame_94).wait(53).call(this.frame_147).wait(41).call(this.frame_188).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(188).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnCont).wait(147).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(147).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(133).to({_off:false},0).wait(56));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(92).to({_off:false},0).wait(97));

	// planet13
	this.instance_4 = new lib.animPlanet13();
	this.instance_4.parent = this;
	this.instance_4.setTransform(1099.8,330.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(19).to({x:409.8},89,cjs.Ease.cubicInOut).wait(81));

	// planet12
	this.instance_5 = new lib.animPlanet12();
	this.instance_5.parent = this;
	this.instance_5.setTransform(398.2,308.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(19).to({x:-391.8},89,cjs.Ease.quadInOut).to({_off:true},1).wait(80));

	// planet17
	this.instance_6 = new lib.animPlanet17();
	this.instance_6.parent = this;
	this.instance_6.setTransform(164.5,342.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(19).to({x:14.5},89,cjs.Ease.quadInOut).wait(81));

	// planet16
	this.instance_7 = new lib.animPlanet16();
	this.instance_7.parent = this;
	this.instance_7.setTransform(554.5,282.9,0.5,0.5,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(19).to({x:364.5},89,cjs.Ease.quadInOut).wait(81));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(61).to({_off:false},0).wait(128));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(76).to({_off:false},0).wait(113));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(54).to({_off:false},0).wait(135));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(27).to({_off:false},0).wait(162));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(38).to({_off:false},0).wait(151));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(189));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(319.3,274,1307.7,795.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/menu12/Bitmap21.png?1527433280688", id:"Bitmap21"},
		{src:"images/menu12/Bitmap22.png?1527433280688", id:"Bitmap22"},
		{src:"images/menu12/Bitmap3.png?1527433280688", id:"Bitmap3"},
		{src:"images/menu12/Bitmap4.png?1527433280688", id:"Bitmap4"},
		{src:"images/menu12/Bitmap5.png?1527433280688", id:"Bitmap5"},
		{src:"images/menu12/Bitmap6.png?1527433280688", id:"Bitmap6"},
		{src:"images/menu12/Bitmap7.png?1527433280688", id:"Bitmap7"},
		{src:"images/menu12/Bitmap8.png?1527433280688", id:"Bitmap8"},
		{src:"images/menu12/blobPlanet.png?1527433280688", id:"blobPlanet"},
		{src:"images/menu12/greenplanet2.png?1527433280688", id:"greenplanet2"},
		{src:"sounds/bleep_stutter.mp3?1527433280688", id:"bleep_stutter"},
		{src:"sounds/menuRock2.mp3?1527433280688", id:"menuRock2"},
		{src:"sounds/stdClick.mp3?1527433280688", id:"stdClick"}
	],
	preloads: []
};
