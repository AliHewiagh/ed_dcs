...
(lib.actMc3_1_3 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		function submitAns(e){
			...
			userAns[4] + ", " + userAns[5] + ", " + userAns[6] + ", " + userAns[7] + ", " + userAns[8];
			for (var i=1; i<=maxItem; i++){
			...
			if (cCount==maxItem){
				...
				//wrong
				_this.parent.sendScore(_userAns, 0);
			}
		}
...
// stage content:
(lib.f5s14 = function(mode,startPosition,loop) {
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/f5s14/Bitmap21.png", id:"Bitmap21"},
		{src:"images/f5s14/Bitmap22.png", id:"Bitmap22"},
		{src:"images/f5s14/Bitmap23.png", id:"Bitmap23"},
		{src:"images/f5s14/Bitmap27.png", id:"Bitmap27"},
		{src:"images/f5s14/Bitmap3.png", id:"Bitmap3"},
		{src:"images/f5s14/Bitmap9.png", id:"Bitmap9"},
