...
p.nominalBounds = new cjs.Rectangle(0,0,266,78);


(lib.Bitmap2 = function() {
	this.initialize(img.Bitmap2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,257,112);
...
(lib.a_mouth = function(mode,startPosition,loop) {
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
...
(lib.a_leg = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#206C67").s().p("");
	this.shape_2.setTransform(28,24.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#2A8D87").s().p("");
	...
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	...
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	...
	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#2A8D87").s().p("");
...
(lib.a_face = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,0,0,3,true).p("");
...
(lib.a_eye = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1,3,true).p("AAbgRQAUAnAWALQACAAABABQAOAGAdAAQA4AEAsAsACPgwQhJAJgBBIAiygWQAAAAABAAIAAAAQgBABAAgBgAjWgtQAMAZAYgCAixgWQACgBAEgBQAHgCANgFQAXgIAYAJQAUAGALAOAhshXQhFAOAAAz");
...
(lib.a_body = function(mode,startPosition,loop) {
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1,1,1,3,true).p("AFZgqQhVh8hEhSQgzg8gqgmQgpgkgsgQQgTgIgVgDQhDgMhbAoQhcAnkHDNQieB8ADBvQACBJBHBFQAvApBUAgQDRBOGyAUQJjAbhNk3QhOk2i3iQQgxgmgtgTQiAg2hpBc");
	this.shape_6.setTransform(-6.5,45.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#85402A").s().p("ACZGUQmygTjRhPQhUgggvgpQhHhEgChKQBXB0BxgGQADguAMgwQAhiDBYhtQCCihDyhvQAsAQApAkQAqAmAzA8QBEBSBVB8QhVh8hEhSQAnhAA5grQAVgQAXgNQAtATAxAmQC3CQBOE2QBGEen+AAQgsAAgygCgADAj/IAAAAg");
...
(lib.a_armR = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	...
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	...
	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#D1D06B").s().p("Ai0GFQgxgVgehpIg5jHQgPg0gGgYQgLgrgDgjQgCglAIgVQAFgNAKgLQAGgGAHgEIAAArQAMAJAMAGQA/AiBWgvIANgIIACgkQAZAHAOAkQALAeACAuIACBNQAGBVAqBLIAKAzIgKgzQgQhYgDhDQBjiTByiAQBUhfBmg0IhnGcQiyFOifAxQgcAIgYACQgSgEgXgKgAiDiRIAUgNIgUANg");
	...
	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFE83").s().p("AkWEuQgoimgqiPQgqiQBdgaIAAAVQgHAEgGAGQgKALgFANQgIAVACAlQADAjALAqQAGAZAPA0IA5DHQAeBpAxAVQAXAKASAEIgOABQhnAAgeiAgAhDApIgChNQgCgugLgeQgOgkgZgHIABgiQBaA6gIBlIgBAOIgBAWIACAoIgCgoIABgWQDek5C/hkIgNA1QhmA1hUBeQhyCAhjCTQADBDAQBZQgqhLgGhWg");
	...
	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_19.setTransform(5.8,-8.1);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	...
	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f().s("#000000").ss(1,1,1,3,true).p("AhbAOQgmghgygUQAWhqgQhoIBMAAQAzA2ABBlQAWgEASALQAtAbAOB8QgaAyg0gGAChBsIgTBnQhYBHhyg9IAkhxQgag3gpgnAgtheQg5AbALBRAChBsQAsgjg3hJQgUhWiHgBAChBsQh+Axg7gx");
	...
	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#999999").s().p("AAmCyQgZg3gpgmQgCgNAAgLQAAg9AvgXQgvAXAAA9QAAALACANQgmgigygUQAWhqgQhnIBMAAQAyA2ABBlQAXgEARAKQAuAbAOB9QgXAsgtAAIgLgBg");
...
(lib.a_armL = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,0,0,3,true).p("");
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFE83").s().p("AiGBVQBpgNBsgIQgqgBgziiQgGgZgDgXQAGACAGAFQAaAUAaAvQAYAsAvA7QATgPAXgLQASgIAYgEQgQASgFAQQgIAZABAJIgBAAIhYAEQAOgTATgPQgTAPgOATIBYgEIABAAQAuAAARADIARADIgRAAIg/AEIg1AFIiLARQhwANghAIQggAIgaAVIADAAQgHABgHACIgJADQAgg2BRgJgABPBAIAAAAg");
	...
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1,1,1,3,true).p("AENDPQgWAegfAZQoZimmQgNQiBhyBFjtQAgAHAnAFQChAZEGANQEnAPEGCTQAaAPAZAPQADAWAAATQACByg5BOIBZAcQAKgIAJgJIB9AzIBLg+QBzhCBygPQgPhMgjg0QhLgFg9AWQgCgugZgRQAtgSAxgGQApAcAcAqAJBDPQAth9gChDAG0A4IhwgpAF5DaQA8g8gBhmQBIhIBVgg");
	this.shape_10.setTransform(75.2,11.3);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#737373").s().p("AhHgzIABAAIADgBIABgBQAwgRA3AAIAAAAIAAAAIAVAAIAGABQAkA1AOBLQhyAPhxBCQAsh9gChCgAhih0QAugRAxgGQAnAcAcAqIgGgBIgVAAIAAAAIAAAAQg3AAgwARIgBABIgDABIgBAAQgCgvgZgSgABAhFIAAAAg");
	...
	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_16.setTransform(-28.2,55.9);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#737373").s().p("AilBpQAJgeAKgZQAahEAig1QAXgiAbgbQAVAJARAPIgoBlIhKCMQgcgLgZgRgAA5B0Ig3huIgogNIAohlQBBA1AdByQAngYAbg9QARBTgyA2QgbAGgZAAIgUgBgAAChsIAAAAg");
	...
	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFE83").s().p("AjCE0QgSgJgSgEQAshhCZABQBMABBMAMQA3AJA3APQg3gPg3gJQA1kKgFkMQA1CYAJDAQAEBRgECFQlYgWg1BtQgNgJgNgGg");
...
(lib.key_in_box = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-166,-167.3,1.467,1.467);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(153));

	// Layer_4
	this.instance_1 = new lib.green("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(21.4,34.2,7.891,7.891);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(153));

	// Layer_1
	this.instance_2 = new lib.key("single",1);
	this.instance_2.parent = this;
	this.instance_2.setTransform(1.8,17.7,0.789,0.789,0,0,0,113.5,98.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(153));

	// Layer 5
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#00CC66","rgba(0,204,102,0)"],[0,1],-5.9,-8.4,0,-5.9,-8.4,153).s().p("A5QG8IBu4xIXXAAIZcFTIkLb6I73Ceg");
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(-191,29.2,1.467,1.467);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(153));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-191,-167.3,415.3,360.9);
...
(lib.tEn5 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt1 = new cjs.Text("I have no idea what this key is for. Nobody has been able \nto retrieve it. You can try by answering these questions.", "italic bold 20px 'Quantico'", "#0EE0E0");
...
(lib.tEn3 = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A2jHGIAAm8IIAAAIkanCIJYHCMAgJAAAIAAG8");
	this.shape_1.setTransform(410.9,478.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("A2jHAIAAm8IIAAAIkanDIJYHDMAgJAAAIAAG8g");
	this.shape_2.setTransform(410.9,479.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_4
	this.myTxt1 = new cjs.Text("Did I hear you \nsay ‘Mabusa’?", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 234;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(246.1,12.4);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_5
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("ARYjFIoFAAICqFsInRlsI2DAA");
	this.shape_3.setTransform(245.4,99.8);
	...
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("AEtDFI2EAAIAAr2MAivAAAIAAL2IoFAAICqFtg");
	this.shape_5.setTransform(245.4,60.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(127.3,3.2,237.8,118.5);
...
(lib.tBm5 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(393,160.5,0.35,0.35,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1));

	// Layer_1
	this.myTxt1 = new cjs.Text("Saya tidak tahu apa kegunaan kunci ini. Tiada siapa \nyang pernah dapat mengambilnya. Awak cubalah \ndengan menjawab soalan-soalan berikut.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 576;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(102.8,68.7);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EAsjANoIAAxbMgm5AAAIGipnIrvJnMgs/AAAIAARb");
	this.shape.setTransform(103.4,83.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EgsiAAAMBZFAAA");
	this.shape_1.setTransform(103.4,171);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("EgsiANhIAAxbMAs/AAAILvpmImiJmMAm5AAAIAARbg");
	this.shape_2.setTransform(103.4,84.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tBm5, new cjs.Rectangle(-187.3,-3.4,605.2,187.4), null);
...
(lib.tBm4 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(324,36,0.35,0.35,0,0,0,0.5,0.5);
	...
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(100.2,19.7);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EgiaADxIAAncMBE1AAAIAAHc");
	this.shape.setTransform(100.2,35.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EAibgDPItwAAIHCGHIr+mHMgyJAAA");
	this.shape_1.setTransform(100.2,80.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("APvAqMgyJAAAIAAnbMBE1AAAIAAHbItwAAIHCGIg");
	this.shape_2.setTransform(100.2,55.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tBm4, new cjs.Rectangle(-123.6,11.2,472.5,92.3), null);
...
(lib.tBm3 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(595.4,525.9,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;
	...
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(419.5,486.9);
	this.myTxt2._off = true;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("A87AAMA53AAA");
	this.shape.setTransform(421.7,523.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A87GtIAAm7IMsAAIkamSIJYGSArCgOMAn+AAAIAAG7");
	this.shape_1.setTransform(421.7,481);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("A87GnIAAm7IMsAAIkamSIJYGSIAPAAMAn+AAAIAAG7g");
	this.shape_2.setTransform(421.7,481.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_5
	this.myTxt1 = new cjs.Text("Saya terdengar awak\nmenyebut nama ‘Mabusa’.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 310;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(248.1,12.4);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_6
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AYDjBIvHAAIBuFjImVljI8XAA");
	this.shape_3.setTransform(247.8,99.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A4CF+IAAr2MAwFAAAIAAL2");
	this.shape_4.setTransform(247.8,41.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("AEVDKI8XAAIAAr2MAwFAAAIAAL2IvHAAIBuFjg");
	this.shape_5.setTransform(247.8,59.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(91.2,3.2,313.9,117.6);
...
(lib.tBm1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("Apa agaknya yang Mabusa lakukan di sini.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	this.myTxt.lineWidth = 479;
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(122.7,8.7);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EAk1AEFIAAoEMhJpAAAIAAIE");
	this.shape.setTransform(125.4,23.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EAk1gHKMgugAAAImgNsICMtsI21AA");
	this.shape_1.setTransform(125.4,95.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("At/izI21AAIAAoEMBJpAAAIAAIEMgufAAAImgNrg");
	this.shape_2.setTransform(125.4,67.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tBm1, new cjs.Rectangle(-118.9,-2.8,510.5,146.3), null);
...
p.nominalBounds = new cjs.Rectangle(-315.2,-37.1,605.2,187.4);
...
p.nominalBounds = new cjs.Rectangle(-251.6,-22,472.5,91.8);
...
p.nominalBounds = new cjs.Rectangle(-36.8,-30,313.9,117.1);
...
p.nominalBounds = new cjs.Rectangle(-204.3,-36,510.5,145.8);
...
(lib.intro15 = function(mode,startPosition,loop) {
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(535.5,429.9,0.107,0.107,0,0,0,11.2,9.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({_off:true},59).wait(66).to({_off:false,regX:11.5,scaleX:0.27,scaleY:0.27,x:499.7,y:406},0).wait(34).to({regX:11.3,scaleX:1,scaleY:1,x:493.7,y:393.3},0).wait(26));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/intro15/Bitmap1.png?1527794853374", id:"Bitmap1"},
		{src:"images/intro15/Bitmap2.png?1527794853374", id:"Bitmap2"},
		{src:"images/intro15/Bitmap5.png?1527794853374", id:"Bitmap5"},
		{src:"images/intro15/Bitmap6.png?1527794853374", id:"Bitmap6"},
		{src:"images/intro15/Bitmap7.png?1527794853374", id:"Bitmap7"},
		{src:"images/intro15/Bitmap8.png?1527794853374", id:"Bitmap8"},
		{src:"sounds/intro.mp3?1527794853374", id:"intro"}
	],
	preloads: []
};
