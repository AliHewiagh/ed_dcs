...
p.nominalBounds = new cjs.Rectangle(0,0,60,62);
...
p.nominalBounds = new cjs.Rectangle(0,0,53,54);
...
(lib.eggyplanet = function() {
	this.initialize(img.eggyplanet);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,279,281);


(lib.gloomplanet = function() {
	this.initialize(img.gloomplanet);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,492,492);


(lib.pinkplanet = function() {
	this.initialize(img.pinkplanet);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,376,351);


(lib.PlanetMenu1 = function() {
	this.initialize(img.PlanetMenu1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,315,314);// helper functions:
...
(lib.planet17s = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_2
	this.instance = new lib.PlanetMenu1();
	this.instance.parent = this;
	this.instance.setTransform(-145,-144,0.917,0.917);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-145,-144,288.9,288);
...
(lib.planet16 = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib.eggyplanet();
	this.instance.parent = this;
	this.instance.setTransform(-122,-123,0.872,0.872);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-122,-123,243.3,245);


(lib.planet14 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_6
	this.instance = new lib.gloomplanet();
	this.instance.parent = this;
	this.instance.setTransform(-193,-193,0.785,0.785);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-193,-193,386,386);
...
(lib.mcTxt2En = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET EARTH", "italic bold 28px 'Quantico'", "#0EE0E0");
...
(lib.mcTxt2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET BUMI", "italic bold 28px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.lineHeight = 42;
...
}).prototype = getMCSymbolPrototype(lib.mcTxt2, new cjs.Rectangle(-78.8,-22,364.8,44.1), null);
...
(lib.hlCorner = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#0EE0E0").ss(1,1,1).p("ApwJxIAAn0AB9pwIH0AA");
...
(lib.gs_motion = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(-28,-30);

	this.instance_2 = new lib.Bitmap30();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-31,-33);

	this.instance_3 = new lib.Bitmap31();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-31,-33);

	this.instance_4 = new lib.Bitmap32();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-25,-26);

	this.instance_5 = new lib.Bitmap33();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-31,-33);

	this.instance_6 = new lib.Bitmap34();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-30,-31);

	this.instance_7 = new lib.Bitmap35();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-31,-33);
...
p.nominalBounds = new cjs.Rectangle(-31,-33,66,69);
...
p.nominalBounds = new cjs.Rectangle(-78.8,-14,364.8,44.1);
...
(lib.animPlanet17d = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.planet17s("single",0);
	this.instance.parent = this;
...
p.nominalBounds = new cjs.Rectangle(-144.8,-151.7,288.9,288);


(lib.animPlanet17c = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.planet14("synched",0);
	this.instance.parent = this;
...
p.nominalBounds = new cjs.Rectangle(-187.5,-179.4,386,386);
...
p.nominalBounds = new cjs.Rectangle(-118.4,-122.1,243.3,245);
...
// stage content:
(lib.menu20 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(90).call(this.frame_94).wait(61).call(this.frame_155).wait(41).call(this.frame_196).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(196).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnCont).wait(155).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(155).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(141).to({_off:false},0).wait(56));
	...
	this.shape_19.graphics.f("#666666").s().p("AjXFQIAJhWICjAAIAxneIirBfIAKhhIDAhpIBNAAIg9JJICiAAIgJBWg");
	this.shape_19.setTransform(118,151.4);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#666666").s().p("Aj3FQIAgktIB2hAIDgAAIAXjcIjvAAIgJBXIhhAAIALhsIB3hBIDQAAIBoBBIgbEIIh2A/IjgAAIgUDBIFPAAIgJBWg");
	this.shape_20.setTransform(112.5,151.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1,p:{x:111.2}},{t:this.shape}]},119).to({state:[{t:this.shape_3,p:{x:120.3}},{t:this.shape_2,p:{x:178.9}}]},1).to({state:[{t:this.shape_5,p:{x:114.5}},{t:this.shape_4}]},1).to({state:[{t:this.shape_7},{t:this.shape_6}]},1).to({state:[{t:this.shape_1,p:{x:115.1}},{t:this.shape_8}]},1).to({state:[{t:this.shape_3,p:{x:113.1}},{t:this.shape_9}]},1).to({state:[{t:this.shape_5,p:{x:114.1}},{t:this.shape_10}]},1).to({state:[{t:this.shape_12},{t:this.shape_11}]},1).to({state:[{t:this.shape_3,p:{x:113.1}},{t:this.shape_13}]},1).to({state:[{t:this.shape_5,p:{x:114.1}},{t:this.shape_14}]},1).to({state:[{t:this.shape_15,p:{x:115.1}},{t:this.shape}]},1).to({state:[{t:this.shape_16,p:{x:124.2}},{t:this.shape_2,p:{x:178.9}}]},1).to({state:[{t:this.shape_17},{t:this.shape_4}]},1).to({state:[{t:this.shape_15,p:{x:116.4}},{t:this.shape_6}]},1).to({state:[{t:this.shape_18},{t:this.shape_8}]},1).to({state:[{t:this.shape_16,p:{x:117}},{t:this.shape_9}]},1).to({state:[{t:this.shape_19},{t:this.shape_10}]},1).to({state:[{t:this.shape_2,p:{x:119.9}},{t:this.shape_11}]},1).to({state:[{t:this.shape_16,p:{x:117}},{t:this.shape_13}]},1).to({state:[{t:this.shape_19},{t:this.shape_14}]},1).to({state:[{t:this.shape_20},{t:this.shape}]},2).wait(57));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(92).to({_off:false},0).wait(105));

	// planet19
	this.instance_4 = new lib.animPlanet17d();
	this.instance_4.parent = this;
	this.instance_4.setTransform(1160.3,329.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(19).to({x:400},89,cjs.Ease.cubicInOut).wait(89));

	// planet20
	this.instance_5 = new lib.animPlanet17c();
	this.instance_5.parent = this;
	this.instance_5.setTransform(395,308.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(19).to({x:-391},89,cjs.Ease.quadInOut).to({_off:true},1).wait(88));

	// planetbg
	this.instance_6 = new lib.animPlanet17copy();
	this.instance_6.parent = this;
	this.instance_6.setTransform(184.5,342.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(19).to({x:64.5},89,cjs.Ease.quadInOut).wait(89));

	// planetbg
	this.instance_7 = new lib.animPlanet16();
	this.instance_7.parent = this;
	this.instance_7.setTransform(565.3,260.9,0.5,0.5,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(19).to({x:499.3},89,cjs.Ease.quadInOut).wait(89));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(61).to({_off:false},0).wait(136));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(76).to({_off:false},0).wait(121));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(54).to({_off:false},0).wait(143));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(27).to({_off:false},0).wait(170));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(38).to({_off:false},0).wait(159));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(1).to({_off:false},0).wait(196));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(197));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(319.3,300,1385.1,769.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/menu20/Bitmap28.png?1529798683832", id:"Bitmap28"},
		{src:"images/menu20/Bitmap29.png?1529798683832", id:"Bitmap29"},
		{src:"images/menu20/Bitmap3.png?1529798683832", id:"Bitmap3"},
		{src:"images/menu20/Bitmap30.png?1529798683832", id:"Bitmap30"},
		{src:"images/menu20/Bitmap31.png?1529798683832", id:"Bitmap31"},
		{src:"images/menu20/Bitmap32.png?1529798683832", id:"Bitmap32"},
		{src:"images/menu20/Bitmap33.png?1529798683832", id:"Bitmap33"},
		{src:"images/menu20/Bitmap34.png?1529798683832", id:"Bitmap34"},
		{src:"images/menu20/Bitmap35.png?1529798683832", id:"Bitmap35"},
		{src:"images/menu20/Bitmap4.png?1529798683832", id:"Bitmap4"},
		{src:"images/menu20/Bitmap5.png?1529798683832", id:"Bitmap5"},
		{src:"images/menu20/Bitmap6.png?1529798683832", id:"Bitmap6"},
		{src:"images/menu20/Bitmap7.png?1529798683832", id:"Bitmap7"},
		{src:"images/menu20/Bitmap8.png?1529798683832", id:"Bitmap8"},
		{src:"images/menu20/eggyplanet.png?1529798683832", id:"eggyplanet"},
		{src:"images/menu20/gloomplanet.png?1529798683832", id:"gloomplanet"},
		{src:"images/menu20/pinkplanet.png?1529798683832", id:"pinkplanet"},
		{src:"images/menu20/PlanetMenu1.png?1529798683832", id:"PlanetMenu1"},
		{src:"sounds/bleep_stutter.mp3?1529798683832", id:"bleep_stutter"},
		{src:"sounds/menuRock2.mp3?1529798683832", id:"menuRock2"},
		{src:"sounds/stdClick.mp3?1529798683832", id:"stdClick"}
	],
	preloads: []
};
