...
p.nominalBounds = new cjs.Rectangle(0,0,824,1666);


(lib.Bitmap6 = function() {
	this.initialize(img.Bitmap6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,837,633);// helper functions:
...
(lib.bird = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AgigLQAYAGAQAUQAJgUARgTIADgBQgNAZgLAXIgBADQgUgSgYgTg");

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AglASQAUgOANgWQALAWAfAEQgYAIgSgVQgNAYgPAAIgFgBg");
	this.shape_1.setTransform(1.3,3.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.shape_1}]},9).wait(9));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-3.5,-2.6,7,5.2);
...
(lib.db_face = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance,p:{startPosition:0}}]}).to({state:[]},1).to({state:[{t:this.shape},{t:this.instance,p:{startPosition:1}}]},1).to({state:[{t:this.shape},{t:this.instance,p:{startPosition:3}}]},1).to({state:[]},1).to({state:[{t:this.shape},{t:this.instance,p:{startPosition:4}}]},1).to({state:[{t:this.shape},{t:this.instance,p:{startPosition:5}}]},1).wait(1));
...
(lib.birds = function(mode,startPosition,loop) {
	...
	// bird
	this.instance = new lib.bird("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(165.8,-102.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:178.3,y:-134.4,startPosition:4},76).wait(1));

	// bird
	this.instance_1 = new lib.bird("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(238.5,-75.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:252.1,y:-91.1,startPosition:4},76).wait(1));

	// bird
	this.instance_2 = new lib.bird("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(290.1,7.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:304.9,y:-17.3,startPosition:4},76).wait(1));

	// bird
	this.instance_3 = new lib.bird("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(253.7,79);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:259.4,y:76.7,startPosition:4},76).wait(1));

	// bird
	this.instance_4 = new lib.bird("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-44.9,-46.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:-42.7,y:-59.9,startPosition:4},76).wait(1));

	// bird
	this.instance_5 = new lib.bird("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(34.1,-40.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({startPosition:4},76).wait(1));

	// bird
	this.instance_6 = new lib.bird("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(-12.1,31);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({x:-18.9,y:-0.8,startPosition:4},76).wait(1));

	// bird
	this.instance_7 = new lib.bird("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(25.5,102.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({y:77.8,startPosition:4},76).wait(1));

	// bird
	this.instance_8 = new lib.bird("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(-290,-64);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({x:-301.4,y:-84.4,startPosition:4},76).wait(1));

	// bird
	this.instance_9 = new lib.bird("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-252.9,5);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({x:-232.5,y:-15.5,startPosition:4},76).wait(1));

	// bird
	this.instance_10 = new lib.bird("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-283,55.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({x:-313.7,y:34.7,startPosition:4},76).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-293.5,-105.3,587.2,210.6);
...
(lib.tapirhead = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({_off:false},0).to({_off:true},1).wait(9).to({_off:false,rotation:10.5,x:-0.6,y:-8.7,startPosition:8},0).to({_off:true},1).wait(6));
...
(lib.TAPIR_HERO = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-98.5,-153.4,1,1,11.1,0,0,-0.1,0);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance,p:{rotation:-2.2,x:36,y:-265.2}}]},29).to({state:[]},1).to({state:[{t:this.instance,p:{rotation:-9,x:9.9,y:-268.7}},{t:this.instance_1}]},1).to({state:[]},1).wait(88));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_3,p:{regX:-33.9,regY:-140.1,rotation:14.1,x:-71.2,y:-177.5}},{t:this.instance_2}]},29).to({state:[]},1).to({state:[{t:this.instance_3,p:{regX:-34,regY:-140.2,rotation:11.1,x:-87.2,y:-170.4}}]},1).to({state:[]},1).wait(88));

	// tapir body
	this.instance_4 = new lib.T_shoulderPad_L("single",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(117.3,-175.5,1,1,-22.3,0,0,0.1,-0.1);

	this.instance_5 = new lib.T_Body("single",3);
	this.instance_5.parent = this;
	this.instance_5.setTransform(15.7,-90.3,1,1,5.7,0,0,0,0.2);

	this.instance_6 = new lib.T_Legs("single",2);
	this.instance_6.parent = this;
	this.instance_6.setTransform(-3.8,-18.4,1,1,0,0,0,16.9,-193.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_6},{t:this.instance_5,p:{regX:0,rotation:5.7,x:15.7,y:-90.3}},{t:this.instance_4}]},29).to({state:[]},1).to({state:[{t:this.instance_6},{t:this.instance_5,p:{regX:0.1,rotation:0,x:5,y:-91.7}}]},1).to({state:[]},1).wait(88));

	// Layer_6
	this.instance_7 = new lib.T_Arm_L("single",8);
	this.instance_7.parent = this;
	this.instance_7.setTransform(113.8,-157.9,1,1,-2.3,0,0,-14.8,-117.4);

	this.instance_8 = new lib.T_Arm_L("single",4);
	this.instance_8.parent = this;
	this.instance_8.setTransform(111,-169.4,1.101,1.06,-2.3,0,0,-14.7,-117.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7}]},29).to({state:[]},1).wait(90));

	// tapir head
	this.instance_9 = new lib.tapirhead("single",2);
	this.instance_9.parent = this;
	this.instance_9.setTransform(44.8,-243.4,1,1,0,4.7,-175.3,-0.3,0);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(29).to({_off:false},0).to({_off:true},1).wait(1).to({_off:false,regX:-0.4,regY:-0.1,skewX:-7.5,skewY:-187.5,x:22.4,y:-251.3,startPosition:12},0).to({_off:true},1).wait(88));

	// Layer_9
	this.instance_10 = new lib.T_shoulderPad_L("single",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(111.4,-202.8,0.891,0.891,-46.8,0,0,0.6,-0.2);

	this.instance_11 = new lib.T_Arm_L("single",15);
	this.instance_11.parent = this;
	this.instance_11.setTransform(126.4,-84.7,0.999,0.999,0,-17,-16);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_11},{t:this.instance_10}]},31).to({state:[]},1).wait(88));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(29).to({_off:false},0).to({_off:true},1).wait(1).to({_off:false},0).to({_off:true},1).wait(88));
...
(lib.Symbol4 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.birds("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(39.6,-657.2);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-362.7,-824);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(75));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-362.7,-824,824,1666);
...
(lib.DigiBot = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.instance_2},{t:this.shape_10},{t:this.shape_9},{t:this.instance_1,p:{startPosition:3}},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.instance}]},2).to({state:[]},1).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.instance_2},{t:this.shape_10},{t:this.shape_9},{t:this.instance_1,p:{startPosition:6}},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.instance}]},9).to({state:[]},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_4,p:{regX:0,regY:0,scaleX:1,scaleY:1,skewX:-147.2,skewY:32.8,x:64.4,y:-50.6,mode:"synched",startPosition:1}},{t:this.instance_3,p:{regY:-18.3,skewX:-160.7,skewY:19.3,x:90.4,y:-85.8}}]},2).to({state:[]},1).to({state:[{t:this.instance_4,p:{regX:-24.3,regY:-29.3,scaleX:1.032,scaleY:1.148,skewX:-140,skewY:25.7,x:36,y:-36.4,mode:"single",startPosition:0}},{t:this.instance_3,p:{regY:-18,skewX:-140.7,skewY:39.3,x:117.7,y:-69.3}}]},9).to({state:[]},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19}]},2).to({state:[]},1).to({state:[{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19}]},9).to({state:[]},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26}]},2).to({state:[]},1).to({state:[{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26}]},9).to({state:[]},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30}]},2).to({state:[]},1).to({state:[{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30}]},9).to({state:[]},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_6,p:{x:-39.5,y:-30,startPosition:1}},{t:this.instance_5,p:{regX:-0.1,skewX:170.2,skewY:-9.8,x:-110.3,y:-100.2}}]},2).to({state:[]},1).to({state:[{t:this.instance_6,p:{x:-34.7,y:-29.7,startPosition:2}},{t:this.instance_5,p:{regX:0,skewX:140.2,skewY:-39.8,x:-137.1,y:-83.4}}]},9).to({state:[]},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(2).to({_off:false},0).to({_off:true},1).wait(9).to({_off:false},0).to({_off:true},1).wait(1));
...
(lib.tEn2 = function(mode,startPosition,loop) {
	...
	this.mcCont.setTransform(537.8,508.4,0.35,0.35,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("Let’s answer these questions \nto gain access.", "italic bold 20px 'Quantico'", "#0EE0E0");
	...
	this.myTxt2.setTransform(362.2,440.8);

	this.timeline.addTween(cjs.Tween.get(this.myTxt2).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AbZLrIAArjIoFAAIFjrkIqwLkMgpfAAAIAALj");
	this.shape.setTransform(362.5,433.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("A7YAAMA2xAAA");
	this.shape_1.setTransform(362.5,508.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("A7YLkIAArjMApeAAAIKwrkIliLkIIFAAIAALjg");
	this.shape_2.setTransform(362.5,434.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tEn2, new cjs.Rectangle(185.2,359,377.5,172.9), null);
...
(lib.tEn1 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(573.5,499.3,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("If Soracle was right, Mabusa \nis hiding right here.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	...
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(391.2,435.3);
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("Aa8KHIAAq3I4UAAIE/pIIqRJII4RAAIAAK3");
	this.shape.setTransform(391.2,434.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("Aa8AAMg13AAA");
	this.shape_1.setTransform(391.2,499);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("A67KAIAAq3IYRAAIKRpIIk/JIIYUAAIAAK3g");
	this.shape_2.setTransform(391.2,435);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_4
	this.myTxt1 = new cjs.Text("After travelling across the galaxy,\nfinally we’re back to Earth.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 391;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(118.5,41.8);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_5
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AecFkIAArCMg83AAAIAALC");
	this.shape_3.setTransform(118.7,72.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("A+bm8MAhWAAAIjvNTII9tTIWTAA");
	this.shape_4.setTransform(118.7,152.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AC7hHMghWAAAIAArEMA83AAAIAALEI2TAAIo9NTg");
	this.shape_5.setTransform(118.7,114.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-79.2,36,395.4,162.8);
...
(lib.tBm2 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(567.4,510.6,0.35,0.35,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("Mari kita jawab soalan-soalan ini\nuntuk mendapatkan akses.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	...
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(381.2,440.8);

	this.timeline.addTween(cjs.Tween.get(this.myTxt2).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AehLrIAArjIuVAAIFjrkIqwLkMgpfAAAIAALj");
	this.shape.setTransform(382.5,433.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("A+gAAMA9BAAA");
	this.shape_1.setTransform(382.5,508.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("A+gLkIAArjMApeAAAIKwrkIliLkIOVAAIAALjg");
	this.shape_2.setTransform(382.5,434.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tBm2, new cjs.Rectangle(176.5,359,415.8,175), null);
...
(lib.tBm1 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(543.5,499.3,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("Jika betul kata Soracle, Mabusa\nsedang bersembunyi di sini.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 373;
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(360.7,435.3);
	this.myTxt2._off = true;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AclKHIAAq3I1WAAIE/pIIqSJII+gAAIAAK3");
	this.shape.setTransform(361.7,434.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AclAAMg5JAAA");
	this.shape_1.setTransform(361.7,499);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("A8kKAIAAq3IegAAIKSpIIk/JIIVWAAIAAK3g");
	this.shape_2.setTransform(361.7,435);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_5
	this.myTxt1 = new cjs.Text("Setelah mengembara merentasi \ngalaksi, akhirnya kita kembali ke Bumi.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	...
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(131.4,41.8);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_6
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EAh1AFkIAArCMhDpAAAIAALC");
	this.shape_3.setTransform(131.1,72.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("Egh0gG8MAizAAAIjvNTII9tTIboAA");
	this.shape_4.setTransform(131.1,152.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AA/hHMgizAAAIAArEMBDpAAAIAALEI7oAAIo9NTg");
	this.shape_5.setTransform(131.1,114.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-91.3,36,445.5,162.8);
...
p.nominalBounds = new cjs.Rectangle(48.5,325.3,415.8,175);
...
p.nominalBounds = new cjs.Rectangle(-176.8,2.8,445.5,162.3);


// stage content:
(lib.intro20 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{a1:1,a2:155});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(3).call(this.frame_4).wait(145).call(this.frame_149).wait(6).call(this.frame_155).wait(44).call(this.frame_199).wait(1));
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(188.1,77.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},119).to({state:[{t:this.instance_1}]},36).wait(45));

	// ?mark
	this.instance_2 = new lib.mark();
	this.instance_2.parent = this;
	this.instance_2.setTransform(393.3,1249.4,1.5,1.5,0,0,0,0.1,0.1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(59).to({_off:false},0).to({y:229.4},60,cjs.Ease.cubicOut).wait(36).to({scaleX:3.38,scaleY:3.38,x:398.2,y:240.9},0).wait(45));

	// TAPIR_HERO
	this.instance_3 = new lib.TAPIR_HERO("single",29);
	this.instance_3.parent = this;
	this.instance_3.setTransform(617.3,1640.6,0.45,0.45,0,0,180,-0.2,405.3);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(59).to({_off:false},0).to({y:614.6},60,cjs.Ease.cubicOut).wait(36).to({regX:-0.4,regY:405.4,scaleX:1,scaleY:1,x:1100.4,y:916.2,startPosition:31},0).to({regX:-0.3,scaleX:0.8,scaleY:0.8,x:699.9,y:750.4},20,cjs.Ease.get(0.5)).wait(25));

	// Digi-Bot
	this.instance_4 = new lib.DigiBot("single",12);
	this.instance_4.parent = this;
	this.instance_4.setTransform(167.7,1584.3,0.4,0.4,0,0,180,-2.3,68.8);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(59).to({_off:false},0).to({y:558.3},60,cjs.Ease.cubicOut).wait(36).to({regY:69,scaleX:1,scaleY:1,x:-136.8,y:674.6,startPosition:2},0).to({scaleX:0.8,scaleY:0.8,x:115.5,y:624.1},20,cjs.Ease.get(0.5)).wait(25));

	// BG
	this.instance_5 = new lib.Symbol4("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(515,808,1,1,0,0,0,164.3,0);

	this.instance_6 = new lib.Bitmap6();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-16,-16);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5}]}).to({state:[{t:this.instance_5}]},59).to({state:[{t:this.instance_5}]},60).to({state:[{t:this.instance_6}]},36).wait(45));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(59).to({startPosition:59},0).to({y:-216,startPosition:44},60,cjs.Ease.cubicOut).to({_off:true},36).wait(45));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(388,284,824,1666);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/intro20/Bitmap2.png?1527799880924", id:"Bitmap2"},
		{src:"images/intro20/Bitmap5.png?1527799880924", id:"Bitmap5"},
		{src:"images/intro20/Bitmap6.png?1527799880924", id:"Bitmap6"},
		{src:"sounds/intro.mp3?1527799880924", id:"intro"}
	],
	preloads: []
};
