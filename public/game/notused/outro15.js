...
(lib.a_mouth = function(mode,startPosition,loop) {
	...
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#333333").ss(1,1,1,3,true).p("");
...
(lib.a_leg = function(mode,startPosition,loop) {
	...
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	...
	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
...
(lib.a_body = function(mode,startPosition,loop) {
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1,1,1,3,true).p("AFZgqQiSjXhkhZQg7g0hCgLQhCgMhcAoQhcAnkHDNQkGDMC0CtQClCQJhAbQJjAbhNk3QhNk2i4iQQi4iQiPB9");
	this.shape_6.setTransform(-6.5,45.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#A95136").s().p("ACZGbQphgbiliQQi0itEGjMQEHjNBcgnQBcgoBCAMQBCALA7A0QBkBZCSDXQiSjXhkhZQCPh9C4CQQC4CQBNE2QBHEen+AAQgtAAgygCgABjlaIAAAAg");
...
(lib.a_armR = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	...
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	...
	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFE83").s().p("AjjE0QgoimgqiPQgqiQBdgaIAABAQBMA/BuhFIAUgNIgUANIADhGQBZA6gIBlIgBAOIgBAXQAABfAfCWQgfiWAAhfIABgXIE4mpIgOHdQiyFOifAxQgkALgeAAQhnAAgeiAg");
	...
	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_15.setTransform(5.8,-8.1);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#000000").ss(1,1,1,3,true).p("AkijgQglgigzgUQAXhqgQhoIBLAAQAzA2ABBlQAXgEASALQAuAbAOB9QgbAyg0gGQgag4gqgmgAjwhKIASg4AguhOIgKAzQhXBGhzg8IASg5QhNADgdBtQgdBugzCcQgzCcC7AbQC6AbIencAj0lNQg4AbAKBSAgliCQAsgjg3hKQgThWiIgBAgliCIgJA0QAzAhgNA6QDPhyCGioAgliCQh9Axg8gxAgIANQhSCegjCv");
	this.shape_16.setTransform(-20.4,1.2);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFE83").s().p("AkiF6Qi7gcAzibQAzicAdhuQAdhuBNgCIgSA4QBzA+BXhHIAKg0QAzAhgNA7QDPhzCGinIBpE0QoBHBjCAAQgLAAgKgBgAh9DsQAjiuBSieQhSCegjCug");
	...
	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f().s("#000000").ss(1,1,1,3,true).p("AhbAOQgmghgygUQAWhqgQhoIBMAAQAzA2ABBlQAWgEASALQAtAbAOB8QgaAyg0gGAChBsIgTBnQhYBHhyg9IAkhxQgag3gpgnAgtheQg5AbALBRAChBsQAsgjg3hJQgUhWiHgBAChBsQh+Axg7gx");
	...
	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f().s("#000000").ss(1,1,1,3,true).p("AmJFyIAAAPQLogfFsncIAgixIAPhVQiXA9jLB4QjLB4jcCIQjeBCicAMIAAAuIAAASIAAAAIAACvIiJAEQAZhOgThdQgDgOgDgOIghgPQACAOAAANQAGBggdBbIA2AAAozCgIhpgyIhdBWIAfAUIBfA8IhXgQIgTgDIgOB1IATAAICYAAAoSCvICJAC");
	this.shape_23.setTransform(0.2,35.2);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#737373").s().p("AhXB2IAGgrQAHgsAAgbIBWAPIhdg7QAJgOASgWQAWgaAJgOIBsAvIACABQAGBegdBcg");
	this.shape_24.setTransform(-64.6,60.9);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#85402A").s().p("Ag9hQICBgIIAACtIiIAFQAZhPgShbg");
	this.shape_25.setTransform(-46,63.7);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#D1D06B").s().p("Ao6FIIAAivIAAgBQBBgQB1gLQCLgOBPgWQFikJGCilIgfCxQltHbroAfg");
	this.shape_26.setTransform(17.9,39.4);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#999999").s().p("AhdCEIAOh1IATADQgBAcgHAsIgGAqgAhjgtIBchWIBpAyIACAbIgBAAIhsgwQgJAOgWAbQgSAWgKAOg");
	this.shape_27.setTransform(-66,59.4);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#4D2256").s().p("AghBrQAdhbgGheIgCgcIAgAPIAGAcQASBcgYBOg");
	this.shape_28.setTransform(-54.9,61.9);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFFE83").s().p("ApBEQIAAguQCcgMDehCQDciJDLh3QDLh4CXg9IgPBVQmDClliEJQhOAXiMAOQh1ALhAAQg");
	this.shape_29.setTransform(18.6,25.7);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#A95136").s().p("AhEgNICIACIAAARIAAAAIiBAIIgHgbg");
	this.shape_30.setTransform(-46,54.1);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_31.setTransform(1.2,32.7);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#737373").s().p("AgvA0QgNgcgJgcQgDgoAEgpIAAgBQAOAFARAKIAhATQATANAbAJQADA3AaA9IgQABQgwAAg2gjg");
	this.shape_32.setTransform(-45.9,20.6);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#3F1C46").s().p("AhABBIgLACQgbg9gCg3QCAhZBRCcQgZA0gwAMQgngfg5AOg");
	this.shape_33.setTransform(-31.1,22.5);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#85402A").s().p("AgrAgIghgsQAwgMAZg0QAmAqAqA+QgeAig4APg");
	this.shape_34.setTransform(-20.2,32);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#D1D06B").s().p("Ak2DIQg3gigYguQgdg0APhDIAiAtQA5gOAegiQAfgiACg3IgfgoQAzgCBUBqQBVBpBIAZIgUgVIgGgGIBvilQA3hUA2g6QBRhaBqhAQACChAOCIQgrCEiPCfQiOCfhqAYQikhuh5hMg");
	this.shape_35.setTransform(15.8,35.1);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#FFFE83").s().p("AjCCKQhUhqgzACIgOgTQAzgTBGBPQA2A+BQBQIAZAZIgZgZQBbiSBwiSQBxiTB0guIAAAwQhqBAhRBbQg2A5g3BTIhvCnIAGAGIAVAVQhJgZhVhqg");
	this.shape_36.setTransform(20.7,18.5);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#999999").s().p("AhJgSIAoATQgNg1AhgxIBYA+QgUApgDAtIhVguIBVAuQgBAOABAOQgbgJgUgMIgggTQgSgLgNgFIAAABQgEApADApQgRg6ADg+g");
	this.shape_37.setTransform(-46.9,10);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#4D2256").s().p("Ah0AhQAAgPABgNIABgCIABAAQA7gzAlgCIADAAIAAAAQAiAAANAwQgNgwgiAAIAAAAIgDAAQglACg7AzIgBAAIgBACQADgtATgqQBZgYAkAIQAmAIAvBaQgFA+gTAnQhQiciBBYg");
	this.shape_38.setTransform(-30,14.2);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#A95136").s().p("Ag4AAQASgoAFg+IAtA6IAOATIAfAnQgCA3gfAiQgpg+gngpg");
	this.shape_39.setTransform(-14.9,24.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10}]},1).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_2},{t:this.shape_3},{t:this.shape_4},{t:this.shape_15}]},1).to({state:[{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16}]},1).to({state:[{t:this.shape_20},{t:this.shape_22},{t:this.shape_19},{t:this.shape_21}]},1).to({state:[{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23}]},1).to({state:[{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31}]},1).wait(1));
...
(lib.a_armL = function(mode,startPosition,loop) {
	...
	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#000000").ss(1,1,1,3,true).p("AliF5Qgqghg5gIQBBhGBZgkQBzBHgKCfIA1gQIBHgVQAKiGhGgoQgegUgggIQAshhCYABQBNABBMAMQBMAMBMAYAjADdQgzgMg4AVAiNG8QAcA3BUAhQEiggEEiMQCRmfkiozQiTgOgaCoQANEug7EsAmLHeIBDB4QAvALA2gLQAyg3gRhTQgbA9gnAZQgdh0hBg1gAnFFQQg/Bqg0BwQAsArA3AXIBKiO");
	this.shape_16.setTransform(-28.2,55.9);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#999999").s().p("Ai8BMQA0hvA/hqQA5AIAoAhIgnBkIhKCOQg4gXgrgrgAAyB4IhBh4IAnhkQBBA1AeBzQAngZAag8QASBSgzA3QgaAFgZAAQgaAAgYgFgAAYhkIAAAAg");
	...
	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f().s("#333333").ss(1,1,1,3,true).p("");
	...
	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
...
(lib.tEn1 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A2kMLIAAsLIGbAAIpMr+IQ5L+MAh5AAAIAAML");
	this.shape.setTransform(268.3,381.4);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("AAvF/IpLr+IQ5L+g");
	this.shape_2.setTransform(160.2,343.1);
...
(lib.tBm1 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(470.7,459.3,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("Kita akan tahu kegunaan kunci \nini tidak lama lagi.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	...
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(295.7,389.2);
	this.myTxt2._off = true;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A7gL8IAAsJIHYAAIn7rhIPpLhMAolAAAIAAMJ");
	this.shape.setTransform(293.8,382.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("Ab2AAMg3rAAA");
	this.shape_1.setTransform(295.9,459.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("AAHFwIn7rgIPpLgg");
	this.shape_2.setTransform(164.2,344.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("A71GFIAAsJIHYAAIHuAAMAolAAAIAAMJg");
	this.shape_3.setTransform(295.9,420.4);
...
p.nominalBounds = new cjs.Rectangle(394.9,297.5,809,751.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/outro15/Bitmap10.png?1527794755721", id:"Bitmap10"},
		{src:"images/outro15/Bitmap11.png?1527794755721", id:"Bitmap11"},
		{src:"images/outro15/Bitmap4.png?1527794755721", id:"Bitmap4"},
		{src:"images/outro15/Bitmap5.png?1527794755721", id:"Bitmap5"},
		{src:"images/outro15/Bitmap6.png?1527794755721", id:"Bitmap6"},
		{src:"images/outro15/Bitmap7.png?1527794755721", id:"Bitmap7"},
		{src:"images/outro15/Bitmap7_1.png?1527794755721", id:"Bitmap7_1"},
		{src:"images/outro15/Bitmap8.png?1527794755721", id:"Bitmap8"},
		{src:"sounds/intro.mp3?1527794755721", id:"intro"},
		{src:"sounds/questionComplete.mp3?1527794755721", id:"questionComplete"}
	],
	preloads: []
};
