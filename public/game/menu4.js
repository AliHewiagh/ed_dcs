...
(lib.planet4e = function() {
	this.initialize(img.planet4e);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,371,406);


(lib.planet5e = function() {
	this.initialize(img.planet5e);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,345,356);// helper functions:
...
(lib.planet5 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_4
	this.instance = new lib.planet5e();
	this.instance.parent = this;
	this.instance.setTransform(-136,-139,0.784,0.784);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-136,-139,270.4,279);


(lib.planet4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_2
	this.instance = new lib.planet4e();
	this.instance.parent = this;
	this.instance.setTransform(-144,-147,0.774,0.774);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-144,-147,287.3,314.4);
...
(lib.mcTxt2En = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET COLOURISTIC", "italic bold 28px 'Quantico'", "#0EE0E0");
...
(lib.mcTxt2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET WARNARISTIK", "italic bold 28px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.lineHeight = 42;
	this.myTxt.lineWidth = 360;
	this.myTxt.parent = this;
...
(lib.animPlanet5 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.planet5("single",0);
	this.instance.parent = this;
...
p.nominalBounds = new cjs.Rectangle(-135.8,-146.7,270.4,279);


(lib.animPlanet4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.planet4("single",0);
	this.instance.parent = this;
	this.instance.setTransform(41,-0.8,1,1,0,0,0,40.8,6.9);
...
p.nominalBounds = new cjs.Rectangle(-143.8,-154.7,287.3,314.4);
...
// stage content:
(lib.menu4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(90).call(this.frame_94).wait(45).call(this.frame_139).wait(41).call(this.frame_180).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(180).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnCont).wait(139).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(139).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(125).to({_off:false},0).wait(56));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1,p:{x:111.2}},{t:this.shape}]},119).to({state:[{t:this.shape_3},{t:this.shape_2}]},1).to({state:[{t:this.shape_5},{t:this.shape_4}]},1).to({state:[{t:this.shape_7},{t:this.shape_6}]},1).to({state:[{t:this.shape_1,p:{x:115.1}},{t:this.shape_8}]},2).wait(57));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(92).to({_off:false},0).wait(89));

	// planet5
	this.instance_4 = new lib.animPlanet5();
	this.instance_4.parent = this;
	this.instance_4.setTransform(969.6,325.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(19).to({x:400.1},89,cjs.Ease.cubicInOut).wait(73));

	// planet4
	this.instance_5 = new lib.animPlanet4();
	this.instance_5.parent = this;
	this.instance_5.setTransform(400.1,325.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(19).to({x:-386.9},89,cjs.Ease.cubicInOut).wait(73));

	// planet19
	this.instance_6 = new lib.animPlanet19();
	this.instance_6.parent = this;
	this.instance_6.setTransform(97.5,231.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(19).to({x:69},89,cjs.Ease.quadInOut).wait(73));

	// planet18
	this.instance_7 = new lib.animPlanet18();
	this.instance_7.parent = this;
	this.instance_7.setTransform(553.7,262.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(19).to({x:515.7},89,cjs.Ease.quadInOut).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(61).to({_off:false},0).wait(120));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(76).to({_off:false},0).wait(105));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(54).to({_off:false},0).wait(127));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(27).to({_off:false},0).wait(154));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(38).to({_off:false},0).wait(143));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(181));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(319.3,274,1184.9,795.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/menu4/Bitmap10.png?1521355836701", id:"Bitmap10"},
		{src:"images/menu4/Bitmap3.png?1521355836701", id:"Bitmap3"},
		{src:"images/menu4/Bitmap4.png?1521355836701", id:"Bitmap4"},
		{src:"images/menu4/Bitmap5.png?1521355836701", id:"Bitmap5"},
		{src:"images/menu4/Bitmap6.png?1521355836701", id:"Bitmap6"},
		{src:"images/menu4/Bitmap7.png?1521355836701", id:"Bitmap7"},
		{src:"images/menu4/Bitmap8.png?1521355836701", id:"Bitmap8"},
		{src:"images/menu4/Bitmap9.png?1521355836701", id:"Bitmap9"},
		{src:"images/menu4/planet4e.png?1521355836701", id:"planet4e"},
		{src:"images/menu4/planet5e.png?1521355836701", id:"planet5e"},
		{src:"sounds/bleep_stutter.mp3?1521355836701", id:"bleep_stutter"},
		{src:"sounds/menuRock2.mp3?1521355836701", id:"menuRock2"},
		{src:"sounds/stdClick.mp3?1521355836701", id:"stdClick"}
	],
	preloads: []
};
