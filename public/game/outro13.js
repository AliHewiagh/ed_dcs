...
(lib.g1 = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#224143").ss(1,1,1).p("AiVAJQBhhWB6gxQABgBAAAAQACgBACgBQATgGAdArQAdArAFArQAFApgGAkQgGAkgSAJQgTAKgEgBQgBAAgCgBQhzAWh8g4AiGBaQgFgBgFgIQgIgKgEgSQgEgQADgOQACgKAGgEQABAAABAAQAKgBAHAJQAIALAEARQAEARgDANQgCAKgKAEQgCABgCAAQAAAAgBAAIABAAAiFBaIAAAA");
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#224143").ss(1,1,1).p("Ah/BaQgFgBgGgIQgIgKgEgSQgDgQACgOQADgKAFgEQBihWB6gxQABgBAAAAQACgBABgBQATgGAUAiQASAhAJA2QAJAygHAoQgGAqgUAGQgDACgEgBQgCAAgBgBQhzAWh9g4Ah/BaIAAAAIABAAQAAAAgBAAg");
...
(lib.wall = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#224143").ss(1,1,1).p("");
...
p.nominalBounds = new cjs.Rectangle(-194.4,-264.8,501,558.2);
...
(lib.tEn4 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(188.7,138,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;
...
(lib.tEn3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("You’re too late. I’ve shrunk this useless little rascal\nwith the Shrink Ray I used to shrink the Sun.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	this.myTxt.lineWidth = 545;
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(-52.2,-32.4);
...
(lib.tEn2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("Hi. I am Mabusa. Are the two \nof you looking for Voldor?", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	...
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(2.1,-29.6);
...
}).prototype = getMCSymbolPrototype(lib.tEn2, new cjs.Rectangle(-193.8,-110.6,405.4,177.5), null);
...
(lib.tBm4 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(172.7,168,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_5
	this.myTxt2 = new cjs.Text("Tidak, dia baru\nsaja diberhentikan.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
...
(lib.tBm3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("Awak sudah terlambat. Saya telah mengecilkan makhluk \nyang tidak berguna ini dengan menggunakan Shrink Ray yang \nsaya gunakan untuk mengecilkan Matahari.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	this.myTxt.lineWidth = 655;
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(-17.3,-36.4);
...
(lib.tBm2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("Hai. Saya Mabusa. Awak berdua\nsedang mencari Voldor?", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/outro13/Bitmap10.png?1527791625203", id:"Bitmap10"},
		{src:"images/outro13/Bitmap11.png?1527791625203", id:"Bitmap11"},
		{src:"images/outro13/Bitmap18.png?1527791625203", id:"Bitmap18"},
		{src:"images/outro13/Bitmap22.png?1527791625203", id:"Bitmap22"},
		{src:"images/outro13/Bitmap25.png?1527791625203", id:"Bitmap25"},
		{src:"images/outro13/Bitmap26.png?1527791625203", id:"Bitmap26"},
		{src:"images/outro13/Bitmap27.png?1527791625203", id:"Bitmap27"},
		{src:"images/outro13/Bitmap28.png?1527791625203", id:"Bitmap28"},
		{src:"images/outro13/Bitmap29.png?1527791625203", id:"Bitmap29"},
		{src:"images/outro13/Bitmap4.png?1527791625203", id:"Bitmap4"},
		{src:"images/outro13/Bitmap8.png?1527791625203", id:"Bitmap8"},
		{src:"images/outro13/Bitmap9.png?1527791625203", id:"Bitmap9"},
		{src:"sounds/evil_laugh.mp3?1527791625203", id:"evil_laugh"},
		{src:"sounds/intro.mp3?1527791625203", id:"intro"},
		{src:"sounds/powerdown.mp3?1527791625203", id:"powerdown"}
	],
	preloads: []
};
