...
(lib.PlanetKekunyah = function() {
	this.initialize(img.PlanetKekunyah);
}).prototype = p = new cjs.Bitmap();
...
(lib.planetMunchieRe = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_2
	this.instance = new lib.PlanetKekunyah();
	this.instance.parent = this;
	this.instance.setTransform(-192,-192);
...
(lib.mcTxt2En = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET KOOKLA", "italic bold 28px 'Quantico'", "#0EE0E0");
...
(lib.animPlanet3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.planetMunchieRe("synched",0);
	this.instance.parent = this;
...
// stage content:
(lib.menu3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(90).call(this.frame_94).wait(44).call(this.frame_138).wait(41).call(this.frame_179).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(179).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnCont).wait(138).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(138).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(124).to({_off:false},0).wait(56));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1},{t:this.shape}]},119).to({state:[{t:this.shape_3},{t:this.shape_2}]},1).to({state:[{t:this.shape_5},{t:this.shape_4}]},1).to({state:[{t:this.shape_7},{t:this.shape_6}]},2).wait(57));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(92).to({_off:false},0).wait(88));

	// planet4
	this.instance_4 = new lib.animPlanet4();
	this.instance_4.parent = this;
	this.instance_4.setTransform(969.6,325.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(19).to({x:400.1},89,cjs.Ease.cubicInOut).wait(72));

	// planet3
	this.instance_5 = new lib.animPlanet3();
	this.instance_5.parent = this;
	this.instance_5.setTransform(404.6,325.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(19).to({x:-385.4},89,cjs.Ease.cubicInOut).wait(72));

	// planet19
	this.instance_6 = new lib.animPlanet19();
	this.instance_6.parent = this;
	this.instance_6.setTransform(121.5,231.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(19).to({x:97.5},89,cjs.Ease.quadInOut).wait(72));

	// planet18
	this.instance_7 = new lib.animPlanet18();
	this.instance_7.parent = this;
	this.instance_7.setTransform(593.7,262.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(19).to({x:553.7},89,cjs.Ease.quadInOut).wait(72));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(61).to({_off:false},0).wait(119));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(76).to({_off:false},0).wait(104));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(54).to({_off:false},0).wait(126));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(27).to({_off:false},0).wait(153));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(38).to({_off:false},0).wait(142));
...
p.nominalBounds = new cjs.Rectangle(319.3,274,1193.8,795.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/menu3/Bitmap10.png?1521201148252", id:"Bitmap10"},
		{src:"images/menu3/Bitmap3.png?1521201148252", id:"Bitmap3"},
		{src:"images/menu3/Bitmap4.png?1521201148252", id:"Bitmap4"},
		{src:"images/menu3/Bitmap5.png?1521201148252", id:"Bitmap5"},
		{src:"images/menu3/Bitmap6.png?1521201148252", id:"Bitmap6"},
		{src:"images/menu3/Bitmap7.png?1521201148252", id:"Bitmap7"},
		{src:"images/menu3/Bitmap8.png?1521201148252", id:"Bitmap8"},
		{src:"images/menu3/Bitmap9.png?1521201148252", id:"Bitmap9"},
		{src:"images/menu3/planet4e.png?1521201148252", id:"planet4e"},
		{src:"images/menu3/PlanetKekunyah.png?1521201148252", id:"PlanetKekunyah"},
		{src:"sounds/bleep_stutter.mp3?1521201148252", id:"bleep_stutter"},
		{src:"sounds/menuRock2.mp3?1521201148252", id:"menuRock2"},
		{src:"sounds/stdClick.mp3?1521201148252", id:"stdClick"}
	],
	preloads: []
};
