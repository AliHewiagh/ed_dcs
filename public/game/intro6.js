...
(lib.tEn3 = function(mode,startPosition,loop) {
	...
	// Layer_5
	this.myTxt = new cjs.Text("I think we can use something which \nwe have collected.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	this.myTxt.lineWidth = 431;
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(-183.4,-22);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_6
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EghcgC/MAqjAAAIHNFgIkWlgIVfAA");
	this.shape.setTransform(-183.2,67.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(1,1,1).p("EghcAGHIAAsNMBC5AAAIAAMN");
	this.shape_1.setTransform(-183.2,9.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("AJHDWMgqjAAAIAAsNMBC5AAAIAAMNI1gAAIEXFhg");
	this.shape_2.setTransform(-183.2,26.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tEn3, new cjs.Rectangle(-400.8,-31,434.9,119.6), null);
...
(lib.tBm3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("Saya rasa kita boleh menggunakan \nsesuatu yang telah kita perolehi.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	...
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(-168,-22);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EggqgC/MAnbAAAIHNFgIkWlgIXDAA");
	this.shape.setTransform(-168.2,67.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(1,1,1).p("EggqAGHIAAsNMBBVAAAIAAMN");
	this.shape_1.setTransform(-168.2,9.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("AGxDWMgnbAAAIAAsNMBBVAAAIAAMNI3EAAIEXFhg");
	this.shape_2.setTransform(-168.2,26.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tBm3, new cjs.Rectangle(-401,-31,466.1,119.6), null);
...
(lib.db_armL = function(mode,startPosition,loop) {
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_8.setTransform(3.2,-2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#4C4C4C").s().p("");
	...
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#747474").s().p("");
...
(lib.T_Arm_L = function(mode,startPosition,loop) {
	...
	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#7E2326").s().p("");
...
p.nominalBounds = new cjs.Rectangle(-259.5,-43.6,466.1,119.1);
...
(lib.DigiBot = function(mode,startPosition,loop) {
	...
	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_23.setTransform(26.4,-5.9);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#747474").s().p("");
	this.shape_24.setTransform(26.4,-5.8);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#4C4C4C").s().p("");
	...
	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#17435F").s().p("AiJDLQBHj2BhhnQAugxAzgRIAEgBQAKAPgBATQAAANgnBzIgFALQgLAggMAvIgbApIgFAGQgSAYgrAkQgsAkhNAgIADgLg");
	this.shape_40.setTransform(38.2,-22.5);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("#FFFFFF").s().p("AhcBFQAghQAmgsQAmgsAYgSQAYgRAxgUIAIAHIAEALQg0AQgtAxQgkAXgdAsQgUAbghBDQgTAngPAaQAAgEAghSg");
	this.shape_41.setTransform(38.6,-30);
...
(lib.tEn4 = function(mode,startPosition,loop) {
	...
	// Layer_8
	this.myTxt1 = new cjs.Text("Hmm...Seems like we need to answer \na few questions to activate this system.", "italic bold 20px 'Quantico'", "#0EE0E0");
	...
	this.myTxt1.setTransform(-173,-22);
...
p.nominalBounds = new cjs.Rectangle(-408.2,-31,470.5,104.7);
...
(lib.tEn1 = function(mode,startPosition,loop) {
	...
	// Layer_8
	this.myTxt1 = new cjs.Text("I’ve scanned everywhere but I couldn’t\ndetect their presence.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 432;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(138.8,-17);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_9
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#0EE0E0").ss(1,0,0,3).p("EAh0AGFIAAsEMhDmAAAIAAME");
	this.shape_3.setTransform(138.1,13.6);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#0EE0E0").ss(4,0,0,3).p("AC/kfIAXAAIAAAAAC/kfIAXAAIheIYIE7oYIbBAAEghygEfMAkxAAA");
	this.shape_4.setTransform(138,81.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("ADVB2IgWAAIAWAAIAAAAIAAAAIgWAAMgkyAAAIAAsEMBDnAAAIAAMEI7BAAIk7IZg");
	this.shape_5.setTransform(138.1,40.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-80.3,-25.8,437.3,137.9);
...
(lib.tBm4 = function(mode,startPosition,loop) {
	...
	// Layer_7
	this.myTxt2 = new cjs.Text("Mari kita menjawab.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	...
	// Layer_1
	this.myTxt1 = new cjs.Text("Hmm...Nampaknya kita perlu menjawab \nbeberapa soalan untuk mengaktifkan sistem ini.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 548;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(-136.7,-29.8);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_2
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#0EE0E0").ss(1,1,1).p("Egp3AGCIAAsDMBTvAAAIAAMD");
	this.shape_3.setTransform(-137.1,1.6);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#0EE0E0").ss(4,0,0,3).p("Egp3gB5MA7vAAAIGvDbIj3jbIVIAA");
	this.shape_4.setTransform(-137.1,52.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#010101").s().p("AjWhtIC3AAID2Dbg");
	this.shape_5.setTransform(-1.1,51.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("rgba(0,0,0,0.996)").s().p("AUwGCIi4AAMg7vAAAIAAsDMBTvAAAIAAMDg");
	this.shape_6.setTransform(-137.1,1.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-412.6,-38,551.9,104.7);
...
(lib.tBm1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt1 = new cjs.Text("Saya sudah mengimbas di seluruh tempat ini\ntetapi saya tidak dapat mengesan mereka.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 502;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(138.9,-17);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_2
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#0EE0E0").ss(1,0,0,3).p("EAmcAGFIAAsEMhM3AAAIAAME");
	this.shape_3.setTransform(138.5,13.6);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#0EE0E0").ss(4,0,0,3).p("AC7kfIAXAAIAAAAAC7kfIAXAAIheIYIE7oYIftAAEgmagEfMApVAAA");
	this.shape_4.setTransform(138.4,81.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("ADRB2IgWAAIAWAAIAAAAIAAAAIgWAAMgpVAAAIAAsEMBM1AAAIAAMEI/sAAIk7IZg");
	this.shape_5.setTransform(138.5,40.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-114.2,-25.8,506.3,137.9);
...
p.nominalBounds = new cjs.Rectangle(-271.1,-50.6,551.9,104.2);
...
p.nominalBounds = new cjs.Rectangle(-298.5,-66,506.3,137.4);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/intro6/Bitmap1.png?1527769571877", id:"Bitmap1"},
		{src:"images/intro6/Bitmap10.png?1527769571877", id:"Bitmap10"},
		{src:"images/intro6/Bitmap11.png?1527769571877", id:"Bitmap11"},
		{src:"images/intro6/Bitmap3.png?1527769571877", id:"Bitmap3"},
		{src:"images/intro6/Bitmap7copy.png?1527769571877", id:"Bitmap7copy"},
		{src:"images/intro6/Bitmap8copy.png?1527769571877", id:"Bitmap8copy"},
		{src:"images/intro6/Bitmap9.png?1527769571877", id:"Bitmap9"},
		{src:"sounds/intro.mp3?1527769571877", id:"intro"},
		{src:"sounds/questionComplete.mp3?1527769571877", id:"questionComplete"},
		{src:"sounds/stdClick.mp3?1527769571877", id:"stdClick"}
	],
	preloads: []
};
