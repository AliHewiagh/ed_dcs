...
p.nominalBounds = new cjs.Rectangle(0,0,358,369);
...
(lib.planet12 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_3
	this.instance = new lib.Bitmap21();
	this.instance.parent = this;
	this.instance.setTransform(-144,-139,0.816,0.816);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-144,-139,292,301);
...
(lib.mcTxt2En = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET HOOTANATE", "italic bold 28px 'Quantico'", "#0EE0E0");
...
(lib.mcTxt2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET HUTANAT", "italic bold 28px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.lineHeight = 42;
...
(lib.animPlanet12 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.planet12("single",0);
	this.instance.parent = this;
	this.instance.setTransform(2.8,3.7,1,1,0,0,0,-0.8,0.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:12.1},29).to({y:3.7},30).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-140.4,-136,292,301);
...
// stage content:
(lib.menu11 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(90).call(this.frame_94).wait(52).call(this.frame_146).wait(41).call(this.frame_187).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(187).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnCont).wait(146).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(146).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(132).to({_off:false},0).wait(56));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(92).to({_off:false},0).wait(96));

	// planet12
	this.instance_4 = new lib.animPlanet12();
	this.instance_4.parent = this;
	this.instance_4.setTransform(1028.2,308.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(19).to({x:398.2},89,cjs.Ease.quadInOut).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(19).to({x:-360.2},89,cjs.Ease.cubicInOut).to({_off:true},1).wait(79));

	// planet17
	this.instance_6 = new lib.animPlanet17();
	this.instance_6.parent = this;
	this.instance_6.setTransform(244.5,342.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(19).to({x:164.5},89,cjs.Ease.quadInOut).wait(80));

	// planet16
	this.instance_7 = new lib.animPlanet16();
	this.instance_7.parent = this;
	this.instance_7.setTransform(654.5,282.9,0.5,0.5,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(19).to({x:554.5},89,cjs.Ease.quadInOut).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(61).to({_off:false},0).wait(127));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(76).to({_off:false},0).wait(112));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(54).to({_off:false},0).wait(134));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(27).to({_off:false},0).wait(161));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(38).to({_off:false},0).wait(150));

	// stars1
	this.instance_13 = new lib.starzRandom();
	this.instance_13.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(188));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(188));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(319.3,274,1260.5,795.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/menu11/Bitmap20.png?1527433962122", id:"Bitmap20"},
		{src:"images/menu11/Bitmap21.png?1527433962122", id:"Bitmap21"},
		{src:"images/menu11/Bitmap3.png?1527433962122", id:"Bitmap3"},
		{src:"images/menu11/Bitmap4.png?1527433962122", id:"Bitmap4"},
		{src:"images/menu11/Bitmap5.png?1527433962122", id:"Bitmap5"},
		{src:"images/menu11/Bitmap6.png?1527433962122", id:"Bitmap6"},
		{src:"images/menu11/Bitmap7.png?1527433962122", id:"Bitmap7"},
		{src:"images/menu11/Bitmap8.png?1527433962122", id:"Bitmap8"},
		{src:"images/menu11/blobPlanet.png?1527433962122", id:"blobPlanet"},
		{src:"images/menu11/greenplanet2.png?1527433962122", id:"greenplanet2"},
		{src:"sounds/bleep_stutter.mp3?1527433962122", id:"bleep_stutter"},
		{src:"sounds/menuRock2.mp3?1527433962122", id:"menuRock2"},
		{src:"sounds/stdClick.mp3?1527433962122", id:"stdClick"}
	],
	preloads: []
};
