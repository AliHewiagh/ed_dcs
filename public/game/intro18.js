...
p.nominalBounds = new cjs.Rectangle(0,0,818,618);
...
p.nominalBounds = new cjs.Rectangle(0,0,845,641);// helper functions:
...
}).prototype = getMCSymbolPrototype(lib.penutup1, new cjs.Rectangle(-22.8,-16.4,45.7,33), null);
...
(lib.penutup2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#34371D").ss(1,1,1).p("ADBiYIAAAtIkHEEADBiYQgKABgLABQgDABgEAAQglAFgqALQhzAehRA1QhPAygDAtQAAABAAACQAAABAAABQAAACAAACIAAAgIAAAOQAAABABAAQAAABAAABQAIAlBJAKQATADAVAAAjAAtIAAAJAjABWQAAAEAAADQAAAEAAADAi/A4QABAHADAGQAPAcA+AIQATADAVAAIAAAtAhGBsIEHkE");
...
}).prototype = getMCSymbolPrototype(lib.penutup2, new cjs.Rectangle(-20.3,-16.3,40.7,32.7), null);
...
(lib.key = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#94610C").s().p("AD6EtIBnhDIgkgjIAIh+Ig4AzIhZhYIBchVIgthVIh2BnIhZhVIB1hnIh8g5IkfgRIhWA4IgkgfIBwg/IA0ACQB9AFB/ALIDIBWIiLBzIAZAYICNh4IBPCjIhaBOIAcAbIBXhIIgUDOIBCA7IhxBPgADcETIBIgzIoOncIhSA3IgMgLIBfg/IImHxIhWA7g");
	this.shape.setTransform(74.9,39.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#B6770E").s().p("Au6rmIAAipIBJBAIAkAfIAhAdIAMALIIZHZIALAKIASAQIABAAIAiAfISBP5IgTCNg");
	this.shape_1.setTransform(123.4,97);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#F1AE3F").s().p("");
	this.shape_2.setTransform(127,87);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#DA8E10").s().p("AFCFMIBJgyIgVCBIhIA/gAmKmbIBag+IABCOg");
	this.shape_3.setTransform(186.6,140.8);
...
(lib.alien18_mouth = function(mode,startPosition,loop) {
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1,0,0,3,true).p("AgLAKQADABAEAAQAEAAAFgDQAFgDACgFQADgFgCgDQgCgDgGACQgFACgFAGQgGAEgBADQgCAEADAAg");
	this.shape_6.setTransform(-5,-15.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#000000").ss(1,0,0,3,true).p("AiJhhQA7gaAwACQATABASAHQAFACAFACQAWAKAVASIg0ABQALBLAeBBQAAABABAAQAQAiAVAgAiJhPQgBAOAEAKQAGAQASAHQADARAEAPQAWBdAcA2QAAABAAAAQAWAqAbASICOhtQgLg2gYgzQAAAAgBgBQgRgmgZgkAg1hPQALBoAqBRQABAAAAAAQANAaARAWAiJhhIAAASIAmAAIAPAAIAfAAIA9gBAiJhhQAXhAAxgw");
	this.shape_7.setTransform(0,0.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#C9393F").s().p("AgxADQAHgDAMAAIAVgDQAQgBAWgKQAWAKAVARIg0ABIg9ABIgeAAQAIgIAOgEg");
	this.shape_8.setTransform(-1.2,-9.4);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FE484F").s().p("Ag5ARQACgGAHgGQAIgGASgFIAogDIAEAAQAQgDALgEIAKAEQgXAKgRABIgUACQgMABgHADQgOAEgIAIg");
	this.shape_9.setTransform(-4.1,-9.6);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#671D20").s().p("AhHACQA7gYAuACQAUABASAHQgKAEgRACIgDABIgqADQgQAEgIAGQgHAGgDAHIglAAg");
	this.shape_10.setTransform(-6.5,-9.9);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#334C66").s().p("AgkByQgcg2gVhcQAMgJAJgVIAEgKIgHgBQgZgEgZgLQgEgKACgOIAlAAIAQAAIAeAAQALBpArBQIABAAIglAeIgRAMIgBgBgAATBJIAAAAgAASBJQgrhQgLhpIA9gBQALBLAfBBIAAABIAAgBQgfhBgLhLIA0gBQAZAkASAmIABABQgWAjggAgIgbAbIgVASIgBAAg");
	this.shape_11.setTransform(-1.7,3.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#386886").s().p("AAsAkIgKgEQgTgHgSAAQgwgDg7AaQAXg/AxgwIB3AFIgVAWQAOAQAZANIAMAGIgYBBQgVgSgWgKg");
	this.shape_12.setTransform(-2.7,-14.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1,p:{x:-4.2,y:-14.6}},{t:this.shape}]}).to({state:[{t:this.shape_5},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_2},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_1,p:{x:-5,y:-15.8}},{t:this.shape_6}]},1).wait(1));
...
(lib.alien18_handL = function(mode,startPosition,loop) {
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(1,0,0,3,true).p("AATArQAAgBAAgBQgagEgVgNQgnAxgfANQgIADgJABAA3ArQgTABgRgDAhWgMQgPADgQgCQgogDABghQABghAsAAQAsAAAagYQAagZAogLICDA6QgZBPgpAqQgWBOgRANQgQANgdgCQgbgCASghQASgfAEggQgYArgeAZQgPAMgagGQgagGgNgVABJgfQgsAjg/gkQgaAPgaAFQgiAcgYAUQgXAVATAVQAOAOATgCAgcAYQgMgHgKgJ");
	this.shape_3.setTransform(3.8,-4.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#26465A").s().p("");
	this.shape_4.setTransform(3.7,-4.7);
...
(lib.alien18_armR = function(mode,startPosition,loop) {
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(1,0,0,3,true).p("AiLg6QATgpAcghQAYgcAfgWQAKgIALgGIC5BDQgDAPgDAOQgLA2gNAyQgDAPgEAOQgMAxgNAvAgegwQAUAEARACQAEAAAFABQB0AKAfhFAgegwQgtghgRgzAhGAiQATALAYAHQACAAACABQBPAVBMgpAhGAiQANAbAVATQAxAuBeADQhWBnhsgzIAAgBQhugzAliCQAJgeAMgbQASA+AzAegACLAEQhNgGg0gYQgWgKgSgM");
	this.shape_3.setTransform(29.2,3.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#584C50").s().p("");
	this.shape_4.setTransform(33.2,3.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#7E6D73").s().p("AgKC2Qhug0AliCQAJgeAMgaQATgqAcghQAXgcAfgWIgUAtQgHASADAQQAFAXAVAPQAQAMAbALIgmgGIAmAGIAJABIgGAQQgXgKgSgNQgtghgQgzQAQAzAtAhQASANAXAKQgQAngSAnIgEgBQgYgGgTgMQgygegSg9QASA9AyAeQANAbAVAUQgYAygaAygAAGAjQATAMAYAGIAEABIgNAcQgVgUgNgbg");
	this.shape_5.setTransform(21.5,3.8);
	...
	// Layer 3
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1,0,0,3,true).p("AiRgGQAugQAsgFQAbgDAcACQARABASADAiRgGQA9hAAzgMQAEgCAEAAQAXgEASALQARAKANAVAiigEQhtCXADCZIAiBEIApBPQBzglCngBQCJh1BHibQhdlkjPjlAiigEQhJhOgggtQgUgcgEgPQgLglANg6QARhLAzg/AiigEIAQgBQAAgBABAA");
	this.shape_6.setTransform(11.2,42);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#4D5764").s().p("AicEGQgDiYBtiXIAQgCIABAAQA8hAAzgNIAIgCIgIACQgzANg8BAIgBAAIgQACQhJhOggguQAGg/AKgcQARgyAqgRQAXgIApACQA/ACAqARQAiAQAPAYQAIAMAEASQADALACAXQAJBDgkAYQgTgKgXADQBqAniIATQgsAEgtARQAtgRAsgEQAbgDAcABQAABDgPBCQgagHgpAEQhCAJgiAcIgWCHQgNApgQA1g");
	this.shape_7.setTransform(0,45.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#353C45").s().p("AjqFxQAQg1ANgpIAWiHQAigcBDgJQApgEAaAHQAPhCAAhDQARABASADQgSgDgRgBQgcgCgbAEQCHgThpgnQAXgEASALQARAKANAVQgNgVgRgKQAkgYgJhDQgCgXgDgLQgEgSgIgMQgPgZghgQQgqgQhAgCQgpgDgXAJQgqARgRAxQgKAcgGBAQgUgcgEgPQgLglANg6QARhLAzg/IDagtQDPDmBdFjQhHCbiJB1QinABhzAlg");
	this.shape_8.setTransform(11.2,41.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(1,0,0,3,true).p("AiIhKQAIgXAJgUQAchAAmgoQAdgeAhgPQA0gYBBAKICxBdQAIEchEBGQhDBFhRApQgYAMgfgJQhKgXh0iQQhviIgehqQAAAAAAAAQgPgzAFgr");
	this.shape_9.setTransform(9.9,22.6);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#4D5764").s().p("AhmBrQhviIgehqQBcg4BQBDQgJAVgIAXQAIgXAJgVQAdg/AlgoQAcgeAigPQDIBEgOB/QgQDaiLCEQhKgWh0iQgAhHh8IAAAAg");
	this.shape_10.setTransform(5.1,23.2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#353C45").s().p("AAoEYQCLiEAQjbQANh+jHhFQA0gYBBAKICxBdQAIEchEBGQhDBFhRApQgNAHgQAAQgNAAgNgEgAkjiBIAAAAIAAAAIAAAAIAAAAQgPgzAFgrID4ACQgmAogcBAQhQhEhcA4g");
	this.shape_11.setTransform(9.9,22.6);
...
(lib.alien18_armL = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(1,0,0,3,true).p("AiUgbQAEgZAFgaQBfiXBoh9IA/AoIC/B+QiKGEhiBWQhhBWiZgSQiYgSAKhpQADgeAEgeQALhJARhFQA4gxBLgHgAieBzQAAgHAAgIQAAgeACgeQAEgkAEgf");
	this.shape_3.setTransform(-3.8,-30.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#4D5764").s().p("AgiDmQggg3ADgzQADglAFgfQgFAfgDAlQgCAegBAeIgzAQQgfALgVAKQgZANgUAVQAKhJARhGQA4gxBMgHIAIg0QBfiWBph9IA+ApQhnB1g7CVQguBzgMB5QgTgYgKgSg");
	this.shape_4.setTransform(-13,-39.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#353C45").s().p("AirFNQiZgSALhpIAHg8QAUgVAZgNQAVgKAfgLIAzgQQABgeACgeQgDAzAgA3QALASASAYQANh4AuhzQA6iVBnh2IDAB+QiKGEhjBWQhQBHh3AAQgYAAgagDgAieBeIAAgIIAAgHIAAAHIAAAIg");
	this.shape_5.setTransform(-3.8,-28.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]},1).wait(1));

	// Layer 2
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1,0,0,3,true).p("");
	this.shape_6.setTransform(-10.2,25.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#7E6D73").s().p("AhiChIAIgoQAJgtALgrQAeAyAqAZQgLAjgLAkQgsgRgagpQAaApAsARIgUBHQg5gNgBhMgAhGAhQANg1ARgzQAOgsAQgqQARgwAVgtQgEAyARAdQARAdApAQQgHAVgSAmQgugjgmg3QAmA3AuAjIgTApQgdgFgYgMQAGAsAVAiQgOAkgNAlQgqgZgegygAACgrQgXgLgTgRQATARAXALgAACgrQAYAMAdAFIgaA9QgVgigGgsgABKhDIAAAAg");
	this.shape_7.setTransform(-19.9,28.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#584C50").s().p("");
	this.shape_8.setTransform(-7.4,25.3);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(1,0,0,3,true).p("");
	this.shape_9.setTransform(-39.8,-18.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#7E6D73").s().p("");
	this.shape_10.setTransform(-39.8,-24.2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#584C50").s().p("ABLBdQgVg4gGg4QAGA4AVA4IiJhkQgGgYAAgYIAAgQQA4AeA8AWQA1ATA3AOIgnBtIgqgegAhRgUIgRgNIgBgBQgSgOAAgeQAAgJABgLQAYAOAYANIAAAQQAAAYAGAYIgTgNgAiVhOQgJgOAFgeIAlAYQgBALAAAJQAAAeASAOQgpgegJgOgAhEhHIAAAAgAh0hiIAAAAg");
	this.shape_11.setTransform(-43.2,-14);
...
(lib.pole = function(mode,startPosition,loop) {
	...
	// Layer 5
	this.instance = new lib.penutup1();
	this.instance.parent = this;
	this.instance.setTransform(65.4,12);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#34371D").ss(1,1,1).p("ADBiYQgKABgLABQgDABgEAAQglAFgqALQhzAehRA1QhPAygDAtQAAABAAACQAAABAAABQAAACAAACIAAAgQAAAEAAADQAAAEAAADADBiYIAAAtIkHEEAi/A4QABAHADAGQAPAcA+AIQATADAVAAIAAAtAjAAtIAAAJAjABWIAAAOQAAABABAAQAAABAAABQAIAlBJAKQATADAVAAAhGBsIEHkE");
	this.shape.setTransform(41,10.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#294132").s().p("AAVAuQhIgKgIgkIAAgBIgBgCIAAgOIAAggIABADQABAHADAFQAPAcA9AHQATADAVAAIAAAtQgVAAgTgDg");
	this.shape_1.setTransform(27.8,20.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#3B7160").s().p("AhvCAQg9gJgPgbQgEgGgBgHQAPAbA9AIQATADAVAAID4j0IAVgDIkIEFQgVgBgTgCg");
	this.shape_2.setTransform(41,8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#2C5548").s().p("AhpB4Qg9gJgPgbIAAgCIgBgJQADgtBPgyQBSg1BzgeQApgKAmgGIAHgBIj4D1QgVgBgTgCg");
	this.shape_3.setTransform(39.9,7.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#1D362F").s().p("AiDBsIEHkEIAAAtIkHEEg");
	this.shape_4.setTransform(47.1,10.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#34371D").ss(1,1,1).p("ADZhTQABgFAAgEQAAgFgBgFQgCgNgKgJQgTgUgygHQgpgFgxAFIj3D1IgRAQQBFABBZgXQBygeBSg2QAigVAUgUQAQgRAHgPQADgIABgGgADZhjIAAAQAjaBuIAAAtQBFABBZgXQBygeBSg2QBIgvAJgnQABgFAAgEQAAAAAAgBIgBgk");
	this.shape_5.setTransform(80.3,12.6);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#294132").s().p("AjaB3IAAgtQBFABBZgXQBzgeBSg0QAhgWAUgVQAQgQAHgQIAFgOIABAkIAAACIgBAIQgKAphHAuQhSA1hzAeQhVAXhDAAIgGgBg");
	this.shape_6.setTransform(80.3,16.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#3B7160").s().p("AjZBpIAQgQQA/gCBOgUQBzgeBSg1QAhgWAUgUQARgRAHgPIAEgOIAAAQIgEAOQgHAPgRARQgUAUghAWQhSA1hzAeQhVAWhCAAIgGAAg");
	this.shape_7.setTransform(80.3,13.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#2C5548").s().p("AAmh4QAygGApAGQAxAGAUAUQAJAKADANIAAACIgFAOQgHAQgQAQQgUAVghAVQhSA1hzAeQhOAUg/ACg");
	this.shape_8.setTransform(81.1,9.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// penutup 2
	this.instance_1 = new lib.penutup2();
	this.instance_1.parent = this;
	this.instance_1.setTransform(51,12.2);

	this.instance_2 = new lib.penutup1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(80.3,12.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1,p:{x:51,y:12.2}}]}).to({state:[{t:this.instance_1,p:{x:41,y:10.3}},{t:this.instance_2}]},1).wait(1));

	// Layer 8
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#34371D").ss(1,1,1).p("AkWAyQAHAmBKALQBSALBzgeQBzgeBSg1QBRg1ABgs");
	this.shape_9.setTransform(59.4,17.3);

	this.timeline.addTween(cjs.Tween.get(this.shape_9).wait(2));

	// Layer 6
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("rgba(255,255,255,0.298)").s().p("AkVEnIgBniQAHAnBKALQAcADAggBQAzgBA8gOIAagGQBzgfBSg1QBRg1ABgtIAABQQjuDMkIgjIAAGsQgxgNgFgfg");
	this.shape_10.setTransform(59.4,41);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#34371D").ss(1,1,1).p("AEXCTIAAgHIAAhDIAAmfAkWi/IABHiQAGAmBLALQBRALBzgeQB0geBSg2QBIgvAJgo");
	this.shape_11.setTransform(59.5,41.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("rgba(51,204,153,0.298)").s().p("AjEFUQgPgCgNgEQgwgNgFgeIgBniQAGAnBLAKQAcAEAggBQAzgCA8gNIAagHQBzgeBSg1QBRg1ABgtIAABQIAAFPIAABDIAAAHIAAADQgHAdgoAiQgPAMgTAMQgbASgeAPQg+AfhPAUQhTAWhDAAQgYAAgWgDg");
	this.shape_12.setTransform(59.5,41.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10}]}).wait(2));

	// Layer 4
	this.instance_3 = new lib.key("single",2);
	this.instance_3.parent = this;
	this.instance_3.setTransform(61.2,48.4,0.2,0.2,0,-12,168,114.6,98.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2));

	// Layer 7
	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#34371D").ss(1,1,1).p("AkWBQQAHAnBKAKQBSALBzgeQB0geBSg1QBQg0ABgtIAAgBQAAguhRgLQhSgLh0AeQhzAehSA1QhSA0AAAuQAAAEABAEg");
	this.shape_13.setTransform(59.4,14.2);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#263423").s().p("AjECBQhLgKgHgnIgBgIQAAguBTg0QBRg1BzgeQB0geBRALQBTALAAAuIAAABQgCAthRA0QhRA1h0AeQhUAWhCAAQgZAAgVgDg");
	this.shape_14.setTransform(59.4,14.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_14},{t:this.shape_13}]}).wait(2));

	// Layer 3
	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.lf(["#233457","#425D87","#46749F"],[0,0.467,1],2.1,9.4,-0.1,-11.9).s().p("AogBcICMg8QCGg7A4gGQA0gGBEgCQA5gDAlgKQAXgGAvgQQArgOAdgBQArgBBPAcQBPAdBjAYIBnBng");
	this.shape_15.setTransform(77.4,215.8);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.lf(["#233457","#425D87","#46749F"],[0,0.467,1],2.7,6.2,0.3,-15).s().p("AmMBOIBugrQCagUA1gTQA1gTArgWQAsgWATgEQAlgJAdAEQAjAEA5AfQA9AiAxAIIAxBNg");
	this.shape_16.setTransform(20.4,215.2);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("#34371D").ss(1,1,1).p("AEWsEIAAgHAEWsBQAAgBAAgCAkWp0IACWtIIrAAIgB3wIAAhFIAAgIAEWr8QAAgDAAgCAkWp0QAGAnBLAKQBSALBzgeQBzgeBSg1QBIgvAJgpQgEgqhOgKQhSgLhyAeQh1AehRA1QhGAtgKAug");
	this.shape_17.setTransform(59.6,133.4);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#263423").s().p("AjEB5QhLgKgGgnQAKguBGgsQBRg1B0geQBzgeBSALQBNAKAEAqQgIAphIAuQhSA1h0AeQhUAWhCAAQgZAAgVgDg");
	this.shape_18.setTransform(59.5,63.3);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.lf(["#242B19","#2E5649","#2D5042","#263524"],[0,0.518,0.882,1],25.3,-17.8,-27.2,-17.8).s().p("AkUMfIgC2tQAGAmBLALQBSALBzgeQBzgeBSg2QBIgvAJgoIAAAEIAAgEIAAgDIAAAHIAABGIABXwg");
	this.shape_19.setTransform(59.6,136);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("rgba(51,204,153,0.298)").s().p("AkWilQAGAnBLAKQBRALB0geQBzgeBSg1QBRg1ABgtIAAGfIAABDIAAAHIAAADQgEgqhOgLQhSgKhzAeQh0AehRA1QhGAtgKAug");
	this.shape_20.setTransform(59.5,38.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-19.3,-4,151.2,229.1);
...
(lib.TAPIR_HERO = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},1).wait(3).to({_off:false},0).to({_off:true},1).wait(24).to({_off:false,regX:-1.7,regY:-3,rotation:-2.2,x:36,y:-265.2},0).to({_off:true},1).wait(90));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1,p:{rotation:0,x:83.7,y:-181.3}}]}).to({state:[]},1).to({state:[{t:this.instance_1,p:{rotation:-4,x:82.7,y:-184.5}}]},3).to({state:[]},1).to({state:[{t:this.instance_3},{t:this.instance_2}]},24).to({state:[]},1).wait(90));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7,p:{startPosition:0}},{t:this.instance_6},{t:this.instance_5,p:{rotation:0,x:-27.5,y:-125.1,startPosition:0}},{t:this.instance_4}]}).to({state:[]},1).to({state:[{t:this.instance_7,p:{startPosition:0}},{t:this.instance_6},{t:this.instance_5,p:{rotation:0,x:-27.5,y:-125.1,startPosition:0}},{t:this.instance_4}]},3).to({state:[]},1).to({state:[{t:this.instance_7,p:{startPosition:2}},{t:this.instance_5,p:{rotation:5.7,x:15.7,y:-90.3,startPosition:3}},{t:this.instance_8}]},24).to({state:[]},1).wait(90));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_9,p:{x:70.2,y:-184.3,startPosition:0,regY:-117.2,rotation:0}}]}).to({state:[]},1).to({state:[{t:this.instance_9,p:{x:68.1,y:-194,startPosition:1,regY:-117.2,rotation:0}}]},3).to({state:[]},1).to({state:[{t:this.instance_10},{t:this.instance_9,p:{x:113.8,y:-157.9,startPosition:8,regY:-117.4,rotation:-2.3}}]},24).to({state:[]},1).wait(90));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({_off:true},1).wait(3).to({_off:false,startPosition:4},0).to({_off:true},1).wait(24).to({_off:false,regX:-0.3,regY:0,skewX:4.7,skewY:-175.3,x:44.8,y:-243.4,startPosition:2},0).to({_off:true},1).wait(90));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).to({_off:true},1).wait(3).to({_off:false},0).to({_off:true},1).wait(24).to({_off:false},0).to({_off:true},1).wait(90));
...
(lib.pole_key = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.pole("single",0);
	this.instance.parent = this;
...
(lib.DigiBot = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3}]}).to({state:[]},1).wait(13));
	...
	this.instance_8 = new lib.db_face("single",0);
	this.instance_8.parent = this;
	...
	this.instance_17 = new lib.db_armR("single",0);
	this.instance_17.parent = this;
	this.instance_17.setTransform(-64.4,-30.5,1,1,0,0,0,22.9,-29);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6}]}).to({state:[]},1).wait(13));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).to({_off:true},1).wait(7).to({_off:false},0).to({_off:true},1).wait(5));
...
(lib.alien = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({rotation:24.4,x:130.2,y:148.4},0).wait(1).to({rotation:0,x:78.4,y:258.5},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({startPosition:1},0).wait(1).to({startPosition:0},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({startPosition:1},0).wait(1).to({startPosition:1},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1));

	// Layer 16
	this.instance_7 = new lib.alien18_armL("single",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(47.2,143.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1).to({startPosition:1},0).wait(1).to({startPosition:1},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1).to({rotation:94.8,x:-19.9,y:103.2,startPosition:1},0).wait(1).to({startPosition:1},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1).to({startPosition:1},0).wait(1).to({startPosition:1},0).wait(1));
...
(lib.tEn5 = function(mode,startPosition,loop) {
	...
	this.mcCont.setTransform(177.3,467.4,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("Answer these questions, please.\nOur planet needs your wisdom.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 372;
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(-14.2,397);
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A8uK3IAAtBIOCAAIjaofIH0IfMAnBAAAIAANB");
	this.shape.setTransform(-14.5,399.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AcvAAMg5dAAA");
	this.shape_1.setTransform(-14.5,468.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("A8uKxIAAtCIOCAAIjaoeIH0IeMAnBAAAIAANCg");
	this.shape_2.setTransform(-14.5,399.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_4
	this.myTxt1 = new cjs.Text("Whoa! Sounds like a heavy responsibility.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 476;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(-74.2,31.2);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_5
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EgkEAC5IAAlsMBIJAAAIAAFs");
	this.shape_3.setTransform(-74.4,47.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EAkFgDjIxAAAIDwGnIn8mnMgy9AAA");
	this.shape_4.setTransform(-74.4,88.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AO4gcMgy8AAAIAAluMBIJAAAIAAFuIxAAAIDwGng");
	this.shape_5.setTransform(-74.4,68.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-314.4,28.3,480.4,85.2);
...
(lib.tEn4 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(283.4,116.8,0.35,0.35,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1));

	// Layer_1
	this.myTxt = new cjs.Text("You’re the one who will unlock \nthis door and retrieve the key to \nrestore the lost Sun.", "italic bold 20px 'Quantico'", "#0EE0E0");
	...
	this.myTxt.setTransform(77,19.7);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EAgGALkIAAw0In9AAIHCmIIr+GIIxAAAIkkAAI9uAAIAAQ0");
	this.shape.setTransform(77.9,44.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EggFAAAIduAAIEkAAId5AA");
	this.shape_1.setTransform(77.9,118.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("ACNLeIkkAAI9uAAIAAwzIduAAIEkAAIRAAAIL+mIInCGIIH9AAIAAQzg");
	this.shape_2.setTransform(77.9,45);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tEn4, new cjs.Rectangle(-129.5,-29.5,437.8,169.8), null);
...
(lib.tEn3 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(464.7,59.3,0.35,0.35,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1));

	// Layer_1
	this.myTxt = new cjs.Text("Yes, the Soracle has spoken about you.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	...
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(250.1,7);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EAiBADhIAAm8MhEBAAAIAAG8");
	this.shape.setTransform(250.5,21.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EAiBgEAMgx7AAAIrFHkIEnnkIroAA");
	this.shape_1.setTransform(250.5,70);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("A2YgTIroAAIAAm8MBEBAAAIAAG8Mgx7AAAIrFHjg");
	this.shape_2.setTransform(250.5,46.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tEn3, new cjs.Rectangle(24.2,-1,465.4,98.7), null);
...
(lib.tEn1 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(380.8,386.9,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("You knew we \nare coming?", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 228;
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(263.1,316.9);
	this.myTxt2._off = true;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("ARFIdIAArDIkJAAIB7lpImwFpI5LAAIAALD");
	this.shape.setTransform(265.5,328.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AxEAAMAiJAAA");
	this.shape_1.setTransform(265.5,382.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AxEIWIAArCIZLAAIGwlpIh7FpIEJAAIAALCg");
	this.shape_2.setTransform(265.5,329);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_5
	this.myTxt1 = new cjs.Text("Tapir and M-droid! \nI’ve been expecting you.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	...
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(223.2,-4.7);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_6
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A3fFfIAAq4MAu/AAAIAAK4");
	this.shape_3.setTransform(223.2,25.6);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("A3fiwIOjAAIizFIIJflIIZwAA");
	this.shape_4.setTransform(223.2,78.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("Ao8C3IujAAIAAq3MAu/AAAIAAK3I5wAAIpfFKg");
	this.shape_5.setTransform(223.2,42.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(68.5,-10,309.6,107.9);
...
(lib.tBm5 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(153.3,487.4,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("Silalah jawab soalan-soalan \nini. Planet kami perlukan\nkebijaksanaan awak.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	...
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(-6.2,393);
	this.myTxt2._off = true;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A6DMvIAAwxIJqAAIjaofIH1IfMAmCAAAIAAQx");
	this.shape.setTransform(-3.6,411.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AaEAAMg0HAAA");
	this.shape_1.setTransform(-3.6,492.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("A6DMoIAAwxIJqAAIjaoeIH0IeMAmDAAAIAAQxg");
	this.shape_2.setTransform(-3.6,411.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_5
	this.myTxt1 = new cjs.Text("Wah! Beratnya tanggungjawab saya.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	...
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(-31.6,32.2);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_6
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EggDAC5IAAlsMBAHAAAIAAFs");
	this.shape_3.setTransform(-31.8,47.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EAgEgDjIzqAAIDxGnIn9mnMgoRAAA");
	this.shape_4.setTransform(-31.8,88.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AIOgcMgoRAAAIAAluMBAHAAAIAAFuIzqAAIDxGng");
	this.shape_5.setTransform(-31.8,68.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-247.1,28.3,431.2,85.2);
...
(lib.tBm4 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("Awaklah orang yang akan membuka\npintu ini dan mengeluarkan kunci \nuntuk mengembalikan Matahari.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	...
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(75,19.7);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EAh8ALkIAAw0IphAAIHCmIIr+GIMg1aAAAIAAQ0");
	this.shape.setTransform(76.1,44.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("Egh7AAAMBD3AAA");
	this.shape_1.setTransform(76.1,118.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("Egh7ALeIAAwzMA1aAAAIL+mIInCGIIJhAAIAAQzg");
	this.shape_2.setTransform(76.1,45);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tBm4, new cjs.Rectangle(-143.1,-29.5,461.4,172.8), null);
...
(lib.tBm3 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(463.7,59.3,0.35,0.35,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1));

	// Layer_1
	this.myTxt = new cjs.Text("Ya, Soracle ada bercerita tentang awak.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	this.myTxt.lineWidth = 456;
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(256.1,6);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EAi0ADhIAAm8MhFnAAAIAAG8");
	this.shape.setTransform(255.6,21.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EAi0gEAMgzhAAAIrFHkIEnnkIroAA");
	this.shape_1.setTransform(255.6,70);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("A3LgTIroAAIAAm8MBFnAAAIAAG8MgzhAAAIrFHjg");
	this.shape_2.setTransform(255.6,46.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tBm3, new cjs.Rectangle(26.2,-1,462.4,98.7), null);
...
(lib.tBm1 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(386.8,394.9,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("Awak dah jangkakan\nkedatangan kami?", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 256;
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(263,326.9);
	this.myTxt2._off = true;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AUDIEIAArDImsAAIBmk3ImbE3I8kAAIAALD");
	this.shape.setTransform(262.9,340.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("A0CAAMAoFAAA");
	this.shape_1.setTransform(262.9,392.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("A0CH+IAArDIckAAIGbk4IhmE4IGsAAIAALDg");
	this.shape_2.setTransform(262.9,341.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_5
	this.myTxt1 = new cjs.Text("Tapir dan M-droid! \nDah lama saya tunggu. ", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 288;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(236.2,-4.7);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_6
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A2aFfIAAq4MAs1AAAIAAK4");
	this.shape_3.setTransform(236.3,25.6);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("A2ajKILbAAIjHF6IJzl6IauAA");
	this.shape_4.setTransform(236.3,80.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("Aq/CeIrbAAIAAq3MAs1AAAIAAK3I6uAAIpzF7g");
	this.shape_5.setTransform(236.3,44.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(90.5,-10,291.6,113.1);
...
p.nominalBounds = new cjs.Rectangle(-375.1,-4.9,431.2,84.7);
...
p.nominalBounds = new cjs.Rectangle(-271,-63.2,461.4,172.8);
...
p.nominalBounds = new cjs.Rectangle(-101.8,-34.2,462.4,98.2);
...
p.nominalBounds = new cjs.Rectangle(5,-43.2,291.6,112.6);


// stage content:
(lib.intro18 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{a1:1,a2:119,a3:150,a4:179});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(3).call(this.frame_4).wait(110).call(this.frame_114).wait(5).call(this.frame_119).wait(26).call(this.frame_145).wait(5).call(this.frame_150).wait(24).call(this.frame_174).wait(5).call(this.frame_179).wait(30).call(this.frame_209).wait(6));

	// t
	this.instance = new lib.dialogue1();
	this.instance.parent = this;
	this.instance.setTransform(230.6,84.4);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(603.3,99.6);

	this.instance_3 = new lib.dialogue5();
	this.instance_3.parent = this;
	this.instance_3.setTransform(585.3,54.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},9).to({state:[{t:this.instance_1}]},110).to({state:[{t:this.instance_2}]},31).to({state:[{t:this.instance_3}]},29).wait(36));

	// kabus fg
	this.instance_4 = new lib.Bitmap3();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-225.3,397.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({_off:true},119).wait(60).to({_off:false},0).wait(36));

	// Digi-Bot
	this.instance_5 = new lib.DigiBot("single",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(719.3,489.5,0.5,0.5,0,0,0,-1.9,68.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({_off:true},119).wait(60).to({_off:false,startPosition:8},0).wait(36));

	// TAPIR_HERO
	this.instance_6 = new lib.TAPIR_HERO("single",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(587.4,516.5,0.5,0.5,0,0,180,-0.6,404.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(94).to({startPosition:4},0).to({_off:true},25).wait(60).to({_off:false,startPosition:29},0).wait(36));

	// Alien
	this.instance_7 = new lib.alien("single",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(223.3,324.6,1,1,0,0,180,74.1,199);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(59).to({startPosition:1},0).wait(60).to({scaleX:2.6,scaleY:2.6,x:260.2,y:575.6,startPosition:2},0).to({_off:true},31).wait(29).to({_off:false,scaleX:1,scaleY:1,x:223.3,y:324.6,startPosition:1},0).wait(36));

	// pole_key
	this.instance_8 = new lib.pole_key("single",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(72.9,357.5,1,1,0,0,0,57.6,110.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({_off:true},119).wait(60).to({_off:false},0).wait(36));

	// BG
	this.instance_9 = new lib.Bitmap2();
	this.instance_9.parent = this;
	this.instance_9.setTransform(-7.9,-8);

	this.instance_10 = new lib.Bitmap5();
	this.instance_10.parent = this;
	this.instance_10.setTransform(-11.9,-14);

	this.instance_11 = new lib.Bitmap6();
	this.instance_11.parent = this;
	this.instance_11.setTransform(-20,-20);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_9}]}).to({state:[{t:this.instance_10}]},119).to({state:[{t:this.instance_11}]},31).to({state:[{t:this.instance_9}]},29).wait(36));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(174.7,292,1163,677.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/intro18/Bitmap2.png?1527797920140", id:"Bitmap2"},
		{src:"images/intro18/Bitmap3.png?1527797920140", id:"Bitmap3"},
		{src:"images/intro18/Bitmap4.png?1527797920141", id:"Bitmap4"},
		{src:"images/intro18/Bitmap5.png?1527797920141", id:"Bitmap5"},
		{src:"images/intro18/Bitmap6.png?1527797920141", id:"Bitmap6"},
		{src:"sounds/intro.mp3?1527797920141", id:"intro"}
	],
	preloads: []
};
