...
(lib.Safe201 = function() {
	this.initialize(img.Safe201);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,948,601);


(lib.safe3 = function() {
	this.initialize(img.safe3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,572,474);// helper functions:
...
(lib.workplace = function(mode,startPosition,loop) {
	...
	// safe
	this.instance = new lib.safe3();
	this.instance.parent = this;
	this.instance.setTransform(-474,-189,0.766,0.766);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Screen
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#121212").s().p("A8VS1MAAAglpMA4rAAAMAAAAlpg");
	this.shape.setTransform(160.9,34.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("A8vTOMAAAgmbMA5fAAAMAAAAmbg");
	this.shape_1.setTransform(160.9,34.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	// bg
	this.instance_1 = new lib.Safe201();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-494,-301);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-494,-301,948,601);


(lib.txtRemain = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgKAnIAAgWIAVAAIAAAWgAgKgQIAAgXIAVAAIAAAXg");
	this.shape.setTransform(133.9,15.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AASApIAAgvQAAgJgDgFQgEgFgIABQgIAAgFAFQgGAGAAAJIAAAtIgUAAIAAg4QAAgNgBgLIATAAIABAOQAEgHAHgFQAGgDAJAAQAdAAAAAhIAAAwg");
	this.shape_1.setTransform(127,15.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgXAlQgIgFgEgKQgFgJAAgNQAAgLAFgKQAEgJAIgGQAJgFAKAAQAIAAAHAEQAHADADAHIAAgMIAUAAIAABQIgUAAIAAgNQgDAHgHADQgHAEgIAAQgLAAgIgFgAgOgSQgGAHAAALQAAANAGAHQAFAGAJAAQAKAAAGgGQAFgHAAgNQAAgMgFgHQgGgGgKAAQgJAAgFAHg");
	this.shape_2.setTransform(117,15.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgXAlQgIgFgEgKQgFgJAAgNQAAgLAFgKQAEgJAIgGQAJgFAKAAQAIAAAHAEQAHADADAHIAAgMIAUAAIAABQIgUAAIAAgNQgDAHgHADQgHAEgIAAQgLAAgIgFgAgOgSQgGAHAAALQAAANAGAHQAFAGAJAAQAKAAAGgGQAFgHAAgNQAAgMgFgHQgGgGgKAAQgJAAgFAHg");
	this.shape_3.setTransform(107.1,15.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgKA3QgHgDgDgIIAAAOIgUAAIAAh0IAUAAIAAAwQAEgGAHgEQAGgEAIAAQALAAAIAFQAIAFAEAKQAFAJAAAMQAAAMgFAKQgEAJgIAGQgIAFgLABQgIAAgHgFgAgPgBQgFAFAAANQAAANAFAHQAGAGAJABQAKAAAFgIQAGgHAAgMQAAgNgGgFQgFgHgKAAQgJAAgGAHg");
	this.shape_4.setTransform(97.7,13.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgkAIIAAgwIATAAIAAAwQAAAJAEAEQAEAEAIAAQAHAAAFgGQAGgFAAgKIAAgsIAUAAIAABQIgTAAIAAgNQgEAHgHADQgGAEgIAAQgdAAAAghg");
	this.shape_5.setTransform(87.7,15.5);
	...
	this.shape_6.setTransform(79.1,15.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AASApIAAgvQAAgJgDgFQgEgFgIABQgIAAgFAFQgGAGAAAJIAAAtIgUAAIAAg4QAAgNgBgLIATAAIABAOQAEgHAHgFQAGgDAJAAQAdAAAAAhIAAAwg");
	this.shape_7.setTransform(65.6,15.3);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgXAlQgIgFgEgKQgFgJAAgNQAAgLAFgKQAEgJAIgGQAJgFAKAAQAIAAAHAEQAHADADAHIAAgMIAUAAIAABQIgUAAIAAgNQgDAHgHADQgHAEgIAAQgLAAgIgFgAgOgSQgGAHAAALQAAANAGAHQAFAGAJAAQAKAAAGgGQAFgHAAgNQAAgMgFgHQgGgGgKAAQgJAAgFAHg");
	this.shape_8.setTransform(55.7,15.4);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AggAzIADgOQAPAHAOAAQAVAAAAgVIAAgRQgDAHgHAEQgHAEgIAAQgLAAgIgFQgIgFgFgJQgEgIAAgMQAAgMAEgJQAFgJAIgGQAIgEALAAQAIAAAHADQAHAEADAHIAAgNIAUAAIAABOQAAATgKAJQgLALgUgBQgRABgPgJgAgOgkQgGAGAAAMQAAALAGAHQAFAFAJAAQAKAAAGgFQAFgHAAgLQAAgMgFgGQgGgHgKABQgJgBgFAHg");
	this.shape_9.setTransform(45.8,17.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AASApIAAgvQAAgJgDgFQgEgFgIABQgIAAgFAFQgGAGAAAJIAAAtIgUAAIAAg4QAAgNgBgLIATAAIABAOQAEgHAHgFQAGgDAJAAQAdAAAAAhIAAAwg");
	this.shape_10.setTransform(36.1,15.3);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgXAlQgIgFgEgKQgFgJAAgNQAAgLAFgKQAEgJAIgGQAJgFAKAAQAIAAAHAEQAHADADAHIAAgMIAUAAIAABQIgUAAIAAgNQgDAHgHADQgHAEgIAAQgLAAgIgFgAgOgSQgGAHAAALQAAANAGAHQAFAGAJAAQAKAAAGgGQAFgHAAgNQAAgMgFgHQgGgGgKAAQgJAAgFAHg");
	this.shape_11.setTransform(26.2,15.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgJA7IAAh1IATAAIAAB1g");
	this.shape_12.setTransform(19.3,13.6);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgJA7IAAhQIATAAIAABQgAgKgmIAAgUIAVAAIAAAUg");
	this.shape_13.setTransform(15.1,13.6);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgsA5IAAhxIAxAAQARAAAKAIQAKAIAAAOQAAAJgEAGQgFAHgIADQAKACAFAHQAFAHAAALQAAAPgKAIQgKAIgTAAgAgYApIAcAAQALAAAFgEQAGgEAAgJQAAgJgGgDQgFgFgLAAIgcAAgAgYgIIAZAAQAWAAAAgQQAAgIgGgEQgFgEgLAAIgZAAg");
	this.shape_14.setTransform(7.8,13.8);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AghAgIAFgOQANAJAQAAQAHAAAEgCQAEgCAAgFQAAgDgDgDQgCgCgHgBIgMgDQgWgFAAgRQAAgHAEgGQAEgGAHgDQAIgDAJAAQAIAAAIADQAJACAGAFIgGAOQgNgJgMAAQgGAAgEACQgEADAAAEQAAAEACACQADACAFABIANAEQAMACAGAFQAFAGAAAJQAAALgJAGQgJAHgPAAQgVAAgNgKg");
	this.shape_15.setTransform(127.8,15.4);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AgaAfQgKgLgBgUQAAgLAGgKQAFgJAIgGQAJgFAKAAQASAAAJALQAKALgBASIAAACIg2AAQABANAFAHQAGAGALAAQANAAAMgJIAFAOQgGAEgIADQgIADgJAAQgTAAgMgLgAgKgWQgFAFgCAJIAlAAQgBgJgEgFQgFgFgIAAQgHAAgFAFg");
	this.shape_16.setTransform(119.5,15.4);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AgYApIAAg5QAAgMgCgLIATAAIACAPQADgIAGgEQAGgEAIAAIAIABIAAASQgFgCgGAAQgKAAgFAGQgFAGABAKIAAAqg");
	this.shape_17.setTransform(108.3,15.3);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AgFAvQgHgIAAgPIAAgkIgPAAIAAgPIAPAAIAAgUIATgGIAAAaIAVAAIAAAPIgVAAIAAAjQAAAOANABIAIgBIAAAPQgFACgHAAQgOAAgHgHg");
	this.shape_18.setTransform(101.5,14.2);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgMA7IAAhBIgPAAIAAgPIAPAAIAAgHQAAgPAIgIQAFgHAOAAQAIAAAFACIAAAPIgIgBQgNAAAAAPIAAAGIASAAIAAAPIgSAAIAABBg");
	this.shape_19.setTransform(91.3,13.5);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AgUAlQgKgFgFgKQgFgJAAgNQAAgMAFgJQAFgKAKgFQAJgFALAAQAMAAAJAFQAKAFAFAKQAFAJAAAMQAAANgFAJQgFAKgKAFQgJAFgMAAQgLAAgJgFgAgPgTQgFAHAAAMQAAANAFAHQAGAGAJAAQAKAAAGgGQAFgHAAgNQAAgMgFgHQgGgHgKAAQgJAAgGAHg");
	this.shape_20.setTransform(83.7,15.4);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgYApIAAg5QAAgMgBgLIASAAIACAPQADgIAFgEQAHgEAJAAIAIABIAAASQgGgCgFAAQgKAAgGAGQgEAGgBAKIAAAqg");
	this.shape_21.setTransform(71.9,15.3);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AgZAfQgMgLAAgUQABgLAFgKQAFgJAIgGQAJgFALAAQAQAAAKALQAKALAAASIAAACIg3AAQABANAFAHQAGAGALAAQANAAAMgJIAFAOQgFAEgJADQgIADgJAAQgTAAgLgLgAgKgWQgFAFgBAJIAkAAQgBgJgFgFQgEgFgIAAQgHAAgFAFg");
	this.shape_22.setTransform(63.9,15.4);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFFFF").s().p("AAqApIAAgvQAAgKgDgFQgDgDgIAAQgIAAgEAFQgFAGAAAKIAAAsIgTAAIAAgvQAAgKgDgEQgEgFgHABQgIAAgFAFQgFAGAAAKIAAAsIgUAAIAAg4QAAgNgBgLIATAAIABAOQAEgHAHgFQAGgDAIAAQATAAAFAPQAEgHAHgFQAHgDAJAAQANAAAHAIQAHAIAAARIAAAwg");
	this.shape_23.setTransform(42.4,15.3);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFFFF").s().p("AgkAIIAAgwIATAAIAAAwQAAAJAFAEQADAEAHAAQAIAAAGgGQAFgFAAgKIAAgsIAUAAIAABQIgUAAIAAgNQgEAHgGADQgGAEgIAAQgdAAAAghg");
	this.shape_24.setTransform(30.4,15.5);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFFFFF").s().p("AAhA5Ig9hPIAABPIgTAAIAAhxIAPAAIA8BPIAAhPIAUAAIAABxg");
	this.shape_25.setTransform(19.6,13.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_14},{t:this.shape_13,p:{x:15.1}},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4,p:{x:97.7}},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_4,p:{x:54.8}},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_13,p:{x:113}},{t:this.shape_16},{t:this.shape_15},{t:this.shape}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,138.1,25.9);
...
(lib.tEn1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("Find the secret code \nusing Binary Search.", "italic bold 16px 'Quantico'", "#0EE0E0");
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#0EE0E0").ss(4,0,0,3).p("AvFAAIeLAA");
	this.shape.setTransform(-155,31.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#0EE0E0").ss(1,0,0,3).p("AtuEyIAAj/IilACIClh6IAAjnIeLAAIAAJe");
	this.shape_1.setTransform(-163.7,0.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AtzEvIAAj/IikACICkh6IAAjmIeLAAIAAJdg");
	this.shape_2.setTransform(-163.3,0.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tEn1, new cjs.Rectangle(-269.5,-30.5,213.1,63.6), null);
...
(lib.tBm1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("Cari kod rahsia dengan \nmenggunakan Carian Binari.", "italic bold 16px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.lineHeight = 25;
	this.myTxt.lineWidth = 233;
	this.myTxt.parent = this;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#0EE0E0").ss(4,0,0,3).p("AzeAAMAm9AAA");
	this.shape.setTransform(-126.9,32.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#0EE0E0").ss(1,0,0,3).p("AyHE3IAAkJIilACIClh6IAAjnMAm9AAAIAAJo");
	this.shape_1.setTransform(-135.6,1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AyME0IAAkJIikACICkh6IAAjmMAm9AAAIAAJng");
	this.shape_2.setTransform(-135.2,1.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tBm1, new cjs.Rectangle(-269.5,-30.5,269.3,64.6), null);
...
(lib.mcQ = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(25.8,-31.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF6600").s().p("AgiA5IAAgKIAngsQAIgIAEgHQADgHAAgHQAAgJgFgGQgGgEgJAAQgQAAgQAMIgFgJQAHgHAKgEQAKgEAKAAQAPABAJAHQAKAJAAANQAAAKgFAJQgEAIgLALIgfAkIA3AAIAAAKg");
	this.shape_1.setTransform(19.2,-36.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FF6600").s().p("AgfA5IAAgLIAZAAIAAhVIgXAOIAAgNIAdgSIAHAAIAABmIAZAAIAAALg");
	this.shape_2.setTransform(10,-36.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FF6600").s().p("AgUA2QgLgEgGgGIAFgKQAPANARgBQAMAAAGgGQAHgHAAgMQAAgLgHgHQgGgGgMAAQgPAAgKANIgJAAIAAhDIBDAAIAAAMIg2AAIAAAoQAJgJAOAAQALAAAIAFQAIAEAEAHQAFAJAAAKQAAALgFAIQgEAIgJAFQgJAFgLgBQgKABgKgEg");
	this.shape_3.setTransform(0.2,-36.1);
	...
	this.shape_4.setTransform(-14.1,-34.6);
	...
	this.shape_5.setTransform(-23.7,-32.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("");
	this.shape_6.setTransform(-33.4,-32.8);
	...
	this.shape_7.setTransform(-42.7,-34.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("AgGA5IAAhPIAMAAIAABPgAgHgqIAAgOIAPAAIAAAOg");
	this.shape_8.setTransform(-49.2,-36.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("AAVA7IAAgyQABgKgFgGQgEgFgKAAQgKAAgHAHQgHAGABAMIAAAuIgOAAIAAh1IAOAAIAAAyQADgHAIgEQAGgEAJAAQAdAAAAAfIAAAzg");
	this.shape_9.setTransform(-55.7,-36.4);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FF6600").s().p("AgcArQgLgPAAgcQAAgcALgPQAJgOATAAQATAAAKAOQALAPAAAcQAAAcgLAPQgKAPgTAAQgTAAgJgPgAgTgjQgGAMAAAXQAAAYAGALQAHAMAMAAQANAAAHgLQAGgMABgYQgBgXgGgMQgGgLgOAAQgMAAgHALg");
	this.shape_10.setTransform(-69.4,-36.2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#000000").s().p("AgGA5IAAhPIAMAAIAABPgAgHgqIAAgOIAPAAIAAAOg");
	this.shape_11.setTransform(-80.3,-36.2);
	...
	this.shape_12.setTransform(-84.6,-34.6);
	...
	this.shape_13.setTransform(-93.1,-34.6);
	...
	this.shape_14.setTransform(-102.7,-36.3);
	...
	this.shape_17.setTransform(-128.9,-34.6);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#000000").s().p("AAWA7IAAgyQAAgKgFgGQgFgFgJAAQgKAAgHAHQgGAGAAAMIAAAuIgOAAIAAh1IAOAAIAAAyQAEgHAGgEQAIgEAIAAQAcAAAAAfIAAAzg");
	this.shape_18.setTransform(-137.4,-36.4);
	...
	this.shape_19.setTransform(-147.2,-34.6);
	...
	this.shape_20.setTransform(-154.1,-34.6);
	...
	this.shape_21.setTransform(-166.8,-36.3);
	...
	this.shape_25.setTransform(-199.1,-34.6);
	...
	this.shape_26.setTransform(-207.6,-34.6);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#000000").s().p("AgUAzQgMgHgGgNQgHgNAAgSQAAgRAHgNQAGgNAMgHQAMgHAPAAQAMAAAKADQAJAEAIAHIgFAKQgIgHgIgDQgIgDgKAAQgSAAgKAMQgKAMAAAWQAAAWAKAMQAKANASAAQAKAAAIgDQAIgDAIgHIAFAKQgIAHgJADQgKAEgMAAQgPAAgMgHg");
	this.shape_27.setTransform(-217.5,-36.2);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#FF6600").s().p("AgUA2QgKgEgHgGIAFgKQAPANARgBQALAAAHgGQAHgHAAgMQAAgLgHgHQgHgGgLAAQgPAAgKANIgJAAIAAhDIBDAAIAAAMIg2AAIAAAoQAJgJAPAAQAKAAAIAFQAIAEAEAHQAFAJAAAKQAAALgFAIQgEAIgKAFQgIAFgLgBQgKABgKgEg");
	this.shape_28.setTransform(2.5,-36.1);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#000000").s().p("AgDAvQgGgGAAgNIAAgtIgQAAIAAgKIAQAAIAAgUIAMgGIAAAaIAXAAIAAAKIgXAAIAAArQAAAJADAEQAEADAHAAQAEAAAEgBIAAALQgEACgHgBQgLAAgGgGg");
	this.shape_29.setTransform(-18.8,-35.7);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#FF6600").s().p("AgdArQgKgPAAgcQAAgcAKgPQALgOASAAQAUAAAKAOQAKAPAAAcQAAAcgKAPQgKAPgUAAQgSAAgLgPgAgTgjQgHAMABAXQgBAYAHALQAGAMANAAQAOAAAGgLQAHgMAAgYQAAgXgHgMQgGgLgOAAQgNAAgGALg");
	this.shape_30.setTransform(-30.5,-36.2);
	...
	this.shape_31.setTransform(-46.6,-34.6);
	...
	this.shape_32.setTransform(-58.1,-34.6);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#000000").s().p("AgIA7IAAhFIgQAAIAAgKIAQAAIAAgNQAAgMAGgHQAFgGAMAAQAFAAAFABIAAALIgIgBQgGAAgEAEQgDADAAAJIAAALIATAAIAAAKIgTAAIAABFg");
	this.shape_33.setTransform(-71.3,-36.4);
	...
	this.shape_34.setTransform(-82.4,-34.6);
	...
	this.shape_35.setTransform(-91.8,-36.3);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#000000").s().p("AgTAlQgJgFgEgKQgFgJAAgNQAAgMAFgJQAEgJAJgGQAJgFAKAAQALAAAJAFQAJAGAEAJQAFAJAAAMQAAANgFAJQgEAKgJAFQgJAFgLAAQgKAAgJgFgAgRgWQgHAIAAAOQAAAPAHAIQAGAIALAAQAMAAAGgIQAHgIAAgPQAAgOgHgIQgGgIgMAAQgLAAgGAIg");
	this.shape_36.setTransform(-101,-34.6);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#000000").s().p("AgOAlQgJgFgFgKQgFgJAAgNQAAgLAFgKQAFgJAJgFQAJgGALAAQAIAAAHADQAIADAFAFIgEAJQgGgEgGgDQgGgCgGAAQgLAAgHAIQgHAJAAANQAAAPAHAIQAHAIALAAQAGAAAGgCQAGgCAGgFIAEAJQgFAFgIADQgIADgIAAQgLAAgIgFg");
	this.shape_37.setTransform(-109.3,-34.6);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#000000").s().p("AgCAvQgHgGAAgNIAAgtIgQAAIAAgKIAQAAIAAgUIAMgGIAAAaIAXAAIAAAKIgXAAIAAArQAAAJAEAEQADADAHAAQAFAAAEgBIAAALQgFACgGgBQgMAAgFgGg");
	this.shape_38.setTransform(-120.5,-35.7);
	...
	this.shape_39.setTransform(-127.6,-34.6);
	...
	this.shape_40.setTransform(-141.5,-34.6);
	...
	this.shape_41.setTransform(-150,-34.6);
	...
	this.shape_42.setTransform(-170.8,-34.6);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#000000").s().p("AAWA7IAAgyQAAgKgFgGQgFgFgJAAQgKAAgHAHQgGAGAAAMIAAAuIgOAAIAAh1IAOAAIAAAyQADgHAHgEQAIgEAIAAQAcAAAAAfIAAAzg");
	this.shape_43.setTransform(-179.8,-36.4);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("#000000").s().p("AgDAvQgGgGAAgNIAAgtIgQAAIAAgKIAQAAIAAgUIAMgGIAAAaIAXAAIAAAKIgXAAIAAArQAAAJADAEQAEADAHAAQAEAAAFgBIAAALQgGACgGgBQgLAAgGgGg");
	this.shape_44.setTransform(-187.4,-35.7);
	...
	this.shape_45.setTransform(-199.4,-36.3);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("#000000").s().p("AgiA5IAAhxIBFAAIAAALIg4AAIAAAoIA1AAIAAAKIg1AAIAAA0g");
	this.shape_46.setTransform(-221.2,-36.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22,p:{x:-175.9}},{t:this.shape_21},{t:this.shape_20,p:{x:-154.1}},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17,p:{x:-128.9}},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12,p:{x:-84.6}},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8,p:{x:-49.2}},{t:this.shape_7,p:{x:-42.7}},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2,p:{x:10}},{t:this.shape_1,p:{x:19.2}},{t:this.shape,p:{x:25.8}}]}).to({state:[{t:this.shape_46},{t:this.shape_8,p:{x:-215.2}},{t:this.shape_7,p:{x:-208.7}},{t:this.shape_45},{t:this.shape_44},{t:this.shape_43},{t:this.shape_42},{t:this.shape_17,p:{x:-158.4}},{t:this.shape_41},{t:this.shape_40},{t:this.shape_20,p:{x:-134.3}},{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_12,p:{x:-65.1}},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_22,p:{x:-11.3}},{t:this.shape_28},{t:this.shape_2,p:{x:12.3}},{t:this.shape_1,p:{x:21.5}},{t:this.shape,p:{x:28.1}}]},1).wait(1));

	// Layer_4
	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f().s("#D40000").ss(4,2,0,3).p("AYaAAI/8AAIw3AA");
	this.shape_47.setTransform(-103.1,-18);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f().s("#D40000").ss(1,2,0,3).p("A4pC2IAGhTIBXhQIhIhPIALh6IaWAAIWdAAIggFs");
	this.shape_48.setTransform(-101.5,-36.3);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#F5F5F5").s().p("AtaC2IAFhTIBYhQIhJhPIALh5IaWAAIqAFrg");
	this.shape_49.setTransform(-173.4,-36.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_49},{t:this.shape_48},{t:this.shape_47}]}).to({state:[{t:this.shape_49},{t:this.shape_48},{t:this.shape_47}]},1).wait(1));

	// Layer_3
	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#FAFAFA").s().p("A4mC2IAFhTIBYhQIhJhPIALh5MAwuAAAIgfFrg");
	this.shape_50.setTransform(-101.8,-36.3);

	this.timeline.addTween(cjs.Tween.get(this.shape_50).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-261.3,-55.6,318.7,39.6);
...
p.nominalBounds = new cjs.Rectangle(-257.9,-36.8,269.3,64.1);
...
(lib.actMc1 = function(mode,startPosition,loop) {
	...
	this.frame_4 = function() {
		...
		txtAns.setAttribute("maxlength", "3");
		txtAns.setAttribute("autocomplete", "false");
		...
		function checkAns(e){
			_this.parent.attempt++;
			_this.txtAttempt.text = _this.parent.attempt;
			_this.btnSubmit.mouseEnabled = false;
			_this.btnSubmit.alpha = .5;
			if (Number(txtAns.value)==cAns){
				_this.parent.storeCorrect(txtAns.value);
			} else {
				historyLength++;
				if (historyLength>11){
				...
				if (Number(txtAns.value)>cAns){
					...
					strAnsHistoryBm += txtAns.value + " adalah lebih kecil daripada kod rahsia.\n";
					strAnsHistoryEn += txtAns.value + " is lesser than the secret code.\n";
				}
				_this.parent.storeWrong(txtAns.value);
			}
			try {
				if (myLanguage==2){
					_this.txtAnsHistory.text = strAnsHistoryEn;
				} else {
					_this.txtAnsHistory.text = strAnsHistoryBm;
				}
			} catch (e) {
				_this.txtAnsHistory.text = strAnsHistoryBm;
			}
	...
	// fb
	this.txtAttempt = new cjs.Text("0", "normal 400 20px 'Muli'", "#FFFF00");
	this.txtAttempt.name = "txtAttempt";
	this.txtAttempt.lineHeight = 29;
	this.txtAttempt.lineWidth = 44;
	this.txtAttempt.parent = this;
	this.txtAttempt.setTransform(213.6,479.1);
	if(!lib.properties.webfonts['Muli']) {
		lib.webFontTxtInst['Muli'] = lib.webFontTxtInst['Muli'] || [];
		lib.webFontTxtInst['Muli'].push(this.txtAttempt);
	}

	this.txtAnsHistory = new cjs.Text("", "normal 400 14px 'Muli'", "#FFFFFF");
	this.txtAnsHistory.name = "txtAnsHistory";
	this.txtAnsHistory.lineHeight = 21;
	this.txtAnsHistory.lineWidth = 350;
	this.txtAnsHistory.parent = this;
	this.txtAnsHistory.setTransform(385.1,214.9);
	if(!lib.properties.webfonts['Muli']) {
		lib.webFontTxtInst['Muli'] = lib.webFontTxtInst['Muli'] || [];
		lib.webFontTxtInst['Muli'].push(this.txtAnsHistory);
	}

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.txtAnsHistory},{t:this.txtAttempt}]}).wait(5));

	// remainCount
	this.txtAttempt_1 = new lib.txtRemain();
	this.txtAttempt_1.name = "txtAttempt_1";
	this.txtAttempt_1.parent = this;
	this.txtAttempt_1.setTransform(69.9,481.3,1,1,0,0,0,-0.6,0.8);

	this.timeline.addTween(cjs.Tween.get(this.txtAttempt_1).wait(5));

	// btn
	this.btnSubmit = new lib.mcBtnCont();
	this.btnSubmit.name = "btnSubmit";
	this.btnSubmit.parent = this;
	this.btnSubmit.setTransform(573.5,527,0.85,0.85,0,0,0,0.2,0.6);
	...
	this.txtAns.setTransform(572.9,480.1,0.603,1.523,0,0,0,50.1,11.3);
...
// stage content:
(lib.f3s1 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(4).call(this.frame_4).wait(39).call(this.frame_43).wait(57).call(this.frame_100).wait(9).call(this.frame_109).wait(50).call(this.frame_159).wait(16).call(this.frame_175).wait(180).call(this.frame_355).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcTimesUp).wait(104).to({_off:false},0).wait(252));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(175).to({_off:false},0).wait(181));
	...
	this.timeline.addTween(cjs.Tween.get(this.timer).wait(104).to({_off:false},0).wait(252));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(29).to({_off:false},0).to({regX:-20.4,regY:-1.9,scaleX:1,scaleY:1,x:683.6,y:59.8},16,cjs.Ease.cubicOut).wait(311));

	// prompt
	this.mcCont = new lib.cursor();
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(535.1,149.7,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(100).to({_off:false},0).to({_off:true},4).wait(252));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(43).to({_off:false},0).to({_off:true},132).wait(181));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(26).to({_off:false},0).to({scaleX:1,scaleY:1,y:124.7},17,cjs.Ease.elasticOut).to({_off:true},132).wait(181));
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:407.2,y:295.9}).wait(175).to({graphics:null,x:0,y:0}).wait(181));

	// actMc
	this.instance_4 = new lib.actMc1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(0,390);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(146).to({_off:false},0).to({y:0},13,cjs.Ease.cubicOut).to({_off:true},1).wait(196));

	// q
	this.instance_5 = new lib.mcQ();
	this.instance_5.parent = this;
	this.instance_5.setTransform(585,191.6,0.1,0.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(109).to({_off:false},0).to({scaleX:1,scaleY:1,x:663.1,y:217.1},21,cjs.Ease.elasticOut).to({_off:true},30).wait(196));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(20).to({_off:false},0).to({_off:true},155).wait(181));
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/f3s1/Bitmap3.png?1529466036533", id:"Bitmap3"},
		{src:"images/f3s1/Bitmap8.png?1529466036533", id:"Bitmap8"},
		{src:"images/f3s1/Bitmap9.png?1529466036533", id:"Bitmap9"},
		{src:"images/f3s1/Safe201.png?1529466036533", id:"Safe201"},
		{src:"images/f3s1/safe3.png?1529466036533", id:"safe3"},
		{src:"sounds/mdroid_talk.mp3?1529466036533", id:"mdroid_talk"},
		{src:"sounds/questionAlert.mp3?1529466036533", id:"questionAlert"},
		{src:"sounds/questionComplete.mp3?1529466036533", id:"questionComplete"},
		{src:"sounds/submitAns.mp3?1529466036533", id:"submitAns"},
		{src:"sounds/suspense.mp3?1529466036533", id:"suspense"},
		{src:"sounds/timeout.mp3?1529466036533", id:"timeout"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1529466036533", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1529466036533", id:"sdk/anwidget.js"},
		{src:"components/ui/src/textinput.js?1529466036533", id:"an.TextInput"}
	],
	preloads: []
};
