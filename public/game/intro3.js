...
(lib.T_hand_L = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},1).to({state:[]},1).wait(6));
	...
	this.shape_16.setTransform(40.5,-42.2);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#DC3D42").s().p("");
	this.shape_17.setTransform(27,-39.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8}]}).to({state:[]},2).to({state:[{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13}]},2).to({state:[]},1).wait(3));
...
(lib.T_Arm_R = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10}]},1).to({state:[]},1).to({state:[{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15}]},2).to({state:[]},1).wait(1));
...
(lib.m4_dress = function(mode,startPosition,loop) {
	...
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1,1,1,3,true).p("AKeugQh+A6h6AfQj1A+jgguQkajilYhtQj+hSkLAMQGIGaknDuIgKMfIgCARIhmM1QFTDAFyA5QHjBMGAgsQD5gPDMhPQDMhOC+iFIiAtwQjfDsooAmQqfAXrrjWAKeugQgHAHg8BzAQ8CZIAAgGIhZsUQAvmCiOlGQhTDNh8C4QgLASgMASAAGsLQgagXgbgV");
...
(lib.m4_armR = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1,3,true).p("AFesMQoxEziHJPQgzDSgNCUQgFAtAAAoQgBAxAFAmQAMBtA+ATQAJAEAKABQBhgBBgkZQBdkSBGhzQBFhxBQhqQCJiMBcgf");
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#A97301").s().p("AmUMIQg+gTgMhtQgGgnACgwQAAgoAEguQAOiTAyjSQCIpOIwkzQCQBHAjA5QAjA4gUBOQgTBNhtCgQhcAfiICMIgDjiQl7Eoh7MzQgKgBgJgDg");
...
(lib.monster4 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).wait(1).to({x:-92.3,y:51.8},0).to({_off:true},1).wait(69));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({_off:false},0).wait(1).to({x:203.4,y:99.1},0).to({_off:true},1).wait(69));

	// m4_dress
	this.instance_2 = new lib.m4_dress("single",1);
	this.instance_2.parent = this;
	this.instance_2.setTransform(37.6,154.7,1,1,0,0,0,-2.1,24.3);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(2).to({_off:false},0).wait(1).to({x:43.1,y:164.8},0).wait(1).to({rotation:-2.2,x:49,y:158.8},0).wait(1).to({x:41.8,y:161.2},0).to({_off:true},1).wait(69));

	// m4_mouth
	this.instance_3 = new lib.m4_mouth("single",2);
	this.instance_3.parent = this;
	this.instance_3.setTransform(65.4,1.1,1,1,-4.9);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({_off:false},0).wait(1).to({regY:0.1,rotation:-4.6,x:69.3,y:3.1,startPosition:3},0).wait(1).to({regY:0.2,rotation:-6.9,x:68.5,y:-3.7,startPosition:2},0).wait(1).to({regX:0.1,rotation:-5.6,x:62.5,y:3.9,startPosition:3},0).to({_off:true},1).wait(69));

	// m4_hat
	this.instance_4 = new lib.m4_hat("single",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-3.1,-225.7,1,1,-7.7,0,0,0,-0.1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(2).to({_off:false},0).wait(1).to({regX:0.1,rotation:-7.4,x:2.1,y:-224},0).wait(1).to({rotation:-9.6,x:-7.4,y:-228.1},0).wait(1).to({regX:0,rotation:-8.4,x:-8.8,y:-222},0).to({_off:true},1).wait(69));

	// m4_hair
	this.instance_5 = new lib.m4_hair("single",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(32.2,-107.8,1,1,-4.9,0,0,0.1,-0.1);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(2).to({_off:false},0).wait(1).to({regY:-0.3,rotation:-4.6,x:36.7,y:-106.1},0).wait(1).to({regX:0.2,rotation:-6.9,x:31.7,y:-111.6},0).wait(1).to({regX:0.3,regY:-0.4,rotation:-5.6,x:27.9,y:-104.8},0).to({_off:true},1).wait(69));

	// m4_eye
	this.instance_6 = new lib.m4_eye("single",2);
	this.instance_6.parent = this;
	this.instance_6.setTransform(56.4,-56.3,1,1,-4.9,0,0,0.1,-0.1);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(2).to({_off:false},0).wait(1).to({regY:-0.2,rotation:-4.6,x:60.7,y:-54.4,startPosition:3},0).wait(1).to({rotation:-6.9,x:57.6,y:-60.9,startPosition:2},0).wait(1).to({rotation:-5.6,x:52.7,y:-53.4,startPosition:3},0).to({_off:true},1).wait(69));

	// m4_armR
	this.instance_7 = new lib.m4_armR("single",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(-42.6,8.2,1,1,0,0,0,53.9,-77.4);

	this.instance_8 = new lib.m4_armL("single",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(163.8,80.1,1,1,-53.9,0,0,-51.4,60.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7,p:{rotation:0,x:-42.6,y:8.2}}]},2).to({state:[{t:this.instance_7,p:{rotation:-3.5,x:-38.4,y:17.7}}]},1).to({state:[{t:this.instance_8,p:{x:163.8,y:80.1}}]},1).to({state:[{t:this.instance_8,p:{x:154.2,y:87.3}}]},1).to({state:[]},1).wait(69));

	// m4_head
	this.instance_9 = new lib.m4_head("single",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(35.1,-14,1,1,-4.9,0,0,0.1,0.1);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(2).to({_off:false},0).wait(1).to({regY:-0.1,rotation:-4.6,x:39.1,y:-12.3},0).wait(1).to({rotation:-6.9,x:37.7,y:-18},0).wait(1).to({regX:0.2,rotation:-5.6,x:31.9,y:-11},0).to({_off:true},1).wait(69));

	// m4_armL
	this.instance_10 = new lib.m4_armL("single",1);
	this.instance_10.parent = this;
	this.instance_10.setTransform(110,42.2,1,1,0,0,0,-51.5,60.7);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(2).to({_off:false},0).wait(1).to({y:36.9,startPosition:0},0).wait(1).to({regX:-51.4,regY:60.6,rotation:-2.2,x:111,y:39.9},0).wait(1).to({x:103.8,y:42.3},0).to({_off:true},1).wait(69));

	// m4_legL
	this.instance_11 = new lib.m4_legL("single",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(94.2,252);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(2).to({_off:false},0).wait(1).to({startPosition:0},0).wait(1).to({scaleY:1,skewX:3.7,x:99},0).wait(1).to({regX:0.1,scaleY:1,skewX:0.6,x:95.1},0).to({_off:true},1).wait(69));

	// m4_legR
	this.instance_12 = new lib.m4_legR("single",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(-0.9,262.5);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(2).to({_off:false},0).wait(1).to({startPosition:0},0).wait(1).to({scaleY:1,skewX:3.7,x:3.3},0).wait(1).to({regX:-0.1,scaleY:1,skewX:0.6,x:-0.2},0).to({_off:true},1).wait(69));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(2).to({_off:false},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).to({_off:true},1).wait(69));
...
(lib.tapirhead = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance,p:{startPosition:0}},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},5).to({state:[{t:this.instance,p:{startPosition:1}},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).to({state:[]},1).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]},5).to({state:[]},2).wait(2));
...
(lib.DigiBot = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-10.6,-171.8,1,1,1);
	...
	this.shape.setTransform(42,-135.9);
	...
	this.shape_5.setTransform(-25.5,-107.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AADBAQARg8ACgyQAEhGgPhNIARADQAIAiACAiQADAwgIAyQgSBxgsBYIgJARQAYhFARg9g");
	this.shape_6.setTransform(47.8,-108);
	...
	this.shape_7.setTransform(-23.8,-100.3);
	...
	this.shape_8.setTransform(-26,-110.5);

	this.instance_1 = new lib.db_face("single",2);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-29.1,-115.6,1,1,1,0,0,0,-0.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(1,1,1,3,true).p("AGLA/QArg/CIhlIgki3Ql+iIoPAPQivEIgbGqINzB6QA0jsAhhsg");
	this.shape_9.setTransform(-27.3,-115.4);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#333333").s().p("AhOCNQA8i7BHh/IAkC2QiGBlgrBAIAKghg");
	this.shape_10.setTransform(21.1,-126.5);

	this.instance_2 = new lib.DB_glass("single",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-19.4,-124.9,1,1,1,0,0,0.1,-0.1);
	this.instance_2.alpha = 0.34;

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_11.setTransform(-35.7,-59.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#747474").s().p("");
	this.shape_12.setTransform(-42.2,-51.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#666666").s().p("");
	this.shape_13.setTransform(-39.9,-54.6);
	...
	this.shape_14.setTransform(-35.4,-61.2);
	...
	this.shape_15.setTransform(-73.7,-136.6);
	...
	this.shape_16.setTransform(-70.6,-159.9);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AANAVQgMgVgVgQIgNgHQAOADAPAIQAVALALAMQAGAIAAAFIgVgDg");
	this.shape_17.setTransform(-63.3,-186.9);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#6B8A08").s().p("AhrH2QhWmKCgmMQgdCyANCuQAXhMAhhJQgDA/ACA8QAJDzBFD5gAA9m4QgJgKgHgJIAKgTIAEgHQgPgJgIgKQgLgOAGgHQACgCAEgCQABACAAAEQAAACAeATQAWAOAbAGIAVADQABAEgCADQgHAIgUgCQgNgBgOgHIgPgGIgJgFIAJAFIAPAGIgDAHIgLAjQgEgEgEgEg");
	this.shape_18.setTransform(-73.7,-136.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.instance_2},{t:this.shape_10},{t:this.shape_9},{t:this.instance_1},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.instance}]},2).to({state:[]},1).wait(4));

	// Layer_7
	this.instance_3 = new lib.db_handL("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(68.8,-77.3,1,1,0,-160.7,19.3,0,-18.3);

	this.instance_4 = new lib.db_armL("synched",1);
	this.instance_4.parent = this;
	this.instance_4.setTransform(42.8,-42.1,1,1,0,-147.2,32.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_4},{t:this.instance_3}]},2).to({state:[]},1).wait(4));

	// Layer_8
	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_19.setTransform(-33.2,-7.5);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#F5D802").s().p("AiNBcQhZgfgQg5QgQg4Abg4IADgHQBggJB0AZQBPASCNAxIA1ARQgNAOgJALQgVAagmAnQgmAnheAEIgWAAQhRAAhOgag");
	this.shape_20.setTransform(-35.3,-39.6);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AhcBFQAghRAmgrQAmgsAYgRQAYgSAygUIAHAGIAEALQgzARgvAxQgjAXgdAsQgUAbghBEQgTAlgPAbQAAgEAghSg");
	this.shape_21.setTransform(7.6,-26.3);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#2875A9").s().p("");
	this.shape_22.setTransform(-32.9,-7.7);
	...
	this.shape_23.setTransform(-34.4,-4.4);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#17435F").s().p("AiJDLQBHj2BhhnQAugxAzgRIAEgBQAKAPgBATQAAANgnBzIgFALQgLAggMAvQgMATgPAWIgFAGQgSAYgrAkQgsAkhNAgIADgLg");
	this.shape_24.setTransform(7.3,-18.8);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#6B8A08").s().p("ACHBLQiLgyhRgRQhzgZhhAKQAagzAagZIABAAIAHgIIA2ACQCOAHBVAKQBWAQBOAYIBRAbIAJACQgmARglAnQgTAUgQATIg1gRg");
	this.shape_25.setTransform(-28.8,-50.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19}]},2).to({state:[]},1).wait(4));

	// Layer_10
	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f().s("#000000").ss(1,1,1,3,true).p("ACKhxQgEhLAUhIIhpgCIjigEQgIArgCArQgDAmAAAmQABBJAOBIQAKA5ASA4AC4BPQAeB2hfAtQgTAJgYAHQgMADgLACQhXAQhTgtQgRgogNgoAC4BPQgRANgQALQgPAKgPAJQiHBOiFguACcAAQALAnAQAnIABABACcAAQgQg4gCg5QgfAPgeALQgTAGgSAFQh/Ahhng9ACcAAQgUAMgUALQgSAIgSAIQh8AviDgt");
	this.shape_26.setTransform(-31.8,62.3);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#747474").s().p("");
	this.shape_27.setTransform(-35.1,66.6);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#666666").s().p("ABxDOQALgQAFgKQAIgPAAgNQACgNgFgPIAegSIgeASIgDgJIgSgkQgKgSgKgUIAkgQIgkAQQgPgigMgmQgHgTgFgXIAkgMIgkAMQgJgigJgqQhsAIhmglQACgrAIgrIDiAEQAEBgAYBPIAGAWQANAmAUAyQAOAiASAoIADAHQALAbAAAOQAAALgEANIgKAXQgPAfgOATQgSAKgZAGIgXAFQAUgVAbgmg");
	this.shape_28.setTransform(-33.1,62.1);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#4C4C4C").s().p("AAcDKIAJgWQAFgOAAgKQgBgPgKgbIgDgHQgSgogNgiIAngXIgnAXQgVgxgMgnIgGgWQAegKAegPQACA4AQA4QALAnAQAoIABAAIghAZIAhgZQAeB2heAuQAMgUAQgfgAhGj8IBoACQgUBJAEBLQgeAPgeAKQgYhPgEhgg");
	this.shape_29.setTransform(-19.8,61.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26}]},2).to({state:[]},1).wait(4));
	...
	this.shape_30.setTransform(-31.9,110.7);
	...
	this.shape_31.setTransform(-32.7,144.6);
	...
	this.shape_32.setTransform(-32.1,110.6);
	...
	this.shape_33.setTransform(-20.7,93.8);
	...
	this.shape_34.setTransform(-34.5,107.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30}]},2).to({state:[]},1).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7},{t:this.instance_6},{t:this.instance_5}]}).to({state:[]},1).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_20).to({_off:true},1).wait(1).to({_off:false,rotation:1,x:-29.1,y:210.5},0).to({_off:true},1).wait(4));
...
(lib.tEn4 = function(mode,startPosition,loop) {
	...
	this.myTxt1.setTransform(-42.7,-44.7);
...
(lib.tEn3 = function(mode,startPosition,loop) {
	...
	// Layer_8
	this.myTxt1 = new cjs.Text("Two nasty robots changed the password\n to unlock the door of my home.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 440;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(199.9,-17.7);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_9
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#0EE0E0").ss(1,1,1).p("EAhtAGGIAAsLMhDZAAAIAAML");
	this.shape_3.setTransform(205.9,12.6);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#0EE0E0").ss(4,1,1).p("EAhtgGVMgrZAAAIj0MrIA4srI1EAA");
	this.shape_4.setTransform(205.9,92.2);
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("rgba(0,0,0,0.996)").s().p("ApsGGIi8AAI1EAAIAAsLMBDZAAAIAAMLg");
	this.shape_6.setTransform(205.9,12.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-22.1,-27.4,445.7,162.2);
...
(lib.tBm4 = function(mode,startPosition,loop) {
	...
	// Layer_5
	this.myTxt2 = new cjs.Text("Sudah tentu. Itulah\n sebabnya kami datang.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 277;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(18.8,64.9);
	this.myTxt2._off = true;
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#0EE0E0").ss(4,0,0,3).p("AZnphIgXAAMghBAADIgjAAEAmIgJnIshAGIgXAAAnxpeIgLABQgMAAgMgBInFABIi2ScIgGycIzyAA");
...
(lib.TAPIR_HERO = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1,p:{regX:-34,regY:-140.2,skewX:8.2,skewY:-171.8,x:59.1,startPosition:4}},{t:this.instance,p:{regX:-0.1,skewX:-6.2,skewY:173.8,x:67.7,y:10}}]},12).to({state:[{t:this.instance_1,p:{regX:-34.1,regY:-140.1,skewX:-4.3,skewY:175.7,x:71.5,startPosition:0}},{t:this.instance,p:{regX:-0.2,skewX:-3.8,skewY:176.2,x:79.6,y:10.4}}]},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(12).to({_off:false},0).wait(1).to({skewX:-4.5,skewY:175.5,x:-53.2,y:-90.9},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(12).to({_off:false},0).wait(1).to({skewX:13.2,skewY:-166.8,x:-135.3,y:19.4},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_6},{t:this.instance_5,p:{regX:-0.1,skewX:-13.7,skewY:171.2,x:-10.1,y:76.6}}]},12).to({state:[{t:this.instance_6},{t:this.instance_5,p:{regX:0.1,skewX:-11.2,skewY:173.7,x:-6.1,y:74.4}}]},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(13).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(12).to({_off:false},0).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(12).to({_off:false},0).wait(1).to({rotation:-2.8,x:-55,y:-75.1,startPosition:6},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(12).to({_off:false},0).wait(2));
...
(lib.intro3 = function(mode,startPosition,loop) {
	...
	// tapir
	this.instance_4 = new lib.TAPIR_HERO("single",12);
	this.instance_4.parent = this;
	this.instance_4.setTransform(492.1,661.6,0.7,0.7,0,0,0,-175.8,622.9);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(74).to({_off:false},0).wait(30).to({scaleX:1.09,scaleY:1.09,x:464.6,y:962.2},0).wait(59).to({startPosition:13},0).wait(10));

	// alien
	this.instance_5 = new lib.monster4("single",2);
	this.instance_5.parent = this;
	this.instance_5.setTransform(142.1,526.9,0.4,0.4,0,0,0,32.4,373.9);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(74).to({_off:false},0).wait(16).to({startPosition:3},0).wait(14).to({regX:32.5,regY:374.1,scaleX:0.62,scaleY:0.62,x:137.5,y:731.6,startPosition:4},0).wait(59).to({startPosition:5},0).wait(10));

	// md
	this.instance_6 = new lib.DigiBot("single",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(437.2,595.8,0.7,0.7,0,0,0,-15,323.6);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(74).to({_off:false},0).wait(16).to({startPosition:2},0).wait(14).to({regX:-14.9,scaleX:1.09,scaleY:1.09,x:377.3,y:859.6,startPosition:0},0).wait(69));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(74).to({_off:false},0).wait(30).to({scaleX:1.55,scaleY:1.55,x:-111.8,y:-170},0).wait(69));
