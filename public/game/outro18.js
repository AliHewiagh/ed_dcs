...
(lib.penutup2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#34371D").ss(1,1,1).p("ADBiYIAAAtIkHEEADBiYQgKABgLABQgDABgEAAQglAFgqALQhzAehRA1QhPAygDAtQAAABAAACQAAABAAABQAAACAAACIAAAgIAAAOAjAAtIAAAJAjABWQAAAEAAADQAAAEAAADQAAABABAAQAAABAAABQAIAlBJAKQATADAVAAAi/A4QABAHADAGQAPAcA+AIQATADAVAAIAAAtAhGBsIEHkE");
...
(lib.alien18_mouth = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,0,0,3,true).p("");
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#334C66").s().p("AgkByQgcg2gVhcQAMgJAJgVIAEgKIgHgBQgZgEgZgLQgEgKACgOIBTAAQALBpArBQIABAAIglAeIgRAMIgBgBgAATBJIAAAAgAASBJQgrhQgLhpIA9gBQALBLAfBBIAAABIAAgBQgfhBgLhLIA0gBQAZAkASAmIABABQgWAjggAgIgbAbIgVASIgBAAg");
...
(lib.alien18_leg = function(mode,startPosition,loop) {
	...
	// Layer 4
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1,0,0,3,true).p("ABehXQgxgHgsgKQhigXhKglIg1jcIAagBIF9gOIAND2IAJCmIAGBxABehXQA5gcAtgmAiJgTQBRgMBDgWQAsgPAngTAhqBvQBPADBCgPQBigXBEg/AhqBvIgfiCIgiiRAgQECQAnALAdAOQAFACAGACQAyAQBqgRIAGByIibgfIh5gYIgYhlQAgAGAbAIQAngIAjgMQBhgkA4hMIAICgAhLD0IgfiF");
	this.shape_6.setTransform(14.9,55.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#7E6D73").s().p("");
	...
	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#714312").s().p("");
	this.shape_13.setTransform(-23.1,89);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#4C2D0C").s().p("AjNBmIACgYQABgOACgKQADgMAFgKIgFABIAFgBIAUgEIgUAEIAUgEQAhgHAggKIAcgIQAhgJAAgOIgBgDQARgOAOgTQARgWAKgYQAXAXAeAFQAlAFBpgJIgPCeQicAXilAAIhLgBgAhkAJQAdgLAYgVIABADQAAAOghAJIgcAIIAHgCgAgvgXIAAAAg");
...
(lib.alien18_handR = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,0,0,3,true).p("AAShJQgGADgFAEQgdARgaAQIghgKAh9AYQgmhIADhQQBqgrBNgWQACAAACgBQBMgQAnCrQApCugwAfQgxAegUgoQgPAKgPAGQglAPgogFAgwghQgJAGgIAFQgQALgOALQgQAMgOAMAAtBGIiSA8IgEACQAAAAAAABQAAAYAkAoIAAABAhpCEQgngogCgwQAKgKALgK");
	this.shape.setTransform(-19.5,-77.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#26465A").s().p("AheDFIgBgMQgBgDADgDQACgDAMgEIAqgPQAdgKAUgMIAVgQIACgBQAFgjgUgOIiRA8IAmgdQA8gsBJgVIADguQACgmghgeQAVhGgkguQBLgQAoCrQApCvgwAeQgxAegUgoQgPAKgQAGQgkAPgogFIgcAQgAh8gMQgKgXgCgNQAAgJACgCQADgIAKgCQAdgLAhADQAWACAUAIQgeARgZARIgigLIAiALIgRALIgeAWIgFgMg");
	this.shape_1.setTransform(-17.1,-77.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#386886").s().p("");
	this.shape_2.setTransform(-23.9,-77.3);
...
(lib.alien18_armR = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,0,0,3,true).p("");
	this.shape.setTransform(-13.6,77.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#584C50").s().p("");
	this.shape_1.setTransform(-13.5,82.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#7E6D73").s().p("Aj1BUIADgCQAyAhATAuIghALQgBgggmg4gAjyBSQAhgXAggYQA/AlAZA4QgqASgqAPQgTgugyghgAixAjQAjgbAggbQAkgfAighQBSAyAkBKQgkhKhSgyQAjgjAegkQBugsBKBHQAXAWAOAbQgkAdgkAbQgvhbhmgpQBmApAvBbQgvAhgxAeQgsAagrAXQgchChJgrQBJArAcBCQgoAUgoASQgZg4g/glgACugWIAAAAg");
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#4D5764").s().p("AicEGQgDiYBtiXIAQgCIABAAIgBAAIgQACQhJhOggguQAGg/AKgcQARgyAqgRQAXgIApACQA/ACAqARQAiAQAPAYQAIAMAEASQADALACAXQAJBDgkAYQgTgKgXADIgIACQgzANg8BAQAtgRAsgEQgsAEgtARQA8hAAzgNIAIgCQBqAniIATQAbgDAcABQAABDgPBCQgagHgpAEQhCAJgiAcIgWCHQgNApgQA1g");
	this.shape_4.setTransform(0,45.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#353C45").s().p("AjqFxQAQg1ANgpIAWiHQAigcBDgJQApgEAaAHQAPhCAAhDQARABASADQgSgDgRgBQgcgCgbAEQCHgThpgnQAXgEASALQAkgYgJhDQgCgXgDgLQgEgSgIgMQgPgZghgQQgqgQhAgCQgpgDgXAJQgqARgRAxQgKAcgGBAQgUgcgEgPQgLglANg6QARhLAzg/IDagtQDPDmBdFjQhHCbiJB1QinABhzAlgAAugtQgNgVgRgKQARAKANAVg");
...
(lib.alien18_armLcopy = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(1,0,0,3,true).p("");
	this.shape_3.setTransform(-10.2,25.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#7E6D73").s().p("");
...
(lib.alien18_eye = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,0,0,3,true).p("ACtAYIgMAvQg/Abg0AGQgwAGgngOQhRgcgeACQgZgDAEgrIANAAIDbAAgAigAKIDVAAIB4AAIAAAOACtAKQhqhrg/gHQgNgCgNAEQhBAUgsAjQgrAiAAAXIAOAAIAAAO");
	this.shape_1.setTransform(0.1,0);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#666666").s().p("AAMBgQhQgcgdACQgagDAFgrIANAAIDaAAQATA0gfAcQgPACgNAAQghAAgcgKgAhpAKIgOAAQAAgXAqgiQAsgjBBgUQAMgEAPACQA1AxgFBBg");
	this.shape_2.setTransform(-5.4,0);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#474747").s().p("AgdAZIBxAAIgMAuQg/AcgyAGQAfgcgTg0gAgjALQAFhBg1gyQA/AIBoBrg");
...
(lib.tBm3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt2 = new cjs.Text("Sorakel ada menyebut ‘Kelam’.\nJadi, saya rasa Planet Kelamlah tempatnya.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 477;
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(-19,352.2);
	this.myTxt2._off = true;
...
p.nominalBounds = new cjs.Rectangle(302.1,294.2,900,1512.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/outro18/Bitmap10.png?1525020689696", id:"Bitmap10"},
		{src:"images/outro18/Bitmap11.png?1525020689696", id:"Bitmap11"},
		{src:"images/outro18/Bitmap14.png?1525020689696", id:"Bitmap14"},
		{src:"images/outro18/Bitmap15.png?1525020689696", id:"Bitmap15"},
		{src:"images/outro18/Bitmap18.png?1525020689696", id:"Bitmap18"},
		{src:"images/outro18/Bitmap19.png?1525020689696", id:"Bitmap19"},
		{src:"images/outro18/Bitmap20.png?1525020689696", id:"Bitmap20"},
		{src:"images/outro18/Bitmap21.png?1525020689696", id:"Bitmap21"},
		{src:"images/outro18/Bitmap4.png?1525020689696", id:"Bitmap4"},
		{src:"images/outro18/Bitmap7.png?1525020689696", id:"Bitmap7"},
		{src:"images/outro18/Bitmap8.png?1525020689696", id:"Bitmap8"},
		{src:"sounds/intro.mp3?1525020689696", id:"intro"},
		{src:"sounds/powerup.mp3?1525020689696", id:"powerup"},
		{src:"sounds/questionComplete.mp3?1525020689696", id:"questionComplete"}
	],
	preloads: []
};
