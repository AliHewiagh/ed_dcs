...
p.nominalBounds = new cjs.Rectangle(0,0,825,618);
...
(lib.T_Legs = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("Ahrq8QjyJdieJUIgTB5AAIK9IIHvv");
	this.shape.setTransform(-12.6,-73.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AizLVQg6iJgZABIATh4QCepUDxpdIBrgDQgRBTgSAwIAAABQgoBngqBwQhzEvg1DOQg3DMgIAkQhCDkAGARQAGARgQBxg");
	this.shape_1.setTransform(-39,-70.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#424242").s().p("AldJeQgGgRBCjkQAJgkA2jMQA3jOBzkvQAphwAnhnIABgBQARgwARhTIDLA5IBiAIQhtCSgDAHQg7BthXC1QhSCqiGFdQheDygSDJIiFABQAQhxgGgRg");
	this.shape_2.setTransform(-18.7,-70.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#585858").s().p("AknEEQCHldBSiqQBWi1A7htQAEgHBsiSIA8CGIAgAoQBrCHAdAXIoGPvIknBCQASjJBdjyg");
	this.shape_3.setTransform(-0.6,-67.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("ABZAvQg1gqjZilQBvA6BJAxQEQCmiNAwQAIhIg1gqg");
	this.shape_4.setTransform(148.1,155.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_5.setTransform(119.7,158.6);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#2A2A2A").s().p("ACrCiQg2gGgagIQhbgYg/ghQgxgZgfgKQg1gShsgVQhDgTgrgkQgVhDgNg6QApAuBHAZQBoAbAwAPQArAMBRAmQBTAlAqAOQB3AlCWgaQA5gKAwgQQAKAmAAAzQgwASg1AIQhcANg1AAQgSAAgOgCg");
	this.shape_6.setTransform(113.7,178.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#7E2326").s().p("ABLEdQgqgOhTgmQhSgmgqgMQgxgPhngbQhHgZgpguQgIhRgBhSQgBhSAVh9IAAgBIBIgEIAGAhQBEB3D5B1IExCOQA5AaAOAMQANAMAeATQAtAfAQBAQgvAQg5AKQg+AKg5AAQhQAAhGgVg");
	this.shape_7.setTransform(112.7,154.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#A92F33").s().p("AEcDIQgdgTgOgNQgNgMg5gZIkyiOQj4h1hFh3IgFgiID3gMIAKARQBBA5A/AyQBAAxAuAcIB3BEQBIAmBbA2QBaA0AwB3QgwAihAAVQgRhAgtgegAFeA5IACAAIAFAFIgHgFg");
	this.shape_8.setTransform(123,152.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#DC3D42").s().p("AC5BiQhbg2hHgnIh2hCQgwgdg/gxQhAgxhAg6IgKgRIBmgGIAAADQCFB+B6BHQB8BGBDAxQBEAyAgAlQAfAkAJBCIABAPIgVAQQgwh3hbg1gADaBXIgDAAQANAKgKgKg");
	this.shape_9.setTransform(136.4,149.4);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#3D3D3D").s().p("AgMggIAUgPQAJBCgHAUIgKAJQACgngOgpg");
	this.shape_10.setTransform(170.1,179.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#333333").s().p("Ag9gQQA+gVAxgiQAPAqgDAlQg2Apg7AXQAAgzgKglg");
	this.shape_11.setTransform(163.8,183.6);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(1,1,1,3,true).p("AlhJRQAAgEABgDIBvyaIA4DcQAbBhA4BQQBvhhBwhVQALgIALgIQB8hcBYglIjdRG");
	this.shape_12.setTransform(-46.6,69.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#A92F33").s().p("Ah4nhQAbBhA4BRQBuhiBxhUQgZCDgtEaQgtEYgbDMQgDAPgdA1IgLAAIAEAAIhMAEIAGABIh4ABQAEoRA9m2g");
	this.shape_13.setTransform(-53,80.3);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#7E2326").s().p("AhUJQIACgHIBuyaIA4DcQg8G0gEISIgVABQgrAAgogCg");
	this.shape_14.setTransform(-73.6,69.6);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#DC3D42").s().p("AiqHnQAajLAtkaQAukZAYiDIAWgQQB7hcBXglIjbRGIABABQhTAIhoAIQAdg2ADgPg");
	this.shape_15.setTransform(-31.5,72.8);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("Aj7BqQC+gGE5jkQiqCtiHA3QhIAdgzAAQguAAgdgXg");
	this.shape_16.setTransform(-84.3,169);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("#0000FF").ss(1,1,1,3,true).p("Ag+ADQAAAAABAAAAzgBQAGgBAGAA");
	this.shape_17.setTransform(-57,128.5);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f().s("#000000").ss(1,1,1,3,true).p("AnfDmQABiMCUh2QCTh3BShjQBLhZAQgiAHKhSQgHBFgUA6Qg1AzhCAWQhCAVhxBfQhxBeiUAkQhGAQg2AGQg0AGgjgFQgDAAgDgBQg+gLhNhEQAAgeAFgvQAGAOAKAJQABACADADQApAuBOAJQAoAFAzgFQASgCAVgEQC4gfCyibQA9g7BZgiQBagiBChMgAHgmFQAQBjgmDQ");
	this.shape_18.setTransform(-80.7,165.8);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#333333").s().p("AgrAkQACgbgCgeIgBgQQAoAFAxgFQgFAlADAjQgdADgXAAQgTAAgPgCg");
	this.shape_19.setTransform(-110.3,200.9);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#3D3D3D").s().p("AlgChIAogFQC4gfCxibQA9g6BagjQBZgjBDhMQgHBFgVA7Qg1A0hCAVQhBAVhyBeQhwBfiUAjQhHARg1AGQgDgkAFgmg");
	this.shape_20.setTransform(-70.5,180.9);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#DC3D42").s().p("AleEVQAahTBrh3IA/hFQA7g/EKkWIAMAAIgMAAIAPgPQAFgFgIAUIgHAPIAHgPQBXgGBdgJQAQBjgmDQQhDBLhZAjQhaAig9A7QixCbi4AfIgoAGQAFgkAMgng");
	this.shape_21.setTransform(-69,161.9);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#A92F33").s().p("Ak6FXQgniYBdheQBeheBwiEQBuiFA+hHIABgFIBRgBIgCAGIADgGQA3gBA6gEQkLEWg6BAIg/BEQhrB3gaBTQgMAngFAkQgaACgYAAQgVAAgTgCgAFGlYIAAAAIgHAPIAHgPg");
	this.shape_22.setTransform(-83.3,162.8);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#2A2A2A").s().p("ABCBOQg+gLhMhDQAAgfAFgvQAGAPAKAJIAEAEQApAuBNAJIACAPQABAggCAbIgGgBg");
	this.shape_23.setTransform(-121.9,196.6);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#7E2326").s().p("Ak1EgIgFgEQgJgJgGgPQABiMCTh3QCUh2BRhiQBKhaARgiQAyACA2AAIgBAEQg9BHhwCGQhuCEhfBeQhdBdAnCZQhOgKgpgugAFElSIABAAIgBAAQACgHAEADQgDABgCADIgDAGIACgGg");
	this.shape_24.setTransform(-95.7,162.7);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f().s("#000000").ss(1,1,1).p("AjtrWIgnFBIgUKfIgLFxQAdAwAmAXQAbAPAgAEQBIAIA2gVQADgBADAAQA3gXgEgPIEhyAQAXiAgIho");
	this.shape_25.setTransform(-41,58.1);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#585858").s().p("AjXLNQgggDgagQQCcuNAji2QAfigAVg1IASAAIgGgBIAtgFIACADIAAgDQCPgUBJg+QANgLAOgOQAIBogWCAIkhSAQAFAPg4AXIgGACQgoAPgwAAQgTAAgUgDgAA7pXIAMgSQgIALAAgCIgEAJg");
	this.shape_26.setTransform(-37.6,58.8);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#424242").s().p("AjNJXIALlxQBPoiAThkQAShYA6ilQA4AhA4ABIAMAAQgVA2gfCgQgjC1ibOOQgngXgcgwgADGp8QAAACAIgMIgMASIAEgIgACiqAIACgBIAAADIgCgCg");
	this.shape_27.setTransform(-51.1,61.7);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#333333").s().p("AhCivIAmlBQA5A+A6AgQg5ClgTBYQgRBjhQIjg");
	this.shape_28.setTransform(-61.9,35);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f().s("#000000").ss(1,1,1).p("AKaA1IgOkGIACi9Qg/AUg/ARQgjAJgiAJQgYAFgWAFQmKBVmDgvQgCAAgCAAQhqgNhqgXQgYB6g5DRAgzGPIAXgHQBagJBSggQAtgRApgXIAJgFAgxGJQgBADgBADIgCAA");
	this.shape_29.setTransform(41,-137.8);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#585858").s().p("AoNCBQBliGAxhLIA1gCQCRgGC+guQDAgvEzh6IAOEGImrD9IgJAEQgpAXgtARQhRAghbAJIgXAHIACgFIgCAFIgCAAg");
	this.shape_30.setTransform(55,-128.3);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#424242").s().p("AptCrQA3irANhAQCRADCGgRQCIgRDDguQDIgvCqhEIBFgRQA/gRA/gUIgBC9Qk0B6jAAuQi+AviQAFIg1ADQgxBKhmCHgAn5hKIADABIgEADIABgEg");
	this.shape_31.setTransform(44.2,-146.6);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#333333").s().p("AoxCCQA4jQAZh6QBpAXBqAMIAFABQGDAvGKhVIAugLQirBEjIAvQjDAuiIARQiFARiRgDQgNA/g4CsgAlvgeIgCgBQgDAHAFgGg");
	this.shape_32.setTransform(30.6,-150.9);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f().s("#000000").ss(1,1,1).p("AGoMfQAdh9gBhRIkw1vAnDm+IFgRnIAAAC");
	this.shape_33.setTransform(92.2,-65);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#333333").s().p("AEfKyQh0gehvg9IgBgDIlfxmQBJhEA4geQA5gfA+gfQg1CvgiAvQgkAvAIAUQBvGmBaDuQBbDuApA9IB3CFg");
	this.shape_34.setTransform(76.3,-56.6);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#424242").s().p("AETLWQhSgEhPgUIAGAAIh3iFQgog9hbjtQhbjvhvmlQgIgVAkgvQAigvA1iuIBYgyQhHCfACgCIgSESQBtE1CkF4QBvD8CnBZQgegBgegCg");
	this.shape_35.setTransform(93.6,-57.8);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#585858").s().p("Ag1HLQill3htk1IASkSQgCABBHieIEHiPIEwVvQABBRgdB9QglACgmAAQinhYhuj9g");
	this.shape_36.setTransform(104.7,-64.9);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f().s("#000000").ss(1,1,1,3,true).p("ABxI+QAMhFA0kOQA1kVBQliQhgClg6A0Qgig0hdhvQhMhgiChWQg7gmgPgLIg6Qn");
	this.shape_37.setTransform(101,76.1);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#7E2326").s().p("AhBINIA6wnQAPALA6AmIglMtQgOCAgIBXg");
	this.shape_38.setTransform(76.6,72.6);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#DC3D42").s().p("AiLHRIgKggQgPgtAKjYQAKjYAMiaQAMibgBhOQBdBvAhA0QA6g0BgikQhQFig1EUQgzEOgMBFg");
	this.shape_39.setTransform(116.1,84.9);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#A92F33").s().p("AiEHpQAIhXAOiAIAlssQCBBVBNBgQABBOgMCbQgMCZgKDZQgKDYAPAtIAKAgg");
	this.shape_40.setTransform(90.6,77.5);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f().s("#000000").ss(1,1,1).p("Ai4rPIhHCyQgUBZgHQ9QApAoApAVQAPAJAQAFQAcAMAjAAQAqABA0gTQAOgGAQgHIEIxrQAAAAABgB");
	this.shape_41.setTransform(107,57.4);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("#333333").s().p("AiPKGQAHw9AVhZIBGiyQBWBbBmBBIh0g1QhICFgEBPQgUGjAJKnQgpgVgqgog");
	this.shape_42.setTransform(93.1,56.1);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#424242").s().p("AiuKRQgQgGgPgIQgIqnATmkQAFhPBJiFIB0A1QBEAsBOAfIA6AWIAEAFQiSADhmgpQgGDNgNBlQgTCTgRDeQgQDfAAFCQgjAAgcgMgAhEl6QgCASAIghQgEAGgCAJg");
	this.shape_43.setTransform(107.5,62.6);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("#585858").s().p("AjCJiQAAlCAQjfQARjeATiSQANhlAGjOQBnApCRgDIgEgEQAlAMAlALIgBABIkHRrIgfANQgyATgqAAIgCgBgAiXm1QACgIAEgHQgFAWgBAAIAAgHg");
	this.shape_44.setTransform(115.8,68.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_44},{t:this.shape_43},{t:this.shape_42},{t:this.shape_41},{t:this.shape_40},{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},2).to({state:[]},1).wait(3));
...
(lib.T_hand_L = function(mode,startPosition,loop) {
	...
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_5.setTransform(23.9,10.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#A92F33").s().p("");
	this.shape_6.setTransform(31.7,11.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#7E2326").s().p("");
	this.shape_7.setTransform(32.2,10.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#DC3D42").s().p("AAmDYIg7guQhThahOk2IC/g1IAEgBIABADIgFgCIAFACQAIATAEANQAIAXAAAWQAAAZgPAkQgSAngGATQgPAlAFAhQAFAYAUAgIAkA0IATAhIAHAKQAIAMAIAHQAJAHAsAWQAhARAJAVQgTAmghAZIhdhFg");
	this.shape_8.setTransform(7.9,8.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},7).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5}]},1).to({state:[]},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9}]},8).to({state:[]},1).wait(1));
...
(lib.T_Arm_R = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape.setTransform(68.4,-27.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#7E2326").s().p("");
	this.shape_1.setTransform(71.3,-26);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#A92F33").s().p("");
	this.shape_2.setTransform(69.8,-28.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#DC3D42").s().p("");
	this.shape_3.setTransform(65,-31.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhiACQhVADgJAHIAmgtQBUgBBOAKQBPAKBqAwQjFgjheADg");
	this.shape_4.setTransform(-9.8,-39.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1,1,1,3,true).p("AGCkDQgpAAhAgCQgGAAgGAAQhhgEiEgPQhtgph3gMQhMgIhLAEQgTATgQAUQgCADgCADQgqA2gUBDQgcBcAABhQAABkA0BWQAEAFADAGQAyBMBPAnQAJAFAKAEQCFgCDahpQB/gVCGgpQA7gTA7gW");
	this.shape_5.setTransform(7.4,-9.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#7E2326").s().p("AkYEzQhPgngyhMIgHgLQg0hWAAhjQAAhiAchcQAUhDAqg2QgTAxgLAzQgSBXAKBTQAKBVAoBNQAUAoAaAhQA5gFBCgNICtgnQBbgVBCgHIAOgCIAEAAQBdgJBegSQAxgKAxgMQAPAaASAaQg7AWg7ATQiGAph/AVQjaBpiFACIgTgJg");
	this.shape_6.setTransform(7.4,-6.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#A92F33").s().p("Al2C3QgohNgKhWQgKhSAShXQALgzATgxIAEgGQgPBdANBiQAQB2A3BlQCxgLCjgcQCSgHCRgbQAqgHApgKQAMAcAPAbQgxAMgxAKQheAShdAJIgEAAIgOACQhCAHhbAVIitAnQhCANg5AFQgaghgUgog");
	this.shape_7.setTransform(8.2,-13.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#DC3D42").s().p("AmFAFQgOhgAQhdQAQgVATgSQBLgFBMAIQB3ANBtAoQCEAQBhADIAMABQBAACApAAQgNAugBAxQgBAiAFAdQAIA/AZA8QgpAJgqAIQiSAbiRAGQijAcixAMQg3hmgQh3g");
	this.shape_8.setTransform(8.7,-20.6);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_9.setTransform(-40.4,-69.9);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#585858").s().p("AAiGbQg0gLgfAHQgeAHgng2Qgmg2gIgiQgIgigLi/QgHiGAgkMIAEAAQBNAAA+gIQB0gQBUgwIgOBVQhXBXg+BsQgUAkgHAZQgIAXgCAVQBUgTAEgFQgxDsAsBwQAsBwBFAiQg5gEhagNg");
	this.shape_10.setTransform(-59.4,-21.9);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#424242").s().p("ACBHiIgbgBQhEgigshwQgshvAxjsQgEAFhUARQABgUAIgXQAJgYATglQA9hrBXhXIAOhVQhUAwhzAPQg/AJhNAAIgEAAIAIg9QAnAEBegRQBegRBfgfQBggeAxgdQgsB+gaCDQgtAjgmAtQgbAggWAkQgQAHgNADQANgDAQgHIgIAMQATgIAkgFQhMDVAtClQAsCmAxAQIgIABIgIgBgAAkhNIAAAAg");
	this.shape_11.setTransform(-51.6,-27.3);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#333333").s().p("");
	this.shape_12.setTransform(-39.5,-69.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},5).to({state:[]},1).wait(2));
...
(lib.db_feature = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AjTCAIASg5IFKAtIgTA7gABcAXIA3irIBAAHIg1CtgAiugHIA5inIA7AGIgzCog");
	this.shape_1.setTransform(-1.5,-1.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},1).to({state:[]},1).to({state:[{t:this.shape_1}]},2).to({state:[]},1).wait(1));
...
(lib.T_features = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},1).wait(2).to({_off:false,startPosition:1},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:4},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({_off:true},1).wait(2).to({_off:false,startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:-18.2,y:-30.8},0).wait(1).to({x:34.4,y:-21.8,startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:2},0).wait(1));
...
(lib.T_Arm_L = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-86.2,-45.7,1.05,1.05,106,0,0,-0.1,0.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(1,1,1,3,true).p("ADxEqQgXADgWABQg0ABg1gMQiDgehcgWQhcgWgegIQgRgEgEgCIAAmiQCfguCJgXQAbgHA9gHQA8gIBrAP");
	this.shape_4.setTransform(-12.3,-33.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#585858").s().p("ABMDaQABgcgDgdQgPiNhchzQgyg/hDguQAcgHA8gIQA9gHBqAPQBID+gpCzIg8gEg");
	this.shape_5.setTransform(4.8,-41.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#424242").s().p("ABMEbQiDgehdgWIh6gfIgVgFIAAmjQCgguCIgWQBCAuAzA/QBdB0AOCMQADAdAAAcIA8AEQgSBMglA9IgMASQgWAEgXAAIgNAAQgtAAgugKg");
	this.shape_6.setTransform(-10.8,-33);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#000000").ss(1,1,1,3,true).p("ACJkbIg8ABQgpARglA0AiIBCQAcBLApA2QAMAQALAMQAdAfAXAMQAOAKAOAI");
	this.shape_7.setTransform(-5.3,-40.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#333333").s().p("AkOETIAfgHIAcgLQAPgEAOgHIAbgNIgmguQg4hHgYhWQgXhXAWhXQAYhZBRg7IEcgWQgIAfACAjQACAxAVAwQAgBLBWBTQATATARANQhyBvhDAoIhjA8Ig6AnQgcASg+AHIgOABQgxAAhBgog");
	this.shape_8.setTransform(25.3,-39.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#424242").s().p("AgsEKQgYgMgcgfQAagCAbgGQAZgHAWgJQgYgngVgoQgnhNAGhWQAGhXAlhPIgFgDQgJgCgJACIABgBQAlg0AogRIA8gBQhRA7gXBZQgXBXAYBXQAWBWA5BHIAlAuIgaANQgOAHgPAEIgdALIgdAHIgcgSg");
	this.shape_9.setTransform(0,-40.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#585858").s().p("AgbC/Qgqg2gbhMICFkVQAJgDAJADIAGACQglBPgHBYQgFBVAnBOQAVAnAZAnQgYAJgYAHQgbAHgaABQgLgMgMgPg");
	this.shape_10.setTransform(-9.3,-40.4);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(1,1,1,3,true).p("AjMr2QAtgMAxAAQAggBAhAGQCCAlBZEYQBYEYAaCHQAVAyASAwQATAvAPAkQAeA5AXAyQBECPATBZQACALACALQADAZgBAXQgHBUhMA4QhIA0hRARQgTAEgUACQgKgBgJAAQkbh8hklNQhjlNg0h5Qg0h6hHieQhHidAKhcQDphFBEgUg");
	this.shape_11.setTransform(3,-70.3);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#424242").s().p("ACIGNIgegcQhBg6gmgnQg1g3gng0QgEgFgShrQAgi5FrhdQAeA5AXAzIgHgBIkCBzQiGBlEAEmQgUAEgTACIgTgBgAlQmNQAGAJAIAHIgBAAQgHAAgGgQg");
	this.shape_12.setTransform(10.7,-32.9);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#333333").s().p("AhhE6QhjlMg0h6Qg0h6hHidQhHieAKhcIEthYQAtgNAxAAQAgAAAgAGQCDAkBZEZQBYEYAaCGIAnBiQASAvAQAkQlsBdggC6QASBrAEAFQAnA0A2A3QAmAnBBA6IAeAcQkdh8hilNgAisgGQgIgIgGgJQAHASAHgBg");
	this.shape_13.setTransform(-4.3,-70.4);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#585858").s().p("AibiLIEBhzIAHAAQBECPATBZIAEAWQADAYgBAXQgHBUhMA4QhIA0hQAQQkAklCGhlg");
	this.shape_14.setTransform(33.4,-19.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},4).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.instance,p:{regX:-0.1,rotation:106,x:-86.2,y:-45.7,startPosition:8}}]},1).to({state:[]},1).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.instance,p:{regX:0,rotation:-113.4,x:46.8,y:-49,startPosition:7}}]},2).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11}]},1).to({state:[]},1).wait(3));
...
(lib.rain2copy = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},60).wait(34));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},60).wait(34));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({_off:true},60).wait(34));
...
(lib.rain2 = function(mode,startPosition,loop) {
	...
	// Layer 6
	this.instance_1 = new lib.raindrops("synched",7);
	this.instance_1.parent = this;
	...
	// Layer 4
	this.instance_2 = new lib.raindrops("synched",0);
	this.instance_2.parent = this;
	...
	// Layer 5
	this.instance_3 = new lib.raindrops("synched",0);
	this.instance_3.parent = this;
...
(lib.gate = function(mode,startPosition,loop) {
	...
	this.instance_1 = new lib.lasercopy2("synched",29);
	this.instance_1.parent = this;
	...
	this.instance_12 = new lib.laser("synched",29);
	this.instance_12.parent = this;
	...
	this.instance_14 = new lib.laser("synched",0);
	this.instance_14.parent = this;
	...
	this.instance_17 = new lib.laser("synched",29);
	this.instance_17.parent = this;
	this.instance_17.setTransform(328.4,130,0.357,0.718,0,21.7,25.1,339.1,0.6);

	this.instance_18 = new lib.laser("synched",49);
	this.instance_18.parent = this;
	...
	this.instance_21 = new lib.laser("synched",24);
	this.instance_21.parent = this;
	this.instance_21.setTransform(166.2,187.8,0.31,0.85,0,-13,2.7,338.2,0.7);

	this.instance_22 = new lib.laser("synched",0);
	this.instance_22.parent = this;
	...
	this.instance_27 = new lib.lasercopy3("synched",44);
	this.instance_27.parent = this;
	...
	this.instance_33 = new lib.lasercopy2("synched",29);
	this.instance_33.parent = this;
	this.instance_33.setTransform(485.7,272.6,0.926,0.818,0,7.7,6.1,158.9,46.6);

	this.instance_34 = new lib.laser("synched",0);
	this.instance_34.parent = this;
	...
	this.instance_37 = new lib.lasercopy3("synched",9);
	this.instance_37.parent = this;
	...
	this.instance_40 = new lib.laser("synched",11);
	this.instance_40.parent = this;
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_49},{t:this.instance_48},{t:this.instance_47},{t:this.instance_46},{t:this.instance_45},{t:this.instance_44},{t:this.instance_43},{t:this.instance_42},{t:this.instance_41},{t:this.instance_40},{t:this.instance_39},{t:this.instance_38},{t:this.instance_37},{t:this.instance_36},{t:this.instance_35},{t:this.instance_34},{t:this.instance_33},{t:this.instance_32},{t:this.instance_31},{t:this.instance_30},{t:this.instance_29},{t:this.instance_28},{t:this.instance_27},{t:this.instance_26},{t:this.instance_25},{t:this.instance_24},{t:this.instance_23},{t:this.instance_22},{t:this.instance_21},{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(60));
...
(lib.db_face = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.db_feature("single",1);
	this.instance.parent = this;
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape},{t:this.instance,p:{startPosition:1}}]},2).to({state:[]},1).to({state:[{t:this.shape},{t:this.instance,p:{startPosition:4}}]},2).to({state:[]},1).wait(1));
...
(lib.tapirhead = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({_off:true},1).wait(2).to({_off:false,startPosition:4},0).to({_off:true},1).wait(10));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},4).to({state:[]},1).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},2).to({state:[]},1).wait(10));
...
(lib.TAPIR_HEROcopy = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(56,-255.1,1,1,5.7,0,0,0,-0.1);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(127.6,-122.4,1,1,18.4,0,0,-14.8,-117.4);

	this.instance_2 = new lib.T_shoulderPad_L("single",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(137.1,-137.5,1,1,-1.5,0,0,0.1,-0.1);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(-77.3,-167.4,1,1,12,0,0,-0.1,-0.1);

	this.instance_4 = new lib.T_Arm_R("single",5);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-60.6,-183.3,1,1,8.8,0,0,-34.1,-140.3);

	this.instance_5 = new lib.T_Body("single",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(17.3,-90,1,1,5.7,0,0,0,0.1);

	this.instance_6 = new lib.T_Legs("single",2);
	this.instance_6.parent = this;
	this.instance_6.setTransform(-3.8,-18.4,1,1,0,0,0,16.9,-193.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3}]}).wait(91));

	// Layer_6
	this.instance_7 = new lib.T_Arm_L("single",4);
	this.instance_7.parent = this;
	this.instance_7.setTransform(129,-134,1.1,1.06,18.4,0,0,-14.7,-117.3);
	...
	this.instance_8.parent = this;
	this.instance_8.setTransform(58.5,-240,1,1,0,10.2,-169.8,-0.1,0);
...
p.nominalBounds = new cjs.Rectangle(-197.5,-333.5,406.6,734.4);
...
(lib.TAPIR_HERO = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).to({state:[]},1).to({state:[{t:this.instance_1},{t:this.instance}]},2).to({state:[]},1).wait(113));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2}]}).to({state:[]},1).to({state:[{t:this.instance_3},{t:this.instance_2}]},2).to({state:[]},1).wait(113));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4}]}).to({state:[]},1).to({state:[{t:this.instance_5},{t:this.instance_4}]},2).to({state:[]},1).wait(113));

	// tapir head
	this.instance_6 = new lib.tapirhead("single",4);
	this.instance_6.parent = this;
	this.instance_6.setTransform(44.8,-243.4,1,1,0,4.7,-175.3,-0.3,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({_off:true},1).wait(2).to({_off:false},0).to({_off:true},1).wait(113));

	// Layer_9
	this.instance_7 = new lib.T_shoulderPad_L("single",1);
	this.instance_7.parent = this;
	this.instance_7.setTransform(77.4,-171.9,1.001,1,0,-88.4,-85.5,-43.2,-44.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({_off:true},1).wait(2).to({_off:false},0).to({_off:true},1).wait(113));

	// tapir body
	this.instance_8 = new lib.T_Arm_L("single",9);
	this.instance_8.parent = this;
	this.instance_8.setTransform(106.4,-167.1,1,0.965,0,-99.3,-99.2,-14.8,-117);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({_off:true},1).wait(2).to({_off:false},0).to({_off:true},1).wait(113));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).to({_off:true},1).wait(2).to({_off:false},0).to({_off:true},1).wait(113));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-197.5,-338,416.6,738.9);
...
(lib.Symbol14 = function(mode,startPosition,loop) {
	...
	// ?mark
	this.instance = new lib.mark("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(3.4,99.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(60));

	// gate
	this.instance_1 = new lib.gate("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-5.4,74.9,1,1,0,0,0,501.9,218.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(60));

	// rain2 copy
	this.instance_2 = new lib.rain2copy("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(4.2,-49.8,1,1.275);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(-412.5,-309);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(60));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1095,-309,3006.9,1759.3);
...
(lib.DigiBotcopy = function(mode,startPosition,loop) {
	...
	this.instance_13.parent = this;
	this.instance_13.setTransform(-112.6,-49,1,1,0,150,-30,-0.1,-18.9);

	this.instance_14 = new lib.db_armR("single",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(-51.7,-21.5,1,1,0,150,-30,22.9,-28.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3}]}).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(4));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-145.5,-164.2,241.3,487.7);
...
(lib.tEn3 = function(mode,startPosition,loop) {
	...
	// Layer_5
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("ANdIbIAAm6IpjAAICKptInSJtIsOAAIAAG6");
	this.shape.setTransform(263.7,378.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("ANdAAI65AA");
	this.shape_1.setTransform(263.7,432.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("AtcIUIAAm6IMOAAIHSptIiKJtIJjAAIAAG6g");
	this.shape_2.setTransform(263.7,379.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_1
	this.myTxt1 = new cjs.Text("Looks like the only way to get in is to answer a\nseries of questions.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 516;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(-8.1,87.3);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_2
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EgoigJnIZrAAIh5SmIG4ymMAybAAA");
	this.shape_3.setTransform(-7.9,213.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EgoiAFOIAAqWMBRFAAAIAAKW");
	this.shape_4.setTransform(-7.9,118.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("Au3kHI5rAAIAAqXMBRFAAAIAAKXMgybAAAIm4Smg");
	this.shape_5.setTransform(-7.9,178);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-269.4,84.3,523,192.5);
...
(lib.tEn1 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(369.3,340,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("Voldor must be in there. ", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 299;
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(224.7,299.9);
	this.myTxt2._off = true;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A3cGFIAAncMAkJAAAIKnkjIktEjIDcAAIAAHc");
	this.shape.setTransform(228.2,301.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AWwAAMgtfAAA");
	this.shape_1.setTransform(223.7,340);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("A3YGAIAAncMAkKAAAIKnkjIktEjIDbAAIAAHcg");
	this.shape_2.setTransform(227.8,301.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_4
	this.myTxt1 = new cjs.Text("Whew! We made it and landed safely\nthanks to the energy gem.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 419;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(59.4,42.5);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_5
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AncmHMAoZAAAIAAMUAncmHIgBAFEgg8AGNIAAsUIHmAAIR6AA");
	this.shape_3.setTransform(60.2,73.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EAg9gGQIsLAAIFuL+Ir+r+MgveAAA");
	this.shape_4.setTransform(60.2,153.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("AhLBLIAAiWICYCWg");
	this.shape_5.setTransform(-94.4,42.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AOiAKMgveAAAIAAsTIHmAAIR6AAIgBAFIABgFMAoZAAAIAAMTIsLAAIFuMAgA5WpyICZAAIiZiXg");
	this.shape_6.setTransform(60.2,112.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-152.7,33.5,425.8,162.1);
...
(lib.tBm3 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(403.9,430.8,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_5
	this.myTxt2 = new cjs.Text("Mari kita lakukannya!", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	...
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(264.5,393.3);
	this.myTxt2._off = true;
	...
	// Layer_6
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AUuIMIAAmcIxDAAICKptInSJtIzQAAIAAGc");
	this.shape.setTransform(265.2,377.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AUuAAMgpbAAA");
	this.shape_1.setTransform(265.2,429.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("A0tIFIAAmcITQAAIHSptIiKJtIRDAAIAAGcg");
	this.shape_2.setTransform(265.2,378.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_1
	this.myTxt1 = new cjs.Text("Nampaknya terdapat hanya satu cara untuk masuk\nke dalam, iaitu dengan menjawab beberapa soalan.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 571;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(10.5,87.3);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_2
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EgrHgJnIZsAAIh6SmIG4ymMA3lAAA");
	this.shape_3.setTransform(8.6,213.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EgrHAFOIAAqWMBGjAAAIC0AAIM4AAIAAKW");
	this.shape_4.setTransform(8.6,118.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("AxbkHI5sAAIAAqXMBGjAAAIC0AAIM4AAIAAKXMg3lAAAIm4Smg");
	this.shape_5.setTransform(8.6,178);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-276.9,84.3,575,192.5);
...
(lib.tBm1 = function(mode,startPosition,loop) {
	...
	// Layer_5
	this.myTxt2 = new cjs.Text("Voldor pasti ada di dalam.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 319;
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(215.7,299.9);
	this.myTxt2._off = true;
	...
	// Layer_6
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A5BGFIAAncMAnTAAAIKnkjIktEjIDcAAIAAHc");
	this.shape.setTransform(218.1,301.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AYVAAI44AAIjLAAI0mAA");
	this.shape_1.setTransform(213.6,340);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("AhMGAIjLAAI0mAAIAAncMAnUAAAIKnkjIktEjIDbAAIAAHcg");
	this.shape_2.setTransform(217.7,301.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_1
	this.myTxt1 = new cjs.Text("Fuh! Kami dah mendarat dengan selamat.\nMujurlah ada permata tenaga itu.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 477;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(77.4,42.5);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_2
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("Ap/mHMAtfAAAIAAMUAp/mHIgBAFEgjfAGNIAAsUIHmAAIR6AA");
	this.shape_3.setTransform(76.5,73.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EAjggGQIxRAAIFuL+Ir+r+MgveAAA");
	this.shape_4.setTransform(76.5,153.5);
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AL/AKMgveAAAIAAsTIHmAAIR6AAIgBAFIABgFMAtfAAAIAAMTIxRAAIFuMAgA75pyICZAAIiZiXg");
	this.shape_6.setTransform(76.5,112.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-163.2,33.5,481.2,162.1);
...
p.nominalBounds = new cjs.Rectangle(-404.9,51.1,575,192);
...
p.nominalBounds = new cjs.Rectangle(-291.1,0.3,481.2,161.6);


// stage content:
(lib.intro13 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{a1:1,a2:69});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(3).call(this.frame_4).wait(55).call(this.frame_59).wait(10).call(this.frame_69).wait(25).call(this.frame_94).wait(1));
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(411.8,13.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},46).to({state:[{t:this.instance_1}]},23).wait(26));

	// rain
	this.instance_2 = new lib.rain2();
	this.instance_2.parent = this;
	this.instance_2.setTransform(401.8,237.3,1,1.275);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regX:0.1,regY:-0.1,scaleX:2.07,scaleY:2.64,x:147.6,y:-119.6},42,cjs.Ease.get(1)).wait(27).to({regY:0,scaleX:2.7,scaleY:3.44,x:307.9,y:-175.1},0).wait(26));

	// Digi-Bot
	this.instance_3 = new lib.DigiBot("single",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(578.8,569.7,0.243,0.243,0,0,0,-1.7,67.7);
	this.instance_3.filters = [new cjs.ColorFilter(0.7, 0.7, 0.7, 1, 0, 0, 0, 0)];
	this.instance_3.cache(-145,-176,258,502);

	this.instance_4 = new lib.DigiBotcopy("single",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(130.9,537.1,0.656,0.656,0,0,180,-1.4,67.9);
	this.instance_4.filters = [new cjs.ColorFilter(0.7, 0.7, 0.7, 1, 0, 0, 0, 0)];
	this.instance_4.cache(-147,-166,245,492);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3}]}).to({state:[{t:this.instance_3}]},42).to({state:[{t:this.instance_4}]},27).wait(26));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:-1.5,regY:68.2,scaleX:0.5,scaleY:0.5,x:514.6,y:570},42,cjs.Ease.get(1)).to({_off:true},27).wait(26));

	// TAPIR_HERO
	this.instance_5 = new lib.TAPIR_HERO("single",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(649.6,563.8,0.243,0.243,0,0,180,-0.8,403.6);
	this.instance_5.filters = [new cjs.ColorFilter(0.7, 0.7, 0.7, 1, 0, 0, 0, 0)];
	this.instance_5.cache(-199,-340,421,743);

	this.instance_6 = new lib.TAPIR_HEROcopy("single",7);
	this.instance_6.parent = this;
	this.instance_6.setTransform(659.2,605.4,0.656,0.656,0,0,180,-1.1,403.7);
	this.instance_6.filters = [new cjs.ColorFilter(0.7, 0.7, 0.7, 1, 0, 0, 0, 0)];
	this.instance_6.cache(-199,-335,411,738);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5}]}).to({state:[{t:this.instance_5}]},42).to({state:[{t:this.instance_6}]},27).wait(26));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:-1,regY:403.9,scaleX:0.5,scaleY:0.5,x:661.4,y:557.7,startPosition:3},42,cjs.Ease.get(1)).to({_off:true},27).wait(26));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({scaleX:2,scaleY:2,x:121.6,y:8.9},42,cjs.Ease.get(1)).wait(27).to({scaleX:2.7,scaleY:2.7,x:265.5,y:-51.2},0).wait(26));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-295,-68.6,3006.9,2118.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/intro13/Bitmap1.png?1524634810836", id:"Bitmap1"},
		{src:"images/intro13/Bitmap11.png?1524634810836", id:"Bitmap11"},
		{src:"images/intro13/Bitmap5.png?1524634810836", id:"Bitmap5"},
		{src:"images/intro13/Bitmap8.png?1524634810836", id:"Bitmap8"},
		{src:"sounds/intro.mp3?1524634810836", id:"intro"}
	],
	preloads: []
};
