...
(lib.T_Legs = function(mode,startPosition,loop) {
	...
	this.shape_130.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
...
(lib.dgd = function(mode,startPosition,loop) {
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#757D84").s().p("");
	this.shape_2.setTransform(45.5,-225.6);
...
(lib.db_armL = function(mode,startPosition,loop) {
	...
	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(1,1,1,3,true).p("AgHijQgngTgqgSQgWgJgWgJQgmgPgogOIhYCnQB5AlBYAnQAggRAVgUQAOgPAIgQQATgogMgzgAAxBGQAcgGAWgLQAOgHAMgJQAqghgBg7AAxBGQBcBCAABFQANgDAMgBQARgCAQABQA/ADAhAtQAViNhfhsQgYgbgfgbQhFg4hog0AhZgEQBVAkA1Am");
	this.shape_12.setTransform(-3.8,-17.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#747474").s().p("ABtCxIgBgHQgHg5ghg2QgPgYgSgWQApgfAAg5IAAgDIAAADQAAA5gpAfQgVgXgYgVQgngjg3gdQAMgYAAgcQAAgTgFgUQBoA0BFA4QAgAaAXAcQBfBrgVCNQghgsg/gDgAhthiQgogVg7gZQAKgOAEgNQAJgSAEgYIADgKQArASAmATQAFAUAAATQAAAcgMAYIgFgDg");
...
(lib.boss_armR = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_6.setTransform(75.8,22.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("");
	...
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#999999").s().p("");
	this.shape_9.setTransform(104.5,20.2);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#CCCCCC").s().p("");
...
(lib.boss_armL = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
...
(lib.T_Arm_L = function(mode,startPosition,loop) {
	...
	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#DC3D42").s().p("");
...
(lib.DigiBot = function(mode,startPosition,loop) {
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#3399DB").s().p("AgUCBQg0gigLgVIgHgSQgFgSgDgTIAAgPQgBggAMgfQAhg6BGgiQAdgNAkgJQgIANgGANQgfBBAFBYQAGBZAoA8IANATQhEgLg0gig");
	this.shape_2.setTransform(-60.2,-133.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#17435F").s().p("AgaBJQgSgbgGgoQgEgoALgfQAMgeAVgDQAUgDASAcQATAbAEAqQAEAmgLAfQgLAfgVADIgEAAQgSAAgQgag");
	this.shape_3.setTransform(-41.8,-133.6);
...
(lib.tEn4 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("Yes! I know you’d come. So, answer\nthese questions if you want to stay in\none piece.", "italic bold 20px 'Quantico'", "#0EE0E0");
	...
	this.myTxt.setTransform(85,19.7);
...
(lib.tEn3 = function(mode,startPosition,loop) {
	...
	// Layer_4
	this.myTxt1 = new cjs.Text("You have very sharp eyes, Tapir!\nThis one has a timed bomb.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 396;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(256.2,12.4);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_5
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("A+DAAMArLAAAIBKAAIPyAA");
	this.shape_3.setTransform(256.7,80);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EAhuAF+IAAr2Mg8HAAAIAACFInMHRIHMi+IAAFe");
	this.shape_4.setTransform(233.2,41.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("AR4F7IhKAAMgrLAAAIAAldInMC+IHMnRIAAiFMA8HAAAIAAL1g");
	this.shape_5.setTransform(233.7,42.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(16.9,3.2,439.2,78.9);
...
(lib.tEn1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt2 = new cjs.Text("Don’t you think this one\nlooks a bit odd?", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 322;
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(415.9,88);
	this.myTxt2._off = true;
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AWkkvIvBAAIlEAAIDZI7IoIo7I0TAA");
	this.shape_1.setTransform(415.6,184.8);
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AiQBEI0TAAIAArDMAtHAAAIAALDIvBAAIAAhjIhmAAIBmBjIlEAAIDZI8g");
	this.shape_3.setTransform(415.6,147.6);
	...
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(164.5,10.6);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_5
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AaCEFIAAoEMg0DAAAIAAIE");
	this.shape_4.setTransform(164,25.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AaCmQI3hAAIChL6Inzr6I3QAA");
	this.shape_5.setTransform(164,91.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("rgba(0,0,0,0.996)").s().p("Aixh7I3QAAIAAoEMA0DAAAIAAIEI3hAAIChL6g");
	this.shape_6.setTransform(164,64);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-22.9,-1,375,134.8);
...
(lib.tBm4 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(313.4,119.8,0.35,0.35,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1));

	// Layer_1
	this.myTxt = new cjs.Text("Ya! Saya tahu awak tentu akan datang.\nJadi, jawablah soalan-soalan ini jika\nawak nak selamat.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	this.myTxt.lineWidth = 463;
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(100.5,19.7);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EAmyAIdIAAw0MhFHAAAIAACNIoSF6IISh4IAAKl");
	this.shape.setTransform(74.1,65.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EgijAAAMAxjAAAICVAAIRPAA");
	this.shape_1.setTransform(101.1,119.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("AVeIaIiVAAMgxjAAAIAAqkIoSB4IISl6IAAiNMBFHAAAIAAQzg");
	this.shape_2.setTransform(74.6,66);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tBm4, new cjs.Rectangle(-174.5,11.2,512.8,132.1), null);
...
(lib.tBm3 = function(mode,startPosition,loop) {
	...
	// Layer_5
	this.myTxt1 = new cjs.Text("Tajam mata awak, Tapir! Yang\nini dah dipasang bom masa.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 396;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(236.2,12.4);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_6
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("A65AAMA1zAAA");
	this.shape_3.setTransform(236.4,80);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AekF+IAAr2Mg1yAAAIAACFInMHRIHMi+IAAFe");
	this.shape_4.setTransform(213,41.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("A3TF7IAAldInMC+IHMnRIAAiFMA1zAAAIAAL1g");
	this.shape_5.setTransform(213.4,42.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(16.9,3.2,419.2,78.9);
...
(lib.tBm1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt2 = new cjs.Text("Awak rasa tak patung \nini ganjil sikit?", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 294;
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	...
	// Layer_5
	this.myTxt1 = new cjs.Text("Seram tempat ini.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 268;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(164.8,10.6);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_6
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AWDEFIAAoEMgsFAAAIAAIE");
	this.shape_4.setTransform(164,25.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AWDmQIziAAIChL6Inzr6IzRAA");
	this.shape_5.setTransform(164,91.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("rgba(0,0,0,0.996)").s().p("Aixh7IzRAAIAAoEMAsFAAAIAAIEIziAAIChL6g");
	this.shape_6.setTransform(164,64);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(21,-1,286.2,134.8);
...
p.nominalBounds = new cjs.Rectangle(-302.5,-22,512.8,131.6);
...
p.nominalBounds = new cjs.Rectangle(-111.1,-30,419.2,78.4);
...
p.nominalBounds = new cjs.Rectangle(-64.5,-34.2,286.2,134.3);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/intro16/Bitmap1.png?1524639494648", id:"Bitmap1"},
		{src:"images/intro16/Bitmap2.png?1524639494648", id:"Bitmap2"},
		{src:"images/intro16/Bitmap3.png?1524639494648", id:"Bitmap3"},
		{src:"images/intro16/Bitmap4.png?1524639494648", id:"Bitmap4"},
		{src:"images/intro16/Bitmap5.png?1524639494648", id:"Bitmap5"},
		{src:"images/intro16/Bitmap6.png?1524639494648", id:"Bitmap6"},
		{src:"sounds/intro.mp3?1524639494648", id:"intro"}
	],
	preloads: []
};
