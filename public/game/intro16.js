...
p.nominalBounds = new cjs.Rectangle(0,0,2685,821);


(lib.Bitmap2 = function() {
	this.initialize(img.Bitmap2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,2655,811);


(lib.Bitmap3 = function() {
	this.initialize(img.Bitmap3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,307,214);
...
p.nominalBounds = new cjs.Rectangle(0,0,820,634);


(lib.Bitmap6 = function() {
	this.initialize(img.Bitmap6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,826,628);// helper functions:
...
(lib.T_Legs = function(mode,startPosition,loop) {
	...
	this.shape_127.graphics.f().s("#000000").ss(1,1,1,3,true).p("AAlIbQBkkTExp7Qh/Ckh2BMQgng8h2h7Qhbhhh5hZQg2gmgSgJQiDEchCMr");
	this.shape_127.setTransform(78.1,73.6);

	this.shape_128 = new cjs.Shape();
	this.shape_128.graphics.f("#A92F33").s().p("AixFJQA4nzBflwQB5BZBcBhQgiBOgdCZQgeCagKDDQgLDBAOA4QALAuAOAEIkqAMg");
	this.shape_128.setTransform(63.4,77.4);

	this.shape_129 = new cjs.Shape();
	this.shape_129.graphics.f("#DC3D42").s().p("Aj2GiQgOg3ALjCQAKjCAeiaQAdiaAihOQB1B7AnA8QB2hMB/ikQkxJ7hkETIhCAaIgFABQgOgEgLgvg");
	this.shape_129.setTransform(96.8,83.3);

	this.shape_130 = new cjs.Shape();
	this.shape_130.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_130.setTransform(80.4,159);

	this.shape_131 = new cjs.Shape();
	this.shape_131.graphics.f("#3D3D3D").s().p("AgKgcIAUgPIABAcQAAAlgFAOIgLAIQAFgkgKgkg");
	this.shape_131.setTransform(129.8,176.6);

	this.shape_132 = new cjs.Shape();
	this.shape_132.graphics.f("#FFFFFF").s().p("ABbA2IgLgKQgugmjCiZQBmA2BBAtQCaBfAAA2QAAANgKANQgMAMgZAJQAKg6ghgkg");
	this.shape_132.setTransform(111,154.7);

	this.shape_133 = new cjs.Shape();
	this.shape_133.graphics.f("#DC3D42").s().p("AEACuQAKgNAAgNQAAg2iahfQhCgthlg2QDCCZAuAmIALAKQgOgMgPgJQhRgxhBgiIhtg/Qgsgbg7guQg3gtg4gzIBxABQBqBlBkA7QBwBCA8AsQA6AtAbAhQAZAhAEA9IAAACIAAAMIgUAOQgMgigPgcg");
	this.shape_133.setTransform(100.4,150);

	this.shape_134 = new cjs.Shape();
	this.shape_134.graphics.f("#2A2A2A").s().p("ACrCVQg0gEgZgFQhbgVg8gdQgxgWgfgJQg2gPhwgRQhGgSgrghQgQhEgJg4QAoAsBMAXQBqAYAyANQArALBQAhQBQAjAqALQByAgCUgfQA2gMAugQQAGAkgDAvQgvATgzAKQhZAPgzADIgRABIgPgBg");
	this.shape_134.setTransform(74.1,177.1);

	this.shape_135 = new cjs.Shape();
	this.shape_135.graphics.f("#7E2326").s().p("ABOEPQgqgLhQgjQhQgigrgLQgygNhqgYQhMgXgogtQgBhRAIhSQAGhPAih3IBRABIABAUQA9B1D3BxIEgCCQA0AXANALQALALAbASQAoAbALA7QguAQg2AMQhKAPhBAAQhCAAg5gQg");
	this.shape_135.setTransform(73.9,154.6);

	this.shape_136 = new cjs.Shape();
	this.shape_136.graphics.f("#A92F33").s().p("AEQC0QgbgTgMgKQgNgLg0gXIkgiDQj2hwg+h2IgBgUIESAEQA4AyA4AuQA5AtAsAcIBuA/QBBAiBSAxQAOAJAPALQAhAkgLA7QAZgKAMgMQAPAdAMAiQgvAgg9AWQgLg7gngag");
	this.shape_136.setTransform(85.7,152.5);

	this.shape_137 = new cjs.Shape();
	this.shape_137.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_137.setTransform(19,-18.9);

	this.shape_138 = new cjs.Shape();
	this.shape_138.graphics.f("#333333").s().p("");
	this.shape_138.setTransform(0.9,-22.8);

	this.shape_139 = new cjs.Shape();
	this.shape_139.graphics.f("#424242").s().p("");
	this.shape_139.setTransform(11.9,-5.1);

	this.shape_140 = new cjs.Shape();
	this.shape_140.graphics.f("#585858").s().p("");
	this.shape_140.setTransform(25.1,15.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4,p:{x:64.2,y:178.3}},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_43},{t:this.shape_42},{t:this.shape_41},{t:this.shape_40},{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26,p:{x:112.1}},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22,p:{x:35.8}},{t:this.shape_21},{t:this.shape_20}]},1).to({state:[{t:this.shape_88},{t:this.shape_87},{t:this.shape_86},{t:this.shape_85},{t:this.shape_84},{t:this.shape_83},{t:this.shape_82},{t:this.shape_81},{t:this.shape_80},{t:this.shape_79},{t:this.shape_78},{t:this.shape_77},{t:this.shape_76},{t:this.shape_75},{t:this.shape_74},{t:this.shape_73},{t:this.shape_72},{t:this.shape_71},{t:this.shape_70},{t:this.shape_69},{t:this.shape_68},{t:this.shape_67},{t:this.shape_66},{t:this.shape_65},{t:this.shape_64},{t:this.shape_63},{t:this.shape_62},{t:this.shape_61},{t:this.shape_60},{t:this.shape_59},{t:this.shape_58},{t:this.shape_57},{t:this.shape_56},{t:this.shape_55},{t:this.shape_54},{t:this.shape_53},{t:this.shape_52},{t:this.shape_51},{t:this.shape_50},{t:this.shape_49},{t:this.shape_48},{t:this.shape_47},{t:this.shape_46},{t:this.shape_45},{t:this.shape_44}]},1).to({state:[]},1).to({state:[{t:this.shape_126},{t:this.shape_125},{t:this.shape_124},{t:this.shape_123},{t:this.shape_122},{t:this.shape_121},{t:this.shape_120},{t:this.shape_119},{t:this.shape_118},{t:this.shape_117},{t:this.shape_116},{t:this.shape_115},{t:this.shape_114},{t:this.shape_113},{t:this.shape_112},{t:this.shape_111},{t:this.shape_110},{t:this.shape_109},{t:this.shape_108},{t:this.shape_107},{t:this.shape_106},{t:this.shape_105},{t:this.shape_104},{t:this.shape_103},{t:this.shape_102},{t:this.shape_101},{t:this.shape_100},{t:this.shape_99},{t:this.shape_98},{t:this.shape_97},{t:this.shape_96},{t:this.shape_95},{t:this.shape_94},{t:this.shape_93},{t:this.shape_92},{t:this.shape_4,p:{x:133.8,y:24.5}},{t:this.shape_91},{t:this.shape_90},{t:this.shape_89}]},2).to({state:[{t:this.shape_140},{t:this.shape_139},{t:this.shape_138},{t:this.shape_137},{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_136},{t:this.shape_135},{t:this.shape_134},{t:this.shape_133},{t:this.shape_132},{t:this.shape_26,p:{x:123.6}},{t:this.shape_131},{t:this.shape_130},{t:this.shape_129},{t:this.shape_22,p:{x:47.3}},{t:this.shape_128},{t:this.shape_127}]},1).wait(1));
...
(lib.T_eye = function(mode,startPosition,loop) {
	...
	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f().s("#000000").ss(1,1,1,3,true).p("AAPgmQATATAAAVQABATgNAJQgXARgSgPQgRgOADgf");
	this.shape_18.setTransform(-2.2,3.1);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f().s("#000000").ss(1,1,1,3,true).p("Ag6AnQgOgDgNgDQgCgBgCAAQAQgdAXgVQAIgHAJgGQAGgEAHgDQAKgEAJgBQALAAAMAEQAXAJAQAUQAOARAMATQACADABADQgCABgDABQgXAHgeACQgMABgLAAQgEAAgEAAQgFAAgHgBQgLAAgMgBQgMgBgMgCg");
	this.shape_19.setTransform(-0.6,3.5);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AABAsIgMgBIgXgBIgYgDIgbgGIgEgBQAQgdAXgVQgDAgASAOQARAOAXgQQANgJAAgTQgBgVgSgUQALAAAMAEQAXAJAQAUQAOARAMATIADAGIgFACQgXAHgeACIgXABIgIAAg");
	this.shape_20.setTransform(-0.6,3.5);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#000000").s().p("AgTAgQgRgOADgfIAQgNIANgIQAJgDAKgBQATATAAAVQABATgNAJQgNAJgKAAQgKAAgIgHg");
	this.shape_21.setTransform(-2.2,3.1);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f().s("#000000").ss(1,1,1,3,true).p("ABaAwQgRgkghgfQgTgUgUgGQgNgEgOACQgjAGgcAh");
	this.shape_22.setTransform(1.8,-5.7);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#7A89A7").s().p("AhYBWQgKg8AihIQAbghAjgGQANgCAOAEQgWApADAkQBOAYAHBEg");
	this.shape_23.setTransform(-0.7,-1.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_1},{t:this.shape_2},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},1).to({state:[{t:this.shape_10},{t:this.shape_1},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7}]},1).to({state:[{t:this.shape_12},{t:this.shape_11}]},1).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_5},{t:this.shape_4}]},1).to({state:[{t:this.shape_3},{t:this.shape_17},{t:this.shape_15},{t:this.shape_14},{t:this.shape_16}]},1).to({state:[{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18}]},1).wait(1));
...
(lib.T_Body = function(mode,startPosition,loop) {
	...
	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f().s("#000000").ss(1,1,1,3,true).p("ALZkIIB4A0IhBGAIjzg5gAq0jOIicBBIFNGWIFUiSQk8h4jJjNg");
	this.shape_53.setTransform(-3.1,-83.8);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#333333").s().p("AlPiqICbhBQDIDNE9B4IlTCSg");
	this.shape_54.setTransform(-54.3,-80.9);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#FFFFFF").s().p("AhdgtIAqBCQA8gRBLhBQAIAcACAfQhYA+hBACg");
	this.shape_55.setTransform(62.7,72.8);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f().s("#000000").ss(1,1,1,3,true).p("AH/i7QBaggAzhBQA2C9giClQhHA9hRArQjNBtkSACQkwADmHiCQg9jYA9ifQCzCXFqAGIBEhiQA1gEA3gHQC3gWC5g1QATgGATgFg");
	this.shape_56.setTransform(6.5,92.8);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#DC3D42").s().p("AhBheIgkg0QgOgbgLgPIAmgMIAqBEQBZgfAzhCQA2C+giClQhHA8hQAsQgWihgGijg");
	this.shape_57.setTransform(62.3,87.3);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#A92F33").s().p("Aj9haIAQgYQAQgXASgyIAAgCQC4gWC4g1QALAPAOAbIAkA1QAGCjAWCgQjNBtkRACg");
	this.shape_58.setTransform(33.1,94.9);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#7E2326").s().p("AlWB8Qg+jXA+igQCyCXFpAGIBEhiQA3gEA2gGIgBABQgSAygPAXIgQAZIAcFjIgLAAQktAAl+iAg");
	this.shape_59.setTransform(-24.6,96.2);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_60.setTransform(9.1,5.5);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f().s("#CACACA").ss(1,1,1,3,true).p("AAuD5QAHgUAHgVQAdhiAFhiQACglgCglQgBgmgFgmIAAAAQABgIACgHQAqjchOjZQg1iRhriQAAuD5QACAOABAOQAZEOgYFN");
	this.shape_61.setTransform(30.9,5.2);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#3F3F3F").s().p("ArCHTIgEgxIAChFQAIjXgehvQgQg7g2h6QgghHgSg0IAlgQQA6BiAmA4QBGBnBIBKQAZErAwElgAIHhZQDNjXA2lAIAAAAQAnA9AfBDIADAIQgpDFhLCYQiWE0gBD7Ih+BZQA2kcAHk6g");
	this.shape_62.setTransform(12.6,32.6);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#2C2C2C").s().p("AnTL6QgwklgZkqQhJhLhFhmQgmg5g6hiIglAQQASA0AfBHQA3B6AQA7QAdBvgHDXIgCBFQgdlYhTiFQhYiOg8lQIAAABQBABoBFBdIAeAoQBqCKB3BuQAlAjAmAgIA9KNgANzloQgfhDgng9QASgXAPgYQAog9AXhBQAXhFAFhKQgDBPgGBKQgNChgdCKIgDgIg");
	this.shape_63.setTransform(9.1,18.9);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#FFFFFF").s().p("");
	this.shape_64.setTransform(28.2,12.9);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#F1F1F1").s().p("");
	this.shape_65.setTransform(21.5,17.8);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#C6B3A1").s().p("");
	this.shape_66.setTransform(15.9,11.4);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("#84776B").s().p("");
	this.shape_67.setTransform(9.2,-42.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_24},{t:this.shape_23},{t:this.shape_15},{t:this.shape_14},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_19},{t:this.shape_18},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).to({state:[{t:this.shape_27},{t:this.shape_26},{t:this.shape_15},{t:this.shape_14},{t:this.shape_25},{t:this.shape_21},{t:this.shape_20},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_19},{t:this.shape_18},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).to({state:[{t:this.shape_38},{t:this.shape_37},{t:this.shape_15},{t:this.shape_14},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).to({state:[{t:this.shape_52},{t:this.shape_51},{t:this.shape_50},{t:this.shape_49},{t:this.shape_48},{t:this.shape_47},{t:this.shape_46},{t:this.shape_45},{t:this.shape_44},{t:this.shape_43},{t:this.shape_42},{t:this.shape_41},{t:this.shape_40},{t:this.shape_39}]},1).to({state:[]},1).to({state:[{t:this.shape_67},{t:this.shape_66},{t:this.shape_65},{t:this.shape_64},{t:this.shape_63},{t:this.shape_62},{t:this.shape_61},{t:this.shape_60},{t:this.shape_59},{t:this.shape_58},{t:this.shape_57},{t:this.shape_56},{t:this.shape_55},{t:this.shape_54},{t:this.shape_53}]},1).wait(1));
...
(lib.sky = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#232E2A","#AEAEAE"],[0.255,0.51],6.9,438.9,0,6.9,438.9,4574.2).s().p("EiZhgrIUCd/gdTCVEAwDMAAABNhMkyqABGg");
	this.shape.setTransform(913.7,309.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-68.9,-37.2,1965.3,694.2);
...
(lib.dgd = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#757D84").s().p("Egw/gG6QgKgCgGgGQgOgIgLgNQgJgMgFgHIgNgSQgLgNgCgbQJaCrJjgZQHQgVHMiUQKdjhJCGMQFGDwEjDyInyoUQGvm4Jhh2QMUiSMACvQAOATADAQIgGAGQgCALgTAOIFYMHMhbhAS+g");
	this.shape.setTransform(86.3,579);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#242626").s().p("AFPCgQpCmLqdDhQnMCTnRAVQpiAZpairIAXhCQGYCLGwAMQJ9AXJOjoQK7kTKBHQQBFhRBHg+QICm6K4hsQK0hmJzEsQsBivsTCSQphB2mvG3IHyIVQkkjzlFjwg");
	this.shape_1.setTransform(69.6,522.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#757D84","#61676D"],[0,1],-39.6,178.2,-39.2,534.5).s().p("");
	this.shape_2.setTransform(123.4,-68.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#4D5B67").s().p("");
	this.shape_3.setTransform(73,-91.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#757D84").s().p("");
	this.shape_4.setTransform(45.5,-225.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#242626").s().p("");
	this.shape_5.setTransform(124,-67.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#757D84").s().p("");
	this.shape_6.setTransform(73.7,548.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#242626").s().p("");
	this.shape_7.setTransform(73.6,499.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#3E4952").s().p("");
	this.shape_8.setTransform(98.8,139.8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.lf(["#757D84","#61676D"],[0,1],18.3,253.3,93.6,569.2).s().p("");
	this.shape_9.setTransform(-32.7,-62.9);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#242626").s().p("");
	this.shape_10.setTransform(-32.2,-64.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6}]},1).to({state:[]},1).wait(3));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-355.3,-665,710.7,1330);
...
(lib.db_feature = function(mode,startPosition,loop) {
	...
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("AjFC0IAXguQCXikCFC0IATAvQjVgfhxAOgABUgUIAlhyIBOgpIgvClgAi0g0IAviQIArA+IgaBZg");
...
(lib.db_armL = function(mode,startPosition,loop) {
	...
	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#000000").ss(1,1,1,3,true).p("ACEABQBShoAZh1QADgMACgMQgigtg/gDQgPAAgRABQgMACgNACQAAATgHATQgVA8g0BIQAhgEAYAGQATAGANALQAiAdgBBGgAhyAYQAXAHAQAJQAUAKALAOQAgAngfBDAAKh1QgWAfgdAiQgkAqglAiQg/A8hCAoIAECpQAugZApgZQAcgRAagRQAdgUAagTQBrhRBEhY");
	this.shape_16.setTransform(1.4,32.1);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#666666").s().p("AiGD1QADgIAAgUQgCgygVgfIBWhHIAHgGQA9g1AjgqQAWgbAQgbQAUggAMgiQAUg5gEg1QARgBAPAAQAGA6gUA/QgNAlgVAkQgNgMgTgFQATAFANAMQgMAVgPAVQgjAtgzAxIgeAaQgLgOgTgKQATAKALAOQgcAYgmAfQASArgGAuIg2AjQAJgMADgLgABphJIAAAAg");
	this.shape_17.setTransform(0.7,29.6);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#4C4C4C").s().p("AizB8QBCgpA/g7QAlgjAjgqQAdghAXggIAXgBIAAAAIAAAAQARAAAOADIACAAIABABIgBgBIgCAAQgOgDgRAAIAAAAIAAAAIgXABQAzhHAWg9QAHgTAAgSIAZgEQAEA0gUA6QgMAhgUAhQgQAbgWAaQgkAsg9AzIgHAGQgQgJgXgGQAXAGAQAJIhVBIQAVAfABAxQAAAUgCAJQgDALgJAMQgpAZguAYg");
	this.shape_18.setTransform(-5,32.1);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#747474").s().p("AiwChQAmgeAcgZIAdgaQA0gxAigtQAPgVAMgVQAWgkAMglQAVg+gGg7QA/ADAhAtIgEAYQgaB1hRBoIAAgCQAAhEgigdQAiAdAABEIAAACQhDBYhsBRQAPggAAgaQAAgcgQgUQAQAUAAAcQAAAagPAgQgaATgdAUQAGgvgSgrgAhtDUIAAAAg");
	this.shape_19.setTransform(8,27.9);
...
(lib.bosseyeR = function(mode,startPosition,loop) {
	...
	// Layer 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1,3,true).p("AD/B2QglgzgmgwQgbghgggcQgWgSgYgQQg4gihBgGQhCgCg0AoQg5ArghBA");
	this.shape.setTransform(0.3,-17.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#CFC1C2").s().p("AgTDdIAHgDQAHgCARgBQAPgBAIgDQAcgNgRgtIgHgCIADgUIgwgVQhciyhNhFIgBgSQAAgrADgWQACgaALgJQAIgGANgBQAKAAAMAEQAXAMAPADQAgAcAbAiQAmAwAlAzIB6FZg");
	this.shape_1.setTransform(20.4,2.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#A39899").s().p("AkjCUIBLkPQAhhAA5gsQA0goBCACQBCAGA3AjQAYAQAWASQgPgDgXgNQgMgEgKAAQgNABgIAHQgLAIgCAaQgDAWAAAsIABASIgSgPQhVhAilD2QDNAWDJBmIBLAMIACgPIAHABQARAtgcANQgIAEgPAAQgSABgHACIgHAEg");
	this.shape_2.setTransform(-3.5,-2.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("ACjCaQjHhmjPgWQClj2BWBAIARAPQBOBFBbCxIAyAVIgEAVIgCAPgAjNAOQDNATCjBkIALgZQhMiXhGhBQgMgLgMgJQgSgOgVAAQhHAAhjCcg");
	...
	this.shape_4.setTransform(-7.4,-1);

	this.timeline.addTween(cjs.Tween.get(this.shape_4).wait(1));

	// Layer 4
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgyBQQgUghAAgvQAAguAUgiQAVghAdAAQAeAAAUAhQAVAiAAAuQAAAvgVAhQgUAigeAAQgdAAgVgig");
...
(lib.Bosscopy = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-179,-493);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-179,-493,307,214);
...
(lib.boss_inner = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_2},{t:this.shape_3},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5}]},1).wait(1));
...
(lib.boss_bootR = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(1,1,1,3,true).p("AMsItQARFEkjBPQh3AgiQAYQjUAikLAOQnDAZiNhKQgOgIgLgIQhrhRBPjJQBYjgE4juIAAuBQAukUDiiXIDzAMIHZAYICgAJQCPCaAqEbQhZM1ARFDgAinE5IAAAA");

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#5E2C51").s().p("AjFOFQBIhaAohUQBLiWARjSQAKiAgLj5Igtv2ICfAJQCPCaAqEbQhaM1ASFDQARFEkjBPQh2AgiRAYQBHhOAkgug");
	this.shape_3.setTransform(57.9,-0.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#482445").s().p("AqoPwQgOgHgMgJQAVgrAng4QAmg4BAhPQA/hPBghtQBghtDuiaIAAAAQgelPA3lUQA6ltCWlKIHZAYIAuP1QALD5gLCBQgRDShLCWQgoBThIBbQgkAuhHBNQjTAikMAPQhwAGhdAAQkZAAhpg4g");
	this.shape_4.setTransform(-11.6,0.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#351E3B").s().p("Am4LxQBYjgE4jvIAAuAQAtkUDiiYID0ANQiWFKg7FtQg3FTAeFQIAAAAQjuCahfBtQhgBtg/BPQg/BPgnA4QgnA4gUAsQhrhRBPjJg");
	this.shape_5.setTransform(-40.9,-3.5);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1,1,1,3,true).p("ArBDSQgbECCeCZQA/A9A8A3QBZBSBRBFQCIByCtBrQCfBiCMARQAOABAOABQCYAKBXhEQBXhEAak6QAak8iak1IBat8QgzkVixiwIkJgNIl+gSIjlgLQhuCNg+D3QhIMWgaECg");
	this.shape_6.setTransform(25.8,16.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#351E3B").s().p("Ah0NiQieiZAbkCQAbkDBIsVQA+j3BsiNIDlALQgJATgNAUQhZB7gkA/QgyBYgXB/QgOBOghEeQghEegJFQQgJFRBJC9Qg7g3g/g9g");
	this.shape_7.setTransform(-20,-8.2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#482445").s().p("AB0RRQithriIhyQhRhFhZhSQhLi9AKlRQAJlPAhkfQAhkeAOhOQAXh/AyhYQAkg/Bah7QAMgUAKgTIF+ASQAoBIAaBYQAqCSAAC1QAABvgVDZQgWDbgBBsQgBCXAcDaQAQB7AjD2QAbDWgDCYQgCBbgNBUQiMgRifhig");
	this.shape_8.setTransform(17,16.7);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#5E2C51").s().p("AhXS7IgcgCQAMhTAChcQADiXgajWQgjj2gQh8QgdjZABiXQABhsAWjbQAVjZABhvQAAi1griTQgZhXgohIIEJANQCvCvAzEVIhZN9QCZE0gaE8QgaE7hXBEQhLA6h8AAIgmgBg");
	this.shape_9.setTransform(70.2,17.7);
...
(lib.boss_bootL = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(1,1,1,3,true).p("AtFItQgRFEEjBPQB3AgCQAYQDUAiELAOQHDAZCNhKQAOgIALgIQBrhRhPjJQhYjgk4juIAAuBQhPkOjBidIjzAMInaAZIifAIQhfCXglD8QAkNXgRFDg");
	this.shape_2.setTransform(18.4,-3.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#351E3B").s().p("AAPPJQkihPARlEQARlEgktWQAlj8BfiYICegHIgsP0QgLD6AKCAQARDSBKCWQApBTBIBbQAkAuBGBNQiQgXh3ggg");
	this.shape_3.setTransform(-39.5,-4.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#5E2C51").s().p("AFiOnQgmg4hAhPQg/hPhghtQhfhtjuiaQAelQg3lTQg7ltiWlKID0gNQDBCeBOEOIAAOBQE4DuBYDgQBQDJhrBQQgVgrgng4g");
	this.shape_4.setTransform(56.7,-6.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#482445").s().p("ABaQiQkLgPjUgiQhGhNglguQhIhbgohTQhLiWgRjSQgLiBALj5IAuv1IHZgYQCWFKA6FtQA3FUgeFPQDuCZBgBuQBgBtA/BPQBABPAmA4QAnA4AVArQgMAJgOAHQhpA4kZAAQhdAAhwgGg");
	this.shape_5.setTransform(27.4,-2.6);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1,1,1,3,true).p("ArXEqQgBEECsCIQBFA3BBAxQBhBJBYA8QCSBkC4BZQCnBRCOADQAOAAANgBQCZgFBPhMQBQhMgGk8QgFk9i4kkIAAuBQhPkOjBidIkJAOIl+AUIjlALQhfCYglD8QAHMYAAEEg");
	this.shape_6.setTransform(6.2,10.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#351E3B").s().p("AgBNxQisiJAAkDQABkEgIsZQAmj8BfiXIDjgMQgHAUgLAVQhMCEgdBCQgqBdgKCAQgFBQgEEgQgFEfAYFQQAYFPBdC1QhBgxhEg2g");
	this.shape_7.setTransform(-49.2,-8.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#482445").s().p("ACsRZQi4hZiShkQhYg8hhhJQhdi1gYlQQgZlOAFkgQAEkgAGhQQAKiAAqhdQAdhCBNiEQAKgVAIgUIF+gUQAvBEAiBUQA5COASC0QALBuAADaQAADcAKBsQAPCWAyDWQAcB5A8DyQAwDSAMCXQAHBagEBVQiOgDinhRg");
	this.shape_8.setTransform(-1.7,10.7);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#5E2C51").s().p("AAdS0QAEhVgHhbQgMiXgvjSQg8jxgch6QgyjVgOiXQgKhrAAjcQgBjagKhvQgSi0g5iNQgihVgvhDIEIgOQDBCdBOEOIAAOBQC4EkAGE9QAFE8hPBMQhQBMiYAFIgSABIgKAAg");
	this.shape_9.setTransform(43.5,10.1);
...
(lib.boss_body = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#2C2029").ss(1,1,1,3,true).p("AO1kFQDxhqDbiFQGJjvFBlIQAwgwAugzAO1kFQgggYgggZQgWgQgVgQQlgkPkNjuQlRkqjOj3AGRWQQBSkPAVksQngkrnhl2QgrgigsgiQgqghgpghQmBk0mDlkQmVl2mXmqQgCgCgDgDAogBwQA0gFAzgGQMAhbJukP");
	this.shape.setTransform(5.3,59.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,1,1,3,true).p("EAi4gI5QhtrRlaouQg0gOgzgNQh0geh1gaQjbgyjcglQo/hgpEgIQw8gQrxDZIjORMIhDFpQBYKlFrIbQC/EcBbFzQBAAjA+AhQJ9FUFPCxQAKAFAKAGQFvDBE+h8QA/gZBQgfQC3hGEUhpQDghUEdhrQCRliDxlHQBeiBBth8QGCm5h+tKQgBgDAAgDg");
	this.shape_1.setTransform(3.8,0);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#7C6074").s().p("Apcb2QA8jUCsmCQCol6A9jeQBAjugEjPQGIjuFClIQlCFImIDuIgFjLQCMjIA7kGQA1jygWkLQgSjnhLkMQgqiXhIjLQBzAaB0AeQAgBXApBiQB1EQA5CJQBjDuAxCuQA7DTALC8IABAdQAJD6hNEnQgyDBiAFTQhLDHgxCKQjwFHiRFiIn9DAQAMg1AQg2g");
	this.shape_2.setTransform(154.5,-4.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#493744").s().p("");
	this.shape_3.setTransform(-14.2,-6.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#44323F").s().p("Al+bGQhbl0i/kbQlrochXqkIBDlpIDNxMQLyjZQ7AQIB4QQQh+CMiWB1QimCBi7BdQhZAshzAvIhGAcQmbFXgkB3QmVl1mXmqQGXGqGVF1QgYBPgfBTQgyCGhhDUQCGHpAwH4Ih/hEgAjrEtIAAAAg");
	this.shape_4.setTransform(-111.1,-32.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#5C4A56").s().p("");
	this.shape_5.setTransform(92.7,5.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#2C2029").ss(1,1,1,3,true).p("AI9meQHJjWHjjEQEqh4EzhyQAxgRAygSAGRXYQBSkPAVksQm9monJmQQgIgHgIgHQm+mDnLltQm4lfnElJQgCgDgDgCAI9meQhtjeiAjAQjRk4kCjmQgpgkgqgiQgigcgjgbAmeBXQATgKATgLQHMj6Hpjm");
	this.shape_6.setTransform(5.3,52.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#44323F").s().p("Al+bGQhbl0i/kbQlrochXqkIBDlpIDNxMQLyjZQ7AQIB4QQQhOBXhYBPQgigcgjgbQAjAbAiAcQglAggmAfIgjAcQimCBi7BdQhZAshzAvIhGAcQkBDWhuCAQm4lenElJQHEFJG4FeQhCBLgOAtQgYBPgfBTQgyCGhhDUQCGHpAwH4Ih/hEgAO1pRIAAAAg");
	this.shape_7.setTransform(-111.1,-32.3);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#493744").s().p("");
	this.shape_8.setTransform(-14.2,-6.4);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#5C4A56").s().p("");
	this.shape_9.setTransform(92.7,5.3);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#7C6074").s().p("Apcb2QA8jUCsmCQCol6A9jeQBAjugEjPIgFjLQA/haAuhmQA5h+AhiQQAVhiAJhmQAOiWgNifQgSjnhLkMQgqiXhIjLQBzAaB0AeQAgBXApBiQB1EQA5CJQBjDuAxCuQAxCwAQCgIAFA/IABAdQAJD6hNEnQgyDBiAFTQhLDHgxCKQjwFHiRFiIn9DAQAMg1AQg2gAAVkAQEqh4EzhyQkzBykqB4g");
	this.shape_10.setTransform(154.5,-4.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_1},{t:this.shape_6}]},1).wait(1));
...
(lib.boss_armR = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AiBnVQBXgJBMAlQBnHFgHHLQhDqGjAkmg");
	this.shape.setTransform(91.3,-253.3);
	...
	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,1,1,3,true).p("AJ7NIQhMifhViKQhciVhnh9Qi6jkjdiTQg1gkg4gfQkSialEgqQKbnQJvgGQCJgBCHAVQAqCJAZCRQBEGDgsG7Ii3IjIkZAAQmysErzigIAAkV");
	this.shape_1.setTransform(25.5,-220.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#351E3B").s().p("AHGJdQmzsDrxihIAAkVQFEAqERCaQA4AfA1AkQDdCUC7DjQBmB9BcCVQBVCKBMCfg");
	this.shape_2.setTransform(15.4,-197.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#482445").s().p("AgvEsQkSialEgqQKanPJxgGQniCvmrEFQCCBEBmBtIABACQAyA3ApA9Qg1gjg3gfg");
	this.shape_3.setTransform(6.5,-268.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#5E2C51").s().p("ApvCCQGskFHhivQCJgCCHAVQApCJAZCRQh0hMjggWQlECZisCQQiLAygoA/QhmhtiChEg");
	this.shape_4.setTransform(42.4,-274);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#532748").s().p("ACnG5QhciVhlh9Qi7jijeiVQgog9g0g3IgBgCQAog/CLgyQCsiQFEiaQDgAWB0BMQBFGEgtG6Ii3IjQhMifhViKg");
	this.shape_5.setTransform(56.1,-210.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1}]},3).wait(1));

	// Layer_3
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_6.setTransform(75.8,22.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("");
	this.shape_7.setTransform(57.1,69.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#666666").s().p("");
	this.shape_8.setTransform(88.7,55.3);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#999999").s().p("");
	this.shape_9.setTransform(104.5,20.2);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#CCCCCC").s().p("");
	this.shape_10.setTransform(111.7,-3.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6}]},3).wait(1));

	// Layer_4
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(1,1,1,3,true).p("AJNCqQDqhwBxkBQBajLAOknItmtYQkODTjQDOQrILBAlJ2QihFHEsCLQGCNfN8AaIB1i4IB3i6ICTjmICPjhQiLljjojMQhihWhzg8QgngUgqgR");
	this.shape_11.setTransform(-37,-105.6);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#282626").s().p("ArXCFQAgtbK1noQDNBNCwB1QnwEnjPLyQF5JQKjGYIh3C7QvYgrlgwQg");
	this.shape_12.setTransform(-42.7,-90.1);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#1E1B1B").s().p("AtMKZQksiLChlHQglp2LIrBQDQjOEOjTINmNYQgOEnhaDLQhqi5iDiXQiojBjRiKQixh1jNhNQq0HoggNbQFfQRPYAqIh1C4Qt8gamCtfg");
	this.shape_13.setTransform(-37,-105.6);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#3F3B3B").s().p("AlLjeQApARAoAVQByA7BiBXQhihXhyg7QAVlUEsjcQCDCXBrC5QhyECjpBwQDnDLCLFjIiPDhQh7pQmNl3g");
	this.shape_14.setTransform(25.8,-84.7);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#353030").s().p("ApXAZQDPrzHxkmQDRCKCoDBQktDcgWFUQgngVgqgRQGPF3B7JPIiTDmQqimYl6pQg");
	this.shape_15.setTransform(-15.2,-89.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11}]},3).wait(1));
...
(lib.boss_armL = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AmXA5QEhg8EYhkQgCA5gTBIQksBokrA1QAnhIAMg2gADUAWQAShHAEhGQBvABBxhAQgBBBgjBTQhdA6hUAAQgRAAgQgCg");
	this.shape.setTransform(-16.4,92.4);
	this.shape._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(7).to({_off:false},0).to({_off:true},1).wait(1));

	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,1,1,3,true).p("ADIK+QAfgTAdgXQBwhVBbh+QBziiBSjlQimkGjWirQjSipj/hRQjbhGj/gGIAiB7IFcUAg");
	this.shape_1.setTransform(-26.8,-214.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#5E2C51").s().p("AlDqCQEABRDQCoQCLGYAsGgQhaB/hwBVQihp7kcqKg");
	this.shape_2.setTransform(-12.9,-213.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#482445").s().p("ApxpCIgih7QD/AGDbBGQEcKKChJ7QgdAXgfATQkrrVoOorgAEYl4QDWCsCmEFQhSDmhzCiQgtmhiKmYg");
	this.shape_3.setTransform(-26.8,-214.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#351E3B").s().p("AhAKAIlc0AQINIsEsLUg");
	this.shape_4.setTransform(-48.1,-208.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1}]},7).to({state:[]},1).wait(1));

	// Layer_3
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_5.setTransform(-51.4,50);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#CCCCCC").s().p("");
	this.shape_6.setTransform(-50.1,96.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#999999").s().p("");
	this.shape_7.setTransform(-50.8,61.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#333333").s().p("AoeCiIGIgLQAgAgAdAgQgdAVmlAZgAhZDXIAAAAgAiWCXIFwkOQAqAUAoAWQgogWgqgUQgWhHCog7QBNgbBmAnQhYAfhVAtQgmAVgNASQgMAPgHAeQgCAHmDEdQgdggggggg");
	this.shape_8.setTransform(-81.9,-10.4);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#666666").s().p("");
	this.shape_9.setTransform(-62.8,16.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5}]},7).to({state:[]},1).wait(1));

	// Layer_4
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1,1,1,3,true).p("AkdDDQmejAkyuOIRNqFQBbBgBSBgQBEBSA+BSQGaImBEIwQBbB0AJDAQCwPKuHEnQh5AniLAbInYpQIiJirQB4mBDWjSQAvguAzglQBDgxBLgjQBbgqBngV");
	this.shape_10.setTransform(2.1,-71.4);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#282626").s().p("AlyHkQAdl6EKnXIgNgOQgZgfgag4Qhyj3hXjgQBSg6BPhQQALF+DqD0QBcgrBogVQjJDsh5DIQAsAhAoAtQAfAiAeApQA0BHAxBfQDfGrguFUQh5AoiNAbgAhLltQBDgxBKgjQhKAjhDAxg");
	this.shape_11.setTransform(-9.1,-23.6);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#1E1B1B").s().p("Aj6Q+QB4mBDVjSQmdi/kyuPIRMqFQBcBgBRBgQk/HXh2CUQg9BNg/BCIAAABQhOBQhSA5QBWDgByD2QAaA5AZAeIANAPQgzAlguAuQAuguAzglQkJHXgdF6gAC0GYIAAAAg");
	this.shape_12.setTransform(-34.7,-101);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#353030").s().p("AiMNyQgqgugsghQB7jIDHjrQhmAVhcArQjrj1gMl9IABAAQA+hCA+hOQB2iTE+nXQBEBSA+BSQg7DDh1CuQhNByheBfQB9CKBZCnQBHCFArCPQiUCfh4C6QhMB3g+B+Qgegpgfgig");
	this.shape_13.setTransform(7.4,-111.7);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#3F3B3B").s().p("AmeI/Qgyhfg0hHQA/h+BNh4QB4i4CUifQgriPhHiGQhainh9iLQBfheBNhyQB0iuA7jEQGaImBEIwQBbB1AJC/QCwPLuGEmQAulUjemrg");
	this.shape_14.setTransform(51,-56.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10}]},7).to({state:[]},1).wait(1));
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(-58,36);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-88,27,2685,821);
...
(lib.T_features = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},1).wait(2).to({_off:false,startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:1},0).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},1).wait(2).to({_off:false},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:-4.1,y:3.1,startPosition:1},0).wait(1).to({x:-13.6,y:1.8,startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2}]}).to({state:[]},1).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3},{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({_off:true},1).wait(2).to({_off:false,startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:6},0).wait(1).to({x:-18.2,y:-30.8,startPosition:0},0).wait(1).to({x:34.4,y:-21.8,startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:4},0).to({_off:true},1).wait(1));
...
(lib.T_Arm_L = function(mode,startPosition,loop) {
	...
	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_50.setTransform(139.9,-95.4);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#7E2326").s().p("AmFAvQBpgaBDg1QBCg1BWgeQAsAAAVACQAdAAAggGQAggGA1gVQBhAdBhAEQAoAAATgHQAVgFANgMQgDAgg/APQhQAViagoQhPAqhrgBQhaA1hKA/QhKA/iNAlQAbg0AQgxg");
	this.shape_51.setTransform(144,-65.9);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#A92F33").s().p("");
	this.shape_52.setTransform(147.3,-94.2);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#DC3D42").s().p("");
	this.shape_53.setTransform(139.8,-107.9);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f().s("#000000").ss(1,1,1,3,true).p("ACwhHQgKgIgLgIQgtghg4ggQj5iRnfiRIg8J6QDRAzDUBTQDVBUCQAXQCRAYCLgiQCKgiDqheQBLjAhUjDQhkgUhigCQihgDicAugADmgZQgYgXgegX");
	this.shape_54.setTransform(42.7,-91.6);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#585858").s().p("ACPBuQAFggABgqQAAgagDgxQgFAqgpAlQgPANgXAPIgpAZIgwAfQgeATgWAKQgUAJgTAFIgagGQiXgmi/heIAFgQQABgKgBgMQAjAPATAHQAkAMAeAAQAXAAAdgIQATgFAfgMQB3grA9ggQBMgnAygwIAWAQQCbguChAEIA4B6QAfBDAIAiQAHAeAAAeQghAIgkAMQihA1gJACQhBARhFADQATgiAKgugAB6hkQgYgXgdgXQAdAXAYAXg");
	this.shape_55.setTransform(53.5,-84.1);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#424242").s().p("");
	this.shape_56.setTransform(47.9,-82);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#333333").s().p("AAsGxQiQgXjVhUQjUhTjRgzIA8p6QHfCRD5CRQghAWgxAZQhdAvgjAqQgPAUgJAJQgPARgQAGQgVAJgngHQhpgVhigtIAAANQgGBUgJA6IEzCBQBOAiAyARQBGAZA9AIQBLAKBcgLQBAgIBngXQBdgXBLgTQAIgYAEgZQAEgYAAgXQAAgegHgeQgIgigfhEIg4h6QBiACBkAUQBUDDhLDAQjqBeiKAiQhTAUhUAAQg6AAg7gKg");
	this.shape_57.setTransform(42.7,-91.6);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f().s("#000000").ss(1,1,1,3,true).p("AgYkXQhCB3APCtQAOCuCMBd");
	this.shape_58.setTransform(92.8,-79.1);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#671D1F").s().p("AiVANQgPitBCh3QDcAtAXCjQAXCjgpBHQgoBHhTAuQiLhdgOiug");
	this.shape_59.setTransform(100.2,-79.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.instance,p:{regY:0,rotation:0,x:17.6,y:74,startPosition:0,regX:0,scaleX:1,scaleY:1}}]}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.instance,p:{regY:0.2,rotation:-116,x:102.5,y:-68.3,startPosition:1,regX:0,scaleX:1,scaleY:1}}]},1).to({state:[]},1).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},2).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.instance,p:{regY:0.3,rotation:106,x:-86.2,y:-45.7,startPosition:8,regX:-0.1,scaleX:1.05,scaleY:1.05}}]},1).to({state:[]},1).to({state:[{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.instance,p:{regY:0.3,rotation:-113.4,x:46.8,y:-49,startPosition:7,regX:0,scaleX:1.05,scaleY:1.05}}]},2).to({state:[{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23}]},1).to({state:[{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.instance,p:{regY:0.3,rotation:108,x:-98,y:-56.2,startPosition:9,regX:-0.1,scaleX:0.938,scaleY:0.938}}]},1).to({state:[{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31}]},1).to({state:[{t:this.shape_49},{t:this.shape_48},{t:this.shape_47},{t:this.shape_46},{t:this.shape_45},{t:this.shape_44},{t:this.shape_43},{t:this.shape_42},{t:this.shape_41},{t:this.shape_40}]},1).to({state:[{t:this.shape_59},{t:this.shape_58},{t:this.shape_57},{t:this.shape_56},{t:this.shape_55},{t:this.shape_54},{t:this.shape_53},{t:this.shape_52},{t:this.shape_51},{t:this.shape_50}]},1).wait(1));
...
(lib.db_face = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance,p:{startPosition:0}}]}).to({state:[]},1).to({state:[{t:this.shape},{t:this.instance,p:{startPosition:1}}]},1).to({state:[]},1).to({state:[{t:this.shape},{t:this.instance,p:{startPosition:4}}]},2).to({state:[{t:this.shape},{t:this.instance,p:{startPosition:5}}]},1).to({state:[{t:this.shape},{t:this.instance,p:{startPosition:6}}]},1).wait(1));
...
(lib.boss_head = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape.setTransform(0,9.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#CCCCCC").s().p("AiLmnQBZAHBEANICFI+IgsBAIgkAxQhSBuiLAeg");
	this.shape_1.setTransform(51.4,46.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("AiVD+QhxgxAhkzQBOhQgbhqQA9BmhlBWQgNB0ANBuQANBtB8AbQB7AcAXgqQAXgpAug/QAuhAAegWQAPgLAMgFQiFCZgEAiQgEAjhDAUQgTAFgWAAQg4AAhRgjg");
	this.shape_2.setTransform(-49.2,-14.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#666666").s().p("Al5J5Qijh2iyisQhTkXAElBQCKkCDDjEQhkCKhGCIIAAAAQAbBrhOBPQggE0BwAxQBxAxBDgUQBCgTAEgjQAFgiCFiYIAAgBQhxF1BGG9Qg6gkg7grgAKvBcQAyh8A7gNIACAAQhKBBgYBPg");
	this.shape_3.setTransform(-3.7,0.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#999999").s().p("Ai8HgQiqgojCh5QhGm7Bxl2QAMgGAJACQASACAgAlQAgAlAtBnQBlgpEIAFQA9ACA2AEIgLNOQgcAGgfADQgXACgZAAQhWAAhngYgAEVlNQBDAMAwAUIADACIABgBIAMAIQAYhQBLhCQADgBACACQAdAOAdB+QAcB9g2CeQgnBxhfCOg");
	this.shape_4.setTransform(25.5,39.5);
	...
	// Layer_3
	this.instance = new lib.bosseyeR("synched",0);
	this.instance.parent = this;
	...
	// Layer_4
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgVAEQAagSAUABQAEAAACABQgDAFgHAFQgWAOgdADQACgFAHgGg");
	this.shape_5.setTransform(58.3,-37.5);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1,1,1,3,true).p("ADQCLQgBi9hjg4Qhkg3hXAnQhYAngoCH");
	this.shape_6.setTransform(52.1,-51.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("AigCFIgEgQIgCgPIApgLQAUg2AUgoQA7h8A2gFQBHgGBEDNQitgwhsBygAAehuQgxAEg5BsQgUAogVAzIAJAYQBrh6CeBBQg4iqhCAAIgFAAg");
	this.shape_7.setTransform(49.9,-35.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#CFC1C2").s().p("AjdD5IAck2QAoiIBYgnQBXgnBkA3QBkA4AAC9IgXDkgAAVhTQg1AEg8B8QgUAogUA3IgpALIACAPIAEAQIAuAAQBshyCtAvQhBjGhGAAIgEAAg");
	this.shape_8.setTransform(50.6,-40.4);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("AguBKQgPgfADgrQADgqATgfQATgfAYAAQAZAAAPAfQAPAfgDAqQgCArgUAfQgTAfgYAAQgZAAgPgfg");
	this.shape_9.setTransform(53.3,-29.7);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFBD5D").s().p("AiZBKQA2hPAwg1QAwg1AVABQAXAAAVAWQAVAWAWAdQAWAcAQAZIAKASIkoBNg");
	this.shape_10.setTransform(52.8,-31.3);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#E5AA54").s().p("AihBJQBfjCBIgKQBIgLBTDqIgBABIgKgSQgQgagWgdQgWgbgVgWQgVgXgXAAQgWAAgvA0QgwA0g2BQg");
	this.shape_11.setTransform(52.1,-37.2);
	...
	// Layer_5
	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(1,1,1,3,true).p("ADqqrQAUAFAVAFQFECoCSEYIAlHrIlZHWIl8AAImvAAImXoDIAYk9QCpmJEjjxQAEgCADgDQAsAAB2ADQClAEDFAtg");
	this.shape_12.setTransform(-1.8,-16.3);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#A39899").s().p("AgYLdImXoDIAZk8QComJEjjxQCcBPBmCXQBmCWATCvQjTgZDECrQARBBgjAQQgIAEgPAAQgSABgHACQgVAIgHAaQgHAWAEAdQAIBRAVBlQAIArAyFug");
	this.shape_13.setTransform(-36.8,-16);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#CFC1C2").s().p("Ai4LfQgzltgIgrQgUhmgJhRQgDgcAGgWQAHgbAVgIQAHgBASgBQAQgBAIgEQAigPgRhCQjDirDSAaQgTivhmiWQhmiXichQIAGgEQAsAAB3ACQDSA3C1CiQAPhHgshhIAoALQFFCnCSEYIAlHrIlaHVg");
	this.shape_14.setTransform(22.4,-16.3);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#330000").s().p("AjFhrQClAEDEAtQAtBfgPBHQi2igjRg3g");
	this.shape_15.setTransform(5.1,-78.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]},1).wait(1));
...
(lib.Boss = function(mode,startPosition,loop) {
	...
	// boss_armR
	this.instance = new lib.boss_armR("single",3);
	this.instance.parent = this;
	this.instance.setTransform(-191.5,-370.9,1,1,3,0,0,67.3,-284.9);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-83.2,-356.2,1,1,-2.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// boss_head
	this.instance_2 = new lib.boss_head("single",1);
	this.instance_2.parent = this;
	this.instance_2.setTransform(5.3,-411.4,1,1,-5.9,0,0,-0.1,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// boss_inner
	this.instance_3 = new lib.boss_inner("single",1);
	this.instance_3.parent = this;
	this.instance_3.setTransform(-0.9,-352,1,1,-2.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

	// boss_body
	this.instance_4 = new lib.boss_body("single",1);
	this.instance_4.parent = this;
	...
	// boss_leg
	this.instance_5 = new lib.boss_leg("single",0);
	this.instance_5.parent = this;
	...
	// boss_bootL
	this.instance_6 = new lib.boss_bootL("single",1);
	this.instance_6.parent = this;
	this.instance_6.setTransform(78.4,388);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1));

	// boss_bootR
	this.instance_7 = new lib.boss_bootR("single",1);
	this.instance_7.parent = this;
	this.instance_7.setTransform(-153.7,397.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1));

	// boss_armL
	this.instance_8 = new lib.boss_armL("single",7);
	this.instance_8.parent = this;
	this.instance_8.setTransform(257.5,-95.3,1,1,-2.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-411.9,-500.3,772.3,1037.9);
...
(lib.tapirhead = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({_off:true},1).wait(2).to({_off:false,startPosition:4},0).to({_off:true},1).wait(4).to({_off:false,rotation:10.5,x:-0.6,y:-8.7,startPosition:8},0).to({_off:true},1).wait(6));
	...
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(1,1,1,3,true).p("AEdp4QA5AxAeBFQAcBCAIBHQADAkACAkQAFBKAsChQAtChC6DrQgcBViNCHQiNCIj5AMQqBBni5nOQAmggAeihQAeihAIhIQAAAAAAgBIAAAAQAAgCgBgCQALgfgDgUQAeiHAqhXQAWg/Aeg5QAhg8Aqg3QArg4A/gcQAKgEAKgEQAQgFASgEQA4gLBMAFQAVABAVACQBTAGBBAJQBEAJA+AYQAcAKAYAS");
	this.shape_9.setTransform(32.1,17.4);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#545E73").s().p("");
	this.shape_10.setTransform(37.4,16.7);
...
(lib.TAPIR_HERO = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.T_Arm_L("single",5);
	this.instance.parent = this;
	this.instance.setTransform(200.2,-223.9,0.865,0.986,0,39.3,46.3,20.9,-42.6);

	this.instance_1 = new lib.tapir_spacehelmet("single",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(36,-265.2,1,1,-2.2,0,0,-1.7,-3);

	this.instance_2 = new lib.T_shoulderPad_R("single",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-75.7,-159.9,1,1,6,0,0,-0.1,-0.2);

	this.instance_3 = new lib.T_Arm_R("single",5);
	this.instance_3.parent = this;
	this.instance_3.setTransform(-67.3,-171.5,1,1,10.5,0,0,-34.2,-140.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1,p:{regX:-1.7,regY:-3,rotation:-2.2,x:36,y:-265.2}},{t:this.instance}]},3).to({state:[]},1).to({state:[{t:this.instance_3},{t:this.instance_2,p:{regY:-0.2,rotation:6,x:-75.7,y:-159.9}}]},18).to({state:[]},1).to({state:[{t:this.instance_1,p:{regX:0,regY:0,rotation:0,x:-5.4,y:-293.2}}]},7).to({state:[{t:this.instance_1,p:{regX:-1.7,regY:-3,rotation:-9,x:9.9,y:-268.7}},{t:this.instance_2,p:{regY:0,rotation:11.1,x:-98.5,y:-153.4}}]},1).to({state:[]},1).wait(88));

	// Layer_4
	this.instance_4 = new lib.T_shoulderPad_R("single",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-83.5,-161.2,1,1,14.1,0,0,-0.1,0);

	this.instance_5 = new lib.T_Arm_R("single",5);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-71.2,-177.5,1,1,14.1,0,0,-33.9,-140.1);

	this.instance_6 = new lib.T_Arm_L("single",8);
	this.instance_6.parent = this;
	this.instance_6.setTransform(124,-125.7,1,1,-2.2,0,0,-14.7,-117.3);

	this.instance_7 = new lib.T_shoulderPad_L("single",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(89.1,-201.4,1,1,-21.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_5},{t:this.instance_4}]},3).to({state:[]},1).to({state:[{t:this.instance_6}]},18).to({state:[]},1).to({state:[{t:this.instance_7,p:{regX:0,regY:0,scaleX:1,scaleY:1,rotation:-21.4,x:89.1,y:-201.4}}]},7).to({state:[{t:this.instance_7,p:{regX:0.5,regY:-0.2,scaleX:0.891,scaleY:0.891,rotation:-53.7,x:109.6,y:-201.5}}]},1).to({state:[]},1).wait(88));

	// tapir body
	this.instance_8 = new lib.T_Body("single",3);
	this.instance_8.parent = this;
	this.instance_8.setTransform(15.7,-90.3,1,1,5.7,0,0,0,0.2);

	this.instance_9 = new lib.T_Legs("single",2);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-3.8,-18.4,1,1,0,0,0,16.9,-193.8);

	this.instance_10 = new lib.tapir_spacehelmet("single",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(57.8,-247.3,1,1,2.8,0,0,0.2,-0.3);

	this.instance_11 = new lib.T_shoulderPad_R("single",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(-129.3,-192.7,1,1,6.2,0,0,-0.1,-0.1);

	this.instance_12 = new lib.T_Arm_R("single",5);
	this.instance_12.parent = this;
	this.instance_12.setTransform(-114.3,-210.2,1,1,3.1,0,0,-34.1,-140.2);

	this.instance_13 = new lib.tapirhead("single",12);
	this.instance_13.parent = this;
	this.instance_13.setTransform(22.4,-251.3,1,1,0,-7.5,172.5,-0.4,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_9,p:{startPosition:2}},{t:this.instance_8,p:{rotation:5.7,x:15.7,y:-90.3,startPosition:3}}]},3).to({state:[]},1).to({state:[{t:this.instance_10}]},18).to({state:[]},1).to({state:[{t:this.instance_9,p:{startPosition:0}},{t:this.instance_8,p:{rotation:0,x:-27.5,y:-125.1,startPosition:0}},{t:this.instance_12},{t:this.instance_11}]},7).to({state:[{t:this.instance_13}]},1).to({state:[]},1).wait(88));

	// Layer_6
	this.instance_14 = new lib.T_shoulderPad_L("single",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(128.3,-144.3,1,1,-10.3,0,0,0.1,-0.3);

	this.instance_15 = new lib.T_Arm_L("single",1);
	this.instance_15.parent = this;
	this.instance_15.setTransform(72.3,-206.2,1,1,-17.5,0,0,-14.8,-117.3);

	this.instance_16 = new lib.T_Arm_R("single",5);
	this.instance_16.parent = this;
	this.instance_16.setTransform(-87.2,-170.4,1,1,11.1,0,0,-34,-140.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_14}]},22).to({state:[]},1).to({state:[{t:this.instance_15}]},7).to({state:[{t:this.instance_16}]},1).to({state:[]},1).wait(88));

	// tapir head
	this.instance_17 = new lib.tapirhead("single",4);
	this.instance_17.parent = this;
	this.instance_17.setTransform(44.8,-243.4,1,1,0,4.7,-175.3,-0.3,0);

	this.instance_18 = new lib.T_Body("single",6);
	this.instance_18.parent = this;
	this.instance_18.setTransform(2.8,-92.4,1.001,0.971,0,15.1,11.1,0.1,0.3);

	this.instance_19 = new lib.T_Legs("single",6);
	this.instance_19.parent = this;
	this.instance_19.setTransform(12.5,-45.8,1,1,0,0,0,16.9,-193.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_17,p:{regX:-0.3,regY:0,skewX:4.7,skewY:-175.3,x:44.8,y:-243.4,startPosition:4}}]},3).to({state:[]},1).to({state:[{t:this.instance_19,p:{x:12.5,y:-45.8,startPosition:6}},{t:this.instance_18,p:{regY:0.3,scaleX:1.001,scaleY:0.971,skewX:15.1,skewY:11.1,x:2.8,y:-92.4,startPosition:6}}]},18).to({state:[]},1).to({state:[{t:this.instance_17,p:{regX:-0.1,regY:0.1,skewX:4.5,skewY:-175.5,x:-1.4,y:-278.5,startPosition:7}}]},7).to({state:[{t:this.instance_19,p:{x:-3.8,y:-18.4,startPosition:2}},{t:this.instance_18,p:{regY:0.2,scaleX:1,scaleY:1,skewX:0,skewY:0,x:5,y:-91.7,startPosition:3}}]},1).to({state:[]},1).wait(88));

	// Layer_9
	this.instance_20 = new lib.T_shoulderPad_L("single",1);
	this.instance_20.parent = this;
	this.instance_20.setTransform(77.4,-171.9,1.001,1,0,-88.4,-85.5,-43.2,-44.2);

	this.instance_21 = new lib.T_Arm_L("single",4);
	this.instance_21.parent = this;
	this.instance_21.setTransform(121.1,-137.2,1.101,1.06,-2.2,0,0,-14.7,-117.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_20}]},3).to({state:[]},1).to({state:[{t:this.instance_21,p:{regX:-14.7,scaleX:1.101,scaleY:1.06,rotation:-2.2,x:121.1,y:-137.2,startPosition:4}}]},18).to({state:[]},1).to({state:[{t:this.instance_21,p:{regX:-14.8,scaleX:1,scaleY:1,rotation:-17.5,x:78.9,y:-191.3,startPosition:13}}]},8).to({state:[]},1).wait(88));

	// tapir body
	this.instance_22 = new lib.T_Arm_L("single",9);
	this.instance_22.parent = this;
	this.instance_22.setTransform(106.4,-167.1,1,0.965,0,-99.3,-99.2,-14.8,-117);

	this.instance_23 = new lib.tapirhead("single",12);
	this.instance_23.parent = this;
	this.instance_23.setTransform(68.1,-238,1,1,0,8.5,-171.5,-0.3,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_22}]},3).to({state:[]},1).to({state:[{t:this.instance_23}]},18).to({state:[]},1).wait(97));
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.rf(["rgba(0,0,0,0.498)","rgba(0,0,0,0)"],[0.463,1],9.6,-36.7,0,9.6,-36.7,300.2).s().p("Ax2HvIgEAAIgCAAIhRgDIgugDQingOjigtQhegUg5gdQhQgpgihHQgUgqgDgvQgBggAGgiQAIguAVgmQAPgcAVgXQArgxBGgjQArgWBZgfQgng9A2hCQAxg7BNgVQHgiBITAAQBTAABTAEQHCAQHIBpIAEABQIXBgI6C8QBfAfAxAeQBLArAdA+QARAlAAAlQAABThVBNQhpBfijAiQklA7o7gaQn8gXzKAkQhBAEhGAAIgNAAg");
	this.shape_1.setTransform(10.6,350.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},3).to({state:[]},1).to({state:[{t:this.shape_1}]},18).to({state:[]},1).to({state:[{t:this.shape}]},7).to({state:[{t:this.shape}]},1).to({state:[]},1).wait(88));
...
(lib.DigiBot = function(mode,startPosition,loop) {
	...
	// Layer_6
	this.instance = new lib.db_armL("single",2);
	this.instance.parent = this;
	this.instance.setTransform(36,-36.4,1.032,1.148,0,-140,25.7,-24.3,-29.3);
	this.instance._off = true;
	...
	// Layer_7
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("AA6DVQgEAAgVgBQgVgCgTgGQgYgGgYgJQgWgKgSgMQgTgMgPgPQgBgBgCgBQgcgcgOgiQgFgJgDgJQgFgSgCgTQAAgHgBgIQAAggALgfQAGgQAJgPQAhg5A5gjQAEgCAFgCQAQgKASgGQAagJAZgCQAFAAAEgBQAHgBAYAGQAYAFAkAjQAkAjAQAuQAPAtADAqQADArgLAvQgLAwgdAlQgeAlg2AAg");
	this.shape.setTransform(-51,-133.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#2E89C4").s().p("ABbBDQgUgCgUgGQgYgGgYgJQgVgKgTgMQgSgLgPgPIgDgCQgdgcgOghQALAUA0AiQA1AiBDAKQAWAaAbALIgZgBg");
	this.shape_1.setTransform(-56.9,-118.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#17435F").s().p("AgaBJQgSgbgGgoQgEgoALgfQAMgeAVgDQAUgDASAcQATAbAEAqQAEAmgLAfQgLAfgVADIgEAAQgSAAgQgag");
	this.shape_2.setTransform(-41.8,-133.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#3399DB").s().p("AgUCBQg0gigLgVIgHgSQgFgSgDgTIAAgPQgBggAMgfQAhg6BGgiQAdgNAkgJQgIANgGANQgfBBAFBYQAGBZAoA8IANATQhEgLg0gig");
	this.shape_3.setTransform(-60.2,-133.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhZAvQAig5A3gjIAJgEQAQgJATgHQAagJAagBIAJgBIgCAFQgWAKgRAZQgjAKgdANQhGAggiA6QAGgPAJgPg");
	this.shape_4.setTransform(-58.5,-146.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#2875A9").s().p("Ag9CwIgMgTQgog8gGhZQgFhYAfhBQAGgNAHgNQARgZAWgKIACgGQAGgBAYAGQAXAFAlAjQAjAjAQAuQAQAtACAqQAEArgMAvQgLAwgdAlQgeAlg1AAQgbgLgXgagAALhlQgTACgMAeQgLAfAEApQAGAoASAbQAQAcAWgDQAVgDALgeQALgfgFgnQgDgpgTgcQgQgZgTAAIgFABg");
	this.shape_5.setTransform(-44.1,-133.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1,1,1).p("Ah0C6QADABAUAIQAVAGAUAEQAZADAZAAQAWgBAXgDQAVgEATgIQABgBABgBQAkgOAZgZQAHgHAGgIQALgOAHgSQAEgGADgHQALgfgBghQABgRgEgRQgMhBgsg4QgCgEgCgEQgNgPgPgNQgVgTgZgMQgCgBgFgDQgGgDgYgEQgXgEgtASQguASgfAmQgcAjgSAmQgQAngFAwQgFAxAPAuQAQAuAyAVg");
	this.shape_6.setTransform(20.8,-124.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#3399DB").s().p("Ag0DNQgUgEgVgGIgXgJQgygVgQguQgPguAFgxQAFgwAQgnQASgmAcgjQAfgmAugSQAtgSAXAEQAYAEAGADIAHAEQAZAMAVATQAPANANAPIAEAIQAsA4AMBBQAEARgBARQABAhgLAfIgHANQgHASgLAOIgNAPQgZAZgkAOIgCACQgTAIgVAEQgXADgWABIgGAAQgWAAgWgDg");
	this.shape_7.setTransform(20.8,-124.9);

	this.instance_1 = new lib.db_armL("single",4);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-61.6,-53.1,1,1,180,0,0,-24.4,-29.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},13).wait(1));

	// Layer_8
	this.instance_2 = new lib.db_headlight("single",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(11,-180.3,1,1,1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#000000").ss(1,1,1,3,true).p("AEijiQASAXAFAWQACAKgBAHQgBAJgGAEQgKAIgUgLQgOgIgNgOQgFgGgFgGQgEgGgDgFQgLgSgEgRQgFgVAJgIIABgBQALgHAUALQATALARAXgAD1itQhIA6gyBDQggApgXAtQjmgBiXDnQA5hoBYhZQBQhSBqhHQBfg/Bzg2");
	this.shape_8.setTransform(63.6,-144.4);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAeAxQABgPgJgRQgPgcgagUQgMgKgOgGIAAAAQALgIAUALQATAMARAWQARAXAGAWQABAKAAAHIgQgDg");
	this.shape_9.setTransform(90.4,-166);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#F5D802").s().p("AgtAQQBdg+Bzg2IAFgEIAHALIAKAMIgEADIgBgCQgvAYg3AmQhTA+grAdQhJA1g/AaQgZALgYAHQBRhTBrhHgADphIQgIgCgQgOQgRgPgJgQQgKgSgPggQAOAHAMAJQAbAUAPAdQAJARgBAPg");
	this.shape_10.setTransform(70,-153.8);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#6B8A08").s().p("AioBJQAYgGAYgLQA/gaBJg0QAqgeBUg+QA3gnAwgXIAAACQhIA6gyBDQggAogXAuQjmgCiXDnQA5hnBYhagAEVicQgOgIgNgOIgKgMIgHgKQgLgSgEgRQgFgWAJgIIABAAIAAAAQAOAgAKARQAKARARAPQAQAOAIACIAAAAIAQADQgBAJgGAEQgEADgGAAQgIAAgMgHg");
	this.shape_11.setTransform(63.6,-144.2);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#17435F").ss(3,1,1).p("ABXABQgbA0gqAnABPg5QhABdgwAuAArhaQgkA8hNBOAgXhPQgfAyggAb");
	this.shape_12.setTransform(56.1,-108.4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#000000").ss(1,1,1,3,true).p("ALpjyQgBAAgBAAQjagEiSDPQgJAOgJAOQhOB5g4C5QgEAOgEAPIsphqQgmjBALitQAHiBAjh1QiAB+gsCVQgtCUApBvQAFANAGAMQAHAQAIAOQAmA/A7AUQE4gQD/A8QBzAbBOARQBSAWBUAFQAUACAUAAQBmgBBagsQBPgnA2hHQARgWAOgZQAFgJAEgIQAthYAShxQAIgygDgwQgCgjgIghQAAgBAAAAQgGgagKgYg");
	this.shape_13.setTransform(-3.9,-116.4);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AADBBQARg9ACgyQAEhGgPhNIARADQAIAhACAjQADAwgIAzQgSBwgsBYIgJARQAYhFARg8g");
	this.shape_14.setTransform(69.4,-116.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#2875A9").s().p("");
	this.shape_15.setTransform(-2.2,-108.8);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#3399DB").s().p("AEkFvQgdgHgTgWQgIgIgEgKQA4i5BOh5IASgbQBPhFBjg0QBjg0BpATIAAABIgRgDQAPBNgEBGQgdA9gRAfQg0BehRBJQhRBIhiApQgvAUglAAQgOAAgMgDgAqoDuQgIgCgJgHIgPgOIgIAFQgIgOgHgPIgLgZQgphvAtiUQAsiWCAh+QgjB2gHCBQgfCaAMCbQAAARgBAIQgCAOgHAHQgHAHgMABIgEABQgIAAgIgEg");
	this.shape_16.setTransform(-4.4,-119);

	this.instance_3 = new lib.db_face("single",6);
	this.instance_3.parent = this;
	this.instance_3.setTransform(-7.5,-124.1,1,1,1,0,0,0,-0.1);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("#000000").ss(1,1,1,3,true).p("AGLA/QArg/CIhlIgki3Ql+iIoPAPQivEIgbGqINzB6QA0jsAhhsg");
	this.shape_17.setTransform(-5.7,-123.9);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#333333").s().p("AhOCNQA8i7BHh/IAkC2QiGBlgrBAIAKghg");
	this.shape_18.setTransform(42.7,-135);

	this.instance_4 = new lib.DB_glass("single",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(2.2,-133.4,1,1,1,0,0,0.1,-0.1);
	this.instance_4.alpha = 0.34;

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_19.setTransform(-14.1,-68.3);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#747474").s().p("");
	this.shape_20.setTransform(-20.6,-59.7);
	...
	this.shape_21.setTransform(-18.3,-63.1);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#4C4C4C").s().p("");
	this.shape_22.setTransform(-13.8,-69.7);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f().s("#000000").ss(1,1,1,3,true).p("ACJnXQgHAIgUgCQgNgCgOgGQgIgDgHgDQgFgDgEgCQgPgJgIgKQgLgOAGgHQACgCAEgCQAHgDANACQAGABAHACQAOADAPAIQAWALALANQAGAHAAAGQABAEgCADgABQnTQgGASgFASQg0CygKCpQgDA/ACA8QAJDzBFD4Ii/gcQhWmJCgmNQAhhVAthWQAFgJAFgJ");
	this.shape_23.setTransform(-52.1,-145.1);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#F5D802").s().p("AhBg3QAihVAthWQAHAKAJAJQADAFAFAEQg0CygJCoQgiBJgYBMQgMivAcixgAAlkMQgegTAAgDQAAgDgCgCQAHgDAOACIAMADIANAHQAWAPANAXQgbgGgWgOg");
	this.shape_24.setTransform(-49,-168.4);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#6B8A08").s().p("AhrH1QhWmICgmOQgdCyANCuQAXhKAhhKQgDA/ACA9QAJDzBFD3gAA9m5QgJgJgHgKIAKgSIAEgHQgPgJgIgKQgLgOAGgHQACgCAEgBQABACAAACQAAADAeATQAWAOAbAGIAVADQABAFgCADQgHAHgUgCQgNgCgOgFIgPgHIgJgFIAJAFIAPAHIgDAFIgLAkQgEgDgEgGg");
	this.shape_25.setTransform(-52.1,-145);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("AANAVQgMgVgVgQIgNgHQAOADAPAIQAVALALAMQAGAIAAAFIgVgDg");
	this.shape_26.setTransform(-41.7,-195.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.instance_4},{t:this.shape_18},{t:this.shape_17},{t:this.instance_3},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.instance_2}]},13).wait(1));

	// Layer_9
	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_27.setTransform(-11.6,-16);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#17435F").s().p("AiJDLQBHj2BhhnQAugxAzgRIAEgBQAKAPgBATQAAANgnBzIgFALQgLAggMAvIgbApIgFAGQgSAYgrAkQgsAkhNAgIADgLg");
	this.shape_28.setTransform(28.9,-27.3);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#2875A9").s().p("");
	this.shape_29.setTransform(-11.3,-16.2);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#3399DB").s().p("");
	this.shape_30.setTransform(-12.8,-12.9);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#6B8A08").s().p("ACHBKQiLgwhRgSQhzgYhhAIQAagyAagZIABABIAHgIIA2ABQCOAGBVALQBWAQBOAYIBRAaIAJADQgmARglAnQgTAVgQARIg1gRg");
	this.shape_31.setTransform(-7.2,-58.9);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#F5D802").s().p("AiNBcQhZgfgQg5QgQg4Abg4IADgHQBggJB0AZQBPASCNAxIA1ARQgNAOgJALQgVAagmAnQgmAnheAEIgWAAQhRAAhOgag");
	this.shape_32.setTransform(-13.7,-48.1);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#FFFFFF").s().p("AhcBFQAghRAmgrQAmgsAYgSQAYgRAygUIAHAHIAEAKQgzARguAxQgkAXgdAsQgUAbghBDQgTAmgPAbQAAgFAghRg");
	this.shape_33.setTransform(29.2,-34.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27}]},13).wait(1));

	// Layer_10
	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f().s("#000000").ss(1,1,1,3,true).p("ACKhxQgEhLAUhIIhpgCIjigEQgIArgCArQgDAmAAAmQABBJAOBIQAKA5ASA4ACcAAQgUAMgUALQgSAIgSAIQh8AviDgtACcAAQALAnAQAnIABABQgRANgQALQgPAKgPAJQiHBOiFguAC4BPQAeB2hfAtQgTAJgYAHQgMADgLACQhXAQhTgtQgRgogNgoACcAAQgQg4gCg5QgfAPgeALQgTAGgSAFQh/Ahhng9");
	this.shape_34.setTransform(-10.2,53.8);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#747474").s().p("");
	this.shape_35.setTransform(-13.5,58.1);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#666666").s().p("ABxDNQALgQAFgIQAIgQABgNQABgNgFgPIAegTIgeATIgDgKIgSgjQgKgSgKgUIAkgQIgkAQQgPgigMgmQgHgTgFgYIAkgLIgkALQgJghgJgqQhsAIhmgkQACgsAIgrIDiAEQAEBgAYBPIAGAVQANAnAUAyQAOAiASAoIADAGQALAcAAAPQAAAKgEAOIgKAWQgPAegOAVQgSAIgZAHIgXAFQAUgVAbgng");
	this.shape_36.setTransform(-11.5,53.6);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#4C4C4C").s().p("AAcDKIAJgWQAFgOAAgKQgBgPgKgbIAhgZIghAZIgDgHQgSgogNgiQgVgxgMgnIgGgWQAegKAegPQACA4AQA4IgnAXIAngXQALAnAQAoIABAAQAeB2heAuQAMgUAQgfgAhGj8IBoACQgUBJAEBLQgeAPgeAKQgYhPgEhgg");
	this.shape_37.setTransform(1.8,52.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34}]},13).wait(1));

	// Layer_11
	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_38.setTransform(-10.3,102.2);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#333333").s().p("Ag5BvQizgZiGg/QiHg9gZgQQgYgQgLgeIA6AhQAeARAfAPQAgAQAiAPQAiANAkAMQAoAPApALQApAMArALIBXAPIBZAKIBDACQApABApgDQAcgEAcgHQAigHAhgKQAvgQAngXQAZgOAXgPQAVgNAUgQQASgQAQgQQAdgcAYgfQABAFgDARQgEARgVAfQgVAehHAxQhIAyh/AdQhDAPhSAAQhIAAhTgLg");
	this.shape_39.setTransform(-11.1,136.1);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#2875A9").s().p("");
	this.shape_40.setTransform(-10.5,102.1);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("#FFFFFF").s().p("AHJCFQgLgigOgcQgYgygjgkQgogqhOA7QhPA7hQCWQgKgcBEhmQBEhlA5gVQA5gVgQgyQgQgyhbgzQhbgzh2gJQh1gKhsAWQhfAVhnAyQgfAPghASQBmhKBVgYQBUgZBogHQB5gOBzAiQB1AhBVBYQBTBYAqBzQALAhAGAjQALA2ABA6QAAAYgEAfQAAhVgXhKg");
	this.shape_41.setTransform(0.9,85.3);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("#3399DB").s().p("");
	this.shape_42.setTransform(-12.9,98.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_42},{t:this.shape_41},{t:this.shape_40},{t:this.shape_39},{t:this.shape_38}]},13).wait(1));

	// Layer_12
	this.instance_5 = new lib.db_atL("single",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(62,-121.4);

	this.instance_6 = new lib.db_headlight("single",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(8.7,-155.7);

	this.instance_7 = new lib.DB_glass("single",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(0.4,-109.1);
	this.instance_7.alpha = 0.34;

	this.instance_8 = new lib.db_armL("single",3);
	this.instance_8.parent = this;
	this.instance_8.setTransform(-61.6,-53.1,1,1,180,0,0,-24.4,-29.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7},{t:this.instance_6},{t:this.instance_5}]},10).to({state:[]},1).to({state:[{t:this.instance_8}]},2).wait(1));

	// Layer 5
	this.instance_9 = new lib.db_headf("single",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-5.1,-92.2);

	this.instance_10 = new lib.db_mon("single",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-6.8,-99);

	this.instance_11 = new lib.db_face("single",7);
	this.instance_11.parent = this;
	this.instance_11.setTransform(-8.8,-99);

	this.instance_12 = new lib.db_atR("single",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(-54,-120.3);

	this.instance_13 = new lib.db_neck("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(-12.1,-46.4,1,1.021,0,11.7,0);

	this.instance_14 = new lib.db_handL("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(79.7,28,1,1,-23.7,0,0,0,-18.5);

	this.instance_15 = new lib.db_armL("single",0);
	this.instance_15.parent = this;
	this.instance_15.setTransform(57.2,2.6,1,1,-7.4);

	this.instance_16 = new lib.db_body("synched",0);
	this.instance_16.parent = this;
	this.instance_16.setTransform(-11.4,1);

	this.instance_17 = new lib.db_j("single",0);
	this.instance_17.parent = this;
	this.instance_17.setTransform(-5.8,64.4);

	this.instance_18 = new lib.db_b("single",0);
	this.instance_18.parent = this;
	this.instance_18.setTransform(-2.6,107.4);

	this.instance_19 = new lib.db_handR("single",0);
	this.instance_19.parent = this;
	this.instance_19.setTransform(-113.5,-0.3,1,1,17.5,0,0,-0.1,-19);

	this.instance_20 = new lib.db_armR("single",0);
	this.instance_20.parent = this;
	this.instance_20.setTransform(-60,-40.2,1,1,17.5,0,0,22.9,-28.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9}]},10).to({state:[]},1).wait(3));

	// Layer 2
	this.instance_21 = new lib.db_shadow("single",0);
	this.instance_21.parent = this;
	this.instance_21.setTransform(1.7,207.3);
	this.instance_21.alpha = 0.5;
	this.instance_21._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(10).to({_off:false},0).to({_off:true},1).wait(2).to({_off:false,rotation:1,x:-7.5,y:202},0).wait(1));
...
(lib.boss_hologram = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 3 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(-5.9,11.3);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:63.1},14).to({y:-17.9},15).wait(1));

	// Layer 1
	this.instance_1 = new lib.Boss("single",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(8,1.3,0.541,0.541);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(30));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-215.2,-269.8,418.6,562.3);


(lib.boss_hohlo = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.boss_hologram("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-0.8,-1.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:26.8,startPosition:29},29).to({y:-1.2,startPosition:28},29).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-216,-271,418.6,562.3);
...
(lib.tEn4 = function(mode,startPosition,loop) {
	...
	this.mcCont.setTransform(293.4,119.8,0.35,0.35,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1));

	// Layer_1
	this.myTxt = new cjs.Text("Yes! I know you’d come. So, answer\nthese questions if you want to stay \nin one piece.", "italic bold 20px 'Quantico'", "#0EE0E0");
	...
	this.myTxt.setTransform(87.5,19.7);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EAkhAIdIAAw0MhAlAAAIAACNIoSF6IISh4IAAKl");
	this.shape.setTransform(59.6,65.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EggSAAAMBAlAAA");
	this.shape_1.setTransform(86.6,119.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("A8JIaIAAqkIoSB4IISl6IAAiNMBAlAAAIAAQzg");
	this.shape_2.setTransform(60.1,66);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tEn4, new cjs.Rectangle(-174.5,11.2,492.8,132.1), null);
...
(lib.tEn3 = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AyKAAMAkVAAA");
	this.shape.setTransform(305.1,534.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AyKLHIAArpIbWAAIHVqWIi2KWIEgAAIAALp");
	this.shape_1.setTransform(305.1,463);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("AyKLAIAArqIbWAAIHVqVIi2KVIEgAAIAALqg");
	this.shape_2.setTransform(305.1,463.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_4
	this.myTxt1 = new cjs.Text("You have very sharp eyes, Tapir! This \nis installed with a time bomb.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 424;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(266.1,12.4);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_5
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("A/rAAMArLAAAIBKAAITCAA");
	this.shape_3.setTransform(267.1,80);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EAjWAF+IAAr2Mg/XAAAIAACFInMHRIHMi+IAAFe");
	this.shape_4.setTransform(243.6,41.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("AQQF7IhKAAMgrLAAAIAAldInMC+IHMnRIAAiFMA/XAAAIAAL1g");
	this.shape_5.setTransform(244.1,42.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(16.9,3.2,463.1,78.9);
...
(lib.tEn1 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(567.8,157.5,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("Don’t you think this \none looks a bit odd?", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	...
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(413.9,88);
	this.myTxt2._off = true;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A2jFkIAArCMAtHAAAIAALC");
	this.shape.setTransform(415.6,118.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AWkjzIvBAAIlEAAIBNHDIl8nDI0TAA");
	this.shape_1.setTransform(415.6,178.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("AgygxIBlAAIAABjg");
	this.shape_2.setTransform(458.9,149.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AiQCAI0TAAIAArDMAtHAAAIAALDIvBAAIAAhkIhmAAIBmBkIlEAAIBNHDg");
	this.shape_3.setTransform(415.6,141.6);
	...
	// Layer_4
	this.myTxt1 = new cjs.Text("This place gives me the creeps.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 371;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(174.5,10.6);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_5
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AbiEFIAAoEMg3DAAAIAAIE");
	this.shape_4.setTransform(173.6,25.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AbimQI6gAAIChL6Inzr6I3RAA");
	this.shape_5.setTransform(173.6,91.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("rgba(0,0,0,0.996)").s().p("AkQh7I3QAAIAAoEMA3BAAAIAAIEI6fAAIChL6g");
	this.shape_6.setTransform(173.6,64);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-12.9,-1,375,134.8);
...
(lib.tBm4 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(292.3,119.8,0.35,0.35,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1));

	// Layer_1
	this.myTxt = new cjs.Text("Ya! Saya tahu awak pasti akan datang.\nJawablah soalan-soalan ini jika awak \nmahu selamat.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	this.myTxt.lineWidth = 440;
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(60.9,19.7);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EAm8AIdIAAw0MhFbAAAIAACNIoSF6IISh4IAAKl");
	this.shape.setTransform(33.1,65.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EgitAAAMAxjAAAICVAAIRjAA");
	this.shape_1.setTransform(60.1,119.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("AVUIaIiVAAMgxjAAAIAAqkIoSB4IISl6IAAiNMBFbAAAIAAQzg");
	this.shape_2.setTransform(33.6,66);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tBm4, new cjs.Rectangle(-216.5,11.2,533.7,132.1), null);
...
(lib.tBm3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt2 = new cjs.Text("Awak sediakan ini\nkhas untuk saya?", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 246;
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(303.1,466.9);
	this.myTxt2._off = true;
	...
	// Layer_5
	this.myTxt1 = new cjs.Text("Tajam penglihatan awak, Tapir! Ini \ntelah dipasang dengan bom masa.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 415;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(260.6,12.4);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_6
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("A+rAAMA9XAAA");
	this.shape_3.setTransform(260.6,80);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EAiWAF+IAAr2Mg9WAAAIAACFInMHRIHMi+IAAFe");
	this.shape_4.setTransform(237.2,41.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("A7FF7IAAldInMC+IHMnRIAAiFMA9XAAAIAAL1g");
	this.shape_5.setTransform(237.6,42.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(16.9,3.2,453.2,78.9);
...
(lib.tBm1 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(567.8,165.5,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("Adakah awak perasan yang\npatung ini kelihatan ganjil?", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 343;
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(404.6,87);
	this.myTxt2._off = true;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A52FkIAArCMAztAAAIAALC");
	this.shape.setTransform(407.5,118.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AZ3jkI2HAAIBGGlIl1mlI43AA");
	this.shape_1.setTransform(407.5,177.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("Ag/CPI43AAIAArDMAztAAAIAALDI2HAAIBGGmg");
	this.shape_2.setTransform(407.5,140.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_5
	this.myTxt1 = new cjs.Text("Tempat ini menyeramkan.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 372;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(177.2,10.6);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_6
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AYQEFIAAoEMgwfAAAIAAIE");
	this.shape_3.setTransform(178.1,25.6);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AYQmQI38AAIChL6Inzr6IzRAA");
	this.shape_4.setTransform(178.1,91.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("Ak+h7IzRAAIAAoEMAwfAAAIAAIEI38AAIChL6g");
	this.shape_5.setTransform(178.1,64);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-10.9,-1,376.3,134.8);
...
p.nominalBounds = new cjs.Rectangle(-344.5,-22,533.7,131.6);
...
p.nominalBounds = new cjs.Rectangle(-111.1,-30,453.2,78.4);
...
p.nominalBounds = new cjs.Rectangle(-96.4,-34.2,376.3,134.3);


// stage content:
(lib.intro16 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{a1:1,a2:124,a3:214});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(3).call(this.frame_4).wait(115).call(this.frame_119).wait(5).call(this.frame_124).wait(85).call(this.frame_209).wait(5).call(this.frame_214).wait(25).call(this.frame_239).wait(1));
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(579,63.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},59).to({state:[{t:this.instance_1}]},65).to({state:[{t:this.instance_2}]},90).wait(26));

	// dgd
	this.instance_3 = new lib.dgd("single",1);
	this.instance_3.parent = this;
	this.instance_3.setTransform(631.8,718.8,0.639,0.639,6.6,0,0,-0.3,435.1);
	this.instance_3.filters = [new cjs.ColorFilter(0.7, 0.7, 0.7, 1, 0, 0, 0, 0)];
	this.instance_3.cache(-357,-667,715,1334);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:1489.3},79).to({_off:true},45).wait(116));

	// dgd
	this.instance_4 = new lib.dgd("single",2);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-269.1,927.2,0.863,0.863,9.5,0,0,-0.1,434.8);
	this.instance_4.filters = [new cjs.ColorFilter(0.7, 0.7, 0.7, 1, 0, 0, 0, 0)];
	this.instance_4.cache(-357,-667,715,1334);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:1016.4},79).to({_off:true},45).wait(116));

	// Digi-Bot
	this.instance_5 = new lib.DigiBot("single",13);
	this.instance_5.parent = this;
	this.instance_5.setTransform(470.4,536.9,0.5,0.5,0,0,0,-1.9,68.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(124).to({x:894.4,y:562.1,startPosition:10},0).to({x:690.4},35).to({_off:true},55).wait(26));

	// TAPIR_HERO
	this.instance_6 = new lib.TAPIR_HERO("single",3);
	this.instance_6.parent = this;
	this.instance_6.setTransform(686.1,872.3,0.8,0.8,0,0,180,-0.6,404.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({y:884.8},20).to({y:872.3},20).to({y:884.8},20).to({y:872.3},19).wait(20).to({startPosition:31},0).wait(25).to({scaleX:0.5,scaleY:0.5,x:642.6,y:567.9,startPosition:22},0).wait(50).to({startPosition:30},0).to({_off:true},40).wait(26));

	// Mabusa
	this.instance_7 = new lib.boss_hohlo();
	this.instance_7.parent = this;
	this.instance_7.setTransform(164.1,246.5,0.567,0.567,0,0,0,36.9,0.4);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(124).to({_off:false},0).to({alpha:1},10).wait(80).to({scaleX:0.87,scaleY:0.87,x:224.4,y:297.2},0).wait(26));

	// Boss
	this.instance_8 = new lib.Bosscopy("single",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(-329.1,378.1,1.5,1.5,-6.7,0,0,10,-304.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({x:178.4},79).to({_off:true},45).wait(116));

	// BG
	this.instance_9 = new lib.bg("single",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(598.1,417,1,1,0,0,0,1298.5,422.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({x:1105.6},79).to({_off:true},45).wait(116));

	// bg
	this.instance_10 = new lib.bg("single",1);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-83,178.4,0.5,0.5,-1.9,0,0,1298.2,423.2);
	this.instance_10.filters = [new cjs.ColorFilter(0, 0, 0, 1, 53, 63, 72, 0)];
	this.instance_10.cache(-90,25,2689,825);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({x:424.5},79).to({_off:true},45).wait(116));

	// bg
	this.instance_11 = new lib.bg("single",1);
	this.instance_11.parent = this;
	this.instance_11.setTransform(227.3,187,0.5,0.5,0,7.6,-172.4,1298.3,423.1);
	this.instance_11.filters = [new cjs.ColorFilter(0, 0, 0, 1, 53, 63, 72, 0)];
	this.instance_11.cache(-90,25,2689,825);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({x:734.8},79).to({_off:true},45).wait(116));

	// Sky
	this.instance_12 = new lib.sky("single",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(191.6,158.9,1,1,0,0,0,948.1,324.9);

	this.instance_13 = new lib.Bitmap6();
	this.instance_13.parent = this;
	this.instance_13.setTransform(-8,-12);

	this.instance_14 = new lib.Bitmap5();
	this.instance_14.parent = this;
	this.instance_14.setTransform(-8,-10);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12}]}).to({state:[{t:this.instance_12}]},79).to({state:[{t:this.instance_13}]},45).to({state:[{t:this.instance_14}]},90).wait(26));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({x:699.1},79).to({_off:true},45).wait(116));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-425.5,96.8,2722.1,1323);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/intro16/Bitmap1.png?1527795397972", id:"Bitmap1"},
		{src:"images/intro16/Bitmap2.png?1527795397972", id:"Bitmap2"},
		{src:"images/intro16/Bitmap3.png?1527795397972", id:"Bitmap3"},
		{src:"images/intro16/Bitmap4.png?1527795397972", id:"Bitmap4"},
		{src:"images/intro16/Bitmap5.png?1527795397972", id:"Bitmap5"},
		{src:"images/intro16/Bitmap6.png?1527795397972", id:"Bitmap6"},
		{src:"sounds/intro.mp3?1527795397972", id:"intro"}
	],
	preloads: []
};
