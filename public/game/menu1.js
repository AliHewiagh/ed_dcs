...
p.nominalBounds = new cjs.Rectangle(0,0,960,954);


(lib.PlanetMenu1 = function() {
	this.initialize(img.PlanetMenu1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,315,314);


(lib.PlanetMenu2 = function() {
	this.initialize(img.PlanetMenu2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,275,275);


(lib.PlanetMenuBlack = function() {
	this.initialize(img.PlanetMenuBlack);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,132,132);// helper functions:
...
(lib.planet19 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_3
	this.instance = new lib.PlanetMenuBlack();
	this.instance.parent = this;
	this.instance.setTransform(-66,-72);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-66,-72,132,132);


(lib.planet18 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_4
	this.instance = new lib.Bitmap9();
	this.instance.parent = this;
	this.instance.setTransform(-496,-486);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-496,-486,960,954);
...
(lib.planet2 = function(mode,startPosition,loop) {
	...
	// Layer_4
	this.instance = new lib.PlanetMenu2();
	this.instance.parent = this;
	this.instance.setTransform(-117,-128);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-117,-128,275,275);
...
(lib.mcTxt2En = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET CANDY", "italic bold 28px 'Quantico'", "#0EE0E0");
...
(lib.mcTxt2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET KANDI", "italic bold 28px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.lineHeight = 42;
	this.myTxt.lineWidth = 360;
	this.myTxt.parent = this;
...
}).prototype = getMCSymbolPrototype(lib.mcTxt2, new cjs.Rectangle(-78.8,-22,364.2,44.1), null);
...
(lib.earth = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-160,-191);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-160,-191,315,314);
...
p.nominalBounds = new cjs.Rectangle(-78.8,-14,364.2,44.1);
...
(lib.animPlanet19 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.planet19("single",0);
	this.instance.parent = this;
	this.instance.setTransform(-0.1,9.4,1.535,1.535,0,0,0,-0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:4.4},40).to({y:9.4},41).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-101.2,-101.2,202.6,202.6);


(lib.animPlanet18 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.planet18("single",0);
	this.instance.parent = this;
	this.instance.setTransform(2.8,1.8,0.184,0.184,0,0,0,-0.8,0.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:4.2},29).to({y:1.8},30).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-88.4,-87.8,176.8,175.6);


(lib.animPlanet2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.planet2("single",0);
	this.instance.parent = this;
	this.instance.setTransform(7,-0.8,1,1,0,0,0,40.8,6.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-4.8},49).to({y:-0.8},50).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-150.8,-135.7,275,275);
...
(lib.menu1 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(90).call(this.frame_94).wait(42).call(this.frame_136).wait(41).call(this.frame_177).wait(1));

	// click
	this.mcCont = new lib.cursor();
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(545.9,452,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(177).to({_off:false},0).wait(1));
	...
	this.btnCont.setTransform(400.5,328.3);
	new cjs.ButtonHelper(this.btnCont, 0, 1, 2, false, new lib.btnPlanet(), 3);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1,3,true).p("AAAZIMAAAgyP");
	this.shape.setTransform(217,329.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape},{t:this.btnCont}]},136).wait(42));

	// text
	this.instance_1 = new lib.txtNext2();
	this.instance_1.parent = this;
	this.instance_1.setTransform(299,109.2);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(136).to({_off:false},0).wait(42));

	// text
	this.instance_2 = new lib.txtNext1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(299,85.9);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(122).to({_off:false},0).wait(56));

	// num
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#666666").s().p("AidFVIhohAIA6ooIB2hBIDyAAIBpBBIg6IoIh3BAgAijD/IEQAAIA2n8IkQAAg");
	this.shape_1.setTransform(175,151.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#666666").s().p("AicFVIhphAIA7ooIB1hBIDzAAIBoBBIg7IoIh2BAgAijD/IEQAAIA2n8IkRAAg");
	this.shape_2.setTransform(111.2,151.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#666666").s().p("AjXFQIAJhWICjAAIAxneIirBfIAKhhIDAhpIBNAAIg+JJICjAAIgJBWg");
	this.shape_3.setTransform(178.9,151.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#666666").s().p("AicFVIhphAIA7ooIB1hBIDzAAIBoBBIg6IoIh3BAgAijD/IEQAAIA2n8IkQAAg");
	this.shape_4.setTransform(120.3,151.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1}]},119).to({state:[{t:this.shape_4},{t:this.shape_3}]},1).wait(58));

	// focus
	this.instance_3 = new lib.focus("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(400,328.2);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(92).to({_off:false},0).wait(86));

	// planet2
	this.instance_4 = new lib.animPlanet2();
	this.instance_4.parent = this;
	this.instance_4.setTransform(1190.6,325.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(19).to({x:407.6},89,cjs.Ease.cubicInOut).wait(70));

	// earth
	this.instance_5 = new lib.earth("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(413.5,334.9,1,1,0,0,0,-0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(19).to({startPosition:0},0).to({x:-369.5},89,cjs.Ease.cubicInOut).wait(70));

	// planet19
	this.instance_6 = new lib.animPlanet19();
	this.instance_6.parent = this;
	this.instance_6.setTransform(201.5,231.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(19).to({x:141.5},89,cjs.Ease.quadInOut).wait(70));

	// planet18
	this.instance_7 = new lib.animPlanet18();
	this.instance_7.parent = this;
	this.instance_7.setTransform(723.7,262.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(19).to({x:633.7},89,cjs.Ease.quadInOut).wait(70));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(61).to({_off:false},0).wait(117));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(76).to({_off:false},0).wait(102));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(54).to({_off:false},0).wait(124));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(27).to({_off:false},0).wait(151));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(38).to({_off:false},0).wait(140));

	// stars1
	this.instance_13 = new lib.starzRandom();
	this.instance_13.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(178));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(178));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(319.3,274,1395.5,795.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/menu1/Bitmap3.png?1524642710747", id:"Bitmap3"},
		{src:"images/menu1/Bitmap4.png?1524642710747", id:"Bitmap4"},
		{src:"images/menu1/Bitmap5.png?1524642710747", id:"Bitmap5"},
		{src:"images/menu1/Bitmap6.png?1524642710747", id:"Bitmap6"},
		{src:"images/menu1/Bitmap7.png?1524642710747", id:"Bitmap7"},
		{src:"images/menu1/Bitmap8.png?1524642710747", id:"Bitmap8"},
		{src:"images/menu1/Bitmap9.png?1524642710747", id:"Bitmap9"},
		{src:"images/menu1/PlanetMenu1.png?1524642710747", id:"PlanetMenu1"},
		{src:"images/menu1/PlanetMenu2.png?1524642710747", id:"PlanetMenu2"},
		{src:"images/menu1/PlanetMenuBlack.png?1524642710747", id:"PlanetMenuBlack"},
		{src:"sounds/bleep_stutter.mp3?1524642710747", id:"bleep_stutter"},
		{src:"sounds/menuRock2.mp3?1524642710747", id:"menuRock2"},
		{src:"sounds/stdClick.mp3?1524642710747", id:"stdClick"}
	],
	preloads: []
};
