...
p.nominalBounds = new cjs.Rectangle(0,0,237,462);


(lib.Bitmap3 = function() {
	this.initialize(img.Bitmap3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,129,260);


(lib.Bitmap4 = function() {
	this.initialize(img.Bitmap4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,164,196);


(lib.Bitmap5 = function() {
	this.initialize(img.Bitmap5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,132,326);
...
p.nominalBounds = new cjs.Rectangle(0,0,347,450);


(lib.starbg = function() {
	this.initialize(img.starbg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,815,612);// helper functions:
...
p.nominalBounds = new cjs.Rectangle(0,0.7,237,462);
...
p.nominalBounds = new cjs.Rectangle(-1,-1,132,326);
...
p.nominalBounds = new cjs.Rectangle(0.8,-1,129,260);
...
p.nominalBounds = new cjs.Rectangle(-1,-1,164,196);
...
(lib.bot1bmp = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(12.6,8.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(12.6,8.6,172,181);
...
(lib.bossbmp = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(3.3,3.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(3.3,3.1,347,450);


(lib.tapirMc = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.tapirbmp("single",0);
	this.instance.parent = this;
	this.instance.setTransform(5,-0.5,1,1,0,0,0,123.5,231.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-5.3},59).to({y:-0.6},59).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-118.5,-231,237,462);


(lib.hackerMc = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.hackerbmp("single",0);
	this.instance.parent = this;
	this.instance.setTransform(0.1,0.1,1,1,0,0,0,65,162);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-4.7},67).to({y:0.1},69).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-66,-163,132,326);
...
(lib.digiBot = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.DBbmp("single",0);
	this.instance.parent = this;
	this.instance.setTransform(-0.2,0.6,1,1,0,0,0,65,129.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-4.2},39).to({y:0.5},39).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-64.5,-130,129,260);
...
(lib.bot2Mc = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.bot2bmp("single",0);
	this.instance.parent = this;
	this.instance.setTransform(-0.1,0,1,1,0,0,0,80.9,97);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-6},79).to({y:0},80).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-82,-98,164,196);


(lib.bot1Mc = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.bot1bmp("single",0);
	this.instance.parent = this;
	this.instance.setTransform(-4,-0.7,1,1,0,0,0,94.5,98.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-6.7},68).to({y:-0.7},67).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-86,-90.5,172,181);
...
(lib.bossMc = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.bossbmp("single",0);
	this.instance.parent = this;
	this.instance.setTransform(0.1,-1.8,1,1,0,0,0,176.8,226.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:3},70).to({y:-1.7},67).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-173.5,-225,347,450);
...
(lib.tEn2a = function(mode,startPosition,loop) {
	...
	this.mcCont.setTransform(327.5,116.1,0.35,0.35,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1));

	// Layer_5
	this.myTxt = new cjs.Text("Spot on! Answer all of the \nfollowing questions if you want \nus to return the Sun.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	this.myTxt.lineWidth = 384;
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(127,16);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_6
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AbTIOIAAoYIGJh/ImJgMIAAlzMg84AAAIAAQW");
	this.shape.setTransform(146.6,63.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("A+bAAMA83AAA");
	this.shape_1.setTransform(126.5,116.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("EghgAILIAAwVMA84AAAIAAFzIGJALImJCAIAAIXg");
	this.shape_2.setTransform(146.1,63.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tEn2a, new cjs.Rectangle(-70.3,10.4,432.5,129.2), null);
...
(lib.tEn1 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(327.5,92.1,0.35,0.35,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1));

	// Layer_8
	this.myTxt = new cjs.Text("The Sun is missing and we know\nyou guys did it.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	this.myTxt.lineWidth = 384;
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(126.7,16);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_9
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AecFkIAArCMg83AAAIAALC");
	this.shape.setTransform(126.5,46.3);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("Au4AqIvjAAIAArCMA83AAAIAALCMgqQAAAIk/Jwg");
	this.shape_2.setTransform(126.5,77.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tEn1, new cjs.Rectangle(-70.3,10.2,422.7,140.1), null);
...
(lib.tBm2 = function(mode,startPosition,loop) {
	...
	// Layer_5
	this.myTxt = new cjs.Text("Tepat sekali! Jawablah kesemua \nsoalan yang berikut jika awak ingin\nkami kembalikan Matahari.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	this.myTxt.lineWidth = 384;
...
}).prototype = getMCSymbolPrototype(lib.tBm2, new cjs.Rectangle(-70.3,10.4,432.5,129.2), null);
...
(lib.tBm1 = function(mode,startPosition,loop) {
	...
	// Layer_5
	this.myTxt = new cjs.Text("Matahari telah hilang dan kami \ntahu itu kerja awak berempat.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	this.myTxt.lineWidth = 384;
...
}).prototype = getMCSymbolPrototype(lib.tBm1, new cjs.Rectangle(-70.3,10.2,422.7,140.1), null);
...
(lib.dialogue2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(136.5,34.6,1,1,0,0,0,133.5,35.6);

	this.instance_1 = new lib.tEn2a();
	this.instance_1.parent = this;
	this.instance_1.setTransform(136.5,34.6,1,1,0,0,0,133.5,35.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-67.3,9.9,432.5,128.7);
...
p.nominalBounds = new cjs.Rectangle(-155.8,-23,422.7,139.6);
...
(lib.intro = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(174.9,86.9);

	this.instance_1 = new lib.dialogue2();
	this.instance_1.parent = this;
	this.instance_1.setTransform(174.9,86.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},24).to({state:[]},9).to({state:[{t:this.instance_1}]},1).wait(6));

	// Hacker
	this.instance_2 = new lib.hackerMc();
	this.instance_2.parent = this;
	this.instance_2.setTransform(867.9,423.6);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(4).to({_off:false},0).to({x:720.3},15,cjs.Ease.quadOut).wait(21));

	// robot10-1
	this.instance_3 = new lib.bot1Mc();
	this.instance_3.parent = this;
	this.instance_3.setTransform(894.5,407.3);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(6).to({_off:false},0).to({x:606.5},15,cjs.Ease.quadOut).wait(19));

	// robot10-2
	this.instance_4 = new lib.bot2Mc();
	this.instance_4.parent = this;
	this.instance_4.setTransform(891.6,340.9);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(2).to({_off:false},0).to({x:499.2},15,cjs.Ease.quadOut).wait(23));

	// Boss
	this.instance_5 = new lib.bossMc();
	this.instance_5.parent = this;
	this.instance_5.setTransform(987.6,312.6);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(7).to({_off:false},0).to({x:714},15,cjs.Ease.quadOut).wait(18));

	// Digi-Bot
	this.instance_6 = new lib.digiBot();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-76.1,609.9);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(3).to({_off:false},0).to({x:172.3},15,cjs.Ease.quadOut).wait(22));

	// TAPIR_HERO
	this.instance_7 = new lib.tapirMc();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-125.8,504.8);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1).to({_off:false},0).to({x:83},15,cjs.Ease.quadOut).wait(24));

	// bg
	this.instance_8 = new lib.starbg();
	this.instance_8.parent = this;
	this.instance_8.setTransform(-6.6,-4.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(40));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(393.4,295.3,815,612);
// library properties:
lib.properties = {
