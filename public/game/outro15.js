...
p.nominalBounds = new cjs.Rectangle(0,0,812,608);
...
(lib.a_neck = function(mode,startPosition,loop) {
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(1,1,1,3,true).p("Ag1FKQgPgNgLgPQgmgygLg+QgTAUgGAcQgZhHAOhPQgXAggZAxQgVg2AAhDQAAgPAAgOQABgNACgKQAAgEABgDQABgKACgJQAEgRAVhCIFOktQgGBeAFBYQABAbAEAcQALBwArCBQATA2AQAUQAeA6hLBXQgJALgJAKQgNAOgMAMQgyAwgoARQguAUgZgBQgGAAgFgBQgagHgCgZQgCgZALgaQAJAIAKAJQAEADAFADQAQALATAJ");
	this.shape_3.setTransform(8.6,17.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#4D2256").s().p("AAfCdQARALATAJQgTgJgRgLIgJgGIgTgRQgOgOgLgOQglgzgMg8QgSATgHAcQgZhHAOhPQgWAhgZAxQgWg2AAhDIABgeIACgXIAKABQAHABANAAIANgBIgBAVQACAVAJAFQAEACAFAAIAKgBQAZgEAkgQQAPgFALgHQAHgFAIgIQAAAQADASQAOAAAUgJQAKBAAJAkQARA/AcArQASAcAgAfIAZAYQg4BMhgAHQgLgZARgTg");
	this.shape_4.setTransform(2.9,37.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#3F1C46").s().p("");
	this.shape_5.setTransform(8.8,17.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[]},1).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]},1).wait(1));

	// Layer_1
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1,1,1,3,true).p("ACUgIQgxBLhPA5QhNA4g9AEQgGAAgFAAQgygBgJguQgIgzAxhMQAxhMBOg4QAlgbAhgPQAMgFALgEQAYgIAWgBQA8gEAKAyQAAAAAAABQAIAygxBNg");
	this.shape_6.setTransform(17.2,47);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#D1D06B").s().p("AifCzICzlcIAXgJQBXAVAdAQIAAABQAIAygxBNQgxBLhOA5QhOA4g9AEIgIAAIgDAAg");
	this.shape_7.setTransform(20.2,47.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFE83").s().p("Ai7CJQgIgzAxhMQAxhMBOg4QAkgbAigPIizFcQgzgBgIgugABKitQAYgIAWgBQA8gEAJAyQgdgQhWgVg");
	this.shape_8.setTransform(17.1,47);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6}]}).to({state:[]},1).to({state:[{t:this.shape_7},{t:this.shape_8},{t:this.shape_6}]},1).wait(1));
...
(lib.a_mouth = function(mode,startPosition,loop) {
	...
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#333333").ss(1,1,1,3,true).p("");
	this.shape_7.setTransform(6.4,3.4);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFAEAE").s().p("AhcA3QABgLgCgJQBHh+B0AxQgOAXgUATQgKAKgLAIQgLglgdAQQgeAQADAmQgWAGgVAAQgKAAgLgCg");
	this.shape_8.setTransform(8.9,10.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#A63E46").s().p("AhgBVQgYgGgMAYIgKgGQAOgbAAgvQAHABAJgCQAUgEgCgiIAEgBQAagHAagJQALAgAjgIQAjgJgLgtQAVgLAVgNQAqgZARAOQATAPgSA3QgJAcgQAZQh0gwhGB/QgEgPgPgEg");
	this.shape_9.setTransform(7.4,3.6);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFF1").s().p("AhPBKQAMgZAXAGQAPAEAEAPQADAJgCALQgdgEgagQgABCAjQAfgQAKAmQgdAWggAJIgGACQgEgmAegRgAhLgFQgLgBgIgEQgPgIAEgcQALAEAPABQARAAAVgFQACAkgUADIgOACIgCAAgAANg+QAlgNAjgSQALAugkAIQgHACgGAAQgZAAgJgZg");
	this.shape_10.setTransform(2.1,6.6);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#0000FF").s().p("");
	this.shape_11.setTransform(6.5,2.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]},1).to({state:[]},1).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7}]},1).to({state:[{t:this.shape_11}]},1).wait(1));
...
(lib.a_leg = function(mode,startPosition,loop) {
	...
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_5.setTransform(15.3,42.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#772424").s().p("AH2BeQgXgYgogTQgygZg/gYQgigDgTABIgWAAQgNAAgKgCQgOgEgTgMIASABQBLAFBCgJQDnBGgXBEQgSAHgTAGQgHgSgQgSgAozA7IACgDQARgVASgMIAZgLIAZgKQAwgUAfgpQgUAAgVgGQgagGgagPQBaAQBFgdQAcgMAYgSQAZAngTAqQhgBYhLANQgsAHgrAAIgggBg");
	this.shape_6.setTransform(25.2,101.4);
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#A93333").s().p("AGyB5Qh1gPh1hRIgFhRQAyAJAvAEQATAMAOADQAKADANAAIAWAAQATgBAjADQA+AXAyAZQAoAUAXAYQAQARAHATQg/AUhCAAQgdAAgegEgAnxAfQhLgKgxgbQAPg4BAgUQBAgVAfgVQAcAIAaAFQAaAOAaAHQAVAFAUAAQgfAqgwAUIgZAKIgZAMQgSAKgRAWIgCACIgfgCg");
	this.shape_8.setTransform(15.5,104);
	...
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_10.setTransform(42.9,70.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#333333").s().p("AknHqQAPhxA3hlIABAAQABBagFBHQgNCwhEBkQgBhuAPhxgAgDnsQich6AfhaQBFgjCABrQCBBrBwChQifgHiah5g");
	this.shape_11.setTransform(95.3,85.7);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#A93333").s().p("AlJJ8QgbhIgDhlQBjhMgJiRIBfAdQg3BmgQBxQgPBxABBuQgrgBgbhIgADylBQhygLiwhjIAAAAQiPhvBAhxIAAAAIAyg1QggBaCbB6QCbB5CfAHQgDAxhRAAQgPAAgTgCg");
	this.shape_12.setTransform(90.3,86.1);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#2A8D87").s().p("ADzLHQnHiAl+kbQgvm5ASnXIMHiNQAXC7gjEBIgIA4QgPBlg2AJQA2gJAPhlIAIg4QB7hKB+gjQBWgXBLAyIAAAAQhBBxCQBvIAAAAQgDBYieAbQifAbjAAtQi+AtgohvQAMhaAUhbQBrg/A+iNQg+CNhrA/QgUBbgMBaQgMBfgCBfIgBAyIAAADIAAgDIABgyQFZB+C6DEQADAVABATQAICRhiBMQgTAPgYAMg");
	this.shape_13.setTransform(22.5,59.7);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_14.setTransform(-14.7,94.9);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#772424").s().p("AO6KrQgFg+ALg0QCLhACRgHIAAAAQBvgQBaBcIAZB7QhdiamnCMgAzXjvQi3iygvkQQALgFAKgCQATgCAUALQASAJANARQALANAMAWIATAmQAVAnAgAqQAYAdApAtQAjAlAcABQAVAlAjAlQAVAXAbAXQghBChCAsQgwgjgpgng");
	this.shape_15.setTransform(-15.6,121.3);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#206C67").s().p("");
	this.shape_16.setTransform(3.9,83.8);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#333333").s().p("AijBXQhugFg5gxQBOgfBFgWQGmiNBcCbQkjBeisAAIgfgBg");
	this.shape_17.setTransform(98.2,191.7);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#A93333").s().p("AQoKXQBLg1BOgkQgMA1AGA9QhGAXhNAfgAvBmsQgqgtgXgdQghgqgVgnIgTglQgMgWgKgNQgNgRgSgKQgVgLgTADQgJABgLAGIgEgWQALgbAsgIQAtgJArBNQAsBNBfBNQgBBBAkA/QgbAAgjgmg");
	this.shape_18.setTransform(-41.3,120.7);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#2A8D87").s().p("AONNFQgjlWDslpQAWAvgIA4QgHA2ggBYQgxCIgMBTQgRB6ArBYIAAAAQgQAmgIAmQhOAkhLA1IgBAAQgQhTA1g1gAPPNMQAkgYAngMQgnAMgkAYgAxChPQgkhAABhBIA+gdQBbkjHAkmQGbiCGXgUIg2BIQlEAPkXCVQkoCeiXEIQgUAlgnBLQgjBCghAoQgnAwg6ArQgiglgWglg");
	this.shape_19.setTransform(-22.2,89.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5}]},1).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10}]},1).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14}]},1).wait(1));
...
(lib.a_eye = function(mode,startPosition,loop) {
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgFAPQgDgBgBgGQABgFACgEQACgGAEgEQADgDADABQACABABAFQAAAGgCAEQgCAGgEADQgCADgCAAIgCAAg");
	this.shape_4.setTransform(17.8,10);
	...
	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgFALQgCgBgBgFQABgEADgDQACgFACgCQAEgCACABQACABAAAEQAAAFgDADQgCAFgDACIgDABIgCAAg");
	this.shape_13.setTransform(-7.3,5.4);
	...
	this.shape_14.setTransform(-8.2,6);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#000000").s().p("AgEAQQgFAAgBgFQgCgFADgGQACgGAEgFQAEgEAEAAQAFAAABAFQACAFgCAGQgCAGgFAFQgEAEgDAAIgBAAg");
	this.shape_15.setTransform(-8.2,6);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#000000").ss(1,1,1,3,true).p("AAjACQgCAOgNAKQgMAKgOgBQgPgBgIgLQgIgKADgNQADgPAMgKQANgKAOABQANABAIAKQAJALgDAOg");
	this.shape_16.setTransform(-7.8,6);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FF6600").s().p("AgGAjQgOgBgJgLQgIgKADgNQADgPAMgKQANgKANABQAOABAJAKQAIALgDAOQgDAOgMAKQgLAJgMAAIgDAAg");
	this.shape_17.setTransform(-7.8,6);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1}]},1).wait(1));

	// Layer 2
	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#C1B0C8").s().p("Ag0BLQAkhCAIhWQAbAKASAZQAWAegHAgQgFAigfANQgTALgXAAQgNAAgNgDg");
	this.shape_20.setTransform(25.5,10.4);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#E4D0EC").s().p("ABSA7QgYgdAHghQAFgfAggSQAfgPAnAKQAGACAGADQgHBWglBCQgkgKgWgfgAiHAMQgdgHgNgWQgMgVAMgYQAMgVAdgKQAfgLAdAJQAeAIAOAWQALAWgOAYQgLAUgeAKQgPAGgQAAQgOAAgOgFg");
	this.shape_21.setTransform(6.2,7.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_21},{t:this.shape_20}]}).to({state:[]},1).wait(1));
...
(lib.a_body = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1,3,true).p("ABPnhQh1A+hOBaQkEEEhwGXQAeBCA2A2QAvAvA4AdQAaAOAdAKQBaAfBggKQBEgHA6gbQARglAQgjQCflSDnlQIgyl7Qg6gGhhAgQg6AThCAXQgnAPgqAQg");
	this.shape.setTransform(19.5,23.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#85402A").s().p("AlUIuQgcgKgbgOQAkkCBlj2QB7ksDKjyQBCgXA5gTQBiggA5AGIAzF7QjoFQieFSIggBIQg7AbhEAHQgYADgWAAQhIAAhFgYg");
	this.shape_1.setTransform(28.9,23.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#A95136").s().p("AjvG/Qg2g2gehCQBvmXEDkDQBOhbB2g+IBRgfQjKDyh6EsQhlD3gkECQg4gdgugwg");
	this.shape_2.setTransform(3.1,24.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(1,1,1,3,true).p("AEPkcQAPGeBYEwQj7Cyi/AAQiUABhwhoQhWmxBNmwQAbiEAUgvQAvhVCnAKQADAAADAAQCiAKCzAm");
	this.shape_3.setTransform(28.2,30.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#85402A").s().p("AjEpjQCjAKCyAnIAAEVQAPGfBZEwQj7CxjAABQhqpYBopvg");
	this.shape_4.setTransform(40.8,30.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#A95136").s().p("AhqH9QhWmxBNmwQAbiEAUgvQAvhVClAKIAGAAQhoJvBrJXIgBAAQiTAAhvhng");
	this.shape_5.setTransform(6,30.5);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1,1,1,3,true).p("ABjlaQg7g0hCgLQhCgMhcAoQhcAnkHDNQkGDMC0CtQClCQJhAbQJjAbhNk3QhNk2i4iQQi4iQiPB9gAFZgqQiSjXhkhZ");
	this.shape_6.setTransform(-6.5,45.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#A95136").s().p("ACZGbQphgbiliQQi0itEGjMQEHjNBcgnQBcgoBCAMQBCALA7A0QBkBZCSDXQiSjXhkhZQCPh9C4CQQC4CQBNE2QBHEen+AAQgtAAgygCg");
	this.shape_7.setTransform(-6.5,45.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#000000").ss(1,1,1,3,true).p("AI2F8QiipslxlmQh2hOjDAxQjCAxhPBSQgcB0AeCJQAaB5BICJQCYElgVDJQCQBPB+AiQGNBrDbldg");
	this.shape_8.setTransform(3,13.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#85402A").s().p("AgyJuQAelMjTmdIk+h4QgeiJAch0QBPhSDCgxQDDgxB2BOQFxFmCiJsQioELkQAAQhUAAhcgZg");
	this.shape_9.setTransform(3,13.9);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#A95136").s().p("AgVFAQAVjJiYkkQhIiKgah5IE8B4QDUGdgfFMQh9giiPhPg");
	this.shape_10.setTransform(-26.9,32.8);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(1,1,1,3,true).p("AAypWQiFhHiJAgQgLADgLADQh5AghCA9QhtDWBHETQAHAcAJAbQBjE2gmDBQByA/BmAiQG1CTDpl1QiFqLk5lHg");
	this.shape_11.setTransform(10,13.9);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#85402A").s().p("AiuJeQAFiRgii3IgrjBIjdiGQhHkTBtjWQBCg9B5ggIAWgGQCJggCFBHQE5FHCFKLQioEMkQAAQhqAAh8gqg");
	this.shape_12.setTransform(10,13.9);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#A95136").s().p("AhEDnQAljBhjk1QgJgcgHgcIDcCHIArDAQAiC3gFCRQhmgihwg/g");
	this.shape_13.setTransform(-22.2,41.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]},1).to({state:[{t:this.shape_7},{t:this.shape_6}]},1).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8}]},1).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11}]},1).wait(1));
...
(lib.a_armR = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	...
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_10.setTransform(5.2,30.8);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#999999").s().p("AgeAmQgnAFgmgHQgxg9AfhQQBtAOCOg+QAlBGhKBNQAaAqgJBIQgbAWgfANQgVAIgXADQgkgxAChDgAgeAmQA6gIA9gkQg9Akg6AIg");
	this.shape_11.setTransform(-19.9,-2.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#4D2256").s().p("AhYCcIgLgiQAggMAagXQAJhHgagrQBJhNgkhGQBTBsAmCnQgsAyg7ARQgWAHgRAAQgeAAgQgTg");
	this.shape_12.setTransform(-5.1,-0.8);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFE83").s().p("AjjE0QgoimgqiPQgqiQBdgaIAABAQBMA/BuhFIAUgNIgUANIADhGQBZA6gIBlIgBAOIE4mpIgOHdQiyFOifAxQgkALgeAAQhnAAgeiAgAApECQgfiWAAhfIABgXIgBAXQAABfAfCWg");
	this.shape_13.setTransform(11.8,36.2);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#A95136").s().p("AhdBBIAAhAIAAgoQAaAdA7gRQA6gRAtgyIgBBUIgCBFQg6AkgvAAQgsAAgkgeg");
	this.shape_14.setTransform(-4.6,18.8);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_15.setTransform(5.8,-8.1);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#000000").ss(1,1,1,3,true).p("AkijgQglgigzgUQAXhqgQhoIBLAAQAzA2ABBlQAXgEASALAjwhKIASg4Qgag4gqgmAguhOIgKAzQhXBGhzg8IASg5QhNADgdBtQgdBugzCcQgzCcC7AbQC6AbIencAj0lNQg4AbAKBSAgliCIgJA0QAzAhgNA6QhSCegjCvAgliCQAsgjg3hKQgThWiIgBQAuAbAOB9QgbAyg0gGAgliCQh9Axg8gxAgIANQDPhyCGio");
	this.shape_16.setTransform(-20.4,1.2);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFE83").s().p("AkiF6Qi7gcAzibQAzicAdhuQAdhuBNgCIgSA4QBzA+BXhHIAKg0QAzAhgNA7QhSCegjCuQAjiuBSieQDPhzCGinIBpE0QoBHBjCAAQgLAAgKgBg");
	this.shape_17.setTransform(-20.4,12.1);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#A95136").s().p("AhuAqIASg3IASg5QA8AxB9gxIgKA0IgJAzQgvAmg2AAQgvAAg2gdg");
	this.shape_18.setTransform(-35.2,-4.9);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#4D2256").s().p("AhmBWQA1AGAagyQgNh8gugbQCGABAUBWQA3BJgsAjQg/AYgtAAQgvAAgegYg");
	this.shape_19.setTransform(-32.4,-20.5);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#999999").s().p("AAmCyQgZg3gpgmQgCgNAAgLQAAg9AvgXQgvAXAAA9QAAALACANQgmgigygUQAWhqgQhnIBMAAQAyA2ABBlQAXgEARAKQAuAbAOB9QgXAsgtAAIgLgBg");
	this.shape_20.setTransform(-46.5,-29.8);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f().s("#000000").ss(1,1,1,3,true).p("AgtheQg5AbALBRQgmghgygUQAWhqgQhoIBMAAQAzA2ABBlQAWgEASALAgYBsQgag3gpgnAChBsIgTBnQhYBHhyg9IAkhxAChBsQAsgjg3hJQgUhWiHgBQAtAbAOB8QgaAyg0gGAChBsQh+Axg7gx");
	this.shape_21.setTransform(-40.2,-22.7);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#A95136").s().p("AhuAqIAkhwQA8AxB9gxIgTBnQgvAmg2AAQgvAAg2gdg");
	this.shape_22.setTransform(-35.2,-4.9);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#999999").s().p("AAmCyQgZg3gpgmQgCgNAAgLQAAg9AvgXQAXgEARAKQAuAbAOB9QgXAsgtAAIgLgBgAh0AfQAWhqgQhnIBMAAQAyA2ABBlQgvAXAAA9QAAALACANQgmgigygUg");
	this.shape_23.setTransform(-46.5,-29.8);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f().s("#000000").ss(1,1,1,3,true).p("AmJFyIAAAPQLogfFsncIAgixIAPhVQiXA9jLB4QjLB4jcCIQjeBCicAMIAAAuIAAASIAAAAIAACvIiJAEQAZhOgThdQgDgOgDgOIghgPQACAOAAANQAGBggdBbIA2AAAozCgIhpgyIhdBWIAfAUIBfA8IhXgQIgTgDIgOB1IATAAICYAAAoSCvICJAC");
	this.shape_24.setTransform(0.2,35.2);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#737373").s().p("AhXB2IAGgrQAHgsAAgbIBWAPIhdg7QAJgOASgWQAWgaAJgOIBsAvIACABQAGBegdBcg");
	this.shape_25.setTransform(-64.6,60.9);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#85402A").s().p("Ag9hQICBgIIAACtIiIAFQAZhPgShbg");
	this.shape_26.setTransform(-46,63.7);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#D1D06B").s().p("Ao6FIIAAivIAAgBQBBgQB1gLQCLgOBPgWQFikJGCilIgfCxQltHbroAfg");
	this.shape_27.setTransform(17.9,39.4);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#999999").s().p("AhdCEIAOh1IATADQgBAcgHAsIgGAqgAhjgtIBchWIBpAyIACAbIgBAAIhsgwQgJAOgWAbQgSAWgKAOg");
	this.shape_28.setTransform(-66,59.4);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#4D2256").s().p("AghBrQAdhbgGheIgCgcIAgAPIAGAcQASBcgYBOg");
	this.shape_29.setTransform(-54.9,61.9);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#FFFE83").s().p("ApBEQIAAguQCcgMDehCQDciJDLh3QDLh4CXg9IgPBVQmDClliEJQhOAXiMAOQh1ALhAAQg");
	this.shape_30.setTransform(18.6,25.7);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#A95136").s().p("AhEgNICIACIAAARIAAAAIiBAIIgHgbg");
	this.shape_31.setTransform(-46,54.1);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_32.setTransform(1.2,32.7);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#737373").s().p("AgvA0QgNgcgJgcQgDgoAEgpIAAgBQAOAFARAKIAhATQATANAbAJQADA3AaA9IgQABQgwAAg2gjg");
	this.shape_33.setTransform(-45.9,20.6);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#3F1C46").s().p("AhABBIgLACQgbg9gCg3QCAhZBRCcQgZA0gwAMQgngfg5AOg");
	this.shape_34.setTransform(-31.1,22.5);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#85402A").s().p("AgrAgIghgsQAwgMAZg0QAmAqAqA+QgeAig4APg");
	this.shape_35.setTransform(-20.2,32);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#D1D06B").s().p("Ak2DIQg3gigYguQgdg0APhDIAiAtQA5gOAegiQAfgiACg3IgfgoQAzgCBUBqQBVBpBIAZIgUgVIgGgGIBvilQA3hUA2g6QBRhaBqhAQACChAOCIQgrCEiPCfQiOCfhqAYQikhuh5hMg");
	this.shape_36.setTransform(15.8,35.1);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#FFFE83").s().p("AjCCKQhUhqgzACIgOgTQAzgTBGBPQA2A+BQBQIAZAZIgZgZQBbiSBwiSQBxiTB0guIAAAwQhqBAhRBbQg2A5g3BTIhvCnIAGAGIAVAVQhJgZhVhqg");
	this.shape_37.setTransform(20.7,18.5);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#999999").s().p("AhJgSIAoATQgNg1AhgxIBYA+QgUApgDAtIhVguIBVAuQgBAOABAOQgbgJgUgMIgggTQgSgLgNgFIAAABQgEApADApQgRg6ADg+g");
	this.shape_38.setTransform(-46.9,10);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#4D2256").s().p("Ah0AhQAAgPABgNIABgCIABAAQA9g0AlgBIABAAIAAAAQAiAAANAwQgNgwgiAAIAAAAIgBAAQglABg9A0IgBAAIgBACQADgtATgqQBZgYAkAIQAmAIAvBaQgFA+gTAnQhQiciBBYg");
	this.shape_39.setTransform(-30,14.2);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#A95136").s().p("Ag4AAQASgoAFg+IAtA6IAOATIAfAnQgCA3gfAiQgpg+gngpg");
	this.shape_40.setTransform(-14.9,24.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10}]},1).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_2},{t:this.shape_3},{t:this.shape_4},{t:this.shape_15}]},1).to({state:[{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16}]},1).to({state:[{t:this.shape_23},{t:this.shape_22},{t:this.shape_19},{t:this.shape_21}]},1).to({state:[{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24}]},1).to({state:[{t:this.shape_40},{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32}]},1).wait(1));
...
(lib.a_armL = function(mode,startPosition,loop) {
	...
	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#000000").ss(1,1,1,3,true).p("AiNG8IBHgVQAKiGhGgoQgegUgggIQgzgMg4AVQBzBHgKCfQgbA9gnAZQgdh0hBg1Qgqghg5gIQBBhGBZgkAjADdQAshhCYABQBNABBMAMQBMAMBMAYAiNG8QAcA3BUAhQEiggEEiMQCRmfkiozQiTgOgaCoQANEug7EsAnFFQQg/Bqg0BwQAsArA3AXIBKiOIBDB4QAvALA2gLQAyg3gRhTIA1gQAliF5IgpBl");
	this.shape_16.setTransform(-28.2,55.9);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#999999").s().p("Ai8BMQA0hvA/hqQA5AIAoAhQBBA1AeBzQAngZAag8QASBSgzA3Qg1ALgwgLIhBh4IAnhkIgnBkIhKCOQg4gXgrgrg");
	this.shape_17.setTransform(-66.2,103.7);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#4D2256").s().p("AgegKQgqgig5gHQBChGBXgkQB0BHgLCeQgbA9gnAZQgdh0hAg0g");
	this.shape_18.setTransform(-60.6,94.7);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#A95136").s().p("AhyhrQA4gVAzAMQAfAHAeAVQBGAogKCFIhHAVIg0AQQAJiehyhHg");
	this.shape_19.setTransform(-46.7,89.7);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFE83").s().p("AlJHoIBHgVQAKiGhGgoQgegUgggIQAshhCZABQBNABBMAMQBLAMBMAYQhMgYhLgMQA6ksgNkuQAaioCTAOQEiIziRGfQkECMkiAgQhUghgcg3g");
	this.shape_20.setTransform(-9.4,51.5);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f().s("#333333").ss(1,1,1,3,true).p("");
	this.shape_21.setTransform(-63.4,38.2);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#D1D06B").s().p("AmmHyQgIgIgTgMQgTgMgJgRQgIgSAAgVIAwgCQAuhEgVhRQgEgRgGgRQAFgRAOgOQAQgRAYgKQAggOBAAAQCygDC0AiQA+jeAejnIABgFQA6i3A2ggQA3ghA6A9QAjAlAUAxQAaBAgEBJQhGHQkUEOQkcgMi1AQQgYACgVAAQgdAAgXgEg");
	this.shape_22.setTransform(-38.7,36.9);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#737373").s().p("AhgAGIAGgBQBfgBBggMQgQAbgXAYQhAAahAApQgdgygBg2gAiCAGQADg9AUg2QB3gEB3AdQgJApgVAjQhgAMhfABIgGABIgRAAIgRAAgABlgIIAAAAg");
	this.shape_23.setTransform(-123.8,78.6);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#85402A").s().p("AgwhEIArgDIBUgGQAUBRgtBDIgxACIgkACIg1ADQA/hIgbhKg");
	this.shape_24.setTransform(-87.9,70.6);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#3F1C46").s().p("AhXAvQAUgjAJgpQA7g6AtgHQAtgIAdAKQAcBLhABHQhpABhqAsQAXgYARgcg");
	this.shape_25.setTransform(-104.8,73);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#999999").s().p("Ah6ANQAKgZAOgYQBzgGBqAcQgBAbgGAZQh1gch5ADg");
	this.shape_26.setTransform(-122.3,66.3);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#4D2256").s().p("AhSAZQAahfBOgHQAzAvARAsQgdgKgtAIQgsAHg9A6QAGgYABgcg");
	this.shape_27.setTransform(-101.7,62.3);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#A95136").s().p("AhhgpIBsgFIAwgDQASAeAKAaQAHARAEAQIhWAGIgqAEQgRgugygtg");
	this.shape_28.setTransform(-89.7,58.8);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFFE83").s().p("AlgEqIAlgCQABAVAIASQAIARATAMQAUAMAIAIQhagPgLhHgAkYA3IgwACQAbijINBqQBIjKA5i1QgeDng+DeQi1gjixAEQg/AAggAOQgZAJgQASQgNAOgGARQgKgbgSgdg");
	this.shape_29.setTransform(-55.7,48.4);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f().s("#000000").ss(1,1,1,3,true).p("");
	this.shape_30.setTransform(14.7,78.2);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#737373").s().p("AhnBGIAEgcQAJgpALgaQAOgkAOgUQAOgUARgVQAGgHANgLQA3AcAyAxQhEBkglBoQhBghglgmg");
	this.shape_31.setTransform(17.6,157.1);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#3F1C46").s().p("AhbgGQAagXAzgnIAAgBQA6ALAwAbQgNBdhBAIQgxgyg4gag");
	this.shape_32.setTransform(26.6,143.7);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#85402A").s().p("Ag0BEQAEgdgDhQQgBgdgFgiQAxAEAlAfQAPAfAHAfQANA3gLA5Qgwgag5gLg");
	this.shape_33.setTransform(30.4,130);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#D1D06B").s().p("AhgKYIACgMQAIgWAUgRQgOgqgGgyQgJg/gEjCQgFjCgkjBQgljBhYiVIgCgHQgMilBXhUQCfgBBdD/QBfD/ArEeQAsEfAWCfQAXCfhPAmQgHgfgPgfQgmgegxgEQg2gFhCAbQAFAqgGAlQgvgBgbg5g");
	this.shape_34.setTransform(14.7,57.4);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#FFFE83").s().p("AAfEgQABlIiDoMQBZCVAjDBQAkDCAFDBQAFDCAIA/QAHAyAOAqQgUARgIAWIgDAMQgnhRABjEg");
	this.shape_35.setTransform(-2,67.3);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#A95136").s().p("AhLBSQARgeAGglQAGgjgFgqQBCgbA1AEQAFAiABAdQADBQgEAdQhDgNhRAIg");
	this.shape_36.setTransform(17.7,128);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#999999").s().p("AgNBZQABgQADgOQAOhIA4gsQg4AsgOBIQhXgjgTgvQAShDAwghQBXgCBOAnQgNAMgGAHQgRAUgOAVQgOAUgOAjQgLAbgJApIgEAbQgQgRgLgSg");
	this.shape_37.setTransform(5.8,151.6);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#4D2256").s().p("Ah4gBQAlgaA4gEQBRgIBDANIAAAAQgzAmgZAXQhNgnhYADg");
	this.shape_38.setTransform(12.9,139.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10}]},1).to({state:[{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16}]},1).to({state:[{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21}]},1).to({state:[{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30}]},1).wait(1));
...
(lib.T_features = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},1).wait(2).to({_off:false,startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:0},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},1).wait(2).to({_off:false},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:-4.1,y:3.1,startPosition:1},0).wait(1).to({x:-13.6,y:1.8,startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2}]}).to({state:[]},1).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3},{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({_off:true},1).wait(2).to({_off:false,startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:5},0).wait(1).to({x:-18.2,y:-30.8,startPosition:0},0).wait(1).to({x:34.4,y:-21.8,startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:5},0).wait(1));
...
(lib.key_in_boxcopy = function(mode,startPosition,loop) {
	...
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1,1,1,3,true).p("Aj2hIIEHAHICWAiAD3gMIhEAAIgiAAIjcAAIAQBVIigg2IgbhbACvgdIBIARIgmBVIgwAAIgjAAIi5AAAhLgMIirg8");
	this.shape_5.setTransform(17.6,-2.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape_5}]},1).wait(1));

	// Layer_1
	this.instance = new lib.key("single",1);
	this.instance.parent = this;
	this.instance.setTransform(14.2,17.8,0.1,0.1,-15,0,0,113.7,99.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},1).wait(1));

	// Layer 5
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.rf(["#00CC66","rgba(0,204,102,0)"],[0,1],-0.7,-1,0,-0.7,-1,19.4).s().p("AjMA4IAOjIIC+AAIDNArIgiDiIjhAUg");
	this.shape_6.setTransform(16.6,12);

	this.timeline.addTween(cjs.Tween.get(this.shape_6).wait(2));

	// Layer_2
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#000000").ss(1,1,1,3,true).p("AgaAPIgOBZIjGiAIA2g6IDYgVIC3BfIAYBUIgzAGIgmADIi+ATADXgIIg5AGIgfACIiZAPIiehh");
	this.shape_7.setTransform(13.6,25.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#0073AB").s().p("AjHgmIDYgVIC3BfIg5AFIgfAEIiZAPg");
	this.shape_8.setTransform(15.1,21.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#008FD5").s().p("AgegoIAfgDIAeBTIgmAEg");
	this.shape_9.setTransform(29.4,29.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#004364").s().p("AhpgjIA2g6ICdBiIgOBZg");
	this.shape_10.setTransform(0.3,26.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#006699").s().p("Ah9ggICZgPIAXBVIi+ASgAA7gyIA5gFIAYBTIgzAGg");
	this.shape_11.setTransform(23.5,30.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7}]}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7}]},1).wait(1));
...
(lib.inventory = function(mode,startPosition,loop) {
	...
	this.instance = new lib.key("single",1);
	this.instance.parent = this;
	this.instance.setTransform(371.6,-91.2,0.221,0.23,0,-19.9,-20.4,5.5,1.5);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({_off:false},0).to({regX:3.9,regY:2.5,scaleX:0.5,scaleY:0.5,rotation:-6.9,skewX:0,skewY:0,x:226.2,y:-146.2},26,cjs.Ease.cubicOut).to({regX:3.5,regY:3.4,scaleX:0.25,scaleY:0.25,rotation:-13.6,x:-33.2,y:66.1},23,cjs.Ease.cubicIn).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:23.1},19,cjs.Ease.get(0.5)).wait(56));

	// Layer_3
	this.instance_3 = new lib.repellentgfx("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(-112.6,-165.4,0.275,0.275,0,0,0,0.2,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:-2.9},19,cjs.Ease.get(0.5)).wait(56));

	// inv_box
	this.instance_4 = new lib.inv_box("single",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-110.4,257.4);
	...
	this.instance_5.setTransform(-110.4,172.2);
	...
	this.instance_6.setTransform(-110.4,87.1);
	...
	this.instance_7.setTransform(-110.4,1.9);
	...
	this.instance_8.setTransform(-110.4,-83.2);
	...
	this.instance_9.setTransform(-110.4,-168.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({x:-0.4},19,cjs.Ease.get(0.5)).wait(56));

	// inv_box_bg
	this.instance_10 = new lib.inv_box_bg("single",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-109,0,1,1,0,0,0,1,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({x:1},19,cjs.Ease.get(0.5)).wait(56));
...
(lib.a_head = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({startPosition:1},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({startPosition:1},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:1},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({startPosition:1},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:1},0).wait(1));
...
(lib.tapirhead = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({_off:true},1).wait(6).to({_off:false,startPosition:7},0).to({_off:true},1).wait(7).to({_off:false,startPosition:14},0).wait(1).to({startPosition:15},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},4).to({state:[]},1).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},6).to({state:[]},1).to({state:[{t:this.shape_4},{t:this.shape_5},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},7).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));
...
(lib.TAPIR_HERO = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({_off:true},1).wait(7).to({_off:false,regX:-0.1,regY:-0.1,rotation:-2,x:-15,y:-293.4},0).to({_off:true},1).wait(16).to({_off:false,regX:-1.7,regY:-3,rotation:-2.2,x:36,y:-265.2},0).wait(1).to({regX:0.1,regY:-0.1,rotation:4,x:13.7,y:-288.9},0).to({_off:true},1).wait(89));
	...
	this.instance_4 = new lib.T_Arm_L("single",8);
	this.instance_4.parent = this;
	this.instance_4.setTransform(89.1,-158.4,1,1,16.7,0,0,-14.8,-117.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1,p:{rotation:-4,x:82.7,y:-184.5,regX:0,regY:0}}]},4).to({state:[]},1).to({state:[{t:this.instance_1,p:{rotation:-2,x:77.9,y:-184.4,regX:0,regY:0}}]},7).to({state:[]},1).to({state:[{t:this.instance_3},{t:this.instance_2}]},16).to({state:[{t:this.instance_1,p:{rotation:-3.3,x:98.2,y:-173.8,regX:0.1,regY:-0.1}},{t:this.instance_4}]},1).to({state:[]},1).wait(89));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8,p:{startPosition:0}},{t:this.instance_7,p:{regY:-140,rotation:0,x:-132.2,y:-192.4,regX:-33.8,startPosition:0}},{t:this.instance_6,p:{regY:0.2,rotation:0,x:-27.5,y:-125.1,startPosition:0,regX:0}},{t:this.instance_5,p:{rotation:0,x:-136,y:-176.1,regX:0,regY:0}}]},4).to({state:[]},1).to({state:[{t:this.instance_8,p:{startPosition:0}},{t:this.instance_7,p:{regY:-140.1,rotation:-2,x:-138.2,y:-188.3,regX:-33.8,startPosition:0}},{t:this.instance_6,p:{regY:0.1,rotation:-2,x:-31.3,y:-124.6,startPosition:0,regX:0}},{t:this.instance_5,p:{rotation:-2,x:-141.4,y:-171.8,regX:0,regY:0}}]},7).to({state:[]},1).to({state:[{t:this.instance_8,p:{startPosition:2}},{t:this.instance_6,p:{regY:0.2,rotation:5.7,x:15.7,y:-90.3,startPosition:3,regX:0}},{t:this.instance_9}]},16).to({state:[{t:this.instance_8,p:{startPosition:0}},{t:this.instance_6,p:{regY:0.2,rotation:4,x:-20.2,y:-122.7,startPosition:0,regX:-0.1}},{t:this.instance_7,p:{regY:-140.2,rotation:7.1,x:-100.9,y:-213.5,regX:-34.1,startPosition:5}},{t:this.instance_5,p:{rotation:10.2,x:-117,y:-197.2,regX:-0.1,regY:-0.1}}]},1).to({state:[]},1).wait(89));
	...
	this.instance_11 = new lib.T_Arm_L("single",4);
	this.instance_11.parent = this;
	this.instance_11.setTransform(111,-169.4,1.101,1.06,-2.3,0,0,-14.7,-117.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_10,p:{rotation:0,x:68.1,y:-194,startPosition:1,regY:-117.2,regX:-14.8,scaleX:1,scaleY:1}}]},4).to({state:[]},1).to({state:[{t:this.instance_10,p:{rotation:-2,x:64.3,y:-187.1,startPosition:0,regY:-117.2,regX:-14.8,scaleX:1,scaleY:1}}]},7).to({state:[]},1).to({state:[{t:this.instance_11},{t:this.instance_10,p:{rotation:-2.3,x:113.8,y:-157.9,startPosition:8,regY:-117.4,regX:-14.8,scaleX:1,scaleY:1}}]},16).to({state:[{t:this.instance_10,p:{rotation:16.7,x:90.2,y:-170.1,startPosition:4,regY:-117.3,regX:-14.7,scaleX:1.1,scaleY:1.06}}]},1).to({state:[]},1).wait(89));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(4).to({_off:false},0).to({_off:true},1).wait(7).to({_off:false,regX:0,regY:0,skewX:-0.9,skewY:-180.9,x:-13.3,y:-281.6,startPosition:11},0).to({_off:true},1).wait(16).to({_off:false,regX:-0.3,skewX:4.7,skewY:-175.3,x:44.8,y:-243.4,startPosition:19},0).wait(1).to({regX:-0.1,regY:0.1,skewX:8.5,skewY:-171.5,x:16.5,y:-273.8,startPosition:20},0).to({_off:true},1).wait(89));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(4).to({_off:false},0).to({_off:true},1).wait(7).to({_off:false},0).to({_off:true},1).wait(16).to({_off:false},0).wait(1).to({_off:true},1).wait(89));
...
(lib.DigiBot = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19}]},8).to({state:[]},1).to({state:[]},4).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25}]},8).to({state:[]},1).to({state:[]},4).wait(1));
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(8.7,-155.7);

	this.instance_5 = new lib.DB_glass("single",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(0.4,-109.1);
	this.instance_5.alpha = 0.34;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_49},{t:this.shape_48},{t:this.shape_47},{t:this.shape_46}]},8).to({state:[]},1).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3}]},4).wait(1));
	...
	this.instance_7.parent = this;
	this.instance_7.setTransform(-6.8,-99);

	this.instance_8 = new lib.db_face("single",2);
	this.instance_8.parent = this;
	this.instance_8.setTransform(-8.8,-99);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_54},{t:this.shape_53},{t:this.shape_52},{t:this.shape_51},{t:this.shape_50}]},8).to({state:[]},1).to({state:[{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6}]},4).wait(1));

	// Layer_12
	this.instance_16 = new lib.db_atL("single",0);
	this.instance_16.parent = this;
	this.instance_16.setTransform(63.7,-111.2);

	this.instance_17 = new lib.db_headlight("single",0);
	this.instance_17.parent = this;
	this.instance_17.setTransform(10.4,-146.4);

	this.instance_18 = new lib.DB_glass("single",0);
	this.instance_18.parent = this;
	this.instance_18.setTransform(2.4,-99.2);
	this.instance_18.alpha = 0.34;

	this.instance_19 = new lib.db_handR("single",0);
	this.instance_19.parent = this;
	this.instance_19.setTransform(-109.5,-108.1,1,1,0,171.2,-8.8,0,-18.8);

	this.instance_20 = new lib.db_armR("single",2);
	this.instance_20.parent = this;
	this.instance_20.setTransform(-49.5,-9.4,1,1,127,0,0,22.8,-28.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_18},{t:this.instance_17},{t:this.instance_16}]}).to({state:[]},1).to({state:[{t:this.instance_20},{t:this.instance_19}]},12).wait(1));

	// Layer 5
	this.instance_21 = new lib.db_headf("single",0);
	this.instance_21.parent = this;
	this.instance_21.setTransform(-3.4,-82);

	this.instance_22 = new lib.db_mon("single",0);
	this.instance_22.parent = this;
	this.instance_22.setTransform(-5.1,-89.7);

	this.instance_23 = new lib.db_face("single",0);
	this.instance_23.parent = this;
	this.instance_23.setTransform(-7.1,-89.7);

	this.instance_24 = new lib.db_atR("single",0);
	this.instance_24.parent = this;
	this.instance_24.setTransform(-52.3,-110.1);

	this.instance_25 = new lib.db_neck("synched",0);
	this.instance_25.parent = this;
	this.instance_25.setTransform(-16.2,-43);

	this.instance_26 = new lib.db_handL("synched",0);
	this.instance_26.parent = this;
	this.instance_26.setTransform(72.5,38.7,1,1,0,0,0,0,-18.5);

	this.instance_27 = new lib.db_armL("synched",0);
	this.instance_27.parent = this;
	this.instance_27.setTransform(53.5,10.7);

	this.instance_28 = new lib.db_body("synched",0);
	this.instance_28.parent = this;
	this.instance_28.setTransform(-11.4,4.4);

	this.instance_29 = new lib.db_j("single",0);
	this.instance_29.parent = this;
	this.instance_29.setTransform(-5.8,64.4);

	this.instance_30 = new lib.db_b("single",0);
	this.instance_30.parent = this;
	this.instance_30.setTransform(-2.6,107.4);

	this.instance_31 = new lib.db_handR("single",0);
	this.instance_31.parent = this;
	this.instance_31.setTransform(-103.4,23.7,1,1,0,0,0,-0.1,-19);

	this.instance_32 = new lib.db_armR("single",0);
	this.instance_32.parent = this;
	this.instance_32.setTransform(-64.4,-30.5,1,1,0,0,0,22.9,-29);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_32},{t:this.instance_31},{t:this.instance_30},{t:this.instance_29},{t:this.instance_28},{t:this.instance_27},{t:this.instance_26},{t:this.instance_25},{t:this.instance_24},{t:this.instance_23},{t:this.instance_22},{t:this.instance_21}]}).to({state:[]},1).wait(13));

	// Layer 2
	this.instance_33 = new lib.db_shadow("single",0);
	this.instance_33.parent = this;
	this.instance_33.setTransform(1.7,207.3);
	this.instance_33.alpha = 0.5;

	this.timeline.addTween(cjs.Tween.get(this.instance_33).to({_off:true},1).wait(7).to({_off:false},0).to({_off:true},1).wait(4).to({_off:false},0).wait(1));
...
(lib.aliencopy = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-72.1,13.8,1,1.003,0,-9,-4.5,21.8,26.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// a_neck
	this.instance_1 = new lib.a_neck("single",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-39,36.9,1,1,-25.2,0,0,14.1,27.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// a_armR
	this.instance_2 = new lib.a_armL("single",3);
	this.instance_2.parent = this;
	this.instance_2.setTransform(7,46.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// key_in_box copy
	this.instance_3 = new lib.key_in_boxcopy("single",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(-152.8,75.8,1.872,1.872,-4.3,0,0,11,10.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

	// a_armL
	this.instance_4 = new lib.a_body("single",3);
	this.instance_4.parent = this;
	this.instance_4.setTransform(8.3,122.7,1,1,0,0,0,9.7,42.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1));

	// a_body
	this.instance_5 = new lib.a_armR("single",5);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-115.1,39.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1));

	// a_leg
	this.instance_6 = new lib.a_leg("single",3);
	this.instance_6.parent = this;
	this.instance_6.setTransform(2.6,145.6,1,1,0,0,0,27.7,6);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1));

	// Layer 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.298)").s().p("AMcQ0QhJgNgmgzQg7hNAoh0QAghZBUhmIgCszQidijjAhrQjIhvjTgjQjdgljZA0QjgA2ioCJQg7AxiwC7QiNCXhtA9QhSAvg3gSQgjgMgOgmQgPgmAagZQBKlBD2i9QD3i+Exi/QEwi/KLAzQDrASCrAxQDWA9CVB1QC4COBgDqQBbDggLD0QgLDlhiDnQhaDVicDDQgxA/gpAlQg3Ayg4AXQguASguAAQgVAAgVgEg");
	this.shape.setTransform(-6,241.4);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-192.1,-42.7,334.9,392.2);
...
(lib.alien = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).wait(1).to({x:-62.5,y:12.5},0).to({_off:true},1).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({_off:false},0).wait(1).to({x:-31.7,y:37.7,startPosition:2},0).to({_off:true},1).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(4).to({_off:false},0).wait(1).to({x:7.2,y:45.1,startPosition:4},0).to({_off:true},1).wait(3));

	// key_in_box copy
	this.instance_3 = new lib.key_in_boxcopy("single",1);
	this.instance_3.parent = this;
	this.instance_3.setTransform(-152.8,75.8,1.872,1.872,-4.3,0,0,11,10.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(4).to({_off:false},0).wait(1).to({startPosition:4},0).to({_off:true},1).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(4).to({_off:false},0).wait(1).to({regX:17.1,regY:19.8,x:-71.4,y:68.7,startPosition:6},0).to({_off:true},1).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(4).to({_off:false},0).wait(1).to({startPosition:3},0).to({_off:true},1).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(4).to({_off:false},0).to({_off:true},2).wait(3));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-56.4,-32.2,190.6,281);
...
(lib.tEn4 = function(mode,startPosition,loop) {
	...
	this.mcCont.setTransform(436.1,390.1,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("We can’t do time travel but I think I\nknow where Mabusa went. Let’s go.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 406;
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(238.2,322);
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(4,1,0,3).p("A+8iwIK0AAIlrFMIMRlMMAsfAAA");
	this.shape.setTransform(238,407.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(1,1,0,3).p("Ae9F6IAArzMg95AAAIAALz");
	this.shape_1.setTransform(238,352.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("AgdilIGlAAIsPFLg");
	this.shape_2.setTransform(112.1,406.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AtiF6ImmAAIq0AAIAArzMA95AAAIAALzg");
	this.shape_3.setTransform(238,352.3);
	...
	// Layer_5
	this.myTxt1 = new cjs.Text("He said he’s going back to the Stone Age.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 460;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(21.8,17.2);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_6
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EgiUADgIAAm6MBEpAAAIAAG6");
	this.shape_4.setTransform(21.7,31.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EAiVgDWItXAAIDdGRIpamRMgxVAAA");
	this.shape_5.setTransform(21.7,75.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("rgba(0,0,0,0.996)").s().p("APBAVMgxVAAAIAAm7MBEpAAAIAAG7ItXAAIDdGRg");
	this.shape_6.setTransform(21.7,51.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-210.4,8.6,464.4,90.3);
...
(lib.tEn3 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(142.4,70,0.35,0.35,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1));

	// Layer_1
	this.myTxt = new cjs.Text("Where did Mabusa go?", "italic bold 20px 'Quantico'", "#0EE0E0");
	...
	this.myTxt.setTransform(-21,32.9);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AZVDkIAAksIAAgqIAAhsMgypAAAIAAHC");
	this.shape.setTransform(-19.7,47.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AZViwMgj2AAAItJFOIGOlOIn4AA");
	this.shape_1.setTransform(-19.7,87.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("AxdA5In2AAIAAnBMAyoAAAIAABsIAAAqIAAErMgj1AAAItKFPg");
	this.shape_2.setTransform(-19.7,64.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tEn3, new cjs.Rectangle(-189,24,356.2,83.6), null);
...
(lib.tEn1 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(431.3,459.3,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("We’ll soon find out what\nthis key will unlock.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	...
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(277.5,389.2);
	this.myTxt2._off = true;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A13MzIAAsKIGbAAIqmtOISTNOMAh5AAAIAAMK");
	this.shape.setTransform(263.8,377.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AYBAAMgwBAAA");
	this.shape_1.setTransform(277.5,459.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("ABcGnIqltOISTNOg");
	this.shape_2.setTransform(155.7,339.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("A4AGFIAAsJIGbAAIHtAAMAh5AAAIAAMJg");
	this.shape_3.setTransform(277.5,420.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_5
	this.myTxt1 = new cjs.Text("Wow! You did it.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 250;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(41.9,11.3);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_6
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A3rDCIAAmtMAmJAAAIAHB6II9FYIo9i2IgHCR");
	this.shape_4.setTransform(71.6,28.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("ATFAAIkhAAIjJAAI+fAA");
	this.shape_5.setTransform(42.1,47.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("rgba(0,0,0,0.996)").s().p("AOqAzIgHCRIkhAAIjJAAI+fAAIAAmtMAmJAAAIAHB7II9FXg");
	this.shape_6.setTransform(71.1,28.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-85.1,3.9,308.9,48.7);
...
(lib.tBm4 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt2 = new cjs.Text("Mustahil kita nak mengembara\nmerentas masa tapi saya rasa saya\ntahu ke mana Mabusa pergi. Ayuh.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 406;
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(238.2,293);
	this.myTxt2._off = true;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,1,0,3).p("Ae9IGIAAwLMg95AAAIAAQL");
	this.shape.setTransform(238,338.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,1,0,3).p("A+8iwIK0AAIlrFMIMRlMMAsfAAA");
	this.shape_1.setTransform(238,407.7);
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AtiIGImmAAIq0AAIAAwKMA95AAAIAAQKg");
	this.shape_3.setTransform(238,338.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_5
	this.myTxt1 = new cjs.Text("Dia kata dia nak kembali ke Zaman Batu.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 450;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(21.8,17.2);
...
p.nominalBounds = new cjs.Rectangle(-205.4,8.6,454.4,90.3);
...
(lib.tBm3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("Ke manakah Mabusa pergi?", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	this.myTxt.lineWidth = 332;
...
}).prototype = getMCSymbolPrototype(lib.tBm3, new cjs.Rectangle(-189,24,356.2,83.6), null);
...
(lib.tBm1 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(467.3,459.3,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("Kita akan tahu apa yang kunci\nini akan buka tak lama lagi.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	...
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(295.1,389.2);
	this.myTxt2._off = true;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("A4rMzIAAsKIGbAAIqmtOISTNOMAnhAAAIAAMK");
	this.shape.setTransform(281.8,377.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("Aa1AAMg1pAAA");
	this.shape_1.setTransform(295.5,459.3);
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("A60GFIAAsJIGbAAIHtAAMAnhAAAIAAMJg");
	this.shape_3.setTransform(295.5,420.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_5
	this.myTxt1 = new cjs.Text("Wah! Awak berjaya.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 250;
...
p.nominalBounds = new cjs.Rectangle(-333.3,-24.6,454.4,89.8);
...
p.nominalBounds = new cjs.Rectangle(-316.9,-9.2,356.2,83.1);
...
p.nominalBounds = new cjs.Rectangle(-170.6,-29.7,308.9,48.5);


// stage content:
(lib.outro15 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{a1:1,a2:224,a3:254});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(3).call(this.frame_4).wait(183).call(this.frame_187).wait(32).call(this.frame_219).wait(5).call(this.frame_224).wait(25).call(this.frame_249).wait(5).call(this.frame_254).wait(81).call(this.frame_335).wait(6));

	// t
	this.instance = new lib.dialogue1();
	this.instance.parent = this;
	this.instance.setTransform(337.8,84.4);

	this.instance_1 = new lib.dialogue3();
	this.instance_1.parent = this;
	this.instance_1.setTransform(719.5,74.8);

	this.instance_2 = new lib.dialogue4();
	this.instance_2.parent = this;
	this.instance_2.setTransform(452.8,73.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},19).to({state:[{t:this.instance_1}]},205).to({state:[{t:this.instance_2}]},30).wait(87));

	// hlBlinkStars
	this.instance_3 = new lib.hlBlinkStars();
	this.instance_3.parent = this;
	this.instance_3.setTransform(38.6,356.2,1,1,0,0,0,0.1,-2.5);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(187).to({_off:false},0).to({_off:true},37).wait(117));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(119).to({_off:false},0).to({_off:true},105).wait(117));

	// Alien
	this.instance_5 = new lib.aliencopy("single",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(667.6,169.1,1.185,1.185,0,0,0,38.6,67.6);

	this.instance_6 = new lib.alien("single",4);
	this.instance_6.parent = this;
	this.instance_6.setTransform(667.6,169.1,1.185,1.185,0,0,0,38.6,67.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5}]}).to({state:[{t:this.instance_6,p:{x:667.6,y:169.1,startPosition:4}}]},139).to({state:[]},85).to({state:[{t:this.instance_6,p:{x:694.6,y:239.5,startPosition:5}}]},30).wait(87));

	// TAPIR_HERO
	this.instance_7 = new lib.TAPIR_HERO("single",30);
	this.instance_7.parent = this;
	this.instance_7.setTransform(175.8,709,0.8,0.8,0,0,0,0.1,404.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(19).to({x:150.3,y:717.5,startPosition:29},0).wait(205).to({scaleX:1.44,scaleY:1.44,x:306.5,y:1186.1,startPosition:4},0).wait(30).to({scaleX:0.8,scaleY:0.8,x:156.3,y:727.5,startPosition:12},0).wait(76).to({startPosition:30},0).wait(11));

	// Digi-Bot
	this.instance_8 = new lib.DigiBot("single",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(296,570.7,0.7,0.7,0,0,180,-2.5,68.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(19).to({x:304.5,y:579.2,startPosition:8},0).to({_off:true},205).wait(30).to({_off:false,x:293.5,y:597.7,startPosition:0},0).wait(76).to({startPosition:13},0).wait(11));

	// Layer_1
	this.instance_9 = new lib.Bitmap6();
	this.instance_9.parent = this;
	this.instance_9.setTransform(-5.1,-2.5);

	this.instance_10 = new lib.Bitmap5();
	this.instance_10.parent = this;
	this.instance_10.setTransform(-6.4,-3.8);

	this.instance_11 = new lib.Bitmap7();
	this.instance_11.parent = this;
	this.instance_11.setTransform(-6.4,-5.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_9}]}).to({state:[{t:this.instance_10}]},224).to({state:[{t:this.instance_11}]},30).wait(87));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(394.9,294.2,809,754.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/outro15/Bitmap10.png?1524787054750", id:"Bitmap10"},
		{src:"images/outro15/Bitmap11.png?1524787054750", id:"Bitmap11"},
		{src:"images/outro15/Bitmap4.png?1524787054750", id:"Bitmap4"},
		{src:"images/outro15/Bitmap5.png?1524787054750", id:"Bitmap5"},
		{src:"images/outro15/Bitmap6.png?1524787054750", id:"Bitmap6"},
		{src:"images/outro15/Bitmap7.png?1524787054750", id:"Bitmap7"},
		{src:"images/outro15/Bitmap7_1.png?1524787054750", id:"Bitmap7_1"},
		{src:"images/outro15/Bitmap8.png?1524787054750", id:"Bitmap8"},
		{src:"sounds/intro.mp3?1524787054750", id:"intro"},
		{src:"sounds/questionComplete.mp3?1524787054750", id:"questionComplete"}
	],
	preloads: []
};
