...
(lib.tEn3 = function(mode,startPosition,loop) {
	...
	// Layer_4
	this.myTxt = new cjs.Text("Rename the image file with the name of the \nobject and upload the file.", "italic bold 16px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.lineHeight = 25;
	this.myTxt.lineWidth = 354;
	this.myTxt.parent = this;
	this.myTxt.setTransform(-234.1,-28.2);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_5
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#0EE0E0").ss(4,0,0,3).p("A9OAAMA6dAAA");
	this.shape.setTransform(-64.6,30.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#0EE0E0").ss(1,0,0,3).p("A73FPIAAj9IikADICkh7IAAkjMA6cAAAIAAKY");
	this.shape_1.setTransform(-73.3,-2.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("A77FMIAAj8IilACIClh6IAAkjMA6cAAAIAAKXg");
	this.shape_2.setTransform(-72.8,-2.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tEn3, new cjs.Rectangle(-269.5,-36.6,394,69.4), null);


(lib.tEn2a = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#0EE0E0").ss(4,0,0,3).p("A7ZAAMA2zAAA");
	this.shape.setTransform(-76.2,52.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#0EE0E0").ss(1,0,0,3).p("A6CG8IAAnWIilACIClh7IAAkjMA2zAAAIAANy");
	this.shape_1.setTransform(-84.9,8.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("A6HG5IAAnVIikACICkh7IAAkjMA2zAAAIAANxg");
	this.shape_2.setTransform(-84.5,8.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tEn2a, new cjs.Rectangle(-269.5,-36.6,370.7,91.2), null);
...
(lib.tEn1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("Your friend has sent you an image \nvia email. Let’s download the image \nto view it.", "italic bold 16px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.lineHeight = 25;
	this.myTxt.lineWidth = 316;
	this.myTxt.parent = this;
	this.myTxt.setTransform(-230.5,-29.6);
	...
	this.shape.setTransform(-86,52.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#0EE0E0").ss(1,0,0,3).p("A4hG8IAAnWIikACICkh7IAAkjMAzwAAAIAANy");
	this.shape_1.setTransform(-94.7,8.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("A4lG5IAAnVIilACIClh7IAAkjMAzwAAAIAANxg");
	this.shape_2.setTransform(-94.2,8.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tEn1, new cjs.Rectangle(-269.5,-36.6,356.5,91.2), null);
...
(lib.tBm3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("Namakan semula fail imej tersebut dengan nama \nobjek dan muat naik fail imej itu.", "italic bold 16px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.lineHeight = 25;
	this.myTxt.lineWidth = 403;
	this.myTxt.parent = this;
	this.myTxt.setTransform(-234.1,-28.2);
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#0EE0E0").ss(4,0,0,3).p("EggvAAAMBBfAAA");
	this.shape.setTransform(-42.1,30.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#0EE0E0").ss(1,0,0,3).p("A/YFPIAAj9IikADICkh7IAAkjMBBeAAAIAAKY");
	this.shape_1.setTransform(-50.8,-2.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("A/cFMIAAj8IilACIClh6IAAkjMBBeAAAIAAKXg");
	this.shape_2.setTransform(-50.3,-2.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tBm3, new cjs.Rectangle(-269.5,-36.6,440.5,69.4), null);


(lib.tBm2a = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.myTxt.parent = this;
	this.myTxt.setTransform(-232,-28.6);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#0EE0E0").ss(4,0,0,3).p("A72AAMAnnAAAIDEAAINCAA");
	this.shape.setTransform(-73.3,52.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#0EE0E0").ss(1,0,0,3).p("A6fG8IAAnWIilACIClh7IAAkjMAnnAAAIDEAAINCAAIAANy");
	this.shape_1.setTransform(-82,8.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AQHG5IjEAAMgnnAAAIAAnVIilACIClh7IAAkjMAnnAAAIDEAAINDAAIAANxg");
	this.shape_2.setTransform(-81.5,8.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tBm2a, new cjs.Rectangle(-269.5,-36.6,376.5,91.2), null);
...
(lib.tBm1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("Kawan anda telah menghantar sekeping\ngambar kepada anda melalui e-mel. \nMari muat turun imej tersebut.", "italic bold 16px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.lineHeight = 25;
	this.myTxt.lineWidth = 349;
	this.myTxt.parent = this;
	this.myTxt.setTransform(-231,-28.6);
	...
	this.shape.setTransform(-68.9,52.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#0EE0E0").ss(1,0,0,3).p("A7MG8IAAnWIikACICkh7IAAkjMA5GAAAIAANy");
	this.shape_1.setTransform(-77.6,8.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("A7QG5IAAnVIilACIClh7IAAkjMA5GAAAIAANxg");
	this.shape_2.setTransform(-77.1,8.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tBm1, new cjs.Rectangle(-269.5,-36.6,389.5,91.2), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-88.5,-167.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-88.5,-167.3,177,236);
...
(lib.picIcon = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_3
	this.instance = new lib.Bitmap30();
	this.instance.parent = this;
	this.instance.setTransform(-114.3,-104.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-114.3,-104.9,221,221);


(lib.mcTxtInstrcopy = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_4.setTransform(-75.3,14.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgGA5IAAhPIAMAAIAABPgAgHgqIAAgOIAPAAIAAAOg");
	this.shape_5.setTransform(-85.3,12.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgUA2QgIgFgEgKQgFgJAAgNQAAgMAFgJQAEgJAIgFQAIgFALAAQAIAAAHAEQAIAEADAHIAAgyIANAAIAAB0IgNAAIAAgOQgDAHgIAEQgHAEgIAAQgLAAgIgFgAgRgEQgGAHAAAOQAAAPAGAIQAGAJAMAAQALAAAHgIQAGgJAAgOQAAgPgGgHQgHgIgLAAQgMAAgGAIg");
	this.shape_6.setTransform(-92.2,12.6);
	...
	this.shape_7.setTransform(-106,14.4);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgFA7IAAh1IALAAIAAB1g");
	this.shape_8.setTransform(-112.5,12.6);
	...
	this.shape_9.setTransform(-119,14.5);
	...
	this.shape_10.setTransform(-130.7,14.3);
	...
	this.shape_11.setTransform(-142,14.4);
	...
	this.shape_12.setTransform(-150.4,14.4);
	...
	this.shape_13.setTransform(145.5,-9.6);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgUAlQgIgFgEgKQgFgJAAgNQAAgLAFgKQAEgJAIgFQAIgGALAAQAIAAAHAFQAHAEAEAHIAAgOIANAAIAABQIgNAAIAAgPQgEAIgHAEQgHAEgIAAQgLAAgIgFgAgRgWQgHAJABANQgBAPAHAIQAHAIAKAAQAMAAAGgIQAHgIAAgPQAAgOgHgIQgGgIgMAAQgKAAgHAIg");
	this.shape_14.setTransform(135.8,-9.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AATA7IgognIAAAnIgNAAIAAh1IANAAIAABJIAkgkIARAAIgnAmIAqAqg");
	this.shape_15.setTransform(127.8,-11.3);
	...
	this.shape_16.setTransform(118,-9.5);
	...
	this.shape_17.setTransform(106.3,-9.6);
	...
	this.shape_18.setTransform(94.3,-9.5);
	...
	this.shape_19.setTransform(85,-9.6);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AgGA5IAAhPIAMAAIAABPgAgHgqIAAgOIAPAAIAAAOg");
	this.shape_20.setTransform(78.5,-11.2);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgUA2QgIgFgEgKQgFgJAAgNQAAgMAFgJQAEgJAIgFQAIgFALAAQAIAAAHAEQAIAEADAHIAAgyIANAAIAAB0IgNAAIAAgOQgDAHgIAEQgHAEgIAAQgLAAgIgFgAgRgEQgGAHAAAOQAAAPAGAIQAGAJAMAAQALAAAHgIQAGgJAAgOQAAgPgGgHQgHgIgLAAQgMAAgGAIg");
	this.shape_21.setTransform(71.6,-11.3);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AAVA7IAAgyQAAgKgEgGQgEgFgKAAQgKAAgHAHQgGAGgBAMIAAAuIgMAAIAAh1IAMAAIAAAyQAFgHAGgEQAIgEAHAAQAdAAAAAfIAAAzg");
	this.shape_22.setTransform(58.2,-11.3);
	...
	this.shape_23.setTransform(48.4,-9.5);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFFFF").s().p("AgFA7IAAh1IALAAIAAB1g");
	this.shape_24.setTransform(42,-11.3);
	...
	this.shape_25.setTransform(35.7,-9.5);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("AgDAvQgGgGAAgNIAAgsIgQAAIAAgLIAQAAIAAgVIAMgEIAAAZIAXAAIAAALIgXAAIAAArQAAAIADAEQAEAEAHgBQAEAAAEgBIAAALQgEACgHAAQgLAAgGgHg");
	this.shape_26.setTransform(28.5,-10.7);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("");
	this.shape_27.setTransform(16.5,-7.8);
	...
	this.shape_28.setTransform(7.2,-9.6);
	...
	this.shape_29.setTransform(-2.5,-9.5);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#FFFFFF").s().p("AgjAxQALgEAGgEQAGgEAEgIIACgIIgihPIAOAAIAaBCIAbhCIANAAIglBYQgFANgJAGQgJAHgNACg");
	this.shape_30.setTransform(-11.3,-7.6);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#FFFFFF").s().p("AgRBKIAAgMIAIACQAMAAAAgQIAAhYIAOAAIAABZQAAANgHAHQgGAGgKAAIgLgBgAACg7IAAgPIAQAAIAAAPg");
	this.shape_31.setTransform(-22.6,-9.4);
	...
	this.shape_32.setTransform(-27.9,-9.5);
	...
	this.shape_33.setTransform(-39.3,-9.6);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#FFFFFF").s().p("AgGA5IAAhPIAMAAIAABPgAgHgqIAAgOIAPAAIAAAOg");
	this.shape_34.setTransform(-48.2,-11.2);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#FFFFFF").s().p("AgGA7IAAh1IANAAIAAB1g");
	this.shape_35.setTransform(-56.2,-11.3);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#FFFFFF").s().p("AgGA5IAAhPIAMAAIAABPgAgHgqIAAgOIAPAAIAAAOg");
	this.shape_36.setTransform(-60,-11.2);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#FFFFFF").s().p("AgUAlQgIgFgEgKQgFgJAAgNQAAgLAFgKQAEgJAIgFQAIgGALAAQAJAAAGAFQAIAEADAHIAAgOIANAAIAABQIgNAAIAAgPQgDAIgIAEQgGAEgJAAQgLAAgIgFgAgRgWQgGAJAAANQAAAPAGAIQAHAIALAAQALAAAHgIQAGgIAAgPQAAgOgGgIQgHgIgLAAQgLAAgHAIg");
	this.shape_37.setTransform(-66.9,-9.5);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#FFFFFF").s().p("AgIA7IAAhFIgQAAIAAgKIAQAAIAAgNQAAgMAGgHQAFgGAMAAQAFAAAFABIAAALIgIgBQgGAAgEAEQgDADAAAJIAAALIATAAIAAAKIgTAAIAABFg");
	this.shape_38.setTransform(-74.3,-11.4);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#FFFFFF").s().p("AASA7IgngnIAAAnIgOAAIAAh1IAOAAIAABJIAlgkIAQAAIgoAmIArAqg");
	this.shape_39.setTransform(-84.5,-11.3);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#FFFFFF").s().p("AgGA5IAAhPIAMAAIAABPgAgHgqIAAgOIAPAAIAAAOg");
	this.shape_40.setTransform(-91.2,-11.2);
	...
	this.shape_41.setTransform(-98.2,-9.5);
	...
	this.shape_42.setTransform(-107.5,-9.6);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#FFFFFF").s().p("AgCAvQgHgGAAgNIAAgsIgQAAIAAgLIAQAAIAAgVIAMgEIAAAZIAXAAIAAALIgXAAIAAArQAAAIAEAEQADAEAHgBQAFAAAEgBIAAALQgFACgGAAQgMAAgFgHg");
	this.shape_43.setTransform(-119.2,-10.7);
	...
	this.shape_44.setTransform(-126.9,-9.5);
	...
	this.shape_45.setTransform(-136.1,-9.4);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("#FFFFFF").s().p("AAqA5IAAhTIglBTIgIAAIgmhTIAABTIgMAAIAAhxIALAAIAqBhIArhhIALAAIAABxg");
	this.shape_46.setTransform(-147.5,-11.1);
	...
	this.shape_47.setTransform(-62.9,14.3);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f("#FFFFFF").s().p("AAWA7IAAgyQgBgKgEgGQgEgFgKAAQgKAAgHAHQgGAGgBAMIAAAuIgMAAIAAh1IAMAAIAAAyQAEgHAHgEQAHgEAIAAQAdAAAAAfIAAAzg");
	this.shape_48.setTransform(-79.6,12.6);
	...
	this.shape_49.setTransform(-144.2,14.4);
	...
	this.shape_50.setTransform(-150.9,14.3);
	...
	this.shape_51.setTransform(95.2,-9.5);
	...
	this.shape_52.setTransform(86.5,-9.5);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#FFFFFF").s().p("AgNA3QgIgEgDgIIAAAPIgNAAIAAh0IANAAIAAAzQADgIAIgEQAGgEAJAAQAKAAAJAFQAIAFAFAJQAEAJAAAMQAAANgEAJQgFAKgIAFQgJAFgKAAQgJAAgGgEgAgSgEQgGAHAAAPQAAAOAGAJQAHAIALAAQALAAAHgJQAGgIABgPQgBgOgGgHQgHgIgLAAQgLAAgHAIg");
	this.shape_53.setTransform(77.6,-11.3);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#FFFFFF").s().p("AAVA7IAAgyQAAgKgEgGQgFgFgJAAQgKAAgHAHQgHAGAAAMIAAAuIgMAAIAAh1IAMAAIAAAyQAFgHAHgEQAHgEAHAAQAdAAABAfIAAAzg");
	this.shape_54.setTransform(46.1,-11.3);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#FFFFFF").s().p("AgUAlQgIgFgEgKQgFgJAAgNQAAgLAFgKQAEgJAIgFQAIgGALAAQAIAAAHAFQAIAEADAHIAAgOIANAAIAABQIgNAAIAAgPQgDAIgIAEQgHAEgIAAQgLAAgIgFgAgRgWQgGAJAAANQAAAPAGAIQAGAIAMAAQALAAAHgIQAGgIAAgPQAAgOgGgIQgHgIgLAAQgMAAgGAIg");
	this.shape_55.setTransform(26.6,-9.5);
	...
	this.shape_56.setTransform(17.4,-11.3);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#FFFFFF").s().p("AgDAvQgGgGAAgNIAAgsIgQAAIAAgLIAQAAIAAgVIAMgEIAAAZIAXAAIAAALIgXAAIAAArQAAAIAEAEQADAEAHgBQAFAAAEgBIAAALQgGACgGAAQgLAAgGgHg");
	this.shape_57.setTransform(9.8,-10.7);
	...
	this.shape_58.setTransform(-1.5,-9.5);
	...
	this.shape_59.setTransform(-27.4,-9.5);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#FFFFFF").s().p("AgYAfQgLgLAAgUQAAgLAFgKQAFgJAIgFQAJgGAKAAQAQAAAJALQAJAKAAATIAAABIg6AAQAAAPAHAIQAHAIAMAAQAPAAALgJIAFAJQgGAFgIADQgIADgJAAQgSAAgKgLgAgNgYQgHAGgBALIAtAAQgBgMgFgGQgGgGgKAAQgJAAgGAHg");
	this.shape_60.setTransform(-77.4,-9.5);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#FFFFFF").s().p("AAWA7IAAgyQgBgKgEgGQgEgFgKAAQgKAAgHAHQgGAGgBAMIAAAuIgMAAIAAh1IAMAAIAAAyQAEgHAHgEQAHgEAIAAQAdAAAAAfIAAAzg");
	this.shape_61.setTransform(-86.4,-11.3);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#FFFFFF").s().p("AgUA2QgIgFgEgKQgFgJAAgNQAAgMAFgJQAEgJAIgFQAJgFAKAAQAIAAAIAEQAGAEAEAHIAAgyIANAAIAAB0IgNAAIAAgOQgEAHgGAEQgIAEgIAAQgKAAgJgFgAgRgEQgHAHABAOQgBAPAHAIQAGAJALAAQAMAAAGgIQAHgJAAgOQAAgPgHgHQgGgIgMAAQgLAAgGAIg");
	this.shape_62.setTransform(-105.9,-11.3);
	...
	this.shape_63.setTransform(-124.7,-9.5);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#FFFFFF").s().p("AgkA7IAAhcQAAgMgCgLIANAAIABAQQADgIAIgFQAHgFAJABQAKgBAJAGQAIAFAEAJQAFAKAAAMQAAANgFAJQgEAJgIAFQgIAFgLAAQgJAAgHgEQgHgEgDgIIAAAygAgRgmQgGAHAAAPQAAAPAGAHQAGAJALAAQAMAAAHgJQAGgGAAgQQAAgOgGgIQgHgJgMAAQgLAAgGAJg");
	this.shape_64.setTransform(-137.7,-7.8);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#FFFFFF").s().p("AghAuQgLgMAAgWIAAhFIANAAIAABGQAAAQAIAJQAIAIAPAAQAQAAAIgIQAIgJAAgQIAAhGIANAAIAABFQAAAWgMAMQgLAMgWAAQgWAAgLgMg");
	this.shape_65.setTransform(-148.5,-11.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_46},{t:this.shape_45},{t:this.shape_44,p:{x:-126.9}},{t:this.shape_43,p:{x:-119.2}},{t:this.shape_42},{t:this.shape_41},{t:this.shape_40},{t:this.shape_39},{t:this.shape_38,p:{x:-74.3}},{t:this.shape_37,p:{x:-66.9}},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32,p:{x:-27.9,y:-9.5}},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27,p:{x:16.5}},{t:this.shape_26,p:{x:28.5}},{t:this.shape_25,p:{x:35.7,y:-9.5}},{t:this.shape_24,p:{x:42}},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17,p:{x:106.3}},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14,p:{x:135.8}},{t:this.shape_13,p:{x:145.5}},{t:this.shape_12},{t:this.shape_11,p:{x:-142}},{t:this.shape_10,p:{x:-130.7}},{t:this.shape_9},{t:this.shape_8,p:{x:-112.5,y:12.6}},{t:this.shape_7,p:{x:-106}},{t:this.shape_6,p:{x:-92.2}},{t:this.shape_5},{t:this.shape_4,p:{x:-75.3,y:14.4}},{t:this.shape_3,p:{x:-69.3,y:12.7}},{t:this.shape_2,p:{x:-62.8}},{t:this.shape_1,p:{x:-56.2,y:12.7}},{t:this.shape,p:{x:-52.5}}]}).to({state:[{t:this.shape_65},{t:this.shape_64},{t:this.shape_24,p:{x:-131.1}},{t:this.shape_63},{t:this.shape_37,p:{x:-115.5}},{t:this.shape_62},{t:this.shape_43,p:{x:-94}},{t:this.shape_61},{t:this.shape_60},{t:this.shape_3,p:{x:-66.9,y:-11.2}},{t:this.shape_17,p:{x:-58.1}},{t:this.shape_14,p:{x:-46.4}},{t:this.shape_27,p:{x:-36.8}},{t:this.shape_59},{t:this.shape_38,p:{x:-16.2}},{t:this.shape_1,p:{x:-11.5,y:-11.2}},{t:this.shape_8,p:{x:-7.7,y:-11.3}},{t:this.shape_58},{t:this.shape_57},{t:this.shape_56},{t:this.shape_55},{t:this.shape_26,p:{x:34.3}},{t:this.shape_54},{t:this.shape_44,p:{x:55.3}},{t:this.shape_4,p:{x:64.3,y:-9.5}},{t:this.shape_53},{t:this.shape_52},{t:this.shape_51},{t:this.shape_13,p:{x:104.1}},{t:this.shape_50},{t:this.shape_49},{t:this.shape_2,p:{x:-135.2}},{t:this.shape_7,p:{x:-125.9}},{t:this.shape_10,p:{x:-113.9}},{t:this.shape_32,p:{x:-102.5,y:14.4}},{t:this.shape_6,p:{x:-93.6}},{t:this.shape_48},{t:this.shape_25,p:{x:-70.6,y:14.4}},{t:this.shape_47},{t:this.shape_11,p:{x:-56.1}},{t:this.shape,p:{x:-50}}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-156.3,-24.9,312.8,49.8);


(lib.mcTxtInstr = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgHAIIAAgPIAPAAIAAAPg");
	this.shape.setTransform(3.7,17.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgDAvQgGgHAAgMIAAgtIgQAAIAAgKIAQAAIAAgUIAMgGIAAAaIAXAAIAAAKIgXAAIAAArQAAAJADAEQAEADAHABQAEgBAEgBIAAALQgFACgGgBQgLAAgGgGg");
	this.shape_1.setTransform(-1,13.2);
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgOA3QgGgEgEgIIAAAPIgNAAIAAh0IANAAIAAAzQAEgIAGgEQAIgEAIAAQALAAAIAFQAIAFAFAJQAEAJAAAMQAAANgEAJQgFAKgIAFQgIAFgLAAQgIAAgIgEgAgSgEQgGAHAAAPQAAAOAGAJQAGAIAMAAQALAAAHgJQAGgIABgPQgBgOgGgHQgHgIgLAAQgMAAgGAIg");
	this.shape_3.setTransform(-17.5,12.6);
	...
	this.shape_4.setTransform(-26.9,14.4);
	...
	this.shape_5.setTransform(-35.3,14.4);
	...
	this.shape_6.setTransform(-41.6,14.3);
	...
	this.shape_7.setTransform(-49.3,14.4);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgDAvQgGgHAAgMIAAgtIgQAAIAAgKIAQAAIAAgUIAMgGIAAAaIAXAAIAAAKIgXAAIAAArQAAAJADAEQAEADAHABQAEgBAEgBIAAALQgEACgHgBQgLAAgGgGg");
	this.shape_8.setTransform(-56.6,13.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgRBKIAAgMIAIACQAMAAAAgQIAAhYIAOAAIAABZQAAANgHAHQgGAGgKAAIgLgBgAACg7IAAgPIAQAAIAAAPg");
	this.shape_9.setTransform(-66.4,14.5);
	...
	this.shape_10.setTransform(-71.6,14.4);
	...
	this.shape_13.setTransform(-105.1,14.3);
	...
	this.shape_14.setTransform(-117.1,14.4);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgGA7IAAh1IANAAIAAB1g");
	this.shape_15.setTransform(-123.6,12.6);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AgUAlQgIgFgFgKQgEgJAAgNQAAgLAEgKQAFgJAIgFQAIgGALAAQAIAAAIAFQAGAEAEAHIAAgOIANAAIAABQIgNAAIAAgPQgEAIgGAEQgIAEgIAAQgLAAgIgFgAgRgWQgGAJgBANQABAPAGAIQAHAIAKAAQAMAAAGgIQAHgIAAgPQAAgOgHgIQgGgIgMAAQgKAAgHAIg");
	this.shape_16.setTransform(-130.5,14.4);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AgUA2QgIgFgEgKQgFgJAAgNQAAgMAFgJQAEgJAIgFQAJgFAKAAQAIAAAIAEQAGAEAEAHIAAgyIANAAIAAB0IgNAAIAAgOQgEAHgGAEQgIAEgIAAQgKAAgJgFgAgRgEQgHAHABAOQgBAPAHAIQAGAJALAAQAMAAAGgIQAHgJAAgOQAAgPgHgHQgGgIgMAAQgLAAgGAIg");
	this.shape_17.setTransform(-140.1,12.6);
	...
	this.shape_18.setTransform(132.5,-9.6);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgUAlQgIgFgEgKQgFgJAAgNQAAgLAFgKQAEgJAIgFQAIgGALAAQAIAAAHAFQAIAEADAHIAAgOIANAAIAABQIgNAAIAAgPQgDAIgIAEQgHAEgIAAQgLAAgIgFgAgRgWQgGAJAAANQAAAPAGAIQAGAIAMAAQALAAAHgIQAGgIAAgPQAAgOgGgIQgHgIgLAAQgMAAgGAIg");
	this.shape_19.setTransform(122.9,-9.5);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AATA7IgpgnIAAAnIgMAAIAAh1IAMAAIAABJIAlgkIARAAIgnAmIArAqg");
	this.shape_20.setTransform(114.9,-11.3);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AASA7IgognIAAAnIgNAAIAAh1IANAAIAABJIAmgkIAQAAIgnAmIArAqg");
	this.shape_21.setTransform(106.6,-11.3);
	...
	this.shape_22.setTransform(97.2,-9.4);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFFFF").s().p("AgRBKIAAgMIAIACQAMAAAAgQIAAhYIANAAIAABZQABANgHAHQgGAGgKAAIgLgBgAACg7IAAgPIAQAAIAAAPg");
	this.shape_23.setTransform(89.7,-9.4);
	...
	this.shape_24.setTransform(84,-9.6);
	...
	this.shape_25.setTransform(74.8,-9.4);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("AgDAvQgGgGAAgNIAAgsIgQAAIAAgLIAQAAIAAgVIAMgEIAAAZIAXAAIAAALIgXAAIAAArQAAAIADAEQAEAEAHgBQAEAAAFgBIAAALQgGACgGAAQgLAAgGgHg");
	this.shape_26.setTransform(67.3,-10.7);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("AgGA5IAAhPIAMAAIAABPgAgHgqIAAgOIAPAAIAAAOg");
	this.shape_27.setTransform(62.7,-11.2);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#FFFFFF").s().p("AgUA2QgIgFgEgKQgFgJAAgNQAAgMAFgJQAEgJAIgFQAIgFALAAQAIAAAHAEQAHAEAEAHIAAgyIANAAIAAB0IgNAAIAAgOQgEAHgHAEQgHAEgIAAQgLAAgIgFgAgRgEQgHAHABAOQgBAPAHAIQAHAJAKAAQAMAAAGgIQAHgJAAgOQAAgPgHgHQgGgIgMAAQgKAAgHAIg");
	this.shape_28.setTransform(55.7,-11.3);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFFFFF").s().p("");
	this.shape_29.setTransform(41.9,-7.8);
	...
	this.shape_30.setTransform(32.6,-9.6);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#FFFFFF").s().p("AgUAlQgIgFgFgKQgEgJAAgNQAAgLAEgKQAFgJAIgFQAIgGALAAQAIAAAIAFQAGAEAEAHIAAgOIANAAIAABQIgNAAIAAgPQgEAIgGAEQgIAEgIAAQgLAAgIgFgAgRgWQgGAJgBANQABAPAGAIQAHAIAKAAQAMAAAHgIQAGgIAAgPQAAgOgGgIQgHgIgMAAQgKAAgHAIg");
	this.shape_31.setTransform(22.9,-9.5);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#FFFFFF").s().p("AgkAxQAMgEAFgEQAGgEAEgIIADgIIghhPIANAAIAaBCIAbhCIAOAAIgmBYQgFANgJAGQgIAHgOACg");
	this.shape_32.setTransform(14.1,-7.6);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#FFFFFF").s().p("AASA7IgognIAAAnIgNAAIAAh1IANAAIAABJIAmgkIAQAAIgnAmIArAqg");
	this.shape_33.setTransform(2.2,-11.3);
	...
	this.shape_34.setTransform(-6.9,-9.5);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#FFFFFF").s().p("AgRBKIAAgMIAIACQAMAAAAgQIAAhYIAOAAIAABZQAAANgHAHQgGAGgKAAIgLgBgAACg7IAAgPIAQAAIAAAPg");
	this.shape_35.setTransform(-14.2,-9.4);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#FFFFFF").s().p("AgNA3QgIgEgDgIIAAAPIgNAAIAAh0IANAAIAAAzQADgIAIgEQAGgEAJAAQAKAAAJAFQAIAFAFAJQAEAJAAAMQAAANgEAJQgFAKgIAFQgJAFgKAAQgJAAgGgEgAgSgEQgGAHAAAPQAAAOAGAJQAHAIALAAQALAAAHgJQAGgIABgPQgBgOgGgHQgHgIgLAAQgLAAgHAIg");
	this.shape_36.setTransform(-19.6,-11.3);
	...
	this.shape_37.setTransform(-29.3,-9.5);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#FFFFFF").s().p("AgUAlQgIgFgEgKQgFgJAAgNQAAgLAFgKQAEgJAIgFQAIgGALAAQAJAAAGAFQAIAEADAHIAAgOIANAAIAABQIgNAAIAAgPQgDAIgIAEQgGAEgJAAQgLAAgIgFgAgRgWQgGAJAAANQAAAPAGAIQAHAIALAAQALAAAHgIQAGgIAAgPQAAgOgGgIQgHgIgLAAQgLAAgHAIg");
	this.shape_38.setTransform(-43.1,-9.5);
	...
	this.shape_39.setTransform(-54.7,-9.6);
	...
	this.shape_40.setTransform(-66.7,-9.5);
	...
	this.shape_41.setTransform(-76,-9.6);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("#FFFFFF").s().p("AAWApIAAgxQAAgLgEgFQgFgFgJAAQgKAAgHAHQgHAHAAALIAAAtIgNAAIAAg5QAAgMgBgKIAMAAIACAOQADgIAIgEQAHgEAIAAQAdAAAAAgIAAAxg");
	this.shape_42.setTransform(-89.6,-9.6);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#FFFFFF").s().p("AgUAlQgIgFgFgKQgEgJAAgNQAAgLAEgKQAFgJAIgFQAJgGAKAAQAJAAAGAFQAIAEADAHIAAgOIANAAIAABQIgNAAIAAgPQgDAIgIAEQgGAEgJAAQgLAAgIgFgAgRgWQgGAJgBANQABAPAGAIQAHAIALAAQALAAAHgIQAGgIAAgPQAAgOgGgIQgHgIgLAAQgLAAgHAIg");
	this.shape_43.setTransform(-99.2,-9.5);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("#FFFFFF").s().p("AATA7IgpgnIAAAnIgMAAIAAh1IAMAAIAABJIAmgkIAQAAIgnAmIArAqg");
	this.shape_44.setTransform(-107.2,-11.3);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f("#FFFFFF").s().p("AgkA7IAAhcQAAgMgCgLIANAAIABAQQADgIAIgFQAHgFAJABQAKgBAJAGQAIAFAEAJQAFAKAAAMQAAANgFAJQgEAJgIAFQgIAFgLAAQgJAAgHgEQgHgEgDgIIAAAygAgRgmQgGAHAAAPQAAAPAGAHQAGAJALAAQAMAAAHgJQAGgGAAgQQAAgOgGgIQgHgJgMAAQgLAAgGAJg");
	this.shape_45.setTransform(-116.7,-7.8);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("#FFFFFF").s().p("AgGA5IAAhPIAMAAIAABPgAgHgqIAAgOIAPAAIAAAOg");
	this.shape_46.setTransform(-123.5,-11.2);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f("#FFFFFF").s().p("AgUAlQgIgFgEgKQgFgJAAgNQAAgLAFgKQAEgJAIgFQAIgGALAAQAIAAAHAFQAIAEADAHIAAgOIANAAIAABQIgNAAIAAgPQgDAIgIAEQgHAEgIAAQgLAAgIgFgAgRgWQgGAJAAANQAAAPAGAIQAGAIAMAAQALAAAHgIQAGgIAAgPQAAgOgGgIQgHgIgLAAQgMAAgGAIg");
	this.shape_47.setTransform(-130.5,-9.5);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f("#FFFFFF").s().p("AgGA5IAAhlIgnAAIAAgMIBbAAIAAAMIgnAAIAABlg");
	this.shape_48.setTransform(-139.9,-11.1);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#FFFFFF").s().p("");
	this.shape_49.setTransform(-67.5,16.1);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#FFFFFF").s().p("AAVA7IAAgyQABgKgFgGQgFgFgJAAQgKAAgHAHQgHAGABAMIAAAuIgOAAIAAh1IAOAAIAAAyQADgHAIgEQAGgEAJAAQAdAAAAAfIAAAzg");
	this.shape_50.setTransform(-117,12.6);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#FFFFFF").s().p("AAXAoIgXg+IgWA+IgNAAIgdhPIAOAAIAWBAIAYhAIAKAAIAYBAIAWhAIANAAIgeBPg");
	this.shape_51.setTransform(106.9,-9.5);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#FFFFFF").s().p("AAVA7IAAgyQAAgKgEgGQgFgFgJAAQgKAAgHAHQgHAGAAAMIAAAuIgMAAIAAh1IAMAAIAAAyQAFgHAHgEQAHgEAHAAQAdAAABAfIAAAzg");
	this.shape_52.setTransform(86.2,-11.3);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#FFFFFF").s().p("AgCAvQgHgGAAgNIAAgsIgQAAIAAgLIAQAAIAAgVIAMgEIAAAZIAXAAIAAALIgXAAIAAArQAAAIADAEQAEAEAHgBQAFAAADgBIAAALQgFACgFAAQgMAAgFgHg");
	this.shape_53.setTransform(66.4,-10.7);
	...
	this.shape_54.setTransform(59.9,-9.5);
	...
	this.shape_55.setTransform(29.1,-9.5);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#FFFFFF").s().p("AAWA7IAAgyQAAgKgFgGQgFgFgJAAQgKAAgHAHQgGAGAAAMIAAAuIgOAAIAAh1IAOAAIAAAyQAEgHAGgEQAIgEAIAAQAcAAAAAfIAAAzg");
	this.shape_56.setTransform(7,-11.3);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#FFFFFF").s().p("AgDAvQgGgGAAgNIAAgsIgQAAIAAgLIAQAAIAAgVIAMgEIAAAZIAXAAIAAALIgXAAIAAArQAAAIAEAEQADAEAHgBQAFAAAEgBIAAALQgGACgGAAQgLAAgGgHg");
	this.shape_57.setTransform(-0.6,-10.7);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#FFFFFF").s().p("AgIA7IAAhFIgQAAIAAgKIAQAAIAAgNQAAgMAGgHQAFgGAMAAQAFAAAFABIAAALIgIgBQgGAAgEAEQgDADAAAJIAAALIATAAIAAAKIgTAAIAABFg");
	this.shape_58.setTransform(-10.3,-11.4);
	...
	this.shape_59.setTransform(-17.5,-9.5);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#FFFFFF").s().p("AgYAfQgLgLAAgUQAAgLAFgKQAFgJAIgFQAJgGAKAAQAQAAAJALQAJAKAAATIAAABIg6AAQAAAPAHAIQAHAIAMAAQAPAAALgJIAFAJQgGAFgIADQgIADgJAAQgSAAgKgLgAgNgYQgHAGgBALIAtAAQgBgMgFgGQgGgGgKAAQgJAAgGAHg");
	this.shape_60.setTransform(-30.6,-9.5);
	...
	this.shape_61.setTransform(-76.5,-9.5);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#FFFFFF").s().p("AAWA7IAAgyQgBgKgEgGQgEgFgKAAQgKAAgHAHQgGAGgBAMIAAAuIgMAAIAAh1IAMAAIAAAyQAEgHAHgEQAHgEAIAAQAdAAAAAfIAAAzg");
	this.shape_62.setTransform(-85.5,-11.3);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#FFFFFF").s().p("AgCAvQgHgGAAgNIAAgsIgQAAIAAgLIAQAAIAAgVIAMgEIAAAZIAXAAIAAALIgXAAIAAArQAAAIAEAEQADAEAHgBQAFAAAEgBIAAALQgFACgGAAQgMAAgFgHg");
	this.shape_63.setTransform(-93.1,-10.7);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#FFFFFF").s().p("AgkAxQAMgEAFgEQAHgEADgIIAEgIIgihPIANAAIAaBCIAbhCIAOAAIgmBYQgFANgJAGQgJAHgNACg");
	this.shape_64.setTransform(-121.6,-7.6);
	...
	this.shape_65.setTransform(-130.2,-9.5);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#FFFFFF").s().p("AAcA5Ig7g2IAAA2IgMAAIAAhxIAMAAIAAA0IA3g0IARAAIg6A3IA+A6g");
	this.shape_66.setTransform(-138.8,-11.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_48},{t:this.shape_47},{t:this.shape_46,p:{x:-123.5}},{t:this.shape_45},{t:this.shape_44},{t:this.shape_43},{t:this.shape_42},{t:this.shape_41,p:{x:-76}},{t:this.shape_40},{t:this.shape_39},{t:this.shape_38},{t:this.shape_37,p:{x:-29.3}},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34,p:{x:-6.9}},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30,p:{x:32.6}},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27,p:{x:62.7,y:-11.2}},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24,p:{x:84}},{t:this.shape_23,p:{x:89.7}},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18,p:{x:132.5,y:-9.6}},{t:this.shape_17},{t:this.shape_16,p:{x:-130.5,y:14.4}},{t:this.shape_15},{t:this.shape_14,p:{x:-117.1}},{t:this.shape_13,p:{x:-105.1,y:14.3}},{t:this.shape_12,p:{x:-91.9}},{t:this.shape_11,p:{x:-83.1}},{t:this.shape_10,p:{x:-71.6,y:14.4}},{t:this.shape_9},{t:this.shape_8,p:{x:-56.6}},{t:this.shape_7,p:{x:-49.3}},{t:this.shape_6},{t:this.shape_5,p:{x:-35.3,y:14.4}},{t:this.shape_4,p:{x:-26.9}},{t:this.shape_3,p:{x:-17.5,y:12.6}},{t:this.shape_2},{t:this.shape_1},{t:this.shape,p:{x:3.7}}]}).to({state:[{t:this.shape_66},{t:this.shape_65},{t:this.shape_64},{t:this.shape_46,p:{x:-111.2}},{t:this.shape_41,p:{x:-104.7}},{t:this.shape_63},{t:this.shape_62},{t:this.shape_61},{t:this.shape_30,p:{x:-63.3}},{t:this.shape_16,p:{x:-54,y:-9.5}},{t:this.shape_13,p:{x:-42,y:-9.6}},{t:this.shape_60},{t:this.shape_59},{t:this.shape_58},{t:this.shape_57},{t:this.shape_56},{t:this.shape_34,p:{x:16}},{t:this.shape_55},{t:this.shape_3,p:{x:38.8,y:-11.3}},{t:this.shape_23,p:{x:44.2}},{t:this.shape_10,p:{x:51.5,y:-9.5}},{t:this.shape_54},{t:this.shape_53},{t:this.shape_5,p:{x:77.4,y:-9.5}},{t:this.shape_52},{t:this.shape_37,p:{x:95.4}},{t:this.shape_51},{t:this.shape_24,p:{x:118.5}},{t:this.shape_27,p:{x:-142.8,y:12.7}},{t:this.shape_18,p:{x:-136.3,y:14.3}},{t:this.shape_8,p:{x:-124.6}},{t:this.shape_50},{t:this.shape_7,p:{x:-108}},{t:this.shape_12,p:{x:-97.6}},{t:this.shape_11,p:{x:-88.7}},{t:this.shape_14,p:{x:-77.1}},{t:this.shape_49},{t:this.shape_4,p:{x:-58}},{t:this.shape,p:{x:-51.9}}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-146.7,-24.9,293.4,49.8);
...
(lib.bgQ = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(-257.9,-42.8,440.5,68.9);


(lib.dialogue2a = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Layer_1
	this.instance = new lib.tBm2a();
	this.instance.parent = this;
	this.instance.setTransform(11.6,-6.7);

	this.instance_1 = new lib.tEn2a();
	this.instance_1.parent = this;
	this.instance_1.setTransform(11.6,-6.7);
...
p.nominalBounds = new cjs.Rectangle(-257.9,-42.8,376.5,90.7);
...
p.nominalBounds = new cjs.Rectangle(-257.9,-42.8,389.5,90.7);
...
(lib.btnHorizontal4 = function(mode,startPosition,loop) {
	...
	// Layer_6
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAPBJIgFgIIgOAIIgZAAIgXgNIAIhKIAagNIAZAAIAMAIIAHg1IAbAAIgQCRgAgXAyIAjAAIAGg2IgjAAg");
	this.shape.setTransform(54,-2.3);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgaAzIgVgOIAIhJIAYgOIAqAAIAWAOIgIBJIgZAOgAgTAcIAiAAIAFg2IghAAg");
	this.shape_2.setTransform(30.8,0);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgCBJIgVgOIANiDIAbAAIgNB6IAUAAIgCAXg");
	this.shape_3.setTransform(22.3,-2.3);
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgZAzIgXgOIAIhJIAagOIApAAIAVAOIgIBJIgYAOgAgTAcIAhAAIAGg2IghAAg");
	this.shape_6.setTransform(-12.9,0);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("Ag8BGIAOiLIBWAAIAVANIgLBwIgZAOgAgdAuIA0AAIAJhbIg0AAg");
	this.shape_7.setTransform(-25.4,-2);
	...
	this.shape_8.setTransform(-46.7,-3.6);
...
(lib.btnHorizontal3 = function(mode,startPosition,loop) {
	...
	// Layer_6
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AANAyIAIhMIghAAIgIBMIgcAAIAKhjIAXAAIAEAIIAOgIIAYAAIAWANIgJBWg");
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgjAyIALhjIAWAAIADAIIAPgIIAUAAIgCAXIgiAAIgHBMg");
	...
	this.shape_3.setTransform(30.3,0);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgaBGIAMhzIgmAAIACgYIBnAAIgDAYIglAAIgMBzg");
	this.shape_4.setTransform(19.9,-2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgBBCIgVgNIAGg+IgSAAIADgYIASAAIACgRIAcgPIgEAgIAWAAIgCAYIgWAAIgGA0IAWAAIgCAXg");
	this.shape_5.setTransform(5.1,-1.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAZAzIgNgIIgOAIIgYAAIgWgOIAIhJIAZgOIAXAAIANAIIAPgIIANAAIgKBlgAgUAcIAiAAIAFg2IghAAg");
	this.shape_6.setTransform(-4.8,0);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAQAyIgEgIIgOAIIgYAAIgWgNIAJhWIAcAAIgJBMIAiAAIAIhMIAbAAIgKBjg");
	this.shape_7.setTransform(-16.2,0);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAmBGIAKhcIgBAAIgpBcIgaAAIgWhdIgKBdIgbAAIAPiLIAlAAIAYBmIABAAIAthmIAlAAIgPCLg");
	this.shape_8.setTransform(-30.4,-2);
	...
	this.shape_9.setTransform(-53.6,-3.6);
...
(lib.actMC02c2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// timeline functions:
	this.frame_4 = function() {
		this.stop();
		var cAns = ["PlanetJupiter.jpg", "Planet Jupiter.jpg", "Planet_Jupiter.jpg", "Planet-Jupiter.jpg", "Jupiter.jpg", 
		"JupiterPlanet.jpg", "Jupiter Planet.jpg", "Jupiter_Planet.jpg", "Jupiter-Planet.jpg",
		"PlanetMusytari.jpg", "Planet Musytari.jpg", "Planet-Musytari.jpg", "Musytari.jpg",
		"MusytariPlanet.jpg", "Musytari Planet.jpg", "Musytari-Planet.jpg"];
		var _this = this;
		...
		function checkAns(e){
			...
			if (cResult){
				_this.parent.sendScore(filename, 5);
			} else {
				_this.parent.sendScore(filename, 1);
			}
		}
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(236.5,400.5);
...
(lib.actMC02c = function(mode,startPosition,loop) {
	...
	this.frame_4 = function() {
		this.stop();
		var cAns = ["Planet Jupiter", "Jupiter", "Planet Musytari", "Musytari"];
		var _this = this;
		this.btnSubmit.mouseEnabled = false;
		this.btnSubmit.alpha = .5;
		var myContainer = document.getElementById("dom_overlay_container");
		...
		function checkAns(e){
			...
			if (cResult){
				_this.parent.sendScore(txtAns.value, 5);
			} else {
				_this.parent.sendScore(txtAns.value, 1);
			}
		}
		this.btnSubmit.addEventListener("click", checkAns);
	}
	...
	// Layer_1
	this.instance = new lib.mcTxtInstr();
	this.instance.parent = this;
	this.instance.setTransform(560.3,315.6);
	...
	this.btnSubmit.name = "btnSubmit";
	this.btnSubmit.parent = this;
	this.btnSubmit.setTransform(481,429.5,0.85,0.85,0,0,0,0.2,0.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btnSubmit},{t:this.txtAns},{t:this.instance}]}).wait(5));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AheEoIAAh6IB5AAIAAB6gAhCBPIgIh2IBeg2IA9AAIAAiBIihAAIAABJIhRAAIAAhbIBeg3ICHAAIBeA3IAACmIheA2Ig/AAIgGBjg");
	this.shape.setTransform(260.1,331.2);

	this.instance_1 = new lib.picIcon("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(259.9,345.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.shape}]}).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(145.5,241,561.5,221);


(lib.actMC02b2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// timeline functions:
	this.frame_4 = function() {
		this.stop();
		var cAns = ["PlanetNeptune.jpg", "Planet Neptune.jpg", "Planet_Neptune.jpg", "Planet-Neptune.jpg", "Neptune.jpg", 
		"NeptunePlanet.jpg", "Neptune Planet.jpg", "Neptune_Planet.jpg", "Neptune-Planet.jpg",
		"PlanetNeptun.jpg", "Planet Neptun.jpg", "Planet-Neptun.jpg", "Neptun.jpg",
		"NeptunPlanet.jpg", "Neptun Planet.jpg", "Neptun-Planet.jpg"];
		var _this = this;
		this.btnSubmit.mouseEnabled = false;
		this.btnSubmit.alpha = .5;
		var myContainer = document.getElementById("dom_overlay_container");
...
(lib.actMC02b = function(mode,startPosition,loop) {
	...
	this.frame_4 = function() {
		this.stop();
		var cAns = ["Planet Neptune", "Neptune", "Planet Neptun", "Neptun"];
		var _this = this;
		this.btnSubmit.mouseEnabled = false;
		this.btnSubmit.alpha = .5;
		var myContainer = document.getElementById("dom_overlay_container");
...
(lib.actMC02_a = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// timeline functions:
	this.frame_4 = function() {
		this.stop();
		var cAns = ["PlanetMars.jpg", "Planet Mars.jpg", "Planet_Mars.jpg", "Planet-Mars.jpg", "Mars.jpg", 
		"MarsPlanet.jpg", "Mars Planet.jpg", "Mars_Planet.jpg", "Mars-Planet.jpg",
		"PlanetMarikh.jpg", "Planet Marikh.jpg", "Planet-Marikh.jpg", "Marikh.jpg",
		"MarikhPlanet.jpg", "Marikh Planet.jpg", "Marikh-Planet.jpg"];
		var _this = this;
		this.btnSubmit.mouseEnabled = false;
		this.btnSubmit.alpha = .5;
		var myContainer = document.getElementById("dom_overlay_container");
...
(lib.actMC02 = function(mode,startPosition,loop) {
	...
	this.frame_4 = function() {
		this.stop();
		var cAns = ["Planet Mars", "Mars", "Planet Marikh", "Marikh"];
		var _this = this;
		this.btnSubmit.mouseEnabled = false;
		this.btnSubmit.alpha = .5;
		var myContainer = document.getElementById("dom_overlay_container");
...
(lib.actMC01c = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		function onDownload(e){
			...
			link.href = "images/download/img789.jpg";
			link.setAttribute("type", "file");
			link.download = "img789.jpg";
			document.body.appendChild(link);
			link.click();
			_this.parent.sendScore("(download file)", 5);
		}
		this.btnDownload.addEventListener("click", onDownload);
	}
	...
	// btn
	this.btnDownload = new lib.mcBtnDownload();
	this.btnDownload.name = "btnDownload";
	this.btnDownload.parent = this;
	this.btnDownload.setTransform(430.6,500.5,0.85,0.85,0,0,0,0.2,0.6);

	this.timeline.addTween(cjs.Tween.get(this.btnDownload).wait(1));

	// pic
	this.instance = new lib.picIcon("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(432,337.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.actMC01c, new cjs.Rectangle(317.7,232.6,221,290.6), null);


(lib.actMC01b = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		function onDownload(e){
			var link = document.createElement('a');
			link.href = "images/download/img456.jpg";
			link.setAttribute("type", "file");
			link.download = "img456.jpg";
			document.body.appendChild(link);
			link.click();
			_this.parent.sendScore("(download file)", 5);
		}
...
}).prototype = getMCSymbolPrototype(lib.actMC01b, new cjs.Rectangle(317.7,232.6,221,290.6), null);


(lib.actMC01 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		function onDownload(e){
			var link = document.createElement('a');
			link.href = "images/download/img123.jpg";
			link.setAttribute("type", "file");
			link.download = "img123.jpg";
			document.body.appendChild(link);
			link.click();
			_this.parent.sendScore("(download file)", 5);
		}
...
}).prototype = getMCSymbolPrototype(lib.actMC01, new cjs.Rectangle(317.7,232.6,221,290.6), null);


// stage content:
(lib.f3s11 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{q1:104,q2:126,q3:191,q4:255,q5:277,q6:342,q7:406,q8:428,q9:493,finalFb:568});
	...
	this.frame_99 = function() {
		...
		if (debugMode) {
			...
			var mySet = randRange(0,2);
			this.myData.qItem.push(qItem1[mySet]);
			this.myData.qItem.push(qItem2[mySet]);
			this.myData.qItem.push(qItem3[mySet]);
		}
		function goNextQ (){
			_this.currentQ++;
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(4).call(this.frame_4).wait(39).call(this.frame_43).wait(56).call(this.frame_99).wait(10).call(this.frame_109).wait(16).call(this.frame_125).wait(48).call(this.frame_173).wait(18).call(this.frame_191).wait(59).call(this.frame_250).wait(10).call(this.frame_260).wait(16).call(this.frame_276).wait(48).call(this.frame_324).wait(18).call(this.frame_342).wait(59).call(this.frame_401).wait(10).call(this.frame_411).wait(16).call(this.frame_427).wait(48).call(this.frame_475).wait(18).call(this.frame_493).wait(59).call(this.frame_552).wait(16).call(this.frame_568).wait(172).call(this.frame_740).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcTimesUp).wait(104).to({_off:false},0).wait(637));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(568).to({_off:false},0).wait(173));
	...
	this.timeline.addTween(cjs.Tween.get(this.timer).wait(104).to({_off:false},0).wait(637));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(29).to({_off:false},0).to({regX:-20.4,regY:-1.9,scaleX:1,scaleY:1,x:691.6,y:77.8},16,cjs.Ease.cubicOut).wait(696));

	// prompt
	this.mcCont = new lib.cursor();
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(554.8,189.5,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(99).to({_off:false},0).to({_off:true},5).wait(637));

	// ss
	this.d1 = new lib.dialogue1();
	this.d1.name = "d1";
	this.d1.parent = this;
	this.d1.setTransform(443.3,130.4,1,1,0,0,0,-0.6,0.8);

	this.d2 = new lib.dialogue2a();
	this.d2.name = "d2";
	this.d2.parent = this;
	this.d2.setTransform(443.3,130.4,1,1,0,0,0,-0.6,0.8);

	this.d3 = new lib.dialogue3();
	this.d3.name = "d3";
	this.d3.parent = this;
	this.d3.setTransform(443.3,130.4,1,1,0,0,0,-0.6,0.8);

	this.d4 = new lib.dialogue1();
	this.d4.name = "d4";
	this.d4.parent = this;
	this.d4.setTransform(443.3,130.4,1,1,0,0,0,-0.6,0.8);

	this.d5 = new lib.dialogue2a();
	this.d5.name = "d5";
	this.d5.parent = this;
	this.d5.setTransform(443.3,130.4,1,1,0,0,0,-0.6,0.8);

	this.d6 = new lib.dialogue3();
	this.d6.name = "d6";
	this.d6.parent = this;
	this.d6.setTransform(443.3,130.4,1,1,0,0,0,-0.6,0.8);

	this.d7 = new lib.dialogue1();
	this.d7.name = "d7";
	this.d7.parent = this;
	this.d7.setTransform(443.3,130.4,1,1,0,0,0,-0.6,0.8);

	this.d8 = new lib.dialogue2a();
	this.d8.name = "d8";
	this.d8.parent = this;
	this.d8.setTransform(443.3,130.4,1,1,0,0,0,-0.6,0.8);

	this.d9 = new lib.dialogue3();
	this.d9.name = "d9";
	this.d9.parent = this;
	this.d9.setTransform(443.3,130.4,1,1,0,0,0,-0.6,0.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.d1}]},43).to({state:[{t:this.d2}]},83).to({state:[{t:this.d3}]},65).to({state:[{t:this.d4}]},64).to({state:[{t:this.d5}]},22).to({state:[{t:this.d6}]},65).to({state:[{t:this.d7}]},64).to({state:[{t:this.d8}]},22).to({state:[{t:this.d9}]},65).to({state:[]},75).wait(173));

	// avatar
	this.instance_2 = new lib.avatarMc();
	this.instance_2.parent = this;
	this.instance_2.setTransform(154.4,121.6,0.052,0.052);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(26).to({_off:false},0).to({scaleX:1,scaleY:1,x:144.3,y:121.5},17,cjs.Ease.elasticOut).to({_off:true},525).wait(173));
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:407.2,y:295.9}).wait(568).to({graphics:null,x:0,y:0}).wait(173));

	// actMc
	this.instance_3 = new lib.actMC01();
	this.instance_3.parent = this;
	this.instance_3.setTransform(0,240);
	this.instance_3._off = true;

	this.instance_4 = new lib.actMC02();
	this.instance_4.parent = this;
	this.instance_4.setTransform(0,199.6,1,1,0,0,0,0,-0.4);
	this.instance_4._off = true;

	this.instance_5 = new lib.actMC02_a();
	this.instance_5.parent = this;
	this.instance_5.setTransform(0,199.6,1,1,0,0,0,0,-0.4);
	this.instance_5._off = true;

	this.instance_6 = new lib.actMC01b();
	this.instance_6.parent = this;
	this.instance_6.setTransform(0,240);
	this.instance_6._off = true;

	this.instance_7 = new lib.actMC02b();
	this.instance_7.parent = this;
	this.instance_7.setTransform(0,199.6,1,1,0,0,0,0,-0.4);
	this.instance_7._off = true;

	this.instance_8 = new lib.actMC02b2();
	this.instance_8.parent = this;
	this.instance_8.setTransform(0,199.6,1,1,0,0,0,0,-0.4);
	this.instance_8._off = true;

	this.instance_9 = new lib.actMC01c();
	this.instance_9.parent = this;
	this.instance_9.setTransform(0,240);
	this.instance_9._off = true;

	this.instance_10 = new lib.actMC02c();
	this.instance_10.parent = this;
	this.instance_10.setTransform(0,199.6,1,1,0,0,0,0,-0.4);
	this.instance_10._off = true;

	this.instance_11 = new lib.actMC02c2();
	this.instance_11.parent = this;
	this.instance_11.setTransform(0,199.6,1,1,0,0,0,0,-0.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(109).to({_off:false},0).to({y:0},16,cjs.Ease.cubicOut).to({_off:true},1).wait(615));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(158).to({_off:false},0).to({y:-0.4},15,cjs.Ease.cubicOut).to({_off:true},18).wait(550));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(235).to({_off:false},0).to({y:-0.4},15,cjs.Ease.cubicOut).to({_off:true},5).wait(486));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(260).to({_off:false},0).to({y:0},16,cjs.Ease.cubicOut).to({_off:true},1).wait(464));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(309).to({_off:false},0).to({y:-0.4},15,cjs.Ease.cubicOut).to({_off:true},18).wait(399));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(386).to({_off:false},0).to({y:-0.4},15,cjs.Ease.cubicOut).to({_off:true},5).wait(335));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(411).to({_off:false},0).to({y:0},16,cjs.Ease.cubicOut).to({_off:true},1).wait(313));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(460).to({_off:false},0).to({y:-0.4},15,cjs.Ease.cubicOut).to({_off:true},18).wait(248));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(537).to({_off:false},0).to({y:-0.4},15,cjs.Ease.cubicOut).to({_off:true},16).wait(173));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(20).to({_off:false},0).to({_off:true},548).wait(173));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(741));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/f3s11/Bitmap19.png", id:"Bitmap19"},
		{src:"images/f3s11/Bitmap28.png", id:"Bitmap28"},
		{src:"images/f3s11/Bitmap3.png", id:"Bitmap3"},
		{src:"images/f3s11/Bitmap30.png", id:"Bitmap30"},
		{src:"images/f3s11/Bitmap31.png", id:"Bitmap31"},
		{src:"images/f3s11/Bitmap8.png", id:"Bitmap8"},
		{src:"images/f3s11/Bitmap9.png", id:"Bitmap9"},
