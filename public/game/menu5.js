...
p.nominalBounds = new cjs.Rectangle(0,0,375,252);
...
(lib.planet6 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_4
	this.instance = new lib.Bitmap13();
	this.instance.parent = this;
	this.instance.setTransform(-143,-125,0.851,0.851);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-143,-125,319,214.4);
...
(lib.mcTxt2En = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET TECHNOGLITCH", "italic bold 28px 'Quantico'", "#0EE0E0");
...
(lib.animPlanet6 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.planet6("single",0);
	this.instance.parent = this;
...
p.nominalBounds = new cjs.Rectangle(-142.8,-132.7,319,214.4);
...
// stage content:
(lib.menu5 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(90).call(this.frame_94).wait(46).call(this.frame_140).wait(41).call(this.frame_181).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(181).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnCont).wait(140).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(140).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(126).to({_off:false},0).wait(56));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1,p:{x:111.2}},{t:this.shape}]},119).to({state:[{t:this.shape_3,p:{x:120.3}},{t:this.shape_2}]},1).to({state:[{t:this.shape_5},{t:this.shape_4}]},1).to({state:[{t:this.shape_7},{t:this.shape_6}]},1).to({state:[{t:this.shape_1,p:{x:115.1}},{t:this.shape_8}]},1).to({state:[{t:this.shape_3,p:{x:113.1}},{t:this.shape_9}]},2).wait(57));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(92).to({_off:false},0).wait(90));

	// planet6
	this.instance_4 = new lib.animPlanet6();
	this.instance_4.parent = this;
	this.instance_4.setTransform(980.1,325.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(19).to({x:383.4},89,cjs.Ease.cubicInOut).wait(74));

	// planet5
	this.instance_5 = new lib.animPlanet5();
	this.instance_5.parent = this;
	this.instance_5.setTransform(400.1,325.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(19).to({x:-383.9},89,cjs.Ease.cubicInOut).wait(74));

	// planet19
	this.instance_6 = new lib.animPlanet19();
	this.instance_6.parent = this;
	this.instance_6.setTransform(69,231.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(19).to({x:9},89,cjs.Ease.quadInOut).wait(74));

	// planet18
	this.instance_7 = new lib.animPlanet18();
	this.instance_7.parent = this;
	this.instance_7.setTransform(515.7,262.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(19).to({x:407.7},89,cjs.Ease.quadInOut).wait(74));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(61).to({_off:false},0).wait(121));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(76).to({_off:false},0).wait(106));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(54).to({_off:false},0).wait(128));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(27).to({_off:false},0).wait(155));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(38).to({_off:false},0).wait(144));

	// stars1
	this.instance_13 = new lib.starzRandom();
	this.instance_13.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(182));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(182));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(319.3,274,1237,795.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/menu5/Bitmap10.png?1527739849544", id:"Bitmap10"},
		{src:"images/menu5/Bitmap13.png?1527739849544", id:"Bitmap13"},
		{src:"images/menu5/Bitmap3.png?1527739849544", id:"Bitmap3"},
		{src:"images/menu5/Bitmap4.png?1527739849544", id:"Bitmap4"},
		{src:"images/menu5/Bitmap5.png?1527739849544", id:"Bitmap5"},
		{src:"images/menu5/Bitmap6.png?1527739849544", id:"Bitmap6"},
		{src:"images/menu5/Bitmap7.png?1527739849544", id:"Bitmap7"},
		{src:"images/menu5/Bitmap8.png?1527739849544", id:"Bitmap8"},
		{src:"images/menu5/Bitmap9.png?1527739849544", id:"Bitmap9"},
		{src:"images/menu5/planet5e.png?1527739849544", id:"planet5e"},
		{src:"sounds/bleep_stutter.mp3?1527739849544", id:"bleep_stutter"},
		{src:"sounds/menuRock2.mp3?1527739849544", id:"menuRock2"},
		{src:"sounds/stdClick.mp3?1527739849544", id:"stdClick"}
	],
	preloads: []
};
