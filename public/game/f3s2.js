...
(lib.actMc9 = function(mode,startPosition,loop) {
	...
	this.frame_4 = function() {
		...
		txtPos.style.textAlign = "center"; 
		txtPos.readOnly = true;
		txtPos.value = "40.6892° N, 74.0445° W";
...
(lib.actMc3a = function(mode,startPosition,loop) {
	...
	this.frame_4 = function() {
		...
		txtPos.style.textAlign = "center"; 
		txtPos.readOnly = true;
		txtPos.value = "27.1750° N, 78.0422° E";	 
	...
	this.txtPos.setTransform(540.3,336,2.671,1.591,0,0,0,50.2,11.3);
...
p.nominalBounds = new cjs.Rectangle(247.6,317.2,427,234.3);
...
// stage content:
(lib.f3s2 = function(mode,startPosition,loop) {
	...
	this.frame_100 = function() {
		...
		if (debugMode) {
			...
			this.myData.qItem.push(_this.qItem1[randRange(0, 4)]);
			this.myData.qItem.push(_this.qItem2[randRange(0, 4)]);
			this.myData.qItem.push(_this.qItem3[randRange(0, 4)]);
		}
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/f3s2/Bitmap14.png?1529468021168", id:"Bitmap14"},
		{src:"images/f3s2/Bitmap19.png?1529468021168", id:"Bitmap19"},
		{src:"images/f3s2/Bitmap3.png?1529468021168", id:"Bitmap3"},
		{src:"images/f3s2/Bitmap8.png?1529468021168", id:"Bitmap8"},
		{src:"images/f3s2/Bitmap9.png?1529468021168", id:"Bitmap9"},
		{src:"sounds/mdroid_talk.mp3?1529468021168", id:"mdroid_talk"},
		{src:"sounds/questionAlert.mp3?1529468021168", id:"questionAlert"},
		{src:"sounds/questionComplete.mp3?1529468021168", id:"questionComplete"},
		{src:"sounds/submitAns.mp3?1529468021168", id:"submitAns"},
		{src:"sounds/suspense.mp3?1529468021168", id:"suspense"},
		{src:"sounds/timeout.mp3?1529468021168", id:"timeout"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1529468021168", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1529468021168", id:"sdk/anwidget.js"},
		{src:"components/ui/src/textinput.js?1529468021168", id:"an.TextInput"}
	],
	preloads: []
};
