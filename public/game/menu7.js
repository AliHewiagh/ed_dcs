...
p.nominalBounds = new cjs.Rectangle(0,0,435,413);
...
(lib.blobPlanet = function() {
	this.initialize(img.blobPlanet);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,388,285);// helper functions:
...
(lib.planet17 = function(mode,startPosition,loop) {
	...
	// Layer_4
	this.instance = new lib.blobPlanet();
	this.instance.parent = this;
	this.instance.setTransform(-88,-65,0.453,0.453);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-88,-65,175.9,129.2);


(lib.planet11 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_4
	this.instance = new lib.Bitmap14();
	this.instance.parent = this;
	this.instance.setTransform(-174,-158,0.795,0.795);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-174,-158,345.8,328.3);


(lib.planet8g = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.Bitmap16();
	this.instance.parent = this;
	this.instance.setTransform(-127,-131,0.847,0.847);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-127,-131,254,261.6);
...
(lib.mcTxt2En = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET LOOP-E-LOOP", "italic bold 28px 'Quantico'", "#0EE0E0");
...
(lib.mcTxt2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET LOOP-I-LOOP", "italic bold 28px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.lineHeight = 42;
...
}).prototype = getMCSymbolPrototype(lib.mcTxt2, new cjs.Rectangle(-78.8,-22,362.5,44.1), null);
...
p.nominalBounds = new cjs.Rectangle(-78.8,-14,362.5,44.1);
...
(lib.animPlanet17 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(-84.4,-64,175.9,129.2);


(lib.animPlanet8 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.planet8g("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(13.3,10.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-23.5},49).to({y:10.5},50).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-113.7,-120.5,254,261.6);


(lib.animPlanet7 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.planet11("single",0);
	this.instance.parent = this;
...
p.nominalBounds = new cjs.Rectangle(-173.8,-165.7,345.8,328.3);
...
// stage content:
(lib.menu7 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(90).call(this.frame_94).wait(48).call(this.frame_142).wait(41).call(this.frame_183).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(183).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnCont).wait(142).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(142).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(128).to({_off:false},0).wait(56));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(92).to({_off:false},0).wait(92));

	// planet9
	this.instance_4 = new lib.animPlanet8();
	this.instance_4.parent = this;
	this.instance_4.setTransform(1043.4,325.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(19).to({x:384.4},89,cjs.Ease.cubicInOut).wait(76));

	// planet8
	this.instance_5 = new lib.animPlanet7();
	this.instance_5.parent = this;
	this.instance_5.setTransform(413.4,325.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(19).to({x:-374.6},89,cjs.Ease.cubicInOut).to({_off:true},1).wait(75));

	// planet19
	this.instance_6 = new lib.animPlanet19();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-71,231.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(19).to({x:-171},89,cjs.Ease.quadInOut).to({_off:true},1).wait(75));

	// planet18
	this.instance_7 = new lib.animPlanet18();
	this.instance_7.parent = this;
	this.instance_7.setTransform(277.7,262.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(19).to({x:97.7},89,cjs.Ease.quadInOut).wait(76));

	// planet17
	this.instance_8 = new lib.animPlanet17();
	this.instance_8.parent = this;
	this.instance_8.setTransform(894.5,342.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(19).to({x:726.5},89,cjs.Ease.quadInOut).wait(76));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(61).to({_off:false},0).wait(123));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(76).to({_off:false},0).wait(108));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(54).to({_off:false},0).wait(130));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(27).to({_off:false},0).wait(157));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(38).to({_off:false},0).wait(146));

	// stars1
	this.instance_14 = new lib.starzRandom();
	this.instance_14.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(184));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(184));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(227.7,274,1355.9,795.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/menu7/Bitmap10.png?1522335162958", id:"Bitmap10"},
		{src:"images/menu7/Bitmap14.png?1522335162958", id:"Bitmap14"},
		{src:"images/menu7/Bitmap16.png?1522335162958", id:"Bitmap16"},
		{src:"images/menu7/Bitmap3.png?1522335162958", id:"Bitmap3"},
		{src:"images/menu7/Bitmap4.png?1522335162958", id:"Bitmap4"},
		{src:"images/menu7/Bitmap5.png?1522335162958", id:"Bitmap5"},
		{src:"images/menu7/Bitmap6.png?1522335162958", id:"Bitmap6"},
		{src:"images/menu7/Bitmap7.png?1522335162958", id:"Bitmap7"},
		{src:"images/menu7/Bitmap8.png?1522335162958", id:"Bitmap8"},
		{src:"images/menu7/Bitmap9.png?1522335162958", id:"Bitmap9"},
		{src:"images/menu7/blobPlanet.png?1522335162958", id:"blobPlanet"},
		{src:"sounds/bleep_stutter.mp3?1522335162958", id:"bleep_stutter"},
		{src:"sounds/menuRock2.mp3?1522335162958", id:"menuRock2"},
		{src:"sounds/stdClick.mp3?1522335162958", id:"stdClick"}
	],
	preloads: []
};
