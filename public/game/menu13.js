...
(lib.mcTxt2En = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET STORMALOT", "italic bold 28px 'Quantico'", "#0EE0E0");
...
(lib.mcTxt2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET SERIBUT", "italic bold 28px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.lineHeight = 42;
...
// stage content:
(lib.menu13 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(90).call(this.frame_94).wait(54).call(this.frame_148).wait(41).call(this.frame_189).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(189).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnCont).wait(148).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(148).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(134).to({_off:false},0).wait(56));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(92).to({_off:false},0).wait(98));

	// planet14
	this.instance_4 = new lib.animPlanet14();
	this.instance_4.parent = this;
	this.instance_4.setTransform(1088.2,308.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(19).to({x:394.5,y:311.7},89,cjs.Ease.quadInOut).wait(82));

	// planet13
	this.instance_5 = new lib.animPlanet13();
	this.instance_5.parent = this;
	this.instance_5.setTransform(409.8,330.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(19).to({x:-390.2},89,cjs.Ease.cubicInOut).to({_off:true},1).wait(81));

	// planet17
	this.instance_6 = new lib.animPlanet17();
	this.instance_6.parent = this;
	this.instance_6.setTransform(14.5,342.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(19).to({x:-155.5},89,cjs.Ease.quadInOut).to({_off:true},1).wait(81));

	// planet16
	this.instance_7 = new lib.animPlanet16();
	this.instance_7.parent = this;
	this.instance_7.setTransform(364.5,282.9,0.5,0.5,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(19).to({x:234.5},89,cjs.Ease.quadInOut).wait(82));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(61).to({_off:false},0).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(76).to({_off:false},0).wait(114));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(54).to({_off:false},0).wait(136));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(27).to({_off:false},0).wait(163));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(38).to({_off:false},0).wait(152));

	// stars1
	this.instance_13 = new lib.starzRandom();
	this.instance_13.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(190));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(190));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(319.3,274,1312.4,795.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/menu13/Bitmap22.png?1527433357526", id:"Bitmap22"},
		{src:"images/menu13/Bitmap23.png?1527433357526", id:"Bitmap23"},
		{src:"images/menu13/Bitmap3.png?1527433357526", id:"Bitmap3"},
		{src:"images/menu13/Bitmap4.png?1527433357526", id:"Bitmap4"},
		{src:"images/menu13/Bitmap5.png?1527433357526", id:"Bitmap5"},
		{src:"images/menu13/Bitmap6.png?1527433357526", id:"Bitmap6"},
		{src:"images/menu13/Bitmap7.png?1527433357526", id:"Bitmap7"},
		{src:"images/menu13/Bitmap8.png?1527433357526", id:"Bitmap8"},
		{src:"images/menu13/blobPlanet.png?1527433357526", id:"blobPlanet"},
		{src:"images/menu13/greenplanet2.png?1527433357526", id:"greenplanet2"},
		{src:"sounds/bleep_stutter.mp3?1527433357526", id:"bleep_stutter"},
		{src:"sounds/menuRock2.mp3?1527433357526", id:"menuRock2"},
		{src:"sounds/stdClick.mp3?1527433357526", id:"stdClick"}
	],
	preloads: []
};
