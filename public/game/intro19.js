...
(lib.tEn3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt2 = new cjs.Text("I think here’s where we insert\nthe key.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 353;
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(230.4,7);
...
}).prototype = getMCSymbolPrototype(lib.tEn3, new cjs.Rectangle(51.8,-1,357.2,174.5), null);
...
(lib.tEn4 = function(mode,startPosition,loop) {
	...
	this.mcCont.setTransform(293.4,115.1,0.35,0.35,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1));

	// Layer_1
	this.myTxt = new cjs.Text("We need to answer a few questions\nto gain access.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	this.myTxt.lineWidth = 414;
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(86,50.3);

	this.timeline.addTween(cjs.Tween.get(this.myTxt).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EAgTAF3IAAroMhAlAAAIAALo");
	this.shape.setTransform(86.5,79.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EggSgDPIeTAAInCGHIL9mHIdXAA");
	this.shape_1.setTransform(86.5,138);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.996)").s().p("Ah/CwI+TAAIAArnMBAlAAAIAALnI9XAAIr9GIg");
	this.shape_2.setTransform(86.5,99.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.tEn4, new cjs.Rectangle(-123,41.8,441.3,119), null);
...
(lib.tEn1 = function(mode,startPosition,loop) {
	...
	// Layer_4
	this.myTxt1 = new cjs.Text("Do you think Mabusa had hidden\nthe Sun in there?", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 365;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(189.5,15.8);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_5
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("Ad6FfIAAq4Mg7zAAAIAAK4");
	this.shape_3.setTransform(190.2,46);
	...
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("ACQiAMggJAAAIAAq5MA7zAAAIAAK5I1/AAIpvO6g");
	this.shape_5.setTransform(190.2,94);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-3.1,10.5,386.8,172);
...
(lib.tBm4 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("Kita perlu menjawab beberapa soalan\nuntuk membuka pintu.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.textAlign = "center";
	this.myTxt.lineHeight = 31;
	this.myTxt.lineWidth = 435;
	this.myTxt.alpha = 0.99607843;
	this.myTxt.parent = this;
	this.myTxt.setTransform(86.5,50.3);
...
}).prototype = getMCSymbolPrototype(lib.tBm4, new cjs.Rectangle(-133,41.8,451.3,119), null);
...
(lib.tBm1 = function(mode,startPosition,loop) {
	...
	this.mcCont.name = "mcCont";
	this.mcCont.parent = this;
	this.mcCont.setTransform(495,362.8,0.35,0.35,0,0,0,0.5,0.5);
	this.mcCont._off = true;

	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(1).to({_off:false},0).wait(1));

	// Layer_1
	this.myTxt2 = new cjs.Text("Kita akan tahu tak\nlama lagi.", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt2.name = "myTxt2";
	this.myTxt2.textAlign = "center";
	this.myTxt2.lineHeight = 31;
	this.myTxt2.lineWidth = 253;
	this.myTxt2.alpha = 0.99607843;
	this.myTxt2.parent = this;
	this.myTxt2.setTransform(370.3,293.2);
	this.myTxt2._off = true;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("AY1FqIAArCMgmJAAAIAACCIrViMILVFtIAAFf");
	this.shape.setTransform(335.7,322.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("AzEAAIUnAAIDhAAIOBAA");
	this.shape_1.setTransform(372.5,359.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AKuFnIjhAAI0mAAIAAlgIrWlsILWCLIAAiCMAmIAAAIAALDg");
	this.shape_2.setTransform(336.2,323.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).wait(1));

	// Layer_5
	this.myTxt1 = new cjs.Text("Mungkinkah Mabusa telah menyembunyikan\n Matahari di dalam situ?", "italic bold 20px 'Quantico'", "#0EE0E0");
	this.myTxt1.name = "myTxt1";
	this.myTxt1.textAlign = "center";
	this.myTxt1.lineHeight = 31;
	this.myTxt1.lineWidth = 496;
	this.myTxt1.alpha = 0.99607843;
	this.myTxt1.parent = this;
	this.myTxt1.setTransform(198.2,15.8);

	this.timeline.addTween(cjs.Tween.get(this.myTxt1).wait(2));

	// Layer_6
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(14,224,224,0.996)").ss(1,0,0,3).p("EglqAFfIAAq4MA5cAAAIBJAAIQwAAIAAK4");
	this.shape_3.setTransform(197.9,46);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(14,224,224,0.996)").ss(4,0,0,3).p("EglqgHwMAmtAAAIkEO6IJvu6Ie9AA");
	this.shape_4.setTransform(197.9,130.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.996)").s().p("ABDiAMgmtAAAIAAq5MA5cAAAIBJAAIQwAAIAAK5I+9AAIpvO6g");
	this.shape_5.setTransform(197.9,94);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-51.5,10.5,499.6,172);
...
p.nominalBounds = new cjs.Rectangle(-260.9,8.6,451.3,118.5);
...
p.nominalBounds = new cjs.Rectangle(-137,-22.7,499.6,171.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/intro19/Bitmap1.png?1524641376386", id:"Bitmap1"},
		{src:"images/intro19/Bitmap10.png?1524641376386", id:"Bitmap10"},
		{src:"images/intro19/Bitmap11.png?1524641376386", id:"Bitmap11"},
		{src:"images/intro19/Bitmap2.png?1524641376386", id:"Bitmap2"},
		{src:"images/intro19/Bitmap5.png?1524641376386", id:"Bitmap5"},
		{src:"images/intro19/Bitmap6.png?1524641376386", id:"Bitmap6"},
		{src:"images/intro19/Bitmap7.png?1524641376386", id:"Bitmap7"},
		{src:"images/intro19/Bitmap8.png?1524641376386", id:"Bitmap8"},
		{src:"images/intro19/Bitmap8_1.png?1524641376386", id:"Bitmap8_1"},
		{src:"images/intro19/Bitmap9.png?1524641376386", id:"Bitmap9"},
		{src:"images/intro19/Bitmap9_1.png?1524641376386", id:"Bitmap9_1"},
		{src:"sounds/intro.mp3?1524641376386", id:"intro"},
		{src:"sounds/questionComplete.mp3?1524641376386", id:"questionComplete"},
		{src:"sounds/stdClick.mp3?1524641376386", id:"stdClick"}
	],
	preloads: []
};
