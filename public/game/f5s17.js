...
(lib.actMc2copy2 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.item1.ansStr = "HDD 120GB";
		this.item2.ansStr = "16GB DDR4";
		this.item3.ansStr = "i5 3.2GHz";
		this.item4.ansStr = "SSD 500GB";
		this.item5.ansStr = "8GB DDR3";
		this.item6.ansStr = "i7 4.7GHz";
		this.item7.ansStr = "i5 4.3GHz";
		this.item8.ansStr = "HDD 500GB";
		this.item9.ansStr = "4GB DDR";
		//get positions
		for (i=1; i<=maxItem; i++){
		...
		function submitAns(){
			var cScore = 0;
			var _userAns = _this["item"+userAns[0]].ansStr +", "
			+ _this["item"+userAns[1]].ansStr +", "
			+ _this["item"+userAns[2]].ansStr;
			for (var i=1; i<=3; i++){
...
(lib.actMc2copy = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.btnSubmit.mouseEnabled = false;
		this.btnSubmit.alpha = .5;
		this.item1.ansStr = "HDD 60GB";
		this.item2.ansStr = "16GB DDR4";
		this.item3.ansStr = "i3 2.8GHz";
		this.item4.ansStr = "SSD 120GB";
		this.item5.ansStr = "8GB DDR3";
		this.item6.ansStr = "i7 3.4GHz";
		this.item7.ansStr = "i5 3.2GHz";
		this.item8.ansStr = "HDD 120GB";
		this.item9.ansStr = "1GB DDR";
		//get positions
		for (i=1; i<=maxItem; i++){
			this["item"+i].itemNum = i;
			initX[i-1] = this["item"+i].x;
...
(lib.actMc2 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.btnSubmit.mouseEnabled = false;
		this.btnSubmit.alpha = .5;
		this.item1.ansStr = "HDD 80GB";
		this.item2.ansStr = "16GB DDR4";
		this.item3.ansStr = "i5 3.0GHz";
		this.item4.ansStr = "SSD 256GB";
		this.item5.ansStr = "8GB DDR3";
		this.item6.ansStr = "i7 4.3GHz";
		this.item7.ansStr = "i5 4.0GHz";
		this.item8.ansStr = "HDD 256GB";
		this.item9.ansStr = "4GB DDR";
		//get positions
		for (i=1; i<=maxItem; i++){
			this["item"+i].itemNum = i;
...
// stage content:
(lib.f5s17 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{q1:104,q2:149,q3:194,q4:237,q5:283,q6:330,q7:376,q8:426,q9:474,q10:517,q11:562,q12:607,q13:652,q14:695,finalFb:738});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(4).call(this.frame_4).wait(39).call(this.frame_43).wait(56).call(this.frame_99).wait(5).call(this.frame_104).wait(40).call(this.frame_144).wait(5).call(this.frame_149).wait(40).call(this.frame_189).wait(5).call(this.frame_194).wait(36).call(this.frame_230).wait(7).call(this.frame_237).wait(36).call(this.frame_273).wait(10).call(this.frame_283).wait(40).call(this.frame_323).wait(7).call(this.frame_330).wait(37).call(this.frame_367).wait(9).call(this.frame_376).wait(40).call(this.frame_416).wait(10).call(this.frame_426).wait(37).call(this.frame_463).wait(12).call(this.frame_475).wait(35).call(this.frame_510).wait(8).call(this.frame_518).wait(35).call(this.frame_553).wait(10).call(this.frame_563).wait(35).call(this.frame_598).wait(10).call(this.frame_608).wait(35).call(this.frame_643).wait(10).call(this.frame_653).wait(35).call(this.frame_688).wait(8).call(this.frame_696).wait(35).call(this.frame_731).wait(7).call(this.frame_738).wait(171).call(this.frame_909).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcTimesUp).wait(104).to({_off:false},0).wait(806));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(738).to({_off:false},0).wait(172));
	...
	this.timeline.addTween(cjs.Tween.get(this.timer).wait(104).to({_off:false},0).wait(806));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(29).to({_off:false},0).to({regX:-20.4,regY:-1.9,scaleX:1,scaleY:1,x:691.6,y:87.8},16,cjs.Ease.cubicOut).wait(865));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(99).to({_off:false},0).to({_off:true},5).wait(806));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},43).to({state:[{t:this.instance_3}]},431).to({state:[]},264).wait(172));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(26).to({_off:false},0).to({scaleX:1,scaleY:1,x:154.5,y:121.7},17,cjs.Ease.elasticOut).to({_off:true},695).wait(172));
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:407.2,y:295.9}).wait(738).to({graphics:null,x:0,y:0}).wait(172));
	...
	this.instance_7 = new lib.actMc1_1copy();
	this.instance_7.parent = this;
	this.instance_7.setTransform(0,310);
	this.instance_7._off = true;

	this.instance_8 = new lib.actMc1_2a();
	this.instance_8.parent = this;
	this.instance_8.setTransform(0,310);
	this.instance_8._off = true;

	this.instance_9 = new lib.actMc2_1();
	this.instance_9.parent = this;
	this.instance_9.setTransform(0,310);
	this.instance_9._off = true;

	this.instance_10 = new lib.actMc2_1copy();
	this.instance_10.parent = this;
	this.instance_10.setTransform(0,310);
	this.instance_10._off = true;

	this.instance_11 = new lib.actMc2_2();
	this.instance_11.parent = this;
	this.instance_11.setTransform(0,310);
	this.instance_11._off = true;

	this.instance_12 = new lib.actMc2_2copy();
	this.instance_12.parent = this;
	this.instance_12.setTransform(0,310);
	this.instance_12._off = true;

	this.instance_13 = new lib.actMc1();
	this.instance_13.parent = this;
	this.instance_13.setTransform(0,390);
	this.instance_13._off = true;

	this.instance_14 = new lib.actMc1copy();
	this.instance_14.parent = this;
	this.instance_14.setTransform(0,390);
	this.instance_14._off = true;

	this.instance_15 = new lib.actMc1copy2();
	this.instance_15.parent = this;
	this.instance_15.setTransform(0,390);
	this.instance_15._off = true;

	this.instance_16 = new lib.actMc2();
	this.instance_16.parent = this;
	this.instance_16.setTransform(0,390);
	this.instance_16._off = true;

	this.instance_17 = new lib.actMc2copy();
	this.instance_17.parent = this;
	this.instance_17.setTransform(0,390);
	this.instance_17._off = true;

	this.instance_18 = new lib.actMc2copy2();
	this.instance_18.parent = this;
	this.instance_18.setTransform(0,390);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(130).to({_off:false},0).to({y:0},14,cjs.Ease.cubicOut).to({_off:true},5).wait(761));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(175).to({_off:false},0).to({y:0},14,cjs.Ease.cubicOut).to({_off:true},5).wait(716));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(216).to({_off:false},0).to({y:0},14,cjs.Ease.cubicOut).to({_off:true},7).wait(673));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(259).to({_off:false},0).to({y:0},14,cjs.Ease.cubicOut).to({_off:true},6).wait(631));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(308).to({_off:false},0).to({y:0},15,cjs.Ease.cubicOut).to({_off:true},7).wait(580));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(352).to({_off:false},0).to({y:0},15,cjs.Ease.cubicOut).to({_off:true},9).wait(534));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(401).to({_off:false},0).to({y:0},15,cjs.Ease.cubicOut).to({_off:true},10).wait(484));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(448).to({_off:false},0).to({y:0},15,cjs.Ease.cubicOut).to({_off:true},11).wait(436));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(497).to({_off:false},0).to({y:0},13,cjs.Ease.cubicOut).to({_off:true},1).wait(399));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(540).to({_off:false},0).to({y:0},13,cjs.Ease.cubicOut).to({_off:true},1).wait(356));
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(585).to({_off:false},0).to({y:0},13,cjs.Ease.cubicOut).to({_off:true},1).wait(311));
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(630).to({_off:false},0).to({y:0},13,cjs.Ease.cubicOut).to({_off:true},1).wait(266));
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(675).to({_off:false},0).to({y:0},13,cjs.Ease.cubicOut).to({_off:true},1).wait(221));
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(718).to({_off:false},0).to({y:0},13,cjs.Ease.cubicOut).to({_off:true},7).wait(172));

	// q
	this.instance_19 = new lib.mcQ7();
	this.instance_19.parent = this;
	this.instance_19.setTransform(398.5,203,0.05,0.05);
	this.instance_19._off = true;

	this.instance_20 = new lib.mcQ();
	this.instance_20.parent = this;
	this.instance_20.setTransform(585,191.6,0.1,0.1);
	this.instance_20._off = true;

	this.instance_21 = new lib.mcQ2();
	this.instance_21.parent = this;
	this.instance_21.setTransform(585,191.6,0.1,0.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(104).to({_off:false},0).to({scaleX:1,scaleY:1,x:377.3,y:197},21,cjs.Ease.elasticOut).wait(24).to({scaleX:0.05,scaleY:0.05,x:398.5,y:203},0).to({scaleX:1,scaleY:1,x:377.3},21,cjs.Ease.elasticOut).wait(24).to({scaleX:0.05,scaleY:0.05,x:398.5},0).to({scaleX:1,scaleY:1,x:377.3,y:197},21,cjs.Ease.elasticOut).wait(22).to({scaleX:0.05,scaleY:0.05,x:398.5,y:203},0).to({scaleX:1,scaleY:1,x:377.3,y:197},21,cjs.Ease.elasticOut).to({_off:true},21).wait(4).to({_off:false,scaleX:0.05,scaleY:0.05,x:398.5,y:203},0).to({scaleX:1,scaleY:1,x:377.3},21,cjs.Ease.elasticOut).wait(26).to({scaleX:0.05,scaleY:0.05,x:398.5},0).to({scaleX:1,scaleY:1,x:377.3},21,cjs.Ease.elasticOut).wait(25).to({scaleX:0.05,scaleY:0.05,x:398.5},0).to({scaleX:1,scaleY:1,x:377.3},21,cjs.Ease.elasticOut).wait(29).to({scaleX:0.05,scaleY:0.05,x:398.5},0).to({scaleX:1,scaleY:1,x:377.3},21,cjs.Ease.elasticOut).to({_off:true},27).wait(436));
	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(475).to({_off:false},0).to({scaleX:1,scaleY:1,x:463.1,y:213.1},21,cjs.Ease.elasticOut).to({_off:true},15).wait(7).to({_off:false,scaleX:0.1,scaleY:0.1,x:585,y:191.6},0).to({scaleX:1,scaleY:1,x:463.1,y:213.1},21,cjs.Ease.elasticOut).to({_off:true},15).wait(9).to({_off:false,scaleX:0.1,scaleY:0.1,x:585,y:191.6},0).to({scaleX:1,scaleY:1,x:463.1,y:213.1},21,cjs.Ease.elasticOut).to({_off:true},15).wait(311));
	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(608).to({_off:false},0).to({scaleX:1,scaleY:1,x:463.1,y:213.1},21,cjs.Ease.elasticOut).to({_off:true},15).wait(9).to({_off:false,scaleX:0.1,scaleY:0.1,x:585,y:191.6},0).to({scaleX:1,scaleY:1,x:463.1,y:213.1},21,cjs.Ease.elasticOut).to({_off:true},15).wait(7).to({_off:false,scaleX:0.1,scaleY:0.1,x:585,y:191.6},0).to({scaleX:1,scaleY:1,x:463.1,y:213.1},21,cjs.Ease.elasticOut).to({_off:true},21).wait(172));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.prog4},{t:this.prog3},{t:this.prog2},{t:this.prog1}]},99).to({state:[]},639).wait(172));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(20).to({_off:false},0).to({_off:true},718).wait(172));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(910));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/f5s17/Bitmap11.png?1529741227750", id:"Bitmap11"},
		{src:"images/f5s17/Bitmap14.png?1529741227750", id:"Bitmap14"},
		{src:"images/f5s17/Bitmap15.png?1529741227750", id:"Bitmap15"},
		{src:"images/f5s17/Bitmap17.png?1529741227750", id:"Bitmap17"},
		{src:"images/f5s17/Bitmap21.png?1529741227750", id:"Bitmap21"},
		{src:"images/f5s17/Bitmap22.png?1529741227750", id:"Bitmap22"},
		{src:"images/f5s17/Bitmap3.png?1529741227750", id:"Bitmap3"},
		{src:"images/f5s17/Bitmap4.png?1529741227750", id:"Bitmap4"},
		{src:"images/f5s17/Bitmap7.png?1529741227750", id:"Bitmap7"},
		{src:"images/f5s17/Bitmap9.png?1529741227750", id:"Bitmap9"},
		{src:"sounds/mdroid_talk.mp3?1529741227750", id:"mdroid_talk"},
		{src:"sounds/questionAlert.mp3?1529741227750", id:"questionAlert"},
		{src:"sounds/questionComplete.mp3?1529741227750", id:"questionComplete"},
		{src:"sounds/stdClick.mp3?1529741227750", id:"stdClick"},
		{src:"sounds/submitAns.mp3?1529741227750", id:"submitAns"},
		{src:"sounds/suspense.mp3?1529741227750", id:"suspense"},
		{src:"sounds/timeout.mp3?1529741227750", id:"timeout"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1529741227750", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1529741227750", id:"sdk/anwidget.js"},
		{src:"components/ui/src/combobox.js?1529741227750", id:"an.ComboBox"}
	],
	preloads: []
};
