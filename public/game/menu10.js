...
p.nominalBounds = new cjs.Rectangle(0,0,405,410);


(lib.Bitmap20 = function() {
	this.initialize(img.Bitmap20);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,303,390);
...
p.nominalBounds = new cjs.Rectangle(0,0,388,285);


(lib.greenplanet2 = function() {
	this.initialize(img.greenplanet2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,353,355);// helper functions:
...
(lib.planet11 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-115,-123,0.703,0.703);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-115,-123,213,274.2);


(lib.planet8 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_2
	this.instance = new lib.Bitmap19();
	this.instance.parent = this;
	this.instance.setTransform(-161,-167,0.787,0.787);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-161,-167,318.6,322.6);
...
(lib.mcTxt2En = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET INFINICKRY", "italic bold 28px 'Quantico'", "#0EE0E0");
...
(lib.mcTxt2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.myTxt = new cjs.Text("PLANET INFINIKRI", "italic bold 28px 'Quantico'", "#0EE0E0");
	this.myTxt.name = "myTxt";
	this.myTxt.lineHeight = 42;
...
(lib.animPlanet11 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-24.8},49).to({y:-0.8},50).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-114.8,-130.7,213,274.2);


(lib.animPlanet10 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.instance = new lib.planet8("single",0);
	this.instance.parent = this;
	this.instance.setTransform(2.8,1.7,1,1,0,0,0,-0.8,0.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:12.1},29).to({y:1.7},30).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-157.4,-166.1,318.6,322.5);


(lib.animPlanet9 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
// stage content:
(lib.menu10 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(4).call(this.frame_4).wait(90).call(this.frame_94).wait(51).call(this.frame_145).wait(41).call(this.frame_186).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.mcCont).wait(186).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btnCont).wait(145).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(145).to({_off:false},0).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(131).to({_off:false},0).wait(56));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(92).to({_off:false},0).wait(95));

	// planet11
	this.instance_4 = new lib.animPlanet9();
	this.instance_4.parent = this;
	this.instance_4.setTransform(1193,325.9);

	this.instance_5 = new lib.animPlanet11();
	this.instance_5.parent = this;
	this.instance_5.setTransform(409.8,325.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4}]}).to({state:[{t:this.instance_4}]},19).to({state:[{t:this.instance_5}]},89).wait(79));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(19).to({_off:true,x:409.8},89,cjs.Ease.cubicInOut).wait(79));

	// planet10
	this.instance_6 = new lib.animPlanet10();
	this.instance_6.parent = this;
	this.instance_6.setTransform(398.5,318.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(19).to({x:-387.5},89,cjs.Ease.quadInOut).to({_off:true},1).wait(78));

	// planet17
	this.instance_7 = new lib.animPlanet17();
	this.instance_7.parent = this;
	this.instance_7.setTransform(334.5,342.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(19).to({x:244.5},89,cjs.Ease.quadInOut).wait(79));

	// planet16
	this.instance_8 = new lib.animPlanet16();
	this.instance_8.parent = this;
	this.instance_8.setTransform(784.5,282.9,0.5,0.5,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(19).to({x:654.5},89,cjs.Ease.quadInOut).wait(79));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(61).to({_off:false},0).wait(126));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(76).to({_off:false},0).wait(111));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(54).to({_off:false},0).wait(133));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(27).to({_off:false},0).wait(160));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(38).to({_off:false},0).wait(149));

	// stars1
	this.instance_14 = new lib.starzRandom();
	this.instance_14.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(187));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(187));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(319.3,274,1371.9,795.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/menu10/Bitmap19.png?1522337521053", id:"Bitmap19"},
		{src:"images/menu10/Bitmap20.png?1522337521053", id:"Bitmap20"},
		{src:"images/menu10/Bitmap3.png?1522337521053", id:"Bitmap3"},
		{src:"images/menu10/Bitmap4.png?1522337521053", id:"Bitmap4"},
		{src:"images/menu10/Bitmap5.png?1522337521053", id:"Bitmap5"},
		{src:"images/menu10/Bitmap6.png?1522337521053", id:"Bitmap6"},
		{src:"images/menu10/Bitmap7.png?1522337521053", id:"Bitmap7"},
		{src:"images/menu10/Bitmap8.png?1522337521053", id:"Bitmap8"},
		{src:"images/menu10/blobPlanet.png?1522337521053", id:"blobPlanet"},
		{src:"images/menu10/greenplanet2.png?1522337521053", id:"greenplanet2"},
		{src:"sounds/bleep_stutter.mp3?1522337521053", id:"bleep_stutter"},
		{src:"sounds/menuRock2.mp3?1522337521053", id:"menuRock2"},
		{src:"sounds/stdClick.mp3?1522337521053", id:"stdClick"}
	],
	preloads: []
};
