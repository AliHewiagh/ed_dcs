...
(lib.AMC03 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.btnSubmit.mouseEnabled = false;
		this.btnSubmit.alpha = .5;
		this.item1.ansStr="Hidangkan kek di atas pinggan";
		this.item2.ansStr="Kacau tepung, telur dan mentega dalam mangkuk";
		this.item3.ansStr="Nikmati kek";
		this.item4.ansStr="(Anak panah)";
		//get positions
		for (i=1; i<=maxItem; i++){
...
(lib.AMC02 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.btnSubmit.mouseEnabled = false;
		this.btnSubmit.alpha = .5;
		this.item1.ansStr="Telur sudah masak?";
		this.item2.ansStr="Goreng telur";
		this.item3.ansStr="Kacau telur di dalam mangkuk";
		this.item4.ansStr="Mula";
		//get positions
		for (i=1; i<=maxItem; i++){
			this["item"+i].itemNum = i;
			this["item"+i].cursor = "pointer";
...
(lib.AMC01 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.btnSubmit.mouseEnabled = false;
		this.btnSubmit.alpha = .5;
		this.item1.ansStr="Tuang air ke dalam cerek";
		this.item2.ansStr="Air sudah mendidih?";
		this.item3.ansStr="Nikmati coklat panas";
		this.item4.ansStr="(Anak panah)";
		//get positions
		for (i=1; i<=maxItem; i++){
			this["item"+i].itemNum = i;
...
// stage content:
(lib.f3s5 = function(mode,startPosition,loop) {
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/f3s5/Bitmap22.png", id:"Bitmap22"},
		{src:"images/f3s5/Bitmap3.png", id:"Bitmap3"},
		{src:"images/f3s5/Bitmap8.png", id:"Bitmap8"},
		{src:"images/f3s5/Bitmap9.png", id:"Bitmap9"},
