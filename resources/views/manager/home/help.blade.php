			...
			<div class="container">	
				...
				<div class="tab-content">
					...
					<div class="tab-pane" id="3">
						<div class="bottom-edge">
							<h4 class="text-primary">1. A Teacher has forgotten his/her username and password. How can I help?</h4>
							<p>If the Teacher has NOT logged in before, you can check by clicking <strong>Teachers</strong> in the side menu.</p>
						...
						<div class="bottom-edge">
							<h4 class="text-primary">2. A Student has forgotten his/her username and password. How can I help?</h4>
						...
						<div class="bottom-edge">
							<h4 class="text-primary">3. Some details about my school were wrongly entered. How can I fix this?</h4>
							<ol type="a">
								<li>In the side menu, click <strong>Setting</strong>.</li>
								<li>Review and edit the details of your school.</li>
								<li>Click <strong>Update</strong>.</li>
							</ol>
						</div>
						<div class="bottom-edge">
							<h4 class="text-primary">4. During the assessment, many students are logged out or have their browsers stop responding due to poor Internet connection. What should they do?</h4>
							<ol type="a">
