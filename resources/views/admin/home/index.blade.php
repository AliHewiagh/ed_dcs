...
@section('content')
    ...
    $year6SchoolIds = \App\SchoolClass::where('type', 'Year 6')->pluck('school_id')->toArray();
    ...
    $form3SchoolIds = \App\SchoolClass::where('type', 'Form 3')->pluck('school_id')->toArray();
    ...
    $form5SchoolIds = \App\SchoolClass::where('type', 'Form 5')->pluck('school_id')->toArray();
