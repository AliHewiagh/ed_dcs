                            ...
                            <div class="table-responsive">
                                <table id="example2" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form method="post" action="{{url('/admin/student/done/update/'.$student->id)}}" style="margin-bottom:5px">
                                                @csrf @method('PATCH')
                                            ...
                                            <a href="{{url('/admin/student/edit/'.$student->id)}}" class="btn btn-warning">Edit</a>
                                        ...
                                        <div data-remodal-id="modalDelete{{$student->id}}" role="dialog" class="delete_model_c">
                                            ...
                                            <br>
                                            <form method="post" action="{{url('/admin/student/delete/'.$student->id)}}">
                                                @csrf @method('DELETE')
