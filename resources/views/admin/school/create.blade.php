                ...
                <form id="merchantForm" method="post" action="{{url("admin/school")}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="type" class="form-control required" id="schoolTypeInput">
                            ...
                            <option value="2" @if(old('type') == 2) selected="selected" @endif>Secondary School</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="school_type_id" class="form-control required" id="schoolTypeInput2" required>
                            ...
                            @foreach($priTypes as $priType)
                                <option value="{{$priType->id}}" class="priTypes" @if(old('school_type_id') == $priType->id) selected="selected" @endif>{{$priType->name}}</option>
                            @endforeach
                            @foreach($secTypes as $secType)
                                <option value="{{$secType->id}}" class="secTypes" @if(old('school_type_id') == $secType->id) selected="selected" @endif>{{$secType->name}}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <select name="state_id" class="form-control required" id="stateInput" required>
                            ...
                            @foreach($states as $state)
                                <option value="{{$state->id}}" data-name="{{$state->name}}" @if(old('state_id') == $state->id) selected="selected" @endif>{{$state->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="pkg" class="form-control required" id="PKGInput" required>
                            @if(!empty(old('pkg'))) <option value="{{old('pkg')}}">{{old('pkg')}}</option> @endif
                            <option value="">Please select PKG</option>
                            @foreach($pkgs as $pkg)
                                <option value="{{$pkg->pkg}}" class="PKGOptions {{$pkg->state_id}}" @if($pkg->pkg == old('pkg')) selected="selected" @endif>{{$pkg->pkg}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="location_id" class="form-control required" id="statePPInput" required>
                            ...
                            @foreach($pps as $pp)
                                <option value="{{$pp->id}}" class="ppTypes {{$pp->state_id}}" @if(old('location_id') == $pp->id) selected="selected" @endif>{{$pp->pp}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="area" class="form-control required" id="areaInput">
                            ...
                            <option value="Urban School" @if(old('area') == "Urban School") selected="selected" @endif>Urban School</option>
                            <option value="Rural School" @if(old('area') == "Rural School") selected="selected" @endif>Rural School</option>
                        </select>
                    </div>
                    ...
                    {{--<div class="form-group">--}}
                        ...
                        {{--<select name="mypib" class="form-control" id="mypibInput" required>--}}
                            {{--<option value="">Please Select</option>--}}
                            {{--<option value="1" @if(old('mypib') == 1) selected="selected" @endif>Yes</option>--}}
                            {{--<option value="0" @if(old('mypib') === 0) selected="selected" @endif>No</option>--}}
                        {{--</select>--}}
                    {{--</div>--}}
                    ...
                    {{--<div class="form-group">--}}
                        ...
                        {{--<select name="sekolahi" class="form-control" id="sekolahiInput" required>--}}
                            {{--<option value="">Please Select</option>--}}
                            {{--<option value="1" @if(old('sekolahi') == 1) selected="selected" @endif>Yes</option>--}}
                            {{--<option value="0" @if(old('sekolahi') === 0) selected="selected" @endif>No</option>--}}
                        {{--</select>--}}
                    {{--</div>--}}
                    ...
                    {{--<div class="form-group">--}}
                        ...
                        {{--<select name="sekolahk" class="form-control" id="sekolahkInput" required>--}}
                            {{--<option value="">Please Select</option>--}}
                            {{--<option value="1" @if(old('sekolahk') == 1) selected="selected" @endif>Yes</option>--}}
                            {{--<option value="0" @if(old('sekolahk') === 0) selected="selected" @endif>No</option>--}}
                        {{--</select>--}}
                    {{--</div>--}}
                    ...
                    {{--<div class="form-group">--}}
                        ...
                        {{--<select name="sbt" class="form-control" id="sbtInput" required>--}}
                            {{--<option value="">Please Select</option>--}}
                            {{--<option value="1" @if(old('sbt') == 1) selected="selected" @endif>Yes</option>--}}
                            {{--<option value="0" @if(old('sbt') === 0) selected="selected" @endif>No</option>--}}
                        {{--</select>--}}
                    {{--</div>--}}
